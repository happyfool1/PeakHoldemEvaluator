...
public class EvalData implements Constants {
	...
	*************************************************************************************** */
	 ...
	 * Best made hand or draw for player on this street
	  ************************************************************************************** */
	int[] drawFlop = new int[PLAYERS];
	int[] drawTurn = new int[PLAYERS];
	int[] madeFlop = new int[PLAYERS];
	int[] madeTurn = new int[PLAYERS];
	int[] madeRiver = new int[PLAYERS];
	...
	* This method simply initializes almost all variables in EvalData
	...
	static void initialize() {
		...
		for (int i = 0; i < PLAYERS; i++) {
			...
			int[] drawFlop = new int[PLAYERS];
 drawTurn[i] = new int[PLAYERS];
	  madeFlop = new int[PLAYERS];
	  madeTurn = new int[PLAYERS];
	 madeRiver = new int[PLAYERS];
		}
