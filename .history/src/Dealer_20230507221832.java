...
public class Dealer implements Constants {
	...
	*******************************************************************************/
	private static void setPositions() {
		for (int i = 0; i < PLAYERS; i++) {
			if (EvalData.positions[i] == SB){
				EvalData.playerPositions[BS] =i;
			}
			EvalData.playerPositions[EvalData.positions[SB]] = SB;
			EvalData.playerPositions[EvalData.positions[BB]] = BB;
			EvalData.playerPositions[EvalData.positions[UTG]] = UTG;
			EvalData.playerPositions[EvalData.positions[MP]] = MP;
			EvalData.playerPositions[EvalData.positions[CO]] = CO;
			EvalData.playerPositions[EvalData.positions[BU]] = BU;
		}
	}
}
