...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    void findBestAndWorst() {
        ...
        System.out.println("//yyy " + madeTotalColPerEntries.get(madeTotalColPerEntries.size() - 3).getRowOrCol() + 
        " " + madeTotalColPerEntries.size());
    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        System.out.println("//xxx " + bestMadeCols[0] + " "+ allArrayRowNames[0] + " "
         + bestMadeCols[1] + " "+ allArrayRowNames[1] + " " + bestMadeCols[2] + " "+ allArrayRowNames[2] + " ");
        ...
        st += "The bestDraw cols were " + drawArrayColNames[bestDrawCols[0]] + ", " + allArrayColNames[bestDrawCols[1]]
                + ", " + allArrayRowNames[bestDrawCols[2]] + "\r\n";
        st += "The worstDraw cols were " + allArrayColames[worstDrawCols[0]] + ", "
                + allArrayRowNames[worstDrawCols[1]]
                + ", " + allArrayRowNames[worstDrawCols[2]] + "\r\n";
        st += "The bestMade cols were " + allArrayColNames[bestMadeCols[0]] + ", " + allArrayColNames[bestMadeCols[1]]
                + ", " + allArrayRowNames[bestMadeCols[2]] + "\r\n";
        st += "The worstMade cols were " + allArrayColNames[worstMadeCols[0]] + ", "
                + allArrayRowNames[worstMadeCols[1]]
                + ", " + allArrayRowNames[worstMadeCols[2]] + "\r\n";
        st += "The bestShowdownw cols were " + allArrayRowNames[bestShowdownwCols[0]] + ", "
                + allArrayRowNames[bestShowdownwCols[1]]
