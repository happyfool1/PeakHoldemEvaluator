...
public class BoardAnalysis implements Constants {
	...
	*******************************************************************************/
	private static void doBoard4() {
		...
		} else if (suit == EvalData.boardCards[1].suit && suit == EvalData.boardCards[2].suit) {
			EvalData.boardArray[BOARD_4F] = true;
			EvalData.boardF4 = true;
		} else if (suit == EvalData.boardCards[1].suit && suit == EvalData.boardCards[2].suit) {
			EvalData.boardArray[BOARD_3F] = true;
			EvalData.boardF3 = true;
		} else if (suit2 == EvalData.boardCards[2].suit && suit == EvalData.boardCards[3].suit) {
			EvalData.boardArray[BOARD_3F] = true;
			EvalData.boardF3 = true;
		} else if (suit == EvalData.boardCards[1].suit) {
			EvalData.boardArray[BOARD_2F] = true;
	...
	*******************************************************************************/
	static void doRiver() {
		...
		if (suit == EvalData.boardCards[1].suit && suit == EvalData.boardCards[2].suit &&
			...
			EvalData.boardArray[BOARD_4F] = true;
			EvalData.boardF4 = true;
		} else if (suit2 == EvalData.boardCards[1].suit && suit == EvalData.boardCards[2].suit &&
				suit == EvalData.boardCards[3].suit) {
			EvalData.boardArray[BOARD_4F] = true;
			EvalData.boardF4 = true;
		} else
		...
		if (suit == EvalData.boardCards[1].suit && suit == EvalData.boardCards[2].suit) {
			...
			EvalData.boardArray[BOARD_3F] = true;
			EvalData.boardF3 = true;
		} else if (suit3 == EvalData.boardCards[3].suit && suit == EvalData.boardCards[4].suit) {
			EvalData.boardArray[BOARD_3F] = true;
			EvalData.boardF3 = true;
		} else if (suit == EvalData.boardCards[1].suit) {
			EvalData.boardArray[BOARD_2F] = true;
			...
			EvalData.boardArray[BOARD_2F] = true;
			EvalData.boardF2 = true;
		} else if (suit4 == EvalData.boardCards[4].suit) {
			EvalData.boardArray[BOARD_2F] = true;
			EvalData.boardF2 = true;
		} else {
			EvalData.boardArray[BOARD_RAINBOW] = true;
 ...
 ******************************************************************************/
	private static void evaluateDraws() {
		if (EvalData.drawTypeFlop[EvalData.seat] == DRAW_FLUSH  && EvalData.drawTypeFlop[DRAW_FLUSH_OESD]) {
