...
public class HandRangeConverter implements Constants {
	...
	private static void copyDataGapsArray() {
				...
				action.gapsArrayCall[SB][0][i] = rangeSBLimp.gaps;
				action.gapsArrayRaise[SB][0][i] = rangeSBOpen.gaps;
				action.gapsArrayCall[SB][1][i] = rangeSBCall.gaps;
				action.gapsArrayRaise[SB][1][i] = rangeSBBet3.gaps;
				action.gapsArrayCall[SB][2][i] = rangeSBBet3Call.gaps;
				action.gapsArrayRaise[SB][2][i] = rangeSBBet4.gaps;
				action.gapsArrayCall[SB][3][i] = rangeSBBet4Call.gaps;
				action.gapsArrayRaise[SB][3][i] = rangeSBAllin.gaps;
				action.gapsArrayCall[SB][4][i] = rangeSBAllinCall.gaps;
				action.gapsArrayRaise[BB][0][i] = rangeBBLimp.gaps;
				action.gapsArrayRaise[BB][0][i] = rangeBBOpen.gaps;
				action.gapsArrayCall[BB][1][i] = rangeBBCall.gaps;
				action.gapsArrayRaise[BB][1][i] = rangeBBBet3.gaps;
				action.gapsArrayCall[BB][2][i] = rangeBBBet3Call.gaps;
				action.gapsArrayRaise[BB][2][i] = rangeBBBet4.gaps;
				action.gapsArrayCall[BB][3][i] = rangeBBBet4Call.gaps;
				action.gapsArrayRaise[BB][3][i] = rangeBBAllin.gaps;
				action.gapsArrayCall[BB][4][i] = rangeBBAllinCall.gaps;
				action.gapsArrayCall[UTG][0][i] = rangeUTGLimp.gaps;
				action.gapsArrayRaise[UTG][0][i] = rangeUTGOpen.gaps;
				action.gapsArrayCall[UTG][1][i] = rangeUTGCall.gaps;
				action.gapsArrayRaise[UTG][1][i] = rangeUTGBet3.gaps;
				action.gapsArrayCall[UTG][2][i] = rangeUTGBet3Call.gaps;
				action.gapsArrayRaise[UTG][2][i] = rangeUTGBet4.gaps;
				action.gapsArrayCall[UTG][3][i] = rangeUTGBet4Call.gaps;
				action.gapsArrayRaise[UTG][3][i] = rangeUTGAllinCall.gaps;
				action.gapsArrayCall[MP][0][i] = rangeMPLimp.gaps;
				action.gapsArrayRaise[MP][0][i] = rangeMPOpen.gaps;
				action.gapsArrayCall[MP][1][i] = rangeMPCall.gaps;
				action.gapsArrayRaise[MP][1][i] = rangeMPBet3.gaps;
				action.gapsArrayCall[MP][2][i] = rangeMPBet3Call.gaps;
				action.gapsArrayRaise[MP][2][i] = rangeMPBet4.gaps;
				action.gapsArrayCall[MP][3][i] = rangeMPBet4Call.gaps;
				action.gapsArrayRaise[MP][3][i] = rangeMPAllin.gaps;
				action.gapsArrayCall[MP][4][i] = rangeMPAllinCall.gaps;
				action.gapsArrayCall[CO][0][i] = rangeCOLimp.gaps;
				action.gapsArrayRaise[CO][0][i] = rangeCOOpen.gaps;
				action.gapsArrayCall[CO][1][i] = rangeCOCall.gaps;
				action.gapsArrayRaise[CO][1][i] = rangeCOBet3.gaps;
				action.gapsArrayCall[CO][2][i] = rangeCOBet3Call.gaps;
				action.gapsArrayRaise[CO][2][i] = rangeCOBet4.gaps;
				action.gapsArrayCall[CO][3][i] = rangeCOBet4Call.gaps;
				action.gapsArrayRaise[CO][3][i] = rangeCOAllin.gaps;
				action.gapsArrayCall[CO][4][i] = rangeCOAllinCall.gaps;
				action.gapsArrayCall[BU][0][i] = rangeBULimp.gaps;
				action.gapsArrayRaise[BU][0][i] = rangeBUOpen.gaps;
				action.gapsArrayCall[BU][1][i] = rangeBUCall.gaps;
				action.gapsArrayRaise[BU][1][i] = rangeBUBet3.gaps;
				action.gapsArrayCall[BU][2][i] = rangeBUBet3Call.gaps;
				action.gapsArrayRaise[BU][2][i] = rangeBUBet4.gaps;
				action.gapsArrayCall[BU][3][i] = rangeBUBet4Call.gaps;
				action.gapsArrayRaise[BU][3][i] = rangeBUAllin.gaps;
				action.gapsArrayCall[BU][4][i] = rangeBUAllinCall.gaps;
					}
