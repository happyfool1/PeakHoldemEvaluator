...
public class GUI extends JFrame implements ActionListener, Constants {
	...
	*******************************************************************************/
	public void myFrame() {
		...
		panelShowdown = new JPanel(new GridLayout(6, 1));
		panelShowdown.setBounds(850 + offset, 40, 90, 200);
		mainPanel.add(panelShowdown);
	 
panelShowdownValue = new JPanel(new GridLayout(6, 1));
        panelShowdownValue.setBounds(910 + offset, 40, 90, 200);
