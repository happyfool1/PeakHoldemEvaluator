...
public class HoleCardAction implements Constants {
    ...
    ****************************************************************************** */
    ...
    int[][] actionArrayPlayability = new int[POSITIONS][10];
    int[][] actionArrayGaps = new int[POSITIONS][10];
    int[][] actionArrayCombos = new int[POSITIONS][10];
    double[][] actionArrayPercentage = new double[POSITIONS][10];
    ...
    private static JTextField[][] openLimpText = new JTextField[POSITIONS][4];
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            openLimpText[i][2] = new JTextField(String.valueOf(actionArrayPlayability[i][0][1]));
