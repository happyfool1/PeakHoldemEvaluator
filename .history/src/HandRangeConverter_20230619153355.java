...
* 60 ranges from PeakHoldemDatabase for one player type are combined into one 
* class HandRangeMultiple.
*  @author PEAK_ 
* ****************************************************************************** */
...
/*
 * Write the completed HandRangeMultiple class to a disk file
 */
static void writeToFile() {
    action.writeToFile(EvalData.applicationDirectory + type + "-HandRangeMultiple.ser");
}
