...
static int[] hmlDrawRowTotalTurn = new int[HML_FLOP_SIZE];
	static int[] hmlDrawColTotalTurn = new int[DRAW_SIZE];
	static int[] hmlMadeRowTotalTurn = new int[HML_FLOP_SIZE];
	static int[] hmlMadeColTotalTurn = new int[MADE_SIZE];
	static int[] hmlShowdownRowTotalTurn = new int[HML_FLOP_SIZE];
