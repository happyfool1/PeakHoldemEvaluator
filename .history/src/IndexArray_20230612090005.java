...
/***********************************************************************************
 * Find top 5 rows.
 * For index arrays with less than 5 rows, the top 5 rows are returned.
 ********************************************************************************** *
 void xx (){
...
********************************************************************************** */
	...
	********************************************************************************** */
    ...
    int [] top5DrawCols = new int[5];
    int [] top5ShowdownCols = new int[5];
    // Bottom 5
    int [] bottom5MadeRows = new int[5];
    int [] bottom5DrawRows = new int[5];
    int [] bottom5ShowdownRows = new int[5];
    int [] bottom5MadeCols = new int[5];
    int [] bottom5DrawCols = new int[5];
    int [] bottom5ShowdownCols = new int[5];
