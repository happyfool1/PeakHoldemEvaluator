...
public class Showdown implements Constants {
	...
	***************************************************************************************/
	...
	private static void initializeShowdownValue() {
		...
		EvalData.suit = -1;
		for (int i = 0; i < PLAYERS; i++) {
			EvalData.showdownHand[i] = -1;
			EvalData.showdownWinnerHand[i] = -1;
			EvalData.showdownRank[i] = -1; 
			EvalData.highCards1 = new int[PLAYERS];
			EvalData. highCards2 = new int[PLAYERS];
	EvalData. suits = new int[PLAYERS];
	EvalData.kickers1 = new int[PLAYERS];
	EvalData.kickers2 = new int[PLAYERS];
	EvalData.kickers3 = new int[PLAYERS];
        }
	}
	...
	static void playerData() {
		...
		case MADE_FULL_HOUSE -> {
			...
			EvalData.highCards2[EvalData.seat] = EvalData.highCard2;
			 valData.showdownSt[EvalData.seat] = new StringBuilder().append("//Fill
			  house high card ")
