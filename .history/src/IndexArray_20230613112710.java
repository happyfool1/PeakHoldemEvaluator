    ...
    ****************************************************************************** */
    IndexArray(int[][] drawArray, int[][] madeArray, int[][] showdownArray, String[] rowNames) {
        ...
        for (int i = 0; i < this.rowNames.length; i++) {
            pairList.add(new Pair(this.drawRowTotalPer[i], this.rowNames[i]));
        }

        pairList.sort(Comparator.comparing(Pair::getPercentage));

        for (Pair pair : pairList) {
            System.out.println("Percentage: " + pair.getPercentage() + ", Item: " + pair.getName());
        }
    }
  /*- **************************************************************************************
...
void createIndexArrayList() {
    for (int i = 0; i < this.drawColTotalPerArray.length; i++) {
        indexArrayList.add(this.indexArray[i]);
    }
}


    /*- **************************************************************************************
    * Class that holds percentages, row, col, rowName, and colName.
    * percentage is the unique  key.
    ***************************************************************************************** */
    class Pair {
        Double percentage;
        int row;
        ...
        public Pair(Double percentage, int row, int col, String rowSt, String colSt) {
