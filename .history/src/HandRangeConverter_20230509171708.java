...
public class HandRangeConverter implements Constants {
	...
	public static void main(String[] s0) {
		createRanges();
		doConversion();
		System.out.println("//HandRangeConversion complete " + action.actionArray[0][0][0] 
		+ " " + action.actionArray[0][0][1] 
		+ " " + action.actionArray[0][1][0]
		+ " " + action.actionArray[0][1][1]);
	...
	private static void createRanges() {
		...
		String type = "Hero";
		rangeSBLimp.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\SB\\Limp.ser");
		rangeSBOpen.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\SB\\Open.ser");
		rangeSBCall.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\SB\\Call.ser");
		rangeSBBet3.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\SB\\Bet3.ser");
		rangeSBBet3Call.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\SB\\Bet3Call.ser");
		rangeSBBet4.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\SB\\Bet4.ser");
		rangeSBBet4Call.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\SB\\Bet4Call.ser");
		rangeSBAllin.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\SB\\Allin.ser");
		rangeSBAllinCall.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\SB\\AllinCall.ser");

		rangeBBLimp.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BB\\Limp.ser");
		rangeBBOpen.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BB\\Open.ser");
		rangeBBCall.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BB\\Call.ser");
		rangeBBBet3.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BB\\Bet3.ser");
		rangeBBBet3Call.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BB\\Bet3Call.ser");
		rangeBBBet4.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BB\\Bet4.ser");
		rangeBBBet4Call.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BB\\Bet4Call.ser");
		rangeBBAllin.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BB\\Allin.ser");
		rangeBBAllinCall.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BB\\AllinCall.ser");

		rangeUTGLimp.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\UTG\\Limp.ser");
		rangeUTGOpen.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\UTG\\Open.ser");
		rangeUTGCall.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\UTG\\Call.ser");
		rangeUTGBet3.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\UTG\\Bet3.ser");
		rangeUTGBet3Call.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\UTG\\Bet3Call.ser");
		rangeUTGBet4.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\UTG\\Bet4.ser");
		rangeUTGBet4Call.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\UTG\\Bet4Call.ser");
		rangeUTGAllin.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\UTG\\Allin.ser");
		rangeUTGAllinCall.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\UTG\\AllinCall.ser");

		rangeMPLimp.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\MP\\Limp.ser");
		rangeMPOpen.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\MP\\Open.ser");
		rangeMPCall.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\MP\\Call.ser");
		rangeMPBet3.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\MP\\Bet3.ser");
		rangeMPBet3Call.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\MP\\Bet3Call.ser");
		rangeMPBet4.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\MP\\Bet4.ser");
		rangeMPBet4Call.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\MP\\Bet4Call.ser");
		rangeMPAllin.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\MP\\Allin.ser");
		rangeMPAllinCall.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\MP\\AllinCall.ser");

		rangeCOLimp.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\CO\\Limp.ser");
		rangeCOOpen.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\CO\\Open.ser");
		rangeCOCall.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\CO\\Call.ser");
		rangeCOBet3.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\CO\\Bet3.ser");
		rangeCOBet3Call.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\CO\\Bet3Call.ser");
		rangeCOBet4.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\CO\\Bet4.ser");
		rangeCOBet4Call.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\CO\\Bet4Call.ser");
		rangeCOAllin.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\CO\\Allin.ser");
		rangeCOAllinCall.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\CO\\AllinCall.ser");

		rangeBULimp.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BU\\Limp.ser");
		rangeBUOpen.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BU\\Open.ser");
		rangeBUCall.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BU\\Call.ser");
		rangeBUBet3.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BU\\Bet3.ser");
		rangeBUBet3Call.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BU\\Bet3Call.ser");
		rangeBUBet4.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BU\\Bet4.ser");
		rangeBUBet4Call.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BU\\Bet4Call.ser");
		rangeBUAllin.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BU\\Allin.ser");
		rangeBUAllinCall.readRange("C:\\PeahHoldemDatabase\\"+ type + "\\Preflop\\BU\\AllinCall.ser");
	...
	private static void doConversion() {
		...
		action.writeFile(C:\\ApplicationData\\"+type"+".ser");
	}
