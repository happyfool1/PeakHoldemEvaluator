...
public interface Constants {
	...
	*******************************************************************************/
	...
	int MADE_BOARD_TWOPAIR = 6;

	int MADE_BOARD_PAIR_PLUS_PAIR = 6;

	int MADE_BOTTOM_TWO_PAIR = 7;

	int MADE_TOP_AND_BOTTOM_TWO_PAIR = 8;

	int MADE_TOP_TWO_PAIR = 9;

	int MADE_BOARD_SET = 10;

	int MADE_SET = 11;

	int MADE_STRAIGHT = 12;

	int MADE_FLUSH = 13;

	int MADE_FULL_HOUSE = 14;

	int MADE_FOUR_OF_A_KIND = 15;

	int MADE_STRAIGHT_FLUSH = 16;

	int MADE_ROYAL_FLUSH = 17;

	int MADE_HANDS_SIZE = 18;

	String[] MADE_ARRAY_ST = { "No hand", "Board Pait", "Bottom Pair", "Middle Pair", "Top Pair", "Over Pair",
			"Board Pair + Made Pair", "Bottom 2 pair",
