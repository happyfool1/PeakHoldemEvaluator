...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    ...
    private String stringStrategy() {
        double bestDraw = drawRowTotalSortedPer[0];
        double worstDraw = drawRowTotalSortedPer[drawRowTotalSortedPer.length - 1];
        double bestMade = madeRowTotalSortedPer[0];
        double worstMade = madeRowTotalSortedPer[madeRowTotalSortedPer.length - 1];
        double bestShowdownw = showdownRowTotalSortedPer[0];
        double worstShowdown = showdownRowTotalSortedPer[madeRowTotalSortedPer.length - 1];
