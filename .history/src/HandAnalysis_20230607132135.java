...
/*- **************************************************************************** 
	...
	*******************************************************************************/
	static void doBoard4() {
		...
		if ((EvalData.board[0].value == EvalData.board[1].value && EvalData.board[0].value == EvalData.board[2].value) ||
		(EvalData.board[1].value == EvalData.board[2].value && EvalData.board[1].value == EvalData.board[3].value)) {
			EvalData.boardArray[BOARD_SET] = true;
			EvalData.boardSet = true;
		} 
		else if (EvalData.board[0].value == EvalData.board[1].value) {
		...
		&& EvalData.boardCards[0].suit != EvalData.boardCards[2].suit
		&& EvalData.boardCards[1].suit != EvalData.boardCards[2].suit)
		&& EvalData.boardCards[0].value == EvalData.boardCards[1].value && EvalData.boardCards[0].value == EvalData.boardCards[2].value) {
            EvalData.boardArray[BOARD_FULL] = true;
            EvalData.boardFull = true;
        }{
	return;
}
		...
		if ((suit == EvalData.boardCards[1].suit && suit == EvalData.boardCards[2].suit)||
		(suit == EvalData.boardCards[2].suit && suit2 == EvalData.boardCards[3].suit)){
			EvalData.boardArray[BOARD_3F] = true;
			EvalData.boardF3 = true;
		}
		// ssx xss
		suit = EvalData.boardCards[0].suit;
		suit2 = EvalData.boardCards[1].suit;
		if ((suit == EvalData.boardCards[1].suit && suit != EvalData.boardCards[2].suit))||
		( suit2 == EvalData.boardCards[2].suit && suit != EvalData.boardCards[3].suit)) {
			EvalData.boardArray[BOARD_2F] = true;
			EvalData.boardF2 = true;
		} else {
			suit = EvalData.boardCards[1].suit;
