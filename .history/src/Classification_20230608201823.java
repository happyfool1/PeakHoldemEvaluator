...
public class Classification implements Constants {
	...
	***************************************************************************************************/
	...
	private static void boardPossiblesTurn() {
		...
		if (EvalData.boardArray[BOARD_2F]) {
			 if (EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_GUTSHOT]) {
			 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_FLUSH_GUTSHOT] = true;
		}
		 if (EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_OESD]) {
		 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_FLUSH_OESD] = true;
		 }
		 }
		 ...
		 EvalData.boardArray[BOARD_GAP2]) {
		 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_GUTSHOT] = true;
		 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_GUTSHOT_HIGH] = true;
		 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_GUTSHOT_PAIR] = true;
		 }

		 if (EvalData.boardArray[BOARD_GAP0] || EvalData.boardArray[BOARD_GAP1] ||
		 EvalData.boardArray[BOARD_GAP2]) {
		 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_OESD] = true;
		 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_OESD_PAIR] = true;
		 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_STRAIGHT] = true;
		 }

		if (EvalData.boardArray[BOARD_3F]) {
			 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_FLUSH] = true;
			 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_FLUSH] = true;
			 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_FLUSH_PAIR] = true;
