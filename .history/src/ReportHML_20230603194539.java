...
public class ReportHML implements Constants {
    ...
    ********************************************************************************** */
    static void reportHMLDrawFlop(int c, int r) {
        if (frame7 == null) {
            frame7 = new JFrame("Flop HML Drawing hands");
            frame7.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            frame7.setLocation(c, r);
            frame7.setPreferredSize(new Dimension(750, 330));
        }
        ...
        tableModel7 = new DefaultTableModel(dataHMLDrawFlop, columnsHMLDrawFlop);
        ...
        for (int i = 0; i < HML_FLOP_SIZE; ++i) {
            ...
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
                if (ManyData.hmlDraw[i][j] > 0) {
                    table7.setValueAt("   " + String.valueOf(ManyData.hmlDraw[i][j]), row, col);
                    double per = ((double) ManyData.hmlDraw[i][j] / (double) ManyData.hmlCount) * 100.0;
                    table7.setValueAt(Format.formatPer(per), row  , col);
                
                    String cellValueStr = "   " + String.valueOf(ManyData.hmlDrawn[i][j]);
    ...
    static void reportHMLDrawFlopZZ(int c, int r) {
        if (frame1 == null) {
            frame1 = new JFrame("Flop HML Draw hands");
            frame1.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            frame1.setLocation(c, r);
            frame1.setPreferredSize(new Dimension(650, 330));
    ...
    ********************************************************************************** */
    static void reportHMLMadeFlop(int c, int r) {
        if (frame2 == null) {
            ...
            frame2.setPreferredSize(new Dimension(650, 330));
        ...
        for (int i = 0; i < HML_FLOP_SIZE; ++i) {
            ...
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
                if (ManyData.hmlShowdownWon[i][j] > 0) {
                    ...
                    table11.setValueAt(Format.formatPer(per), row , col);
                }
                col++;
            }
            col = 1;
    ...
    static void reportHMLShowdownRiver(int c, int r) {
        ...
        for (int i = 0; i < HML_FLOP_SIZE; ++i) {
            ...
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
                if (ManyData.hmlShowdownWon[i][j] > 0) {
                    double per = ((double) ManyData.hmlShowdownWon[i][j] / (double) ManyData.showdownCount) * 100.0;
                    table12.setValueAt(Format.formatPer(per), row , col);
                }
                col++;
            }
            col = 1;
    ...
    ***********************************************************************************/
    static void reportHMLShowdownFlop(int c, int r) {
        ...
        table7 = new JTable(tableModell0);
        table7.setFont(ff1);
        table7.setRowHeight(25);
        ...
        for (int i = 0; i < HML_FLOP_SIZE; ++i) {
            ...
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
                if (ManyData.hmlShowdownWon[i][j] > 0) {
                    double per = ((double) ManyData.hmlShowdownWon[i][j] / (double) ManyData.showdownCount) * 70.0;
                    table7.setValueAt(Format.formatPer(per), row , col);
                    String cellValueStr = "   " + String.valueOf(ManyData.hmlShowdownWon[i][j]);
                   // table7.setValueAt(cellValueStr, row, col);
