...
public class Classification implements Constants {
	...
	* Calculate Flop index
	...
	private static void calculateFlopIndex() {
		final int[] ranks = { EvalData.flop[0].value, EvalData.flop[1].value,EvalData.flop[2].value, };
		// Calculate the differences between the ranks
		final int diff1 = EvalData.flop[1].value- EvalData.flop[0].value;
		final int diff2 = EvalData.flop[2].value - ranks[1];
		final int diff3 = 		final int diff1 = EvalData.flop[1].value- EvalData.flop[0].value;
 - ranks[0];
