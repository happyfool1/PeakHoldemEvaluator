...
******************************************************************************/
	 ...
	 ***************************************************************************** */
	static void showdownValueString() {
		switch (EvalData.showdownHand[EvalData.seat]) {
			case MADE_ROYAL_FLUSH -> {
				EvalData. showdownValueSt[EvalData.seat] = "//Waited a long time for a Royal Flush";
			}
			case MADE_STRAIGHT_FLUSH -> {
				EvalData.suits[EvalData.seat] = EvalData.suit;
				EvalData. showdownValueSt[EvalData.seat] = new StringBuilder().append("//Straight Flush high card ")
						.append(Card.CARDS_REVERSE[EvalData.highCard1]).append(SUITS_ST[EvalData.suit]).toString();
			}
			case MADE_FOUR_OF_A_KIND -> {
				EvalData. showdownValueSt[EvalData.seat] = "//Four of a kind high card " + Card.CARDS[EvalData.highCard1];
			}
			case MADE_FULL_HOUSE -> {
				EvalData. showdownValueSt[EvalData.seat] = new StringBuilder().append("//Full House high card ")
			...
			case MADE_FLUSH -> {
				...
				EvalData. showdownValueSt[EvalData.seat] = new StringBuilder().append("//Flush high card  ")
						.append(Card.CARDS_REVERSE[EvalData.highCard1]).append(" suit ")
						.append(SUITS2_ST[EvalData.suit])
						.toString();
			}
			case MADE_STRAIGHT -> {
				EvalData. showdownValueSt[EvalData.seat] = "//Straight high card " +
						Card.CARDS_REVERSE[EvalData.highCard1];
			}
			case MADE_SET -> {
				EvalData. showdownValueSt[EvalData.seat] = new StringBuilder().append("//Set high card  ")
						.append(Card.CARDS_REVERSE[EvalData.highCard1]).append(showKickers()).toString();
			}
			case MADE_TWO_PAIR -> {
				EvalData. showdownValueSt[EvalData.seat] = new StringBuilder().append("//Two pair ")
						.append(Card.CARDS_REVERSE[EvalData.highCard1]).toString();
			}
			case MADE_PAIR -> {
				EvalData. showdownValueSt[EvalData.seat] = new StringBuilder().append("//Any pair card ")
						.append(Card.CARDS_REVERSE[EvalData.highCard1]).append(showKickers()).toString();
			}
			case MADE_NONE -> {
				EvalData. showdownValueSt[EvalData.seat] = new StringBuilder().append("//What were you thinking kickers ")
