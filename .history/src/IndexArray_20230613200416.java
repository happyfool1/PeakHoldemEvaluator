...
String st = "The bestDraw rows were " +  allArrayRowNames[bestDrawRows[0]]  + ", " + allArrayRowNames[bestDrawRows[1]]
               + ", " + allArrayRowNames[bestDrawRows[2]] + "\r\n";
        st += "The worstDraw rows were " +  allArrayRowNames[worstDrawRows[0]]  + ", " + allArrayRowNames[worstDrawRows[1]]
        ...
        st+= "The worstMade rows were " +  allArrayRowNames[worstMadeRows[0]]  + ", " + allArrayRowNames[worstMadeRows[1]]
        + ", " + allArrayRowNames[worstMadeRows[2]] + "\r\n";
        st+= "The bestShowdownw rows were " +  allArrayRowNames[bestShowdownwRows[0]]  + ", " + allArrayRowNames[bestShowdownwRows[1]]
        + ", " + allArrayRowNames[bestShowdownwRows[2]] + "\r\n";
        st+= "The worstShowdown rows were " +  allArrayRowNames[worstShowdownRows[0]]  + ", " + allArrayRowNames[worstShowdownRows[1]]
        + ", " + allArrayRowNames[worstShowdownRows[2]] + "\r\n";
        st+= "The bestDraw cols were " +  allArrayRowNames[bestDrawCols[0]]  + ", " + allArrayRowNames[bestDrawCols[1]]
        + ", " + allArrayRowNames[bestDrawCols[2]] + "\r\n";
        st+= "The worstDraw cols were " +  allArrayRowNames[worstDrawCols[0]]  + ", " + allArrayRowNames[worstDrawCols[1]]
        + ", " + allArrayRowNames[worstDrawCols[2]] + "\r\n";
        st+= "The bestMade cols were " +  allArrayRowNames[bestMadeCols[0]]  + ", " + allArrayRowNames[bestMadeCols[1]]
        + ", " + allArrayRowNames[bestMadeCols[2]] + "\r\n";
        st+= "The worstMade cols were " +  allArrayRowNames[worstMadeCols[0]]  + ", " + allArrayRowNames[worstMadeCols[1]]
        + ", " + allArrayRowNames[worstMadeCols[2]] + "\r\n";
        st+= "The bestShowdownw cols were " +  allArrayRowNames[bestShowdownwCols[0]]  + ", " + allArrayRowNames[bestShowdownwCols[1]]
        + ", " + allArrayRowNames[bestShowdownwCols[2]] + "\r\n";
        st+= "The worstShowdown cols were " +  allArrayRowNames[worstShowdownCols[0]]  
        + ", " + allArrayRowNames[worstShowdownCols[1]]
        + ", " + allArrayRowNames[worstShowdownCols[2]] + "\r\n";
        st+= "The drawSumOfAllValuesPer was " + drawSumOfAllValuesPer + "\r\n";
