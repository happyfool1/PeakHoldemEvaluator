...
/*-***************************************************************************
* This method will classify a Flop.
*  You're looking for combinations where only the gaps matter, not the actual ranks or suits. In this case, there are a few possibilities for the patterns of gaps:

Group 0: All cards of the same rank (like 2-2-2). The gap is 0 between any two cards. There is only 1 combination here (0-0).

Group 1: Two cards are of the same rank and the third card is of a different rank (like 2-2-3). There are 2 combinations here (0-1, 1-0).

Group 2: All cards are of different ranks and consecutive (like 2-3-4). There is only 1 combination here (1-1).

Group 3: Two cards are of the same rank and the third card is two ranks apart (like 2-2-4). There are 2 combinations here (0-2, 2-0).

Group 4: Two cards are of different ranks, one gap of 1 and the other of 2 (like 2-3-5). There are 2 combinations here (1-2, 2-1).

Considering only gaps, these are all the possible combinations for a three-card flop. So in total, we have 1 + 2 + 1 + 2 + 2 = 8 combinations.
*****************************************************************************/
