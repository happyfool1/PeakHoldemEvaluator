...
public interface Constants {
	...
	*******************************************************************************/
	...
	String[] WET_DRY_ST = { "Dry Board", "Wet Board", "Not Wet or Dry Board" };
	...
	int HAVE_NONE = 0;
	int HAVE_GURSHOT_DRAW = 1;
	int HAVE_GURSHOT_DRAW_PAIR = 2;
	int HAVE_GURSHOT_DRAW_OESD = 3;
	int HAVE_GURSHOT_DRAW_FLUSH = 4;
	int HAVE_STRAIGHT_DRAW = 5;
	int HAVE_STRAIGHT_DRAW_PAIR = 6;
	int HAVE_STRAIGHT_DRAW_OESD = 7;
	int HAVE_STRAIGHT_DRAW_FLUSH = 8;
	int HAVE_FLUSH_DRAW = 9;
	int HAVE_FLUSH_DRAW_PAIR = 10;
	int HAVE_FLUSH_DRAW_OESD = 11;
	int HAVE_POCKET_PAIR_BELOW_TP = 12;
	int HAVE_OVER_PAIR = 13;
	int HAVE_TOP_PAIR = 14;
	int HAVE_TWO_PAIR = 15;
	int HAVE_SET = 16;
	int HAVE_STRAIGHT = 17;
	int HAVE_FLUSH = 18;
	int HAND_SIZE = 19;
	String HAVE_ST = { "None", "Gurshot draw", "Gurshot draw + pair","Gurshot draw + OESD", "Gurshot draw + Flush",	
	"Straight draw", "Straight draw + pair", "Straight draw + OESD", "Straight draw + Flush", "Flush draw",
    "Flush draw + pair", "Flush draw + OESD", "Pocket pair below top pair", "Over pair", "Top pair", "Two pair",
	"Set", "Straight", "Flush", "Full house", "Quads", "Gap 
	...
	int MADE_BOTTOM_PAIR = 2;

	int MADE_MIDDLE_PAIR = 3;
	...
	String[] MADE_ARRAY_ST = { "No hand", "Board Pair", "Bottom Pair", "Middle Pair", "Top Pair", "Over Pair",
			...
			"Top-Bottom 2 Pair", "Top 2 Pair", "Board Set", "Set", "Straight", "Flush", "Full house",
	 ...
	 * Possible draws from board only - Flop and Turn
	  ******************************************************************************/
	int POSSIBLE_DRAW_PAIR = 0;

	int POSSIBLE_DRAW_TWO_PAIR = 1;

	int POSSIBLE_DRAW_SET = 2;

	int POSSIBLE_DRAW_GUTSHOT = 3;

	int POSSIBLE_DRAW_GUTSHOT_HIGH = 4;

	int POSSIBLE_DRAW_GUTSHOT_PAIR = 5;

	int POSSIBLE_DRAW_STRAIGHT = 6;

	int POSSIBLE_DRAW_OESD = 7;

	int POSSIBLE_DRAW_OESD_PAIR = 8;

	int POSSIBLE_DRAW_FLUSH = 9;

	int POSSIBLE_DRAW_FLUSH_PAIR = 10;

	int POSSIBLE_DRAW_FLUSH_OESD = 11;

	int POSSIBLE_DRAW_FLUSH_GUTSHOT = 12;

	int POSSIBLE_DRAW_FULL_HOUSE = 13;

	int POSSIBLE_DRAW_FOUR_OF_A_KIND = 14;

	int POSSIBLE_DRAW_STRAIGHT_FLUSH = 15;

	int POSSIBLE_DRAW_ROYAL_FLUSH = 16;

	int POSSIBLE_DRAW_SIZE = 17;

	String[] POSSIBLE_DRAW_ARRAY_ST = { "Pair", "2 pair", "Set", "Gutshot", "Gutshot High", "Gutshot Pair",
			"Straight", "OESD", "OESD Pair", "Flush", "Flush OESD", "Flush Pair", "Flush Gutshot", "Full House",
			"4 of a Kind",
			"Straight Flush", "Royal Flush," };
	 ...
	 * Possible draws from board only - Flop and Turn
	  ******************************************************************************/
	int POSSIBLE_MADE_PAIR = 0;

	int POSSIBLE_MADE_TWO_PAIR = 1;

	int POSSIBLE_MADE_SET = 2;

	int POSSIBLE_MADE_GUTSHOT = 3;

	int POSSIBLE_MADE_GUTSHOT_HIGH = 4;

	int POSSIBLE_MADE_GUTSHOT_PAIR = 5;

	int POSSIBLE_MADE_STRAIGHT = 6;

	int POSSIBLE_MADE_OESD = 7;

	int POSSIBLE_MADE_OESD_PAIR = 8;

	int POSSIBLE_MADE_FLUSH = 9;

	int POSSIBLE_MADE_FLUSH_PAIR = 10;

	int POSSIBLE_MADE_FLUSH_OESD = 11;

	int POSSIBLE_MADE_FLUSH_GUTSHOT = 12;

	int POSSIBLE_MADE_FULL_HOUSE = 13;

	int POSSIBLE_MADE_FOUR_OF_A_KIND = 14;

	int POSSIBLE_MADE_STRAIGHT_FLUSH = 15;

	int POSSIBLE_MADE_ROYAL_FLUSH = 16;

	int POSSIBLE_MADE_SIZE = 17;

	String[] POSSIBLE_MADE_ARRAY_ST = { "Pair", "2 pair", "Set", "Gutshot", "Gutshot High", "Gutshot Pair",
			"Straight", "OESD", "OESD Pair", "Flush", "Flush OESD", "Flush Pair", "Flush Gutshot", "Full House",
			"4 of a Kind",
			"Straight Flush", "Royal Flush," };
