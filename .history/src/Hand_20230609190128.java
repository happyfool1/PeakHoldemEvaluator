...
public class Hand implements Constants {
	...
	*
	...
	private int doPairs() {
		...
		if (EvalData.twoPair) {
			System.out.println("Hand 2 pair " + EvalData.board[0] +
					" " + EvalData.board[1] + " " + EvalData.board[2] + " " + EvalData.board[3] + " " + isTwoPair());
	...
	* Returns MADE_BOTTOM_TWO_PAIR, MADE_TOP_AND_BOTTOM_TWO_PAIR, or MADE_TOP_TWO_PAIR
	...
	boolean isTwoPair() {
		...
		System.out.println("isPair() " + this.cards[0] + " " + this.cards[1] + " " + this.cards[2] + " " + this.cards[3]
				+ " " + this.cards[4] + " " + isCardsTwoPair());
	...
	* Is this a Royal Flush
	...
	private void addCardsOfPair() {
		if (EvalData.twoPair) {
			System.out.println("addCards t **** " + this.taken[0] + " " + this.taken[1] + " " +
					this.taken[2] + " " + this.taken[3] + " " + this.taken[4]);

			System.out.println("addCards c " + this.cards[0] + " " + this.cards[1]
					+ " " + this.cards[2] + " " + this.cards[3] + " " + this.cards[4]);

		}
		addCards t **** false true false false true
addCards c Kd 7h null null null
addCards b Kc Kd 8s 7c 7h
addCards c Kd 7h Kc null null
addCards b Kc Kd 8s 7c 7h
addCards c Kd 7h Kc 7c null
isPair() Kd 7h Kc 7c 8s false
		for (int i = 0; i < EvalData.bothCount - 1; i++) {
			if (EvalData.both[i].value == EvalData.both[i + 1].value) {
				...
				if (EvalData.twoPair) {
					System.out.println("addCards b " + EvalData.both[0] + " " + EvalData.both[1] + " " +
