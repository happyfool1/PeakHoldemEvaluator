...
public class IndexArray implements Constants {
    ...
    ****************************************************************************** */
    IndexArray(int[][] drawArray, int[][] madeArray, int[][] showdownArray, String[] rowNames, String[] colNames) {
        ...
        this.drawArrayRowNames = new String[this.rowNames.length];
        this.madeArrayRowNames = new String[this.rowNames.length];
        this.showdownArrayRowNames = new String[this.rowNames.length];
        this.drawArrayColNames = new String[this.rowNames.length];
