...
private static void copyDataHandRanges() {
	action.rangeArrayCall[SB][0] = rangeSBLimp.rangeArray[i];
	for (int i = 0; i < HANDS; i++) {
	action.rangeArrayCall[SB][0][i] = rangeSBLimp.rangeArray[i];
	action.rangeArrayRaise[SB][0][i] = rangeSBOpen.rangeArray[i];
	action.rangeArrayCall[SB][1][i] = rangeSBCall.rangeArray[i];
	action.rangeArrayRaise[SB][1][i] = rangeSBBet3.rangeArray[i];
	action.rangeArrayCall[SB][2][i] = rangeSBBet3Call.rangeArray[i];
	action.rangeArrayRaise[SB][2][i] = rangeSBBet4.rangeArray[i];
	action.rangeArrayCall[SB][3][i] = rangeSBBet4Call.rangeArray[i];
	action.rangeArrayRaise[SB][3][i] = rangeSBAllin.rangeArray[i];
	action.rangeArrayCall[SB][4][i] = rangeSBAllinCall.rangeArray[i];
	action.rangeArrayRaise[BB][0][i] = rangeBBLimp.rangeArray[i];
	action.rangeArrayRaise[BB][0][i] = rangeBBOpen.rangeArray[i];
	action.rangeArrayCall[BB][1][i] = rangeBBCall.rangeArray[i];
	action.rangeArrayRaise[BB][1][i] = rangeBBBet3.rangeArray[i];
	action.rangeArrayCall[BB][2][i] = rangeBBBet3Call.rangeArray[i];
	action.rangeArrayRaise[BB][2][i] = rangeBBBet4.rangeArray[i];
	action.rangeArrayCall[BB][3][i] = rangeBBBet4Call.rangeArray[i];
	action.rangeArrayRaise[BB][3][i] = rangeBBAllin.rangeArray[i];
	action.rangeArrayCall[BB][4][i] = rangeBBAllinCall.rangeArray[i];
	action.rangeArrayCall[UTG][0][i] = rangeUTGLimp.rangeArray[i];
	action.rangeArrayRaise[UTG][0][i] = rangeUTGOpen.rangeArray[i];
	action.rangeArrayCall[UTG][1][i] = rangeUTGCall.rangeArray[i];
	action.rangeArrayRaise[UTG][1][i] = rangeUTGBet3.rangeArray[i];
	action.rangeArrayCall[UTG][2][i] = rangeUTGBet3Call.rangeArray[i];
	action.rangeArrayRaise[UTG][2][i] = rangeUTGBet4.rangeArray[i];
	action.rangeArrayCall[UTG][3][i] = rangeUTGBet4Call.rangeArray[i];
	action.rangeArrayRaise[UTG][3][i] = rangeUTGAllinCall.rangeArray[i];
	action.rangeArrayCall[MP][0][i] = rangeMPLimp.rangeArray[i];
	action.rangeArrayRaise[MP][0][i] = rangeMPOpen.rangeArray[i];
	action.rangeArrayCall[MP][1][i] = rangeMPCall.rangeArray[i];
	action.rangeArrayRaise[MP][1][i] = rangeMPBet3.rangeArray[i];
	action.rangeArrayCall[MP][2][i] = rangeMPBet3Call.rangeArray[i];
	action.rangeArrayRaise[MP][2][i] = rangeMPBet4.rangeArray[i];
	action.rangeArrayCall[MP][3][i] = rangeMPBet4Call.rangeArray[i];
	action.rangeArrayRaise[MP][3][i] = rangeMPAllin.rangeArray[i];
	action.rangeArrayCall[MP][4][i] = rangeMPAllinCall.rangeArray[i];
	action.rangeArrayCall[CO][0][i] = rangeCOLimp.rangeArray[i];
	action.rangeArrayRaise[CO][0][i] = rangeCOOpen.rangeArray[i];
	action.rangeArrayCall[CO][1][i] = rangeCOCall.rangeArray[i];
	action.rangeArrayRaise[CO][1][i] = rangeCOBet3.rangeArray[i];
	action.rangeArrayCall[CO][2][i] = rangeCOBet3Call.rangeArray[i];
	action.rangeArrayRaise[CO][2][i] = rangeCOBet4.rangeArray[i];
	action.rangeArrayCall[CO][3][i] = rangeCOBet4Call.rangeArray[i];
	action.rangeArrayRaise[CO][3][i] = rangeCOAllin.rangeArray[i];
	action.rangeArrayCall[CO][4][i] = rangeCOAllinCall.rangeArray[i];
	action.rangeArrayCall[BU][0][i] = rangeBULimp.rangeArray[i];
	action.rangeArrayRaise[BU][0][i] = rangeBUOpen.rangeArray[i];
	action.rangeArrayCall[BU][1][i] = rangeBUCall.rangeArray[i];
	action.rangeArrayRaise[BU][1][i] = rangeBUBet3.rangeArray[i];
	action.rangeArrayCall[BU][2][i] = rangeBUBet3Call.rangeArray[i];
	action.rangeArrayRaise[BU][2][i] = rangeBUBet4.rangeArray[i];
	action.rangeArrayCall[BU][3][i] = rangeBUBet4Call.rangeArray[i];
	action.rangeArrayRaise[BU][3][i] = rangeBUAllin.rangeArray[i];
	action.rangeArrayCall[BU][4][i] = rangeBUAllinCall.rangeArray[i];
}
}
