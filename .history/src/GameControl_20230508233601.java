...
public class GameControl implements Constants {
	...
	**************************************************************************** */
	...
	static void preflopSimulationMUltipleHands(int numToPlay) {
		...
		while (played <= numToPlay) {
			...
			System.out.println("//AAAA "+EvalData.returnedToBD[0][2][1] );
			...
			System.out.println("//BBBB "+EvalData.returnedToBD[0][2][1] );
	...
	private static void createPlayers() {
		players[SB] = new Player(rangeSBLimp, rangeSBOpen, rangeSBCall, rangeSBBet3, rangeSBBet3Call, rangeSBBet4,
				rangeSBBet4Call, rangeSBAllin, rangeSBAllinCall);
		players[BB] = new Player(rangeBBLimp, rangeBBOpen, rangeBBCall, rangeBBBet3, rangeBBBet3Call, rangeBBBet4,
				rangeBBBet4Call, rangeBBAllin, rangeBBAllinCall);
		players[UTG] = new Player(rangeUTGLimp, rangeUTGOpen, rangeUTGCall, rangeUTGBet3, rangeUTGBet3Call,
				rangeUTGBet4, rangeUTGBet4Call, rangeUTGAllin, rangeUTGAllinCall);
		players[MP] = new Player(rangeMPLimp, rangeMPOpen, rangeMPCall, rangeMPBet3, rangeMPBet3Call, rangeMPBet4,
				rangeMPBet4Call, rangeMPAllin, rangeMPAllinCall);
		players[CO] = new Player(rangeCOLimp, rangeCOOpen, rangeCOCall, rangeCOBet3, rangeCOBet3Call, rangeCOBet4,
				rangeCOBet4Call, rangeCOAllin, rangeCOAllinCall);
		players[BU] = new Player(rangeBULimp, rangeBUOpen, rangeBUCall, rangeBUBet3, rangeBUBet3Call, rangeBUBet4,
				rangeBUBet4Call, rangeBUAllin, rangeBUAllinCall);
	}
	...
	*  Return uncalled bet
	...
	static void returnUncalledBet() {
		...
		EvalData.stackBD[s] = EvalData.stackBD[s].add(EvalData.);
		EvalData.potBD = EvalData.potBD.subtract(EvalData.lastBetbetNowBDBD);
		EvalData.returnedToBD[0][s][EvalData.orbit] = EvalData.lastBetBD;
		EvalData.betCalled = true;
		System.out.println("//XXXX "+EvalData.returnedToBD[0][2][1] );

		System.out
				.println("returnUncalledBet " + s + " betNow " + EvalData.betNowBD + " moneyIn " + EvalData.moneyInBD[s]
						+ " stack " + EvalData.stackBD[s] + " pot " + EvalData.potBD + " orbit " + EvalData.orbit);
	}
