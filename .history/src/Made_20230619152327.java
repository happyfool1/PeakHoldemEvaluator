...
int doHandStraightFlush() {
		...
		if (this.cards[0].value - this.cards[1].value == 1 && this.cards[1].value - this.cards[1].value == 1
		 this.cards[0].value - this.cards[1].value == 1 && this.cards[0].value - this.cards[1].value == 1){
