...
public class HandRangeConverter implements Constants {
	...
	private static void createRanges() {
		...
		rangeCOLimp.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\CO\\Limp.ser");
		rangeCOOpen.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\CO\\Open.ser");
		rangeCOCall.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\CO\\Call.ser");
		rangeCOBet3.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\CO\\Bet3.ser");
		rangeCOBet3Call.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\CO\\Bet3Call.ser");
		rangeCOBet4.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\CO\\Bet4.ser");
		rangeCOBet4Call.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\CO\\Bet4Call.ser");
		rangeCOAllin.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\CO\\Allin.ser");
		rangeCOAllinCall.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\CO\\AllinCall.ser");
