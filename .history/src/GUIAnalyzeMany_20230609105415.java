...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    *******************************************************************************/
    public void myFrame() {
        ...
        wetDryDrawFlop.setBackground(SILVER);
        ...
        wetDryMadeFlop.setBackground(SILVER);
        ...
        wetDryShowdownFlop.setBackground(SILVER);
        panelCheckBoxesWetDryFlop.add(wetDryShowdownFlop);
        panelCheckBoxesWetDryFlop.setBackground(SILVER);
        ...
        indexDrawFlop.setBackground(SILVER);
        ...
        indexShowdownFlop.setBackground(SILVER);
        ...
        sumOfHoleCardsDrawFlop.setBackground(SILVER);
        ...
        sumOfHoleCardsMadeFlop.setBackground(SILVER);
        ...
        sumOfHoleCardsShowdownFlop.setBackground(SILVER);
        panelCheckBoxesSumOfHoleCardsFlop.add(sumOfHoleCardsShowdownFlop);
           panelCheckBoxesSumOfHoleCardsFlop.setBackground(SILVER);
        ...
        sumOfBoardCardsDrawFlop.setBackground(SILVER);
        ...
        sumOfBoardCardsMadeFlop.setBackground(SILVER);
        ...
        sumOfBoardCardsShowdownFlop.setBackground(SILVER);
        panelCheckBoxesSumOfBoardCardsFlop.add(sumOfBoardCardsShowdownFlop);
        panelCheckBoxesSumOfBoardCardsFlop.setBackground(SILVER);
        ...
        typeOf1755DrawFlop.setBackground(SILVER);
        ...
        typeOf1755MadeFlop.setBackground(SILVER);
        ...
        typeOf1755ShowdownFlop.setBackground(SILVER);
        panelCheckBoxesTypeOf1755Flop.add(typeOf1755ShowdownFlop);
        panelCheckBoxesTypeOf1755Flop.setBackground(SILVER);
        ...
        indexMadeFlop.addActionListener(this);
        indexMadeFlop.setSelected(false);
        indexMadeFlop.setBackground(SILVER);
        panelCheckBoxesIndexFlop.add(indexMadeFlop);
        panelCheckBoxesIndexFlop.setBackground(SILVER);
        ...
        typeDrawFlop.setBackground(SILVER);
        ...
        typeMadeFlop.setBackground(SILVER);
        ...
        typeShowdownFlop.setBackground(SILVER);
        panelCheckBoxesTypeFlop.add(typeShowdownFlop);
        panelCheckBoxesTypeFlop.setBackground(SILVER);
