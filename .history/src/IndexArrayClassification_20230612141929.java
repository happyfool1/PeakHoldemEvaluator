...
public class IndexArrayClassification implements Constants {
	...
	***************************************************************************************************/
	...
	int TEXTURE_RAINBOW_UNCONNECTED = 8;
 	int TEXTURE_SIZE = 9;
	int String TEXTURE_ST[] ={"Monotone Connected", "Monotone Semi", "Monotone Unconnected", "Two-tone Connected"       ,"Two-tone Semi", "Two-tone Unconnected", "Rainbow Connected", "Rainbow Semi", "Rainbow Unconnected"};
