...
not be made solely based on hand strength and flop texture.
    ...
    and more aggressive in later positions. These are not real poker strategies, just an example of how you can adjust the percentages based on the position. You can define the adjustments based on your poker strategy.
