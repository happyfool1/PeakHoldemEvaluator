...
public class Player implements Constants {
	...
	// Constructor
	Player( int handIndex, HandRange rangeLimp, HandRange rangeOpen, HandRange rangeCall, HandRange rangeBet3,
	...
	int getDecision(int seat) {
		...
		Logger.log("ERROR Action getDecision(int EvalData.betType ) EvalData.betType  invalid " + PLAYER_ACTIONS_ST[EvalData.betType ]);
	...
	private void doAllin() {
		...
		var call = EvalData.betNowBD.subtract(EvalData.moneyInBD[seat]);
		...
		EvalData.raisedToBD[0][seat][EvalData.orbit] = EvalData.betNowBD.add(bet);
	...
	private void doCalls() {
		...
		EvalData.stackBD[this.seat] = zeroBD;
		++EvalData.allinCount;
		EvalData.allin$[0][seat][EvalData.orbit] = call;
		EvalData.betBD[0][seat][EvalData.orbit] = call;
		EvalData.raisedToBD[0][seat][EvalData.orbit] = EvalData.betNowBD.add(call);
