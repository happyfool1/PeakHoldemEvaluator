...
public class HandRangeConverter implements Constants {
	...
	private static void createRanges() {
		...
		rangeBULimp.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\BU\\Limp.ser");
		rangeBUOpen.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\BU\\Open.ser");
		rangeBUCall.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\BU\\Call.ser");
		rangeBUBet3.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\BU\\Bet3.ser");
		rangeBUBet3Call.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\BU\\Bet3Call.ser");
		rangeBUBet4.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\BU\\Bet4.ser");
		rangeBUBet4Call.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\BU\\Bet4Call.ser");
		rangeBUAllin.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\BU\\Allin.ser");
		rangeBUAllinCall.readRange("C:\\PeakHoldemDatabase\\"+ type + "\\Preflop\\BU\\AllinCall.ser");
