...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    void findBestAndWorst() {
        ...
        bestMadeRows[1] = madeTotalRowPerEntries.get(madeTotalRowPerEntries.size() -1).getRowOrCol();
