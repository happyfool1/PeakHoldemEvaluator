...
public class Hand implements Constants {
	...
	* Returns MADE_BOTTOM_TWO_PAIR, MADE_TOP_AND_BOTTOM_TWO_PAIR, or MADE_TOP_TWO_PAIR
	...
	as they would have three-of-a-kind (also known as "trips" or "a set"). Also, any player holding a Queen or a King would have a higher two pair (Queens and Jacks, or Kings and Jacks) that beats your two pair.
