    ...
    ****************************************************************************** */
    IndexArray(int[][] drawArray, int[][] madeArray, int[][] showdownArray, String[] rowNames) {
      ...
      Arrays.sort(this.drawRowTotalSortedPer);
         Arrays.sort(this.madeRowTotalSortedPer = this.madeRowTotalPer.clone();
         Arrays.sort(this.showdownRowTotalSortedPer = this.showdownRowTotalPer.clone();
         Arrays.sort(this.drawColTotalSortedPer = this.drawColTotalPer.clone();
         Arrays.sort(this.madeColTotalSortedPer = this.madeColTotalPer.clone();
         Arrays.sort(this.showdownColTotalSortedPer = this.showdownColTotalPer.clone();
     ...
     * 1. The row(s) in the index array of the highest or lowest value
    ********************************************************************************** */
