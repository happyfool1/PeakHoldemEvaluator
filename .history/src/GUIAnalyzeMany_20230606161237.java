...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private JPanel panelCheckBoxesSumOfBoardFlop;
    private static final JCheckBox sumOfDrawFlop = new JCheckBox("Sum Of Board Cards Made Hand");
    private static final JCheckBox sumOfMadeFlop = new JCheckBox("Sum Of BoardCards Made Hand");
    private static final JCheckBox sumOfShowdownFlop = new JCheckBox("Sum of Board Cards Showdown");
