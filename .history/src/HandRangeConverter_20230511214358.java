...
public class HandRangeConverter implements Constants {
	...
	void newRanges() {
		{ 10., 10., 8., 12., 20., 35. };
		double percentSB = 0.20;
		double percentBB = 0.20;
		double percentUTG = 0.20;
		double percentMP = 0.20;
		double percentCO = 0.20;
		double percentBU = 0.20;
		...
		rangeSB.buildRangePercentage(20);
		rangeBB.buildRangePercentage(20);
		rangeUTG.buildRangePercentage(20);
		rangeMP.buildRangePercentage(20);
		rangeCO.buildRangePercentage(20);
		rangeBU.buildRangePercentage(20);
