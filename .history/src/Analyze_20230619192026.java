...
class Analyze implements Constants {
	...
	static void evaluateFlop(int seat) {
		...
		if (EvalData.flush && EvalData.straight) {
			r = EvalData.hand[EvalData.seat].doHandStraightFlush();
		}
		if (r == MADE_NONE && EvalData.fourOfKind || EvalData.fullHouse) {
			r = EvalData.hand[EvalData.seat].doHandFullOrQuad();
		}
		if (r == MADE_NONE && EvalData.flush) {
			r = EvalData.hand[EvalData.seat].doHandFlush();
		}
		if (r == MADE_NONE && EvalData.straight) {
			r = EvalData.hand[EvalData.seat].doHandStraight();
		}
		if (r == MADE_NONE && (EvalData.onePair || EvalData.twoPair || EvalData.threeOfKind)) {
			r = EvalData.hand[EvalData.seat].doHandPairs();
		}
		if (r == MADE_NONE && (EvalData.boardPair || EvalData.boardTwoPair || EvalData.boardSet)) {
			r = EvalData.hand[EvalData.seat].doBoardPairs();
		}
		if (r == MADE_NONE) {
	...
	static void evaluateTurn(int seat) {
		...
		if (EvalData.madeTypeTurn[EvalData.seat] == -1) {
			System.out.println("TTT1 " + EvalData.hand[EvalData.seat].toString() + " " + EvalData.boardSet + " " + EvalData.threeOfKind + " " 
			+ EvalData.boardPair + " " + EvalData.boardTwoPair + " " + r );
			System.out.println("TTT " + EvalData.both[0] + "," + EvalData.both[1] + "," + EvalData.both[2] + ","
		...
		if (EvalData.madeTypeTurn[EvalData.seat] == -1) {
			System.out.println("TTT2 " + EvalData.hand[EvalData.seat].toString() + " " + EvalData.boardSet + " " + EvalData.threeOfKind + " " + r);
			System.out.println("TTT " + EvalData.both[0] + "," + EvalData.both[1] + "," + EvalData.both[2] + ","
					+ EvalData.both[3] + "," + EvalData.both[4]);
		}
		if (r == MADE_NONE) {
		...
		if (EvalData.madeTypeTurn[EvalData.seat] == -1) {
			System.out.println("TTT3 " + EvalData.hand[EvalData.seat].toString() + " " + EvalData.boardSet + " " + EvalData.threeOfKind + " " + r);
			System.out.println("TTT " + EvalData.both[0] + "," + EvalData.both[1] + "," + EvalData.both[2] + ","
					+ EvalData.both[3] + "," + EvalData.both[4]);
		}
