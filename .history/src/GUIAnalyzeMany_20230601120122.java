    ...
    * a radio button or control button.
    ...
    private void doSimulationDataCollection() {
        ...
        if (number == 0) {
            ...
            ReportManyHands.reportHMLMade(750, 100);
            ReportManyHands.reportHHMLDraw(200, 100);
            ReportManyHands.reportHHMLMade(750, 100);
       
            ReportManyHands.reportHHHMLMade(750, 100);
