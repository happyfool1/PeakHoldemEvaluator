...
public class ReportManyHands implements Constants {
	...
	private static final Object[][] dataHHHMLMade = { { "", "", "", "", "", "", "", "", "", "" },
			...
			private static final Object[] columnsHMLShowdownMade = { "HML", "No hand", "Any pair", "Two pair", "Set", "Straight",
			"Flush", "Full house", "Straight flush", "Royal flush" };

		private static final Object[][] dataHMLShowdownMade = { { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" },
			...
			private static final Object[] columnsHHMLShowdown = { "HML", "No hand", "Any pair", "Two pair", "Set", "Straight",
			"Flush", "Full house", "Straight flush", "Royal flush" };

	private static final Object[][] dataHHMLShowdown = { { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" },
			...
			private static final Object[] columnsHHHMLShowdown = { "HML", "No hand", "Any pair", "Two pair", "Set", "Straight",
			"Flush", "Full house", "Straight flush", "Royal flush" };

	private static final Object[][] dataHHHMLShowdown = { { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" },
		...
		for (int i = 0; i < HML_FLOP_SIZE; ++i) {
			...
			for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
				if (ManyData.hmlMade[i][j] > 0) {
					...
					double per = ((double) ManyData.hhmlMade[i][j] / (double) ManyDataHLMCount) * 100.0;
...
********************************************************************************** */
	static void reportHMLShowdownFlop(int c, int r) {
		if (frame7 == null) {
			...
			tableModel7 = new DefaultTableModel(dataHMLShowdownMade , columnsHMLShowdownMade );
		...
		for (int i = 0; i < HML_FLOP_SIZE; ++i) {
			...
			for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
				if (ManyData.hmlMade[i][j] > 0) {
					table7.setValueAt("   " + String.valueOf(ManyData.hhhmlMade[i][j]), row, col);
					double per = ((double) ManyData.hhhmlMade[i][j] / (double) ManyData.hhhmlCount) * 100.0;
...
static void reportHMLShowdownTurn(int c, int r) {
	if (frame8 == null) {
		...
		frame8.setPreferredSize(new Dimension(650, 600));DefaultTableModel(dataHMLShowdownMade , columnsHMLShowdownMade );
		tableModel8 = new DefaultTableModel(dataHHHMLMade, columnsHHHMLMade);
...
static void reportHMLShowdownRiver(int c, int r) {
	if (frame9 == null) {
		...
		tableModel9 = new DefaultTableModel(dataHHHMLMade, columnsHHHMLMade);
