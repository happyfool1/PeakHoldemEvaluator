...
public class Player implements Constants {
	...
	private void doFold() {
		...
		EvalData.stack$[0][seat][EvalData.orbit] =EvalData.stackBD[seat];
		EvalData.moneyIn$[0][seat][EvalData.orbit] = EvalData.moneyIn[seat];
		++EvalData.foldCountPreflop[seat];
		...
		System.out.println("ff " + EvalData.foldCount
				...
				+ new StringBuilder().append("//doFold() ").append(this.seat).append(" ")
						.append(EvalData.EvalData.EvalData.orbit).append(" ").append(this.action.moneyToPot).append(" ")
						.append(this.moneyIn)
	...
	private void doLimp() {
		...
		System.out.println(new StringBuilder().append("//doLimp() ").append(this.seat).append(" ")
				.append(EvalData.EvalData.orbit).append(" ").append(this.action.moneyToPot).append(" ").append(this.moneyIn)
				.append(" ").append(EvalData.stackBD[this.seat]).toString());
	}
	...
	private void doOpen() {
		...
		if (canRaise) {
			...
			this.moneyIn = temp;
			this.action.betNow = EvalData.betBD;
			EvalData.stackBD[this.seat] = EvalData.stackBD[this.seat].subtract(this.moneyIn);
					++EvalData.bet2CountPreflop[seat];
			++EvalData.preflopBet2Count;
			EvalData.preflopBetToMe[seat][positions][seat][BET1] = true;
			++EvalData.preflopBetToMeCount[seat][positions][seat][BET1];
			EvalData.preflopResponseRaise[seat][positions][seat][BET1] = true;
			++EvalData.preflopResponseRaiseCount[seat][positions][seat][bret];
	...
	private void doCall() {
		...
		if (canCall) {
			...
			if (betType == BET2) {
				EvalData.isCalledBet2[0][seat][EvalData.orbit] = true;
			} else if (betType == BET3) {
				EvalData.isCalledBet3[0][seat][EvalData.orbit] = true;
			} else if (betType == BET4) {
				EvalData.isCalledBet4[0][seat][EvalData.orbit] = true;
			} else if (betType == ALLIN) {
				EvalData.isCallAllin[0][seat][EvalData.orbit] = true;
				++callAllinCount;
				plEvalData.ayerCallAllin[0][seat] = true;
			}
			if (betType == BET2) {
				++EvalData.bet2CallCountPreflop[seat];
				EvalData.preflopResponseCall[seat][positions[seat]][BET2] = true;
				++EvalData.preflopResponseCallCount[seat][positions[seat]][BET2];
				++EvalData.preflopResponseCount[seat][positions[seat]][BET2];
			} else if (betType == BET3) {
				++EvalData.bet3CallCountPreflop[seat];
				EvalData.preflopResponseCall[seat][positions[seat]][BET3] = true;
				++EvalData.EvalData.preflopResponseCallCount[seat][positions[seat]][BET3];
				++EvalData.preflopResponseCount[seat][positions[seat]][BET3];
			} else if (betType == BET4) {
				++EvalData.bet4CallCountPreflop[seat];
				EvalData.preflopResponseCall[seat][positions[seat]][BET4] = true;
				++EvalData.preflopResponseCallCount[seat][positions[seat]][BET4];
				++EvalData.preflopResponseCount[seat][positions[seat]][BET4];
			} else if (betType == ALLIN) {
				++EvalData.allinCallCountPreflop[seat];
				EvalData.preflopResponseCall[seat][positions[seat]][ALLIN] = true;
				++EvalData.preflopResponseCallCount[seat][positions[seat]][ALLIN];
				++EvalData.preflopResponseCount[seat][positions[seat]][ALLIN];
			}
	...
	private void doBet3() {
		...
		if (canRaise) {
			...
			++EvalData.bet3CountPreflop[seat];
			EvalData.preflopBetToMe[seat][positions[seat]][BET2] = true;
			++EvalData.preflopBetToMeCount[seat][positions[seat]][BET2];
			EvalData.preflopResponseRaise[seat][positions[seat]][BET2] = true;
			++EvalData.preflopResponseRaiseCount[seat][positions[seat]][BET2];
	...
	private void doAllin() {
		...
		++allinCount;
		++raiseAllinCount;
		playerRaiseAllin[0][seat] = true;
		isRaisedToAllin[0][seat][EvalData.orbit] = true;
		allin$[0][seat][EvalData.orbit] = bet;
	...
	private void doAllinCall() {
		...
		++allinCallCountPreflop[seat];
		playerCallAllin[0][seat] = true;
		playerCallAllinShort[0][seat] = true;
		isCallAllinShort[0][seat][EvalData.orbit] = true;
		isAllin[0][seat][EvalData.orbit] = true;
		isCall[0][seat][EvalData.orbit] = true;
		playerCallAllinShort$[0][seat] = stack[seat] + moneyIn[seat];
		moneyIn$[0][seat][EvalData.orbit] = stack[seat] + moneyIn[seat];
