...
public class Evaluate implements Constants {
	 ...
	 * 		doShowdown() 
	 * 		doPreflopSimulation()
	 * 		doFullSimulation(int number)
	 * 		setSeed(Long seed)
	 * 		setPath(String path)
	 * 		set1755Mode(boolean b)
	 * 		setDetailedAnalysisMode(boolean b)
	 * 		doSimulationDataCollection(number)
	 * 
	 ...
	 * If you are doing a simulation application of course order is important.
	...
	* the component classes and make them available without restriction.
	* 
	*
	* Showdown analysis
	...
	* 
	 ...
	 * 
	 * The original applications, PeakHoldem and PeakHoldemHandHistory have both
	...
	* PeakHoldem was never officially released. There is a PeakHoldem website
	...
	* 
	* PeakHoldemEvaluator is the first such package. This one.
	* 
	*
	...
	* Arg0 - A  Card
	 ...
	 * the data accumulated by River analysis is what is needed for the value of a hand.
