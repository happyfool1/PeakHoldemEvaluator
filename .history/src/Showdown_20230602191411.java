...
public class Showdown implements Constants {
	...
	******************************************************************************/
	static void showdownValue(int seat) {
		...
		EvalData.highCard2 = EvalData.hand[seat].highCard21;
		EvalData.suit =  EvalData.hand[seat].highCard1;
		EvalData.kicker1 =  EvalData.hand[seat].highCard1;
		EvalData.kicker2 = EvalData.hand[seat].highCard1;
		EvalData.kicker3 = EvalData.hand[seat].highCard1;
		System.out.println(
				"Seat " + seat + " showdown value is " + max + " high card 1 " + EvalData.highCard1 + " high card2  "
				 + EvalData.highCard2 +
						" kicker1 " + EvalData.kicker1 + "kicker2 " +
						EvalData.kicker2 + " kicker3 " + EvalData.kicker3 + " suit " + EvalData.suit);
