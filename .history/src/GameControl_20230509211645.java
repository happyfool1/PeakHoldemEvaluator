...
public class GameControl implements Constants {
	...
	*******************************************************************************/
	...
	private static HoleCardAction heroX HoleCardAction = new HoleCardAction();
	private static HoleCardAction averageX = new HoleCardAction();
	private static HoleCardAction reg CardAction = new HoleCardAction();
	private static HoleCardAction fish = new HoleCardAction();
	private static HoleCardAction nit HoleCardAction = new HoleCardAction();
