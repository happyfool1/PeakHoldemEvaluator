...
public class HoleCardAction implements Constants {
    ...
    *  Values are index into playabilityArray, an array of String
    ...
    private private static  String path = EvalData.applicationDirectory; // Default but can be set
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        hands1.setFont(f3);
        combos1.setBackground(CYAN));
        comboPer1.setBackground(CYAN);
        hands1.setBackground(CYAN);
