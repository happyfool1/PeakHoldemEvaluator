...
public class EvalDataMany implements Constants {
	...
	* +1 because of Showdown
	...
	// typeOf1755
	static int[][] typeOf1755DrawFlop = new int[4][DRAW_SIZE];
	static int[][] typeOf1755MadeFlop = new int[4][MADE_SIZE];
	static int[][] typeOf1755ShowdownFlop = new int[4][MADE_SIZE];

	static int[][] typeOf1755DrawTurn = new int[4][DRAW_SIZE];
	static int[][] typeOf1755MadeTurn = new int[4][MADE_SIZE];
	static int[][] typeOf1755ShowdownTurn = new int[4][MADE_SIZE];

	static int[][] typeOf1755DrawRiver = new int[4][DRAW_SIZE];
	static int[][] typeOf1755MadeRiver = new int[4][MADE_SIZE];
	static int[][] typeOf1755ShowdownRiver = new int[4][MADE_SIZE];
	 ...
	 ****************************************************************************** */
	static int[] hmlDrawRowTotalFlop = new int[HML_FLOP_SIZE];
	static int[] hmlDrawColTotalFlop = new int[DRAW_SIZE];
	static int[] hmlMadeRowTotalFlop = new int[HML_FLOP_SIZE];
	static int[] hmlMadeColTotalFlop = new int[MADE_SIZE];
	static int[] hmlShowdownRowTotalFlop = new int[HML_FLOP_SIZE];
	static int[] hmlShowdownColTotalFlop = new int[MADE_SIZE];
	static int hmlDrawSumOfAllValuesFlop = -1;
	static int hmlMadeSumOfAllValuesFlop = -1;
	static int hmlShowdownSumOfAllValuesFlop = -1;

	static int[] hmlDrawRowTotalTurn = new int[HML_TURN_SIZE];
	static int[] hmlDrawColTotalTurn = new int[DRAW_SIZE];
	static int[] hmlMadeRowTotalTurn = new int[HML_TURN_SIZE];
	static int[] hmlMadeColTotalTurn = new int[MADE_SIZE];
	static int[] hmlShowdownRowTotalTurn = new int[HML_TURN_SIZE];
	static int[] hmlShowdownColTotalTurn = new int[MADE_SIZE];
	static int hmlDrawSumOfAllValuesTurn = -1;
	static int hmlMadeSumOfAllValuesTurn = -1;
	static int hmlShowdownSumOfAllValuesTurn = -1;

	static int[] hmlDrawRowTotalRiver = new int[HML_RIVER_SIZE];
	static int[] hmlDrawColTotalRiver = new int[DRAW_SIZE];
	static int[] hmlMadeRowTotalRiver = new int[HML_RIVER_SIZE];
	static int[] hmlMadeColTotalRiver = new int[MADE_SIZE];
	static int[] hmlShowdownRowTotalRiver = new int[HML_RIVER_SIZE];
	static int[] hmlShowdownColTotalRiver = new int[MADE_SIZE];
	static int hmlDrawSumOfAllValuesRiver = -1;
	static int hmlMadeSumOfAllValuesRiver = -1;
	static int hmlShowdownSumOfAllValuesRiver = -1;
