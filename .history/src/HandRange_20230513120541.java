...
public class HandRange implements Constants {
	...
	private static boolean rangeRead = false;
	...
	****************************************************************************** */
	 ...
	 * Index with playability value to find hand index for that hand is also
	...
	****************************************************************************** */
	...
	void updateForHoleCardAction() {
		...
		int high = getRangeHigh();
		if (high != -1) {
			this.lowRangeArrayIndex = high;
			this.lowPlayabilityArrayNumericValue = playabilityArrayNumeric[high];
			this.cards = handsArray[high];
			this.percentage = getRangePercent();
	...
	******************************************************************************/
	 ...
	 * Index into orderArray if found.
	 ******************************************************************************/
	private static record getRangeHigh() {
		// Find lowest playabilityArray element with a hand
		int ndx = -1;
		this.high = -1;
		for (int i = HANDS - 1; i >= 0; i--) {
			if (this.rangeArray[i] > 0 && orderArray[this.rangeArray[i]] > ndx) {
				ndx = orderArray[this.rangeArray[i]];
				this.high= i;
			}
		}
		 	}
	 ...
	 * AA is 169, 72o is 1
	 * This is the inverse of playabilityArray
	  ***************************************************************************/
	private static record createPlayabilityArrayNumeric() {
		int k = 0;for(
		int i = 0;i<HANDS;++i)
		{
			k = getHandStringToIndex(playabilityArray[i]);
	...
	/*-  ****************************************************************************
	 * Create playabilityArray 
	 * playabilityArrayOrder is indexed by handIndex. 
	 * Value is 0 to 168
	 * AA is 0, 72o is 168
	 * This is the inverse of playabilityArrayNumeric
	  ******************************************************************************/
	private static void createPlayabilityArray() {
		int num = 169;
		int k = 0;
		for (int i = 0; i < HANDS; ++i) {
			k = getHandStringToIndex(playabilityArray[i]);
	...
	* Get playabilityNumeric value 
	 ********************************************************************************/
	private static int getPlayabilityNumeric(int index) {
	...
	* Get playabilityOrder value 
	 *******************************************************************************/
	private static int getPlayabilityOrder(int index) {
