...
public class PreflopAdjustments implements Constants {
  ...
  * For bet size adjustment the adjustmeni is the value in the array added to
  * the current bet size.
  The bet size adjustment value in in Big Blind bets
  ******************************************************************************/
  static final int[] adjustmentBet1Limps = new int[] { 0, 4, 8, 12, 20 };
  static final int[] adjustmentBet1Folds = new int[] { 0, 4, 8, 12, 20 };
  static final int[] adjustmentBet2Limps = new int[] { 0, 4, 8, 12, 20 };
  static final int[] adjustmentBet2Folds = new int[] { 0, 4, 8, 12, 20 };
  static final int[] adjustmentBet3Limps = new int[] { 0, 2, 3, 4, 10 };
  static final int[] adjustmentBet3Folds = new int[] { 0, 2, 3, 4, 10 };
  static final int[] adjustmentBet4Limps = new int[] { 0, 0, 0, 0, 0 };
  static final int[] adjustmentBet4Folds = new int[] { 0, 0, 0, 0, 10 };


  static final BigDecimal[] adjustmentBet1BetLimps = {  
    ...
    new BigDecimal(4).setScale(2, RoundingMode.HALF_UP),
    new BigDecimal(5).setScale(2, RoundingMode.HALF_UP)  };
    static final BigDecimal[] adjustmentBet1BetsFolds = {  
    new BigDecimal(0).setScale(2, RoundingMode.HALF_UP),  
    new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),  
    new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),  
    new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),  
    new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),  
    new BigDecimal(1).setScale(2, RoundingMode.HALF_UP)};  
    static final BigDecimal[] adjustmentBet2BetLimps = {  
      new BigDecimal(0).setScale(2, RoundingMode.HALF_UP),
      new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),
      new BigDecimal(2).setScale(2, RoundingMode.HALF_UP),
      new BigDecimal(3).setScale(2, RoundingMode.HALF_UP),
      new BigDecimal(4).setScale(2, RoundingMode.HALF_UP),
      new BigDecimal(5).setScale(2, RoundingMode.HALF_UP)  };
      static final BigDecimal[] adjustmentBet2BetsFolds = {  
      new BigDecimal(0).setScale(2, RoundingMode.HALF_UP),  
      new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),  
      new BigDecimal(2).setScale(2, RoundingMode.HALF_UP),  
      new BigDecimal(3).setScale(2, RoundingMode.HALF_UP),  
      new BigDecimal(4).setScale(2, RoundingMode.HALF_UP),  
      new BigDecimal(4).setScale(2, RoundingMode.HALF_UP)};  
      static final BigDecimal[] adjustmentBet3BetLimps = {  
        new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),
        new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),
        new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),
        new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),
        new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),
        new BigDecimal(1).setScale(2, RoundingMode.HALF_UP)  };
        static final BigDecimal[] adjustmentBet3BetsFolds = {  
        new BigDecimal(0).setScale(2, RoundingMode.HALF_UP),  
        new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),  
        new BigDecimal(2).setScale(2, RoundingMode.HALF_UP),  
        new BigDecimal(3).setScale(2, RoundingMode.HALF_UP),  
        new BigDecimal(4).setScale(2, RoundingMode.HALF_UP),  
        new BigDecimal(5).setScale(2, RoundingMode.HALF_UP)};  
        static final BigDecimal[] adjustmentBet4BetLimps = {  
          new BigDecimal(0).setScale(2, RoundingMode.HALF_UP),
          new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),
          new BigDecimal(2).setScale(2, RoundingMode.HALF_UP),
          new BigDecimal(3).setScale(2, RoundingMode.HALF_UP),
          new BigDecimal(4).setScale(2, RoundingMode.HALF_UP),
          new BigDecimal(5).setScale(2, RoundingMode.HALF_UP)  };
          static final BigDecimal[] adjustmentBet4BetsFolds = {  
          new BigDecimal(0).setScale(2, RoundingMode.HALF_UP),  
          new BigDecimal(1).setScale(2, RoundingMode.HALF_UP),  
          new BigDecimal(2).setScale(2, RoundingMode.HALF_UP),  
          new BigDecimal(3).setScale(2, RoundingMode.HALF_UP),  
  ...
  * 2. Number of Folders
  * 3. Relative position
  * Arg0 - Current maximum playability value
  * Returns new bet size
  ******************************************************************************/
  static int adjustPreflopRange(int playValue ) {
    if (EvalData.betType == PREFLOP_BET1){
      return playValue + adjustmentBet1Limps[EvalData.limpCount] + adjustmentBet1Folds[EvalData.foldCount]; 
    }  
    if (EvalData.betType == PREFLOP_BET2){
      return playValue  + adjustmentBet2Limps[EvalData.limpCount] + adjustmentBet2Folds[EvalData.foldCount]; 
    } 
    if (EvalData.betType == PREFLOP_BET3){
      return playValue  +  adjustmentBet3Limps[EvalData.limpCount] + adjustmentBet3Folds[EvalData.foldCount]; 
    }
    return -1;
  }
  ...
  * 3. Relative position
  ******************************************************************************/
  static BigDecimal adjustPreflopBetSize(BigDecimal  bet) {
    BigDecimal adjust = zeroBD;
    if (EvalData.betType == PREFLOP_BET1){
      adjust =  adjust.add(adjustmentBet1BetLimps[EvalData.limpCount]).add(adjustmentBet1BetsFolds[EvalData.foldCount]);  
      adjust = adjust.multiply(EvalData.BBBetBD);
      return bet.add(adjust);
    }  
    if (EvalData.betType == PREFLOP_BET2){
      return bet.add(adjustmentBet2BetLimps[EvalData.limpCount].add(adjustmentBet2BetsFolds[EvalData.foldCount]));     adjust =  adjust.add(adjustmentBet1BetLimps[EvalData.limpCount]).add(adjustmentBet1BetsFolds[EvalData.foldCount]);  
      adjust = adjust.multiply(EvalData.BBBetBD);
      return bet.add(adjust);
    } 
    if (EvalData.betType == PREFLOP_BET3){
      return bet.add(adjustmentBet3BetLimps[EvalData.limpCount].add(adjustmentBet3BetsFolds[EvalData.foldCount]));      adjust =  adjust.add(adjustmentBet1BetLimps[EvalData.limpCount]).add(adjustmentBet1BetsFolds[EvalData.foldCount]);  
      adjust = adjust.multiply(EvalData.BBBetBD);
      return bet.add(adjust);
    }
    return zeroBD;
