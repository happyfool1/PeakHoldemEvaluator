...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        st += "The bes Made cols were " + Format.formatPer(worstDrawColsPer[0]) + " "+ madeArrayColNames[bestMadeCols[0]] + ", " + madeArrayColNames[bestMadeCols[1]]
                + ", " + madeArrayColNames[bestMadeCols[2]] + "\r\n";
        st += "The worst Made cols were " + Format.formatPer(worstDrawColsPer[0]) + " " + madeArrayColNames[worstMadeCols[0]] + ", "
                + madeArrayColNames[worstMadeCols[1]]
                + ", " + madeArrayColNames[worstMadeCols[2]] + "\r\n";
        st += "The best Showdownw cols were " + Format.formatPer(worstDrawColsPer[0]) + " "+ madeArrayColNames[bestShowdownwCols[0]] + ", "
