...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private static final JCheckBoxFlopIndexesFlop = new JCheckBox("Flop Indexes Draw");
    private static final JCheckBoxFlopINdexesFlop= new JCheckBox("Flop Indexes Made Hand");
   private static final JCheckBoxFlopIndexesFlop = new JCheckBox("FlopIndexes Showdown");
