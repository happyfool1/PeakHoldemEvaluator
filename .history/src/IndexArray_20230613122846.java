...
for (int row = 0; row < hmlDrawFlop.length; row++) {
    for (int column = 0; column < hmlDrawFlop[row].length; column++) {
        entries.add(new PercentageEntry(hmlDrawFlop[row][column], row, column));
    }
}
}
    ...
    ***************************************************************************************** */
    class  ArrayList {
        ...
        public  ArrayList(Double percentage, int value) {
