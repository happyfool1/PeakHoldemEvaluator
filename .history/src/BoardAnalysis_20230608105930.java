...
// Two pair
else if (EvalData.board[0].value == EvalData.board[1].value && EvalData.board[1].value == EvalData.board[2].value) {

}
else if (EvalData.board[1].value == EvalData.board[1].value && EvalData.board[1].value == EvalData.board[2].value) {
