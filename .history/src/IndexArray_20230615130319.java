...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    private void findBestAndWorstOverall() {
        ...
        for (int i = 0; i < drawEntriesReversed.size(); i++) {
            ...
            if (p != 0.) {
                bestDrawTop5Per[count] = p;
                bestDrawTop5Row[count] = drawEntriesReversed.get(ndx).getRow();
                bestDrawTop5Col[count] = drawEntriesReversed.get(ndx).getCol();
                ++ndx;
                if (++count == 5) {
                    break;
                }
        ...
        for (int i = 0; i < drawEntries .size(); i++) {
            ...
            if (p != 0.) {
                worstDrawTop5Per[count] = p;
                worstDrawTop5Row[count] = drawEntries .get(ndx).getRow();
                worsttDrawTop5Col[count] =drawEntries.get(ndx).getCol();
                ++ndx;
                if (++count == 5) {
                    break;
                }
    ...
    ***************************************************************************************** */
    ...
    //  5best in entire array row and column
