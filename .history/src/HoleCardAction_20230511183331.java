...
public class HoleCardAction implements Constants {
    ...
    ****************************************************************************** */
    ...
    private static JTextField[][][] actionArrayText = new JTextField[POSITIONS][5][2];
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            for (int j = 0; j < 5; ++j) {
                actionArrayText[i][j][0] = new JTextField(String.valueOf(actionArrayPlayability[i][j][0]));
