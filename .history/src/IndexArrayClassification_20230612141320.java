...
public class IndexArrayClassification implements Constants {
	...
	***************************************************************************************************/
	 ...
	 * 
	 *******************************************************************************/
	int TEXTURE_SPADE_CONNECTED = 0;
	int TEXTURE_SPADE_SEMI= 1;
	int TEXTURE_SPADE_UNCONNECTED = 2;
	int TEXTURE_HEART_CONNECTED = 3;
	int TEXTURE_HEART_SEMI= 4;
	int TEXTURE_HEART_UNCONNECTED = 5;
	int TEXTURE_DIAMOND_CONNECTED = 6;
	int TEXTURE_DIAMOND_SEMI= 7;
	int TEXTURE_DIAMOND_UNCONNECTED = 8;
	int TEXTURE_CLUB_CONNECTED = 9;
	int TEXTURE_CLUB_SEMI= 10;
	int TEXTURE_CLUB_UNCONNECTED = 11;
	int TEXTURE_CLUBS = 12;
