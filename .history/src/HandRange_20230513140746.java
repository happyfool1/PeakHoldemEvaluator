...
/*- ******************************************************************************
 * Combine this range with another rnge
 *******************************************************************************/
void combineRandeWithThisRange(HandRange range) {
	for (int i = 0; i < HANDS; ++i) {
		if 
        this.rangeArray[i] += range.rangeArray[i];
        this.playabilityArray[i] += range.playabilityArray[i];
        this.playabilityArrayNumeric[i] += range.playabilityArrayNumeric[i];
    }
}
