...
public class Hand implements Constants {
	...
	* Returns MADE_BOTTOM_TWO_PAIR, MADE_TOP_AND_BOTTOM_TWO_PAIR, or MADE_TOP_TWO_PAIR
	...
	For example, if the board is Q-Q-5, and you hold an A-Q, you would not be described as having "Top Two Pair". Instead, you'd have "three-of-a-kind" or "trips". If you hold A-5, you wouldn't have "Top and Middle Pair". Instead, you would have a "pair of fives" with an Ace kicker, or simply "a pair" if there's no chance of confusion.
