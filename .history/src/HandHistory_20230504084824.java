...
class HandHistory implements Constants {
	 ...
	 * 
	* Card holeCards[][] = new Card[PLAYERS][2];
	* int[] bothIndexs = new int[PLAYERS];
	...
	* int[] lastOrbit = new int[4]; // Indexed by street TODO
	* boolean[][][] isFold = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	* boolean[][][] isLimp = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	* boolean[][][] isCheck = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	* boolean[][][] isCall = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	* boolean[][][] isBet = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	* boolean[][][] isRaise = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	* boolean[][][] isAllin = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	* boolean[][][] raisedToBD = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	* BigDecimal[][][] returnedToBD = new BigDecimal[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	* BigDecimal[][][] betBD = new BigDecimal[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	* BigDecimal[][][] callBD = new BigDecimal[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	* BigDecimal[][][] winBD = new BigDecimal[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	* BigDecimal[] winnerCollectedBD = new BigDecimal[PLAYERS]; // Indexed by street,seat,orbit TODO
	* BigDecimal[] returnedToShowdownBD = new BigDecimal[PLAYERS]; // Indexed by street,seat,orbit TODO
	 * BigDecimal[] playerSidePotSplitTotalBD = new BigDecimal[PLAYERS]; // Indexed by street,seat,orbit TODO
	 * BigDecimal[] playerSidePotSplitBD = new BigDecimal[PLAYERS]; // Indexed by street,seat,orbit TODO
	* BigDecimal[][] potStart$ = new BigDecimal[4][4];
	* BigDecimal[][] potEnd$ = new BigDecimal[4][4];
	* BigDecimal[][][] bet$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[][][] pot$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[][][] moneyIn$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[][] potStart$ = new BigDecimal[4][4];
	* BigDecimal[][] potEnd$ = new BigDecimal[4][4];
	* BigDecimal[][][] bet$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[][][] pot$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[][][] moneyIn$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[][][] call$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[][][] allin$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[][][] returnedTo$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[][][] raisedTo$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[][][] calledTo$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[][][] win$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[] returnedToShowdown$ = new BigDecimal[PLAYERS];
	...
	private * final String[] reportSt = new String[150];
	...
	static void initialize() {
		...
		newHHFile();
		// Erasde all files in this directory
		final var files = new File(EvalData.applicationDirectory +
				"\\HandHistory").listFiles();
	...
	private static void doStreetHH(int street) {
		...
		for (int orbit = 0; orbit < EvalData.lastOrbit[street]; ++orbit) {
			...
			for (int j = 0; j < seatCount; ++j) {
				...
				System.out.println(
						"HHH " + street + " " + orbit + " " + seat + " " + EvalData.lastOrbit[street]
								+ " " + seat + " " + EvalData.isFold[street][seat][orbit]);
