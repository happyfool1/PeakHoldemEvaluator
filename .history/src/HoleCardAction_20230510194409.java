...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        panel0.setSize(1000, 500);
        panel0.setFont(f0);

        final var panel1Layout = new GridLayout(10, 6);
        panel1.setLayout(panel1Layout);
        panel1.setSize(1000, 500);
        panel1.setFont(f0);

        JPanel panelCards = new JPanel();
        panelCards.setSize(600, 40);
        ...
        panelLowRange.setSize(600, 40);
        panelLowRange.setFont(f0);
        final var panelLowayout = new GridLayout(1, 6);
        panelLowRange.setLayout(panelCardsLayout);

        JPanel panelLowPlay = new JPanel();
        panelLowPlay.setSize(600, 40);
        ...
        final var frameDimN = new Dimension(1000, 1000);
