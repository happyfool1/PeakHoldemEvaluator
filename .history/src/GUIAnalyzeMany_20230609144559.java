...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    *******************************************************************************/
    public void myFrame() {
        ...
        indexDrawFlop.setBackground(GREEN);
        ...
        indexMadeFlop.setBackground(GREEN);
        ...
        indexShowdownFlop.setBackground(GREEN);
        panelCheckBoxesIndexFlop.add(indexShowdownFlop);
        panelCheckBoxesIndexFlop.setBackground(GREEN);
    ...
    * a radio button or control button.
    ...
    private void doSimulationDataCollection() {
        ...
        Evaluate.doSimulationDataCollection(100);
