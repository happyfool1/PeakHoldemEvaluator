...
public class IndexArrayClassification implements Constants {
	...
	***************************************************************************************************/
	...
	private static void flopTextureSuitednessConnectedness() {
		...
		EvalData.textureSuitednessConnectednessIndex=  (suitType - 1) * 3 + connectivityType;
	}
 ...
 ***************************************************************************** */
   private static int flopTextureStrengthSuitedness(Card[] cards) {
        if (cards.length != 3) {
        ...
        int maxRank = Math.max(cards[0].rank, Math.max(cards[1].rank, cards[2].rank));
        ...
        // Return the combined characterization as an integer
        return (highCardStrengthType - 1) * 3 + suitednessType;
    }
