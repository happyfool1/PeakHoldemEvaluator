...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private static final JCheckBox IndexesFlop = new JCheckBox("Flop Indexes Draw");
    private static final JCheckBoxvIndexesFlop= new JCheckBox("Flop Indexes Made Hand");
     private static final JCheckBoxp IndexesFlop = new JCheckBox("Flop Indexes Showdown");

   private JPanel panelCheckBoxesIndexTurn;
   private static final JCheckBoxIndexesFlop = new JCheckBox("Flop Indexes Draw");
   private static final JCheckBoxIndexesFlop= new JCheckBox("Flop Indexes Made Hand");
  private static final JCheckBoxpIndexesFlop = new JCheckBox("Flop Indexes Showdown");

  private JPanel panelCheckBoxesIndexRiver;
   private static final JCheckBoxIndexesRiver= new JCheckBox("River Indexes Made Hand");
 private static final JCheckBoxpIndexesRiver = new JCheckBox("Flop Indexes Showdown");
