...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            openLimpText[i][0][0] = new JTextField(String.valueOf(actionArrayPlayability[i][0][0]));
            openLimpText[i][0][0].setFont(f0);
            openLimpText[i][0][0].setSize(40, 40);
            panelActionA.add(openLimpText[i][0][0]);
            openLimpText[i][0][1] = new JTextField(String.valueOf(actionArrayPlayability[i][0][1]));
            openLimpText[i][0][1].setFont(f0);
            openLimpText[i][0][1].setSize(40, 40);
            panelActionA.add(openLimpText[i][0][1]);

            openLimpText[i][1][0] = new JTextField(Format.format(actionArrayPercentage[i][0][0]));
            openLimpText[i][1][0].setFont(f0);
            openLimpText[i][1][0].setSize(40, 40);
            panelActionA.add(openLimpText[i][1][0]);
            openLimpText[i][1][1] = new JTextField(Format.format(actionArrayPercentage[i][0][1]));
            openLimpText[i][1][1].setFont(f0);
            openLimpText[i][1][1].setSize(40, 40);
            panelActionA.add(openLimpText[i][1][1]);
        }
