...
public class IndexArray implements Constants {
    ...
    ****************************************************************************** */
    IndexArray(int[][] drawArray, int[][] madeArray, int[][] showdownArray,
        ...
        copyArray( allArrayRowNames, this.rowNames);
        copyArray( drawArrayColNames, this.drawColNames);
        copyArray( madeArrayColNames, this.madeColNames);
    
                copyArray(this.drawToMadeRiver, this.drawToMadeRiver);
                copyArray(this.madeToMadeRiver, this.madeToMadeRiver);
                copyArray(this.drawToMadeWon, this.drawToMadeWon);
                copyArray(this.madeToMadeWon, this.madeToMadeWon);
