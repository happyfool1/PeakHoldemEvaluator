...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
                actionArrayPlayabilityText[i][1][0] = new JTextField(String.valueOf(actionArrayPlayability[i][j][0]));
                ...
                actionArrayPlayabilityText[i][1][1] = new JTextField(String.valueOf(actionArrayPlayability[i][j][1]));
