...
public class Showdown implements Constants {
	...
	*   showdownValue()
	*  	showdown()\
	* There are 2 methods that create S
	* 		showShowdown()	
	*
	***************************************************************************************/
	...
	static void showdownValueString() {
		switch (EvalData.showdownHand[EvalData.seat]) {
			...
			case MADE_FOUR_OF_A_KIND -> {
				EvalData.showdownValueSt[EvalData.seat] = "//Four of a kind high card "
			...
			case MADE_NONE -> {
				EvalData.showdownValueSt[EvalData.seat] = new StringBuilder()
