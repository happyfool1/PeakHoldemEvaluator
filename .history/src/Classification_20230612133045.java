...
public class Classification implements Constants {
	...
	***************************************************************************************************/
	 ...
	 * Sure, to make this Java method, let's consider that each card has two properties: a rank and a suit. Let's represent ranks as integers from 2 (for 2) to 14 (for Ace), and suits as integers from 1 to 4.
	 *******************************************************************************/
