...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    public class PairEntry {
        ...
        public PairEntry(double percentage, int rowOrCol) {
            this.percentage = percentage;
    ...
    ***************************************************************************************** */
     ...
     * Helper to constructor  
     ***************************************************************************************** */
    void createIndexArrayRowAndColumnList() {
    ...
    ***************************************************************************************** */
    void findBestAndWorst() {
        ...
        // Get the smallest percentage in the list
        ...
        bestMadeRows[0] = madeTotalRowPerEntries.get(0).getRowOrCol();
        worstMadeRows[0] = madeTotalRowPerEntries.get(drawTotalRowPerEntries.size() - 1).getRowOrCol();
        bestShowdownwRows[0] = showdownTotalRowPerEntries.get(0).getRowOrCol();
        worstShowdownRows[0] = showdownTotalRowPerEntries.get(drawTotalRowPerEntries.size() - 1).getRowOrCol();
        bestDrawCols[0] = drawTotalColPerEntries.get(0).getRowOrCol();
        worstDrawCols[0] = drawTotalColPerEntries.get(drawTotalColPerEntries.size() - 1).getRowOrCol();
        bestMadeCols[0] = madeTotalColPerEntries.get(0).getRowOrCol();
        worstMadeCols[0] = madeTotalColPerEntries.get(drawTotalColPerEntries.size() - 1).getRowOrCol();
        bestShowdownwCols[0] = showdownTotalColPerEntries.get(0).getRowOrCol();
        worstShowdownCols[0] = showdownTotalColPerEntries.get(drawTotalColPerEntries.size() - 1).getRowOrCol();
     
         bestDrawRows[1] = drawTotalRowPerEntries.get(drawTotalRowPerEntries.size() - 1).getRowOrCol();
        worstDrawRows[1] = drawTotalRowPerEntries.get(0).getRowOrCol();
        bestMadeRows[1] = madeTotalRowPerEntries.get(0).getRowOrCol();
        worstMadeRows[1] = madeTotalRowPerEntries.get(drawTotalRowPerEntries.size() - 1).getRowOrCol();
        bestShowdownwRows[1] = showdownTotalRowPerEntries.get(0).getRowOrCol();
        worstShowdownRows[1] = showdownTotalRowPerEntries.get(drawTotalRowPerEntries.size() - 1).getRowOrCol();
        bestDrawCols[1] = drawTotalColPerEntries.get(0).getRowOrCol();
        worstDrawCols[1] = drawTotalColPerEntries.get(drawTotalColPerEntries.size() - 1).getRowOrCol();
        bestMadeCols[1] = madeTotalColPerEntries.get(0).getRowOrCol();
        worstMadeCols[1] = madeTotalColPerEntries.get(drawTotalColPerEntries.size() - 1).getRowOrCol();
        bestShowdownwCols[1] = showdownTotalColPerEntries.get(0).getRowOrCol();
        worstShowdownCols[1] = showdownTotalColPerEntries.get(drawTotalColPerEntries.size() - 1).getRowOrCol();

       bestDrawRows[2] = drawTotalRowPerEntries.get(drawTotalRowPerEntries.size() - 1).getRowOrCol();
        worstDrawRows[2] = drawTotalRowPerEntries.get(0).getRowOrCol();
        bestMadeRows[2] = madeTotalRowPerEntries.get(0).getRowOrCol();
        worstMadeRows[2] = madeTotalRowPerEntries.get(drawTotalRowPerEntries.size() - 1).getRowOrCol();
        bestShowdownwRows[2] = showdownTotalRowPerEntries.get(0).getRowOrCol();
        worstShowdownRows[2] = showdownTotalRowPerEntries.get(drawTotalRowPerEntries.size() - 1).getRowOrCol();
        bestDrawCols[2] = drawTotalColPerEntries.get(0).getRowOrCol();
        worstDrawCols[2] = drawTotalColPerEntries.get(drawTotalColPerEntries.size() - 1).getRowOrCol();
        bestMadeCols[2] = madeTotalColPerEntries.get(0).getRowOrCol();
        worstMadeCols[2] = madeTotalColPerEntries.get(drawTotalColPerEntries.size() - 1).getRowOrCol();
        bestShowdownwCols[2] = showdownTotalColPerEntries.get(0).getRowOrCol();
        worstShowdownCols[2] = showdownTotalColPerEntries.get(drawTotalColPerEntries.size() - 1).getRowOrCol();

    }

    // Method to return smallest percentage entry
    public static PercentageEntry getSmallest(List<PercentageEntry> entries) {
        if (entries.isEmpty()) {
    ...
    // Method to return largest percentage entry
    public static PercentageEntry getLargest(List<PercentageEntry> entries) {
        if (entries.isEmpty()) {
            return null; // or throw an exception, depending on your preference
        }
        entries.sort(Comparator.comparing(PercentageEntry::getPercentage));
    ...
    *  
    ***************************************************************************************** */
    void indexArrayListInSortedOrder() {
    ...
    ***************************************************************************************** */
    ...
    double[] bestDrawRows = new double[3];
    double[] worstDrawRows = new double[3];
    double[] bestMadeRows = new double[3];
    double[] worstMadeRows = new double[3];
    double[] bestShowdownwRows = new double[3];
    double[] worstShowdownRows = new double[3];
    // top 3 high and low col percentages
    double[] bestDrawCols = new double[3];
    double[] worstDrawCols = new double[3];
    double[] bestMadeCols = new double[3];
    double[] worstMadeCols = new double[3];
    double[] bestShowdownwCols = new double[3];
    double[] worstShowdownCols = new double[3];
