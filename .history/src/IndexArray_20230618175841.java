...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        + Format.formatPer(bestDraw5Per[0])  + " " + allArrayRowNames[bestDraw5Row[0]] + ", " + drawArrayColNames[bestDraw5Col[1]]+ "\r\n"
          + Format.formatPer(bestDraw5Per[1])  + " " + allArrayRowNames[bestDraw5Row[1]] + ", " + drawArrayColNames[bestDraw5Col[0]]+ "\r\n"
  + Format.formatPer(bestDraw5Per[2])  + " " + allArrayRowNames[bestDraw5Row[2]] + ", " + drawArrayColNames[bestDraw5Col[2]]+ "\r\n"
  + Format.formatPer(bestDraw5Per[3])  + " " + allArrayRowNames[bestDraw5Row[3]] + ", " + drawArrayColNames[bestDraw5Col[3]]+ "\r\n"
  + Format.formatPer(bestDraw5Per[4])  + " " + allArrayRowNames[bestDraw5Row[04] + ", " + drawArrayColNames[bestDraw5Col[0]]+ "\r\n";
