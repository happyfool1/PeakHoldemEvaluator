...
public class AnalyzeHelper implements Constants {
	...
	/*-
		 ...
		 */
	public static double calculateMDF(double potSize, double betSize) {
	 ...
	 */
	public static double calculateEV(double probabilityOfWinning, double amountWon, double probabilityOfLosing,
			double amountLost) {
