...
public interface Constants {
	...
	*******************************************************************************/
	...
	int POSSIBLE_DRAW__TWO_PAIR = 1;

	int POSSIBLE_DRAW__SET = 2;

	int POSSIBLE_DRAW__GUTSHOT = 3;

	int POSSIBLE_DRAW__GUTSHOT_HIGH = 4;

	int POSSIBLE_DRAW__GUTSHOT_PAIR = 5;

	int POSSIBLE_DRAW__STRAIGHT = 5;

	int POSSIBLE_DRAW__OESD = 3;

	int POSSIBLE_DRAW__OESD_PAIR = 4;

	int POSSIBLE_DRAW__FLUSH = 4;

	int POSSIBLE_DRAW__FLUSH_PAIR = 5;

	int POSSIBLE_DRAW__FLUSH_OESD = 5;

	int POSSIBLE_DRAW__FLUSH_GUTSHOT = 5;

	int POSSIBLE_DRAW__FULL_HOUSE = 5;

	int POSSIBL_DRAW__FOUR_OF_A_KIND = 6;

	int POSSIBLE__DRAW_STRAIGHT_FLUSH = 7;

	int POSSIBLE_DRAW__ROYAL_FLUSH = 8;

	int POSSIBLE_DRAW__SIZE = 9;
