...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
  ...
  private JPanel panelCheckBoxesIndexRiver;
   private static final JCheckBox IndexesRiver= new JCheckBox("River Indexes Made Hand");
 private static final JCheckBoxp IndexesRiver = new JCheckBox("Flop Indexes Showdown");
