...
public class IndexArrayClassification implements Constants {
	...
	* Characterizing a flop can be done in many ways depending on what is important to the player.
	...
	two could share a suit while the third is a different suit (2 suited), or all three could be different suits (rainbow). This is easy to count quickly and gives a lot of information about the possibility of flush draws.
