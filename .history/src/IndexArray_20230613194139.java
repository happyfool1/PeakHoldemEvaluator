    ...
    ***************************************************************************************** */
    void findBestAndWorst() {
      ...
      bestDrawRows[1] = drawTotalRowPerEntries.get(drawTotalRowPerEntries.size() - 1).getRowOrCol();
        ...
        worstMadeRows[1] = madeTotalRowPerEntries.get(0).getRowOrCol();
        bestShowdownwRows[1] = showdownTotalRowPerEntries.get(showdownTotalRowPerEntries.size()-1).getRowOrCol();
        worstShowdownRows[1] = showdownTotalRowPerEntries.get(0).getRowOrCol();
        bestDrawCols[1] = drawTotalColPerEntries.get(drawTotalColPerEntries.size() -1).getRowOrCol();
        worstDrawCols[1] = drawTotalColPerEntries.get(0).getRowOrCol();
        bestMadeCols[1] = madeTotalColPerEntries.get(madeTotalColPerEntries.size() -1).getRowOrCol();
        worstMadeCols[1] = madeTotalColPerEntries.get(0).getRowOrCol();
        bestShowdownwCols[1] = showdownTotalColPerEntries.get(showdownTotalColPerEntries.size() -1).getRowOrCol();
        worstShowdownCols[1] = showdownTotalColPerEntries.get(0).getRowOrCol();
        ...
        bestMadeRows[2] = madeTotalRowPerEntries.get(madeTotalRowPerEntries.size() -1).getRowOrCol();
        worstMadeRows[2] = madeTotalRowPerEntries.get(0).getRowOrCol();
        bestShowdownwRows[2] = showdownTotalRowPerEntries.get(showdownTotalRowPerEntries.size()-1).getRowOrCol();
        worstShowdownRows[2] = showdownTotalRowPerEntries.get(0).getRowOrCol();
        bestDrawCols[2] = drawTotalColPerEntries.get(drawTotalColPerEntries.size() -1).getRowOrCol();
        worstDrawCols[2] = drawTotalColPerEntries.get(0).getRowOrCol();
        bestMadeCols[2] = madeTotalColPerEntries.get(madeTotalColPerEntries.size() -1).getRowOrCol();
        worstMadeCols[2] = madeTotalColPerEntries.get(0).getRowOrCol();
        bestShowdownwCols[2] = showdownTotalColPerEntries.get(showdownTotalColPerEntries.size() -1).getRowOrCol();
        worstShowdownCols[2] = showdownTotalColPerEntries.get(0).getRowOrCol();
