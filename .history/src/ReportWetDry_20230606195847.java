...
/*-  *********************************************************************************************
 * This Class displays reports of  related data.
 * 
...
public class ReportWetDry implements Constants {
    ...
    private static final Object[] columnsDrawFlop = { "", "No draw", "Gutshot",
    ...
    private static final Object[] columnsMadeFlop = { "", "No hand", "Bottom Pair",
    ...
    private static final Object[] columnsShowdownFlop = { "", "No hand", "Bottom Pair",
            "Middle Pair", "Top Pair", "Over Pair", "Bottom 2 pair", "Top-Bottom 2 Pair", "Top 2 Pair", "Set",
            "Straight", "Flush", "Full house", "Straight flush", "Royal flush", "Total" };
    ...
    private static final Object[] columnsDrawTurn = { "", "No draw", "Gutshot", "Straight", "OESD", "Flush",
            "Flush OESD", "Total" };
    ...
    private static final Object[] columnsMadeTurn = { "", "No hand", "Bottom Pair",
            "Middle Pair", "Top Pair", "Over Pair", "Bottom 2 pair", "Top-Bottom 2 Pair", "Top 2 Pair", "Set",
            "Straight", "Flush", "Full house", "Straight flush", "Royal flush", "Total" };
    ...
    private static final Object[] columnsShowdownTurn = { "", "No hand", "Bottom Pair",
            "Middle Pair", "Top Pair", "Over Pair", "Bottom 2 pair", "Top-Bottom 2 Pair", "Top 2 Pair", "Set",
            "Straight", "Flush", "Full house", "Straight flush", "Royal flush", "Total" };
    ...
    private static final Object[] columnsMadeRiver = { "", "No hand", "Bottom Pair",
            "Middle Pair", "Top Pair", "Over Pair", "Bottom 2 pair", "Top-Bottom 2 Pair", "Top 2 Pair", "Set",
            "Straight", "Flush", "Full house", "Straight flush", "Royal flush", "Total" };
    ...
    private static final Object[] columnsShowdownRiver = { "", "No hand", "Bottom Pair",
            "Middle Pair", "Top Pair", "Over Pair", "Bottom 2 pair", "Top-Bottom 2 Pair", "Top 2 Pair", "Set",
            "Straight", "Flush", "Full house", "Straight flush", "Royal flush", "Total" };
    ...
    ****************************************************************************************************************/
    static void reportDrawFlop(int c, int r) {
        if (frame1 == null) {
            frame1 = new JFrame("Flop  Drawing hands");
        ...
        int col = 0;
        for (int i = 0; i < 3; ++i) {
            table1.setValueAt(_FLOP_ST[i], row, 0);
            col = 1;
            sum = 0.0;
            for (int j = 0; j < DRAW_HANDS_SIZE; ++j) {
                if (ManyData.hmlDraw[i][j] > 0) {
                    ...
                    table1.setValueAt(Format.formatPer(sum), row, 7);
    ...
    static void reportMadeFlop(int c, int r) {
        if (frame2 == null) {
            frame2 = new JFrame("Flop  Made hands");
        ...
        int row = 0;
        int col = 0;
        for (int i = 0; i < _FLOP_SIZE; ++i) {
            table2.setValueAt(_FLOP_ST[i], row, 0);
            col = 1;
            sum = 0.0;
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
                if (ManyData.hmlMade[i][j] > 0) {
                    ...
                    table2.setValueAt(Format.formatPer(sum), row, 15);
    ...
    static void reportShowdownFlop(int c, int r) {
        if (frame3 == null) {
            frame3 = new JFrame("Showdown Flop  Winner hands");
        ...
        int col = 0;
        for (int i = 0; i < _FLOP_SIZE; ++i) {
            table3.setValueAt(_FLOP_ST[i], row, 0);
            col = 1;
            sum = 0.0;
            ...
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
                if (ManyData.hmlShowdownWon[i][j] > 0) {
                    ...
                    table3.setValueAt(Format.formatPer(sum), row, 15);
    ...
    static void reportDrawTurn(int c, int r) {
        if (frame4 == null) {
            frame4 = new JFrame("Turn  Drawing hands");
        ...
        int row = 0;
        int col = 0;
        for (int i = 0; i < _TURN_SIZE; ++i) {
            table4.setValueAt(_TURN_ST[i], row, 0);
            col = 1;
            sum = 0.0;
            for (int j = 0; j < DRAW_HANDS_SIZE; ++j) {
                if (ManyData.hhmlDraw[i][j] > 0) {
                    ...
                    table4.setValueAt(Format.formatPer(sum), row, 7);
    ...
    static void reportMadeTurn(int c, int r) {
        if (frame5 == null) {
            frame5 = new JFrame("Turn  Made hands");
        ...
        int col = 0;
        for (int i = 0; i < _TURN_SIZE; ++i) {
            table5.setValueAt(_TURN_ST[i], row, 0);
            col = 1;
            sum = 0.0;
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
    ...
    static void reportShowdownTurn(int c, int r) {
        if (frame6 == null) {
            frame6 = new JFrame("Showdown Turn  Winner hands");
        ...
        int col = 0;
        for (int i = 0; i < _TURN_SIZE; ++i) {
            table6.setValueAt(_TURN_ST[i], row, 0);
            col = 1;
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
    ...
    ********************************************************************************** */
    static void reportMadeRiver(int c, int r) {
        if (frame7 == null) {
            frame7 = new JFrame("River  Made hands");
        ...
        int row = 0;
        int col = 0;
        for (int i = 0; i < _RIVER_SIZE; ++i) {
            table7.setValueAt(_RIVER_ST[i], row, 0);
            col = 1;
            sum = 0.0;
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
    ...
    ********************************************************************************** */
    static void reportShowdownRiver(int c, int r) {
        if (frame8 == null) {
            frame8 = new JFrame("Showdown River  Winner hands");
        ...
        int col = 0;
        for (int i = 0; i < _RIVER_SIZE; ++i) {
            table8.setValueAt(_RIVER_ST[i], row, 0);
            col = 1;
            sum = 0.0;
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
