...
public class ReportHML implements Constants {
 ...
 private static final int TOTAL_COLz = MADE_FLUSH+2;
    private static final int TOTAL_COL = MADE_FLUSH+2;
        ...
        for (int i = 0; i < HML_FLOP_SIZE; ++i) {
            ...
            for (int j = 0; j < MADE_FLUSH; ++j) {
                if (ManyData.hmlMade[i][j] > 0) {
                    ...
                    table2.setValueAt(Format.formatPer(sum), row,  MADE_FLUSH+2);
        ...
        for (int i = 0; i < HML_FLOP_SIZE; ++i) {
            ...
            for (int j = 0; j <  MADE_FLUSH-1; ++j) {
                if (ManyData.hmlShowdownWon[i][j] > 0) {
                    ...
                    table3.setValueAt(Format.formatPer(sum), row,  MADE_FLUSH+2);
