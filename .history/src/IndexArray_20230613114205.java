...
void createIndexArrayList() {
    ...
    ***************************************************************************************** */
    class AnyArray {
        ...
        public AnyArray(Double percentage, int row, int col, String rowSt, String colSt) {
    ...
    ***************************************************************************************** */
    ...
    // List for each array
    List<AnyArrayList> drawArrayList = new AnyArrayList<>();
   List<AnyArrayList> madeArrayList = new ArrayList<>();
   List<AnyArrayList> showdownArrayList = new ArrayList<>();
