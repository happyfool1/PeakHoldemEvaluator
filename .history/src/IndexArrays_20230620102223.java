...
public class IndexArrays implements Constants {
	...
	* +1 because of Showdown
	...
	static int[][] hmlMadeTurnToMadeRiver = new int[[HML_FLOP_SIZE]MADE_SIZE][MADE_SIZE];
	static int[][] hmlMadeRiverToMadeRiver = new int[HML_FLOP_SIZE][MADE_SIZE][MADE_SIZE];

	static int[][] hmlDrawTurnrawFlopToMadWon = new int[DRAW_SIZE][MADE_SIZE];
	static int[][] hmlDrawTurnToMadeWon = new int[[HML_FLOP_SIZE]DRAW_SIZE][MADE_SIZE];
