...
public interface Constants {
	...
	*******************************************************************************/
	...
	int HHML_FLOP_SIZE = 10;

	int HML_FLOP_SIZE = 10;
	int HML_TURN_SIZE = 13;
	...
	String[] HML_TURN_ST = { "HHHH", "HHHM", "HHHL", "HHMM", "HHML", "HHLL",
			"HMMM", "HMML", "HMLL", "MMMM", "MMML", "MMLL", "MLLL" };

	String[] HML_TURN_ST = { "LLLL", "MLLL", "MMLL", "MMML", "MMMM", "HMll",
			"HMML", "HHLL", "HHML", "HHLMM", "HHHl", "HHHM", "HHHH"};
