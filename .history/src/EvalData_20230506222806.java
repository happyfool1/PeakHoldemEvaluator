...
public class EvalData implements Constants {
	...
	* When you're in position, you might opt for a smaller 4-bet size to give yourself better pot odds 
	...
	a larger 4-bet size can help to discourage your opponent from calling and take down the pot preflop or give you more control of the pot if they do call.
	 * 
	  ************************************************************************************** */
