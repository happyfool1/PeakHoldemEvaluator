...
public class IndexArray implements Constants {
    ...
    ****************************************************************************** */
    IndexArray(int[][] drawArray, int[][] madeArray, int[][] showdownArray, String[] rowNames, String[] drawColNames,
            String[] madeColNames) {
   this.drawArray  = new InterruptedException[ drawArray.length][drawArray[0].length];
        this.madeArray  = new double[ madeArray.length][ madeArray[0].length];
        this.showdownArray  = new double[showdownArray.length][showdownArray[0].length];
