...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private JPanel panel panelCheckBoxesIndexFlop;
    ...
    private static final JCheckBox sumOfHoleCatdsDrawRiver = new JCheckBox("River Indexes Draw");
    ...
    private JPanel panelCheckBoxesTypeHoleCards;
    private static final JCheckBox typeHoleCatdsDraw = new JCheckBox("Hole Cards Type Draw");
    private static final JCheckBox typeHoleCardsMade = new JCheckBox("Hole Cards Type Made Hand");
    private static final JCheckBox typeHoleCardsShowdown = new JCheckBox("Hole Cards Type Showdown");

    private JPanel panelCheckBoxesSumOfHoleCardsType;
    private static final JCheckBox sumOfHoleCatdsDrawType = new JCheckBox("Hole Cards Type Draw");
    private static final JCheckBox sumOfHoleCardsMadeType = new JCheckBox("Hole Cards Type Made Hand");
    private static final JCheckBox sumOfHoleCardsShowdownType = new JCheckBox("Hole Cards Type Showdown");

    private JPanel panelCheckBoxesSumOfHoleCardsWetDry;
    private static final JCheckBox sumOfHoleCatdsDrawWetDry = new JCheckBox("Hole Cards Type Draw");
    private static final JCheckBox sumOfHoleCardsMadeWetDry = new JCheckBox("Hole Cards Type Made Hand");
    private static final JCheckBox sumOfHoleCardsShowdownWetDry = new JCheckBox("Hole Cards Type Showdown");
