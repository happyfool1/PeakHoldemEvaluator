...
public class EvalData implements Constants {
	...
	* When you're in position, you might opt for a smaller 4-bet size to give yourself better pot odds 
	8 and the ability to exert more postflop pressure on your opponent. When you're out of position, 
...
These guidelines provide a starting point for determining your bet sizes on the flop, but keep in mind that poker is a dynamic game that requires constant adjustments based on various factors, including your opponents' tendencies and your overall game plan.
	...
	static final BigDecimal postFlopBbetMultiplierBD = new BigDecimal((double) .5); // Times pot size
