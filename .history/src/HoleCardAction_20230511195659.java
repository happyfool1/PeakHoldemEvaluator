    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            actionArrayPlayabilityTextC[i][02][0].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextC[i][2][0]);
            actionArrayPlayabilityTextC[i][1][1] = new JTextCField(String.valueOf(actionArrayPlayability[i][2][1]));
            actionArrayPlayabilityTextC[i][12][1].setFont(f0);
