...
/*-**********************************************************************************
 * Same as above but for Draw hands
 ********************************************************************************** */
    static void reportHMLDrawTurn(int c, int r) {
        if (frame1 == null) {
            frame1 = new JFrame("Turn HML Drawing hands");
            frame1.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            frame1.setLocation(c, r);
            frame1.setPreferredSize(new Dimension(750, 330));
        }
        ...
        tableModel1 = new DefaultTableModel(dataHMLDrawTurn, columnsHMLDrawTurn);
        table1 = new JTable(tableModel1);
        table1.setFont(ff1);
        table1.setRowHeight(25);
 ...
 ********************************************************************************** */
     static void reportHMLMadeTurn(int c, int r) {
        if (frame2 == null) {
            frame2 = new JFrame("Turn HML Made hands");
            frame2.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            frame2.setLocation(c, r);
            frame2.setPreferredSize(new Dimension(750, 330));
        }
        ...
        tableModel2 = new DefaultTableModel(dataHMLMadeTurn, columnsHMLMadeTurn);
        table2 = new JTable(tableModel2);
        table2.setFont(ff1);
        table2.setRowHeight(25);
 ...
 ********************************************************************************** */
    static void reportHMLShowdownTurn(int c, int r) {
        if (frame3 == null) {
            frame3 = new JFrame("Showdown Turn HML Winner hands");
            frame3.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            frame3.setLocation(c, r);
            frame3.setPreferredSize(new Dimension(750, 600));
        }
        ...
        tableModel3 = new DefaultTableModel(dataHMLTurnShowdownWon, columnsHMLTurnShowdownWon);
        table3 = new JTable(tableModel3);
        table3.setFont(ff1);
        table3.setRowHeight(25);
