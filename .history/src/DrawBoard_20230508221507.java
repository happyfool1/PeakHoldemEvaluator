 ...
 * The  board3FlushDraw  boolean was calculated by yhe Analyze Class.
...
public class DrawBoard implements Constants {
	...
	boolean isNone() {
		...
		EvalData.drawArray[DRAW_NONE] = true;
		this.ok = true;
		return this.ok;
	}
	...
	boolean isPair() {
		...
		if (this.ok) {
			EvalData.madeArray[MADE_PAIR] = true;
	...
	boolean is2Pair() {
		...
		if (this.ok) {
			EvalData.madeArray[MADE_TWO_PAIR] = true;
		}
		return this.ok;
	}
	...
	boolean isSet() {
		...
		if (this.ok) {
			EvalData.madeArray[MADE_SET] = true;
		}
		return this.ok;
	}
