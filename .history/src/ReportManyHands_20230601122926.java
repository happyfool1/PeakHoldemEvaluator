...
********************************************************************************** */
	static void reportHMLShowdownFlop(int c, int r) {
		if (frame7 == null) {
			...
			tableModel7 = new DefaultTableModel(dataHMLFlopShowdown , columnsHMLFlopShowdownMade );
...
static void reportHMLShowdownTurn(int c, int r) {
	if (frame8 == null) {
		...
		tableModel8 = new DefaultTableModel(dataHHMLShowdownMade , columnsHHMLShowdownMade );
