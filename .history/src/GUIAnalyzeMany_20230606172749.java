...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private JPanel panelCheckBoxesFlopIndexFlop;
    private static final JCheckBox flopIndexDrawFlop = new JCheckBox("Flop INdex  Draw");
    private static final JCheckBox flopIndexMadeFlop = new JCheckBox("Flop Index  Made Hand");
    private static final JCheckBox flopIndexShowdownFlop = new JCheckBox("Flop Index Showdown");

    private JPanel panelCheckBoxesFlopIndexFlop;
    private static final JCheckBox flopIndexDrawFlop = new JCheckBox("Flop Index Draw");
    private static final JCheckBox flopIndexMadeFlop = new JCheckBox("Flop Index Made Hand");
    private static final JCheckBox flopIndexShowdownFlop = new JCheckBox("Flop Index howdown");
    private JPanel panelCheckBoxesFlopIndexFlop;
    private static final JCheckBox flopIndexDrawFlop = new JCheckBox("Flop INdex Flop Draw");
    private static final JCheckBox flopIndexMadeFlop = new JCheckBox("Flop Index Flop Made Hand");
    private static final JCheckBox flopIndexShowdownFlop = new JCheckBox("Flop Index Flop Showdown");
