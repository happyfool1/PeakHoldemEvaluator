...
This example
    ...
    are low (meaning the player has to risk a lot to win a little), the code increases the likelihood of folding or bluffing and decreases the likelihood of calling or raising. Conversely, if the pot odds are

    high (meaning the player can win a lot for a small risk), the code decreases the likelihood of folding or bluffing and increases the likelihood of calling or raising.
     */
