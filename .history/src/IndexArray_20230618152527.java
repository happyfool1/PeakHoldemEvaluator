...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        st += "The best Draw cols were "+ Format.formatPer(bestDrawColsPer[0]) + drawArrayColNames[bestDrawCols[0]] + ", "
        ...
        st += "The worst Draw cols were "+ Format.formatPer(worstDrawColsPer[0]) + " " + drawArrayColNames[worstDrawCols[0]] + ", "
              + Format.formatPer(worstDrawColsPer[0]) + " "   + drawArrayColNames[worstDrawCols[1]]
                + ", "+ Format.formatPer(worstDrawColsPer[0]) + " "  + drawArrayColNames[worstDrawCols[2]] + "\r\n";
