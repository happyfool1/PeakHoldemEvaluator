...
public class HandRangeConverter implements Constants {
	...
	void newRanges() {
		...
		rangeBB.buildRangePercentage(percentSB );
		rangeUTG.buildRangePercentage(percentSB);
		rangeMP.buildRangePercentage(percentSB);
		rangeCO.buildRangePercentage(percentSB);
		rangeBU.buildRangePercentage(percentSB);
