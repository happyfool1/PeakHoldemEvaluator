...
public class GameControl implements Constants {
	...
	**************************************************************************** */
	static void preflopSimulationOneHand() {
		...
		System.out.println(
			System.out.println(
				"//seats " + seatSB + " " + seatBB + " " + seatUTG + " " + seatMP + " " + seatCO + " " + seatBU);		"//seats " + seatSB + " " + seatBB + " " + seatUTG + " " + seatMP + " " + seatCO + " " + seatBU);
	...
	*******************************************************************************/
	...
	/*- **************************************************************************** 
		...
		* and contains seat number 0-5
		*******************************************************************************/
	private static void setPlayerPositions() {
		for (int i = 0; i < PLAYERS; i++) {
			EvalData.playerPositions[EvalData.positions[i]] = i;
		}
	}
