...
public interface Constants {
	...
	* Flop texture
	******************************************************************************/
	 int TEXTURE_MONOTONE_CONNECTED = 0;
	int TEXTURE_MONOTONE_SEMI= 1;
	int TEXTURE_MONOTONE_UNCONNECTED = 2;
	int TEXTURE_TWO_TONE_CONNECTED = 3;
	int TEXTURE_TWO_TONE_SEMI= 4;
	int TEXTURE_TWO_TONE_UNCONNECTED = 5;
	int TEXTURE_RAINBOW_CONNECTED = 6;
	int TEXTURE_RAINBOW_SEMI= 7;
	int TEXTURE_RAINBOW_UNCONNECTED = 8;
 	int TEXTURE_SIZE = 9;
	   String TEXTURE_ST[] ={"Monotone Connected", "Monotone Semi", "Monotone Unconnected", "Two-tone Connected"
	,"Two-tone Semi", "Two-tone Unconnected", "Rainbow Connected", "Rainbow Semi", "Rainbow Unconnected"};
