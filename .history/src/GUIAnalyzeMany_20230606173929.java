...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    *******************************************************************************/
    public void myFrame() {
        ...
        typeOf1755DrawFlop p.setFont(fs);
        typesOf1755DrawFlop.setPreferredSize(new Dimension(20, 20));
        typesOf1755DrawFlop.addActionListener(this);
        typesOf1755MadeFlop.setSelected(false);
        panelCheckBoxesWetDryFlop.add(typesOf1755DrawFlop);

        typesOf1755MadeFlop.setFont(fs);
        typesOf1755MadeFlop.setPreferredSize(new Dimension(20, 20));
        typesOf1755MadeFlop.addActionListener(this);
        typesOf1755MadeFlop.setSelected(false);
        panelCheckBoxesWetDryFlop.add(typesOf1755MadeFlop);

        typesOf1755ShowdownFlop.setFont(fs);
        typesOf1755ShowdownFlop.setPreferredSize(new Dimension(20, 20));
        typesOf1755ShowdownFlop.addActionListener(this);
        typesOf1755ShowdownFlop.setSelected(false);
