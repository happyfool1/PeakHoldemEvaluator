...
public class GUIAnalyzeIndexArrays extends JFrame implements ActionListener, Constants {
    ...
    * a radio button or control button.
    ...
    private void doSimulationDataCollection() {
        ...
        IndexArray hml = new IndexArray 
        ( IndexArrays.hmlDrawFlop,IndexArrays.hmlMadeFlop,IndexArrays.hmlShowdownFlop,HML_FLOP_ST,DRAW_ARRAY_ST,
        MADE_ARRAY_ST,SHOWDOWN_ARRAY_ST); );
