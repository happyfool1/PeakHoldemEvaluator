...
public class ReportManyHands implements Constants {
	...
	private static final Object[][] dataHHHMLRiverShowdownMade = { { "", "", "", "", "", "", "", "", "", "" },
		...
		private static final Object[][] dataHMLFlopShowdownWon = { { "", "", "", "", "", "", "", "", "", "" },
			...
			private static final Object[] columnsHHMLTurnShowdownMadeWon = { "HML", "No hand", "Any pair", "Two pair", "Set", "Straight",
			"Flush", "Full house", "Straight flush", "Royal flush" };

	private static final Object[][] dataHHMLTurnShowdownMadeWon = { { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" },
			...
			private static final Object[] columnsHHHMLRiverShowdownMadeWon = { "HML", "No hand", "Any pair", "Two pair", "Set", "Straight",
			"Flush", "Full house", "Straight flush", "Royal flush" };

	private static final Object[][] dataHHHMLRiverShowdownMadeWon = { { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" },
...
static void reportHMLShowdownRiverMade(int c, int r) {
	if (frame9 == null) {
		...
		tableModel9 = new DefaultTableModel(dataHHHMLRiverShowdownMade, columnsHHHMLRiverShowdown);
