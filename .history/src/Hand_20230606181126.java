...
public class Hand implements Constants {
	...
	* Returns MADE_BOTTOM_PAIR, MADE_MIDDLE_PAIR, MADE_TOP_PAIR, or MADE_OVER_PAIR 
	...
	int whatKindOfPair() {
		...
		if (this.pair1Value < EvalData.boardHighCardValue1 && this.pair1Value > EvalData.boardLowCardValue) {
...
ChatGPT
When a player has two pair, it refers to their hand consisting of two different pairs of cards. The classification of these pairs can change as the board develops from the flop to the turn and river. Here's how it typically goes:

Flop:

Top Two Pair: When your hand makes a pair with the two highest cards on the flop. Example: You hold A-Q, and the flop comes Q-A-5.
Top and Middle Pair: When your hand makes a pair with the highest and middle cards on the flop. Example: You hold A-8, and the flop comes A-8-3.
Top and Bottom Pair: When your hand makes a pair with the highest and lowest cards on the flop. Example: You hold A-5, and the flop comes A-9-5.
Middle Two Pair: When your hand makes a pair with the two middle cards on the flop. Example: You hold 9-8, and the flop comes 10-9-8.
Middle and Bottom Pair: When your hand makes a pair with the middle and lowest cards on the flop. Example: You hold 8-3, and the flop comes 10-8-3.
Bottom Two Pair: When your hand makes a pair with the two lowest cards on the flop. Example: You hold 5-3, and the flop comes 8-5-3.
Turn: The addition of a fourth community card can change the classification of your two pairs. For example, if you held A-5, and the flop was A-9-5, you had top and bottom pair. But if a King comes on the turn, your pair of Aces and 5s becomes middle and bottom pair.

River: A fifth and final community card is added. Just like with the turn, the river card may affect the status of your two pairs.

Remember, these classifications mainly serve to describe the strength of your hand, but they don't tell the whole story. The strength of your hand also depends on the actions of your opponents, the board texture, and many other factors in the game situation. Always consider these factors when deciding the best course of action.
...
ChatGPT
When the board pairs, it means that there are two cards of the same rank among the community cards. This changes the dynamics of the game significantly as it introduces the potential for full houses and three-of-a-kinds (also known as 'trips' or 'sets').

Here's how it might affect your situation:

Board Pairs on the Flop: If the flop comes with a pair, for example 8-8-3, and you have a hand like A-8, you would have three-of-a-kind (trips). If you have a hand like A-3, you would have bottom pair, and if you have something like A-K, you would have an over pair to the board.

Board Pairs on the Turn or River: If the board pairs on the turn or river, for example the flop comes A-9-4 and the turn is a 9, this introduces the possibility of full houses. If you hold A-9, you now have a full house. If you hold A-K, you have two pairs (Aces and Nines) with a King kicker.

When the board pairs, it's crucial to consider how the paired board interacts with your opponents' likely ranges. For instance, if an opponent bets aggressively on a paired board, they could have a three-of-a-kind or full house, or they could be bluffing with the intention of representing these hands.

In general, when the board pairs, it often makes your relative hand strength weaker, unless you also hold a card of the same rank as the pair on the board. The more players in the pot, the more cautious you should be when the board pairs, as the likelihood that someone has trips or a full house increases.
...
When you have "Top Two Pair" or "Top and Middle Pair," it traditionally means you're using both of your hole cards to make two different pairs with the community cards.

Top Two Pair: This usually means you have a hand that forms a pair with the two highest cards on the board. For example, if you hold A-Q, and the flop comes Q-A-5, you have Top Two Pair.

Top and Middle Pair: This usually means you have a hand that forms a pair with the highest and middle cards on the board. For example, if you hold A-8, and the flop comes A-8-3, you have Top and Middle Pair.

However, if the board pairs, making one of the pairs on the board, the description of your hand will change. For example, if the board is Q-Q-5, and you hold an A-Q, you would not be described as having "Top Two Pair". Instead, you'd have "three-of-a-kind" or "trips". If you hold A-5, you wouldn't have "Top and Middle Pair". Instead, you would have a "pair of fives" with an Ace kicker, or simply "a pair" if there's no chance of confusion.

It's worth noting that when the board pairs, it greatly increases the strength of hands that can be made, such as three-of-a-kind or full houses, so a simple pair or two pair hand is often much weaker in relative terms. Always consider the whole board texture, the possible hands your opponents could have, and the betting action when determining the strength of your hand.
...
ChatGPT
In this scenario, you hold Ace-Ten (A-T) and the board shows Ten-Jack-Jack (T-J-J). You have two pair, Jacks and Tens, with an Ace kicker.

Your hole card, Ten, pairs with the Ten on the board, and the two Jacks on the board form the second pair. In Texas Hold'em poker, a poker hand consists of the best five-card hand you can make using any combination of your two hole cards and the five community cards on the board. The Ace in your hand acts as the "kicker" or tiebreaker card, meaning that if another player also has two pair (Jacks and Tens), your hand would beat theirs if their fifth card (or kicker) is lower than an Ace.

However, it's important to note that in this situation, any player holding a Jack has you beaten, as they would have three-of-a-kind (also known as "trips" or "a set"). Also, any player holding a Queen or a King would have a higher two pair (Queens and Jacks, or Kings and Jacks) that beats your two pair.
...
ChatGPT
In this scenario, where you hold Ace-Ten (A-T) and the board shows Ace-Jack-Jack (A-J-J), you would have two pair, Aces and Jacks, with a Ten kicker.

Your hole card, Ace, pairs with the Ace on the board, and the two Jacks on the board form the second pair. As mentioned before, in Texas Hold'em, a poker hand consists of the best five-card hand you can make using any combination of your two hole cards and the five community cards on the board. The Ten in your hand acts as the "kicker" or tiebreaker card.

However, in this case, your hand is not considered an "over pair." An over pair refers to a situation where you have a pair in your hole cards that is higher than any card on the board. For instance, if you held A-A and the board was J-7-2, you'd have an over pair (Aces), as your pair is higher than any card on the board.

In your given scenario (hole cards A-T and board A-J-J), your best hand is two pair (Aces and Jacks). It's also worth noting that any player holding a Jack in this situation would have a better hand - a full house (Jacks full of Aces) - and anyone with an Ace and a better kicker than Ten would also beat your hand.
	...
	int whatKindOfTwoPair() {
		...
		} else if (this.pair1Value > EvalData.boardHighCardValue1 && this.pair2Value < EvalData.boardHighCardValue2) {
	...
	private boolean isCardsTwoPair() {
		...
		for (int i = 0; i < 4; i++) {
			if (this.cards[i].value == this.cards[i + 1].value) {
				...
				this.pair2Value = this.cards[i].value;
			}
		}
		return numPairs == 2;
	}
