...
rankpublic class IndexArrayClassification implements Constants {
	...
	*****************************************************************************/
	private static void flopTexturC() {
        ...
        if (EvalData.board[1].rank - EvalData.board[0].rank == 1 && EvalData.board[2].rank - EvalData.board[1].rank == 1) {
            connectivityType = "Connected";
        } else if (EvalData.board[1].rank - EvalData.board[0].rank == 1 || EvalData.board[2].rank - EvalData.board[1].rank == 1) {
