...
public class HandRangeConverter implements Constants {
	...
	private static void copyDataGaps() {
		action.actionArrayPercentage[SB][0][0] = rangeSBLimp.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[SB][0][1] = rangeSBOpen.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[SB][1][0] = rangeSBBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[SB][1][1] = rangeSBCall.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[SB][2][0] = rangeSBBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[SB][2][1] = rangeSBBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[SB][3][0] = rangeSBBet4.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[SB][3][1] = rangeSBBet4Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[SB][4][0] = rangeSBAllin.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[SB][4][1] = rangeSBAllinCall.lowPlayabilitrhyArrayIndex;

		action.actionArrayPercentage[BB][0][0] = rangeBBLimp.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BB][0][1] = rangeBBOpen.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BB][1][0] = rangeBBBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BB][1][1] = rangeBBCall.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BB][2][0] = rangeBBBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BB][2][1] = rangeBBBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BB][3][0] = rangeBBBet4.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BB][3][1] = rangeBBBet4Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BB][4][0] = rangeBBAllin.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BB][4][1] = rangeBBAllinCall.lowPlayabilitrhyArrayIndex;

		action.actionArrayPercentage[UTG][0][0] = rangeUTGLimp.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[UTG][0][1] = rangeUTGOpen.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[UTG][1][0] = rangeUTGBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[UTG][1][1] = rangeUTGCall.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[UTG][2][0] = rangeUTGBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[UTG][2][1] = rangeUTGBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[UTG][3][0] = rangeUTGBet4.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[UTG][3][1] = rangeUTGBet4Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[UTG][4][0] = rangeUTGAllin.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[UTG][4][1] = rangeUTGAllinCall.lowPlayabilitrhyArrayIndex;

		action.actionArrayPercentage[MP][0][0] = rangeMPLimp.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[MP][0][1] = rangeMPOpen.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[MP][1][0] = rangeMPBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[MP][1][1] = rangeMPCall.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[MP][2][0] = rangeMPBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[MP][2][1] = rangeMPBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[MP][3][0] = rangeMPBet4.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[MP][3][1] = rangeMPBet4Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[MP][4][0] = rangeMPAllin.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[MP][4][1] = rangeMPAllinCall.lowPlayabilitrhyArrayIndex;

		action.actionArrayPercentage[CO][0][0] = rangeCOLimp.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[CO][0][1] = rangeCOOpen.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[CO][1][0] = rangeCOBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[CO][1][1] = rangeCOCall.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[CO][2][0] = rangeCOBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[CO][2][1] = rangeCOBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[CO][3][0] = rangeCOBet4.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[CO][3][1] = rangeCOBet4Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[CO][4][0] = rangeCOAllin.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[CO][4][1] = rangeCOAllinCall.lowPlayabilitrhyArrayIndex;

		action.actionArrayPercentage[BU][0][0] = rangeBULimp.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BU][0][1] = rangeBUOpen.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BU][1][0] = rangeBUBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BU][1][1] = rangeBUCall.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BU][2][0] = rangeBUBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BU][2][1] = rangeBUBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BU][3][0] = rangeBUBet4.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BU][3][1] = rangeBUBet4Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BU][4][0] = rangeBUAllin.lowPlayabilitrhyArrayIndex;
		action.actionArrayPercentage[BU][4][1] = rangeBUAllinCall.lowPlayabilitrhyArrayIndex;

	}

// Copy data from HandRange playability index
private static void copyDataCombos() {
	action.actionArrayCombos[SB][0][0] = rangeSBLimp.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[SB][0][1] = rangeSBOpen.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[SB][1][0] = rangeSBBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[SB][1][1] = rangeSBCall.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[SB][2][0] = rangeSBBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[SB][2][1] = rangeSBBet3Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[SB][3][0] = rangeSBBet4.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[SB][3][1] = rangeSBBet4Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[SB][4][0] = rangeSBAllin.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[SB][4][1] = rangeSBAllinCall.lowPlayabilitrhyArrayIndex;

	action.actionArrayCombos[BB][0][0] = rangeBBLimp.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BB][0][1] = rangeBBOpen.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BB][1][0] = rangeBBBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BB][1][1] = rangeBBCall.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BB][2][0] = rangeBBBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BB][2][1] = rangeBBBet3Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BB][3][0] = rangeBBBet4.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BB][3][1] = rangeBBBet4Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BB][4][0] = rangeBBAllin.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BB][4][1] = rangeBBAllinCall.lowPlayabilitrhyArrayIndex;

	action.actionArrayCombos[UTG][0][0] = rangeUTGLimp.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[UTG][0][1] = rangeUTGOpen.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[UTG][1][0] = rangeUTGBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[UTG][1][1] = rangeUTGCall.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[UTG][2][0] = rangeUTGBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[UTG][2][1] = rangeUTGBet3Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[UTG][3][0] = rangeUTGBet4.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[UTG][3][1] = rangeUTGBet4Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[UTG][4][0] = rangeUTGAllin.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[UTG][4][1] = rangeUTGAllinCall.lowPlayabilitrhyArrayIndex;

	action.actionArrayCombos[MP][0][0] = rangeMPLimp.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[MP][0][1] = rangeMPOpen.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[MP][1][0] = rangeMPBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[MP][1][1] = rangeMPCall.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[MP][2][0] = rangeMPBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[MP][2][1] = rangeMPBet3Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[MP][3][0] = rangeMPBet4.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[MP][3][1] = rangeMPBet4Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[MP][4][0] = rangeMPAllin.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[MP][4][1] = rangeMPAllinCall.lowPlayabilitrhyArrayIndex;

	action.actionArrayCombos[CO][0][0] = rangeCOLimp.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[CO][0][1] = rangeCOOpen.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[CO][1][0] = rangeCOBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[CO][1][1] = rangeCOCall.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[CO][2][0] = rangeCOBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[CO][2][1] = rangeCOBet3Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[CO][3][0] = rangeCOBet4.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[CO][3][1] = rangeCOBet4Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[CO][4][0] = rangeCOAllin.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[CO][4][1] = rangeCOAllinCall.lowPlayabilitrhyArrayIndex;

	action.actionArrayCombos[BU][0][0] = rangeBULimp.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BU][0][1] = rangeBUOpen.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BU][1][0] = rangeBUBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BU][1][1] = rangeBUCall.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BU][2][0] = rangeBUBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BU][2][1] = rangeBUBet3Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BU][3][0] = rangeBUBet4.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BU][3][1] = rangeBUBet4Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BU][4][0] = rangeBUAllin.lowPlayabilitrhyArrayIndex;
	action.actionArrayCombos[BU][4][1] = rangeBUAllinCall.lowPlayabilitrhyArrayIndex;
...
private static void copyDatGaps() {
	action.actionArrayGaps[SB][0][0] = rangeSBLimp.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[SB][0][1] = rangeSBOpen.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[SB][1][0] = rangeSBBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[SB][1][1] = rangeSBCall.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[SB][2][0] = rangeSBBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[SB][2][1] = rangeSBBet3Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[SB][3][0] = rangeSBBet4.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[SB][3][1] = rangeSBBet4Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[SB][4][0] = rangeSBAllin.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[SB][4][1] = rangeSBAllinCall.lowPlayabilitrhyArrayIndex;

	action.actionArrayGaps[BB][0][0] = rangeBBLimp.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BB][0][1] = rangeBBOpen.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BB][1][0] = rangeBBBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BB][1][1] = rangeBBCall.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BB][2][0] = rangeBBBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BB][2][1] = rangeBBBet3Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BB][3][0] = rangeBBBet4.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BB][3][1] = rangeBBBet4Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BB][4][0] = rangeBBAllin.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BB][4][1] = rangeBBAllinCall.lowPlayabilitrhyArrayIndex;

	action.actionArrayGaps[UTG][0][0] = rangeUTGLimp.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[UTG][0][1] = rangeUTGOpen.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[UTG][1][0] = rangeUTGBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[UTG][1][1] = rangeUTGCall.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[UTG][2][0] = rangeUTGBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[UTG][2][1] = rangeUTGBet3Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[UTG][3][0] = rangeUTGBet4.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[UTG][3][1] = rangeUTGBet4Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[UTG][4][0] = rangeUTGAllin.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[UTG][4][1] = rangeUTGAllinCall.lowPlayabilitrhyArrayIndex;

	action.actionArrayGaps[MP][0][0] = rangeMPLimp.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[MP][0][1] = rangeMPOpen.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[MP][1][0] = rangeMPBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[MP][1][1] = rangeMPCall.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[MP][2][0] = rangeMPBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[MP][2][1] = rangeMPBet3Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[MP][3][0] = rangeMPBet4.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[MP][3][1] = rangeMPBet4Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[MP][4][0] = rangeMPAllin.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[MP][4][1] = rangeMPAllinCall.lowPlayabilitrhyArrayIndex;

	action.actionArrayGaps[CO][0][0] = rangeCOLimp.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[CO][0][1] = rangeCOOpen.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[CO][1][0] = rangeCOBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[CO][1][1] = rangeCOCall.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[CO][2][0] = rangeCOBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[CO][2][1] = rangeCOBet3Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[CO][3][0] = rangeCOBet4.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[CO][3][1] = rangeCOBet4Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[CO][4][0] = rangeCOAllin.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[CO][4][1] = rangeCOAllinCall.lowPlayabilitrhyArrayIndex;

	action.actionArrayGaps[BU][0][0] = rangeBULimp.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BU][0][1] = rangeBUOpen.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BU][1][0] = rangeBUBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BU][1][1] = rangeBUCall.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BU][2][0] = rangeBUBet3.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BU][2][1] = rangeBUBet3Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BU][3][0] = rangeBUBet4.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BU][3][1] = rangeBUBet4Call.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BU][4][0] = rangeBUAllin.lowPlayabilitrhyArrayIndex;
	action.actionArrayGaps[BU][4][1] = rangeBUAllinCall.lowPlayabilitrhyArrayIndex;
