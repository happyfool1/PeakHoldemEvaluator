...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        JPanel panelActionRaise = new JPanel();
        panelActionRaise.setSize(500, 200);
        panelActionRaise.setFont(f0);
        final var actionLayout = new GridLayout(10, 6);
        panelActionRaise.setLayout(actionLayout);
        panelActionRaise.setBorder(positions);
        for (int i = 0; i < POSITIONS; ++i) {
                ...
                panelAction.add(actionArrayPlayabilityText[i][j][0]);
                ...
                panelAction.add(actionArrayPlayabilityText[i][j][1]);
               }
