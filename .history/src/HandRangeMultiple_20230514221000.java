...
public class HandRangeMultiple implements Constants, java.io.Serializable {
    ...
    ****************************************************************************** */
    ...
    Gaps[][] gapsArrayRaise = new Gaps[POSITIONS][5];
    Gaps[][] gapsArrayCall = new Gaps[POSITIONS][5];
    ...
    *  Construct panel. 
    ...
    void constructPanel(String title) {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            openText[i][2] = new JTextField(String.valueOf(this.rangeArrayRaise[i][0].));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            openText[i][3] = new JTextField(String.valueOf(this.rangeArrayRaise[i][0]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            limpText[i][0] = new JTextField(String.valueOf(this.rangeArrayCall[i][0])
                    + "  " + playabilityArray[this.rangeArrayCall[i][0]]);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            limpText[i][1] = new JTextField(Format.formatPer(this.rangeArrayCall[i][0]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            limpText[i][2] = new JTextField(String.valueOf(this.rangeArrayCall[i][0]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            limpText[i][3] = new JTextField(String.valueOf(this.rangeArrayCall[i][0]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet3Text[i][0] = new JTextField(String.valueOf(this.rangeArrayRaise[i][1])
                    + "  " + playabilityArray[this.rangeArrayRaise[i][1]]);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet3Text[i][1] = new JTextField(Format.formatPer(this.rangeArrayRaise[i][1]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet3Text[i][2] = new JTextField(String.valueOf(this.rangeArrayRaise[i][1]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet3Text[i][3] = new JTextField(String.valueOf(this.rangeArrayRaise[i][0]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            callText[i][0] = new JTextField(String.valueOf(this.rangeArrayCall[i][1])
                    + "  " + playabilityArray[this.rangeArrayRaise[i][1]]);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            callText[i][1] = new JTextField(Format.formatPer(this.rangeArrayCall[i][1]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            callText[i][2] = new JTextField(String.valueOf(this.rangeArrayCall[i][1]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            callText[i][3] = new JTextField(String.valueOf(this.rangeArrayRaise[i][1]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet4Text[i][0] = new JTextField(String.valueOf(this.rangeArrayRaise[i][2])
                    + "  " + playabilityArray[this.rangeArrayRaise[i][2]]);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet4Text[i][1] = new JTextField(Format.formatPer(this.rangeArrayRaise[i][2]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet4Text[i][2] = new JTextField(String.valueOf(this.rangeArrayRaise[i][2]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet4Text[i][3] = new JTextField(String.valueOf(this.rangeArrayRaise[i][2]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet3CallText[i][0] = new JTextField(String.valueOf(this.rangeArrayCall[i][2])
                    + "  " + playabilityArray[this.rangeArrayCall[i][2]]);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet3CallText[i][1] = new JTextField(Format.formatPer(this.rangeArrayCall[i][2]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet3CallText[i][2] = new JTextField(String.valueOf(this.rangeArrayCall[i][2]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet3CallText[i][3] = new JTextField(String.valueOf(this.rangeArrayCall[i][2]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            allinText[i][0] = new JTextField(String.valueOf(this.rangeArrayRaise[i][4])
                    + "  " + playabilityArray[this.rangeArrayRaise[i][4]]);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            allinText[i][1] = new JTextField(Format.formatPer(this.rangeArrayRaise[i][4]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            allinText[i][2] = new JTextField(String.valueOf(this.rangeArrayRaise[i][4]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            allinText[i][3] = new JTextField(String.valueOf(this.rangeArrayRaise[i][4]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet4CallText[i][0] = new JTextField(String.valueOf(this.rangeArrayCall[i][4])
                    + "  " + playabilityArray[this.rangeArrayCall[i][4]]);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet4CallText[i][1] = new JTextField(Format.formatPer(this.rangeArrayCall[i][4]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet4CallText[i][2] = new JTextField(String.valueOf(this.rangeArrayCall[i][4]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet4CallText[i][3] = new JTextField(String.valueOf(this.rangeArrayCall[i][4]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            allinCallText[i][0] = new JTextField(String.valueOf(this.rangeArrayRaise[i][4])
                    + "  " + playabilityArray[this.rangeArrayRaise[i][4]]);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            allinCallText[i][1] = new JTextField(Format.formatPer(this.rangeArrayRaise[i][4]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            allinCallText[i][2] = new JTextField(String.valueOf(this.rangeArrayRaise[i][4]));
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            allinCallText[i][3] = new JTextField(String.valueOf(this.rangeArrayRaise[i][4]));
