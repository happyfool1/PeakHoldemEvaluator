...
public class Hand implements Constants {
	...
	* Returns MADE_BOTTOM_TWO_PAIR, MADE_TOP_AND_BOTTOM_TWO_PAIR, or MADE_TOP_TWO_PAIR
	...
	int whatKindOfTwoPair() {
		// 11 9 9 4 0 3
		// Kc Kh Jc Jh 6c
		System.out.println("// "+this.pair1Value + " " + this.pair2Value + " " + EvalData.boardHighCardValue1 + " " 
		+ EvalData.boardHighCardValue2 + " "+ EvalData.boardLowCardValue  + " " + EvalData.street);
		System.out.println("// "+this.cards[0]+ " " + this.cards[1] + " " + this.cards[2] + " " + this.cards[3] + " " + this.cards[4]);	
		System.out.println("// "+EvalData.board[0]+ " " + EvalData.board[1] + " " + EvalData.board[2] + " "+ EvalData.board[3] + " " + EvalData.board[4]);	
