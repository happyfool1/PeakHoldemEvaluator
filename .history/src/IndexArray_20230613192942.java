...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    void findBestAndWorst() {
        ...
        worstMadeRows[1] = madeTotalRowPerEntries.get(drawTotalRowPerEntries.size() -2).getRowOrCol();
        bestShowdownwRows[1] = showdownTotalRowPerEntries.get(0).getRowOrCol();
        worstShowdownRows[1] = showdownTotalRowPerEntries.get(drawTotalRowPerEntries.size() -2).getRowOrCol();
        bestDrawCols[1] = drawTotalColPerEntries.get(0).getRowOrCol();
        worstDrawCols[1] = drawTotalColPerEntries.get(drawTotalColPerEntries.size() -2).getRowOrCol();
        bestMadeCols[1] = madeTotalColPerEntries.get(0).getRowOrCol();
        worstMadeCols[1] = madeTotalColPerEntries.get(drawTotalColPerEntries.size() -2).getRowOrCol();
        bestShowdownwCols[1] = showdownTotalColPerEntries.get(0).getRowOrCol();
        worstShowdownCols[1] = showdownTotalColPerEntries.get(drawTotalColPerEntries.size() -2).getRowOrCol();
