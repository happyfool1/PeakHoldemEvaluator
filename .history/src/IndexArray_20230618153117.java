    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        st += "The worst Showdown cols were " + Format.formatPer(worstShowdownColsPer[0]) + " "
                ...
                + ", " + Format.formatPer(worstShowdownColsPer[0]) + " "+ madeArrayColNames[worstShowdownCols[1]]
                + ", " + Format.formatPer(worstShowdownColsPer[0]) + " " + madeArrayColNames[worstShowdownCols[2]] + "\r\n";
