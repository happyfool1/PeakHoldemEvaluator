...
public class IndexArrayUpdate implements Constants {
	...
	for (int i = 0; i < PLAYERS; i++) {
			if (!EvalData.playerFolded[i] ) {
				...
				++IndexArrays.hmlMadeFlopToMadeRiver[EvalData.hmlIndexFlop][EvalData.madeTypeFlop[i]][EvalData.madeTypeRiver[i][i]];
				++IndexArrays.hmlDrawFlopToMadeRiver[EvalData.hmlIndexFlop][EvalData.drawTypeFlop[i]][EvalData.showdownHand[i]];
				++IndexArrays.hmlMadeTurnToMadeRiver[EvalData.hmlIndexTurn][EvalData.madeTypeTurn[i]][EvalData.showdownHand[i]];
				++IndexArrays.hmlDrawTurnToMadeRiver[EvalData.hmlIndexTurn][EvalData.drawTypeTurn[i]][EvalData.showdownHand[i]];
			}
		}
