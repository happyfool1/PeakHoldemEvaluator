...
public class ReportHML implements Constants {
    ...
    ********************************************************************************** */
    static void reportHMLShowdownFlopWon(int c, int r) {
        ...
        public void createAndShowGUI(columnsHMLFlopShowdownWon, dataHMLFlopShowdownWon) {
    }
   ...
   ***********************************************************************************/
    public void createAndShowGUI(Object[] columns, Object[][] data) {
        JFrame frame = new JFrame("Highlight cells in JTable");
        ...
        for (int row = 0; row < data.length; row++) {
            for (int column = 0; column < data[0].length; column++) {
                if (largestCells.size() < 5) {
                    largestCells.offer(new Cell(row, column, (int) data[row][column]));
                } else if ((int) data[row][column] > largestCells.peek().value) {
                    largestCells.poll();
                    largestCells.offer(new Cell(row, column, (int) data[row][column]));
                }
            }
