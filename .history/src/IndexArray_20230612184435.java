...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    ...
    private String stringStrategy() {
        bestDraw = drawRowTotalSortedPer[0];
        worstDraw = drawRowTotalSortedPer[drawRowTotalSortedPer.length - 1];
        bestMade = madeRowTotalSortedPer[0];
        worstMade = madeRowTotalSortedPer[madeRowTotalSortedPer.length - 1];
        bestShowdownw = showdownRowTotalSortedPer[0];
        worstShowdown = showdownRowTotalSortedPer[madeRowTotalSortedPer.length - 1];

         bestDrawCol= drawRowTotalSortedPer[0];
        worstDrawCol= drawRowTotalSortedPer[drawRowTotalSortedPer.length - 1];
        bestMadeCol = madeRowTotalSortedPer[0];
        worstMadeCol = madeRowTotalSortedPer[madeRowTotalSortedPer.length - 1];
        bestShowdownwCol = showdownRowTotalSortedPer[0];
        worstShowdownCol = showdownRowTotalSortedPer[madeRowTotalSortedPer.length - 1];
    ...
    double bestMade = -1;
    double worstMade = -1;
    double bestShowdownw = -1;
    double worstShowdown = -1;
