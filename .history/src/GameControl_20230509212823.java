...
public class GameControl implements Constants {
	...
	**************************************************************************** */
	...
	private static void createRanges() {
		heroX.readArray(EvalData.applicationDirectory + "heroX.ser");
		averageX.readArray(EvalData.applicationDirectory + "averageX.ser");
		fish.readArray(EvalData.applicationDirectory + "fish.ser");
		hero.readArray(EvalData.applicationDirectory + "hero.ser");
		average.readArray(EvalData.applicationDirectory + "average.ser");
		nitreadArray(EvalData.applicationDirectory + "nit.ser");
		lag.readArray(EvalData.applicationDirectory + "lag.ser");
		tag.readArray(EvalData.applicationDirectory + "tag.ser");
		fish.eadArray(EvalData.applicationDirectory + "fish.ser");
