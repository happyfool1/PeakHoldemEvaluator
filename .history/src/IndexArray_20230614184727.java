...
private class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    ...
    int[] drawBottom5Row = new int[5];
    int[] drawBottom5Col = new int[5];
    double[] drawBottom5Per = new double[5];
    int[] madeBottom5Row = new int[5];
    int[] madeBottom5Col = new int[5];
    double[] madeBottom5Per = new double[5];
    int[] showdownBottom5Row = new int[5];
    int[] showdownBottom5Col = new int[5];
    double[] showdownBottom5Per = new double[5];
