...
public class Showdown implements Constants {
	...
	******************************************************************************/
	...
	static String showdownString() {
		...
		for (int i = 0; i < PLAYERS; i++) {
			if (EvalData.playerWonShowdown[i]) {
				st += EvalData.hand[i].cardsHoleCardsFirst[0] + " " + EvalData.hand[i].cardsHoleCardsSecond[1] + " "+
				EvalData.hand[i].cardsHoleCardsFirst[2] + " " + EvalData.hand[i].cardsHoleCardsSecond[3] + " " + 
				EvalData.hand[i].cardsHoleCardsFirst[4] + " " + EvalData.hand[i].cardsHoleCardsSecond[3] + " " + 
				+ "\r\n";
			}
		}
