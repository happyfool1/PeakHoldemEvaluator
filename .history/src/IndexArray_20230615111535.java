...
calculatePotOdds method returns the pot odds as a decimal, which is the call amount divided by the total size of the pot after making the call.
getPotOddsRatio method returns the pot odds as a ratio, comparing the pot size to the call amount.
isCallProfitable method checks whether a call would be profitable given a certain probability of winning the hand. If the chance of winning is higher than the calculated pot odds, then the call would be expected to be profitable in the long run.
     */
