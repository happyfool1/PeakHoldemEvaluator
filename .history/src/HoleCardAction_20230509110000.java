 ...
 *      REFLOP_LIMP, PREFLOP_OPEN, PREFLOP_CALL, PREFLOP_BET3, PREFLOP_BET4, 
 *      PREFLOP_ALLIN, PREFLOP_CALL_ALLIN. 
 * 
 * The player can respond to the action to him by:
 *      LIMP, OPEN, CALL, BET3, CALL_BET3, BET4, CALL_BET4, ALLIN, CALL_ALLIN.
 *
 ...
 * 
 * We use an 2 dimensional array. The first indexis the action to the playes,
 * PREFLOP_x. The second index is the response FOLD, LIMP, ...
