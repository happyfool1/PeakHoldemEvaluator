...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private static final JCheckBox sumOfBoardCardsDrawFlop = new JCheckBox("Sum Of Board Cards Made Hand");
    private static final JCheckBox sumOfBoardCardsMadeFlop = new JCheckBox("Sum Of BoardCards Made Hand");
    private static final JCheckBox sumOfBoardCardsShowdownFlop = new JCheckBox("Sum of Board Cards Showdown");
