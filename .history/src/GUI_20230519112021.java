...
public class GUI extends JFrame implements ActionListener, Constants {
	...
	private static final JButton fullSimulation  = new JButton("Full Simulation");
	...
	*******************************************************************************/
	public void myFrame() {
		...
		fullSimulation.setFont(fc);
		fullSimulation.setPreferredSize(new Dimension(15, 15));
		fullSimulation.addActionListener(this);
		fullSimulation.setBackground(CONTROL);
		panelControl.add(fullSimulation);
	...
	****************************************************************************** */
	...
	/*-  ******************************************************************************
	 * The Full Simulatio  option has been selected.
	 * Prompt for the number of hands to play
	 *  ****************************************************************************** */
	private void doFull() {
		System.out.println("doFull()");
		String response = JOptionPane.showInputDialog(null,
		"Please enter number of hands to run",
		"Hands to run",
		JOptionPane.QUESTION_MESSAGE);

// check if response is null or empty before trying to parse it to prevent exceptions
if (response != null && !response.isEmpty()) {
	...
	* a radio button or control button.
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (action.equals("Full Simulation"){
do
		}
		switch (action) {
