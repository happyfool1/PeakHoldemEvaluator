...
public class IndexArrayAnalysis implements Constants {
    ...
    ****************************************************************************** */
    IndexArrayAnalysis(int[][] drawArray, int[][] madeArray, int[][] showdownArray) {
        ...
        this.drawArraySortedPer = drawArray;
        this.madeArraySortedPer = madeArray;
        this.showdownArraySortedPer = showdownArray;
        Arrays.sort(drawArraySortedPer);
        Arrays.sort(madeArraySortedPer);
        Arrays.sort(showdownArrayPer);
