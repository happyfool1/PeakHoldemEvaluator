...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    void findBestAndWorst() {
      ...
      bestDrawRow  = drawTotalRowPerEntries.get(drawTotalRowPerEntries.size()-1).getRowOrCol(); 
        bestDrawRow  = drawTotalRowPerEntries.get(0).getRowOrCol(); 
    ...
    ***************************************************************************************** */
    ...
    // top 3high and low row percentages 
    double[] bestDrawRows = new double[3];
    double[] worstDrawRow= new double[3];
    double[] bestMadeRow= new double[3];
    double[] worstMadeRow = new double[3];
    double[] bestShowdownwRow= new double[3];
    double[] worstShowdownRow = new double[3];
    // Column is
    double[] bestDrawCol= new double[3];
    double[] worstDrawCol= new double[3];
    double[] bestMadeCol = new double[3];
    double[] worstMadeCol = new double[3];
    double[] bestShowdownwCol= new double[3];
    double[] worstShowdownCol= new double[3];
