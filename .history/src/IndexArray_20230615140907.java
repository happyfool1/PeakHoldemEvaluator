...
public class IndexArray implements Constants {
    ...
    ****************************************************************************** */
    IndexArray(int[][] drawArray, int[][] madeArray, int[][] showdownArray, String[] rowNames, String[] drawColNames,
       ...
       this.drawColNames = drawColNames.clone();
          this.drawColNames = madeColNames.clone();
    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        String st = "The best Draw rows were "+ Format.formatPer(bestDrawRowsPer[0]) + " " + allArrayRowNames[bestDrawRows[0]] + ", "
        ...
        st += "The best Draw cols were " + drawArrayColNames[bestDrawCols[0]] + ", " + drawArrayColNames[bestDrawCols[1]]
