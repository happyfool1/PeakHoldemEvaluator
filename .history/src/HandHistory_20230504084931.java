...
class HandHistory implements Constants {
	...
	*  returnedToBD = new BigDecimal[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	*  betBD = new BigDecimal[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	*  callBD = new BigDecimal[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	*  winBD = new BigDecimal[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	...
	*  bet$ = new BigDecimal[4][PLAYERS][4];
	*  pot$ = new BigDecimal[4][PLAYERS][4];
	*  moneyIn$ = new BigDecimal[4][PLAYERS][4];
	* BigDecimal[][] potStart$ = new BigDecimal[4][4];
	* BigDecimal[][] potEnd$ = new BigDecimal[4][4];
	*  bet$ = new BigDecimal[4][PLAYERS][4];
	*  pot$ = new BigDecimal[4][PLAYERS][4];
	*  moneyIn$ = new BigDecimal[4][PLAYERS][4];
	*  call$ = new BigDecimal[4][PLAYERS][4];
	*  allin$ = new BigDecimal[4][PLAYERS][4];
