...
public class IndexArrayUpdate implements Constants {
	...
	for (int i = 0; i < PLAYERS; i++) {
			if (!EvalData.playerFolded[i] ) {
				if (EvalData.madeTypeFlop[i] == 18 ||  EvalData.madeTypeRiver[i] == 18){
					System.out.println("Flop: " + i + " " + EvalData.madeTypeRiver[i] + " " + EvalData.madeTypeFlop[i]);
				}
				++IndexArrays.hmlMadeFlopToMadeRiver[EvalData.hmlIndexFlop][EvalData.madeTypeFlop[i]][EvalData.madeTypeRiver[i]];
				++IndexArrays.hmlDrawFlopToMadeRiver[EvalData.hmlIndexFlop][EvalData.drawTypeFlop[i]][EvalData.madeTypeRiver[i]];
				++IndexArrays.hmlMadeTurnToMadeRiver[EvalData.hmlIndexTurn][EvalData.madeTypeTurn[i]][EvalData.madeTypeRiver[i]];
				++IndexArrays.hmlDrawTurnToMadeRiver[EvalData.hmlIndexTurn][EvalData.drawTypeTurn[i]][EvalData.madeTypeRiver[i]];
			}
		}
