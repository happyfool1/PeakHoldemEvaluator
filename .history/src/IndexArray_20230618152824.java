...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        st += "The bes Made cols were " + Format.formatPer(bestMadeColsPer[0]) + " "+ madeArrayColNames[bestMadeCols[0]] + ", " + madeArrayColNames[bestMadeCols[1]]
                + ", " + madeArrayColNames[bestMadeCols[2]] + "\r\n";
        st += "The worst Made cols were " + Format.formatPer(worstMadeColsPer[0]) + " " + madeArrayColNames[worstMadeCols[0]] + ", "
                + madeArrayColNames[worstMadeCols[1]]
                + ", " + madeArrayColNames[worstMadeCols[2]] + "\r\n";
        st += "The best Showdownw cols were " + Format.formatPer(bestShowdownwColsPer[0]) + " "+ madeArrayColNames[bestShowdownwCols[0]] + ", "
                + madeArrayColNames[bestShowdownwCols[1]]
                + ", " + madeArrayColNames[bestShowdownwCols[2]] + "\r\n";
        st += "The worst Showdown cols were " + Format.formatPer(worstShowdownColssPer[0]) + " "+ madeArrayColNames[worstShowdownCols[0]]
