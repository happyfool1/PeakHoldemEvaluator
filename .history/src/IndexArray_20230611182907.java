...
public class IndexArray implements Constants {
    ...
    ****************************************************************************** */
    ...
    // Suggested action if we have a pair 
     // Suggested action if we have 2 pair 
     // Suggested action if we have a set 
     // Suggested action if we have 3 pair 
     // Suggested action if we have 4 pair 
     // Suggested action if we have 5 pair 
     // Suggested action if we have 6 pair 
     // Suggested action if we have 7 pair 
     // Suggested action if we have 8 pair 
     // Suggested action if we have 9 pair 
     // Suggested action if we have 10 pair
