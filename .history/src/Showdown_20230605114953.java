...
public class Showdown implements Constants {
	...
	******************************************************************************/
	...
	int MADE_TOP_TWO_PAIR = 7;
		...
		} else if (max == MADE_BOTTOM_TWO_PAIR || max == MADE_TOP_TWO_PAIR || max == MADE_TOP_AND_BOTTOM_TWO_PAIR) {
			EvalData.maxValue = 800000 + EvalData.highCard1 * 100 + EvalData.highCard2 * 10 + EvalData.kicker1;
		} else if (max <=MADE_BOTTOM_PAIR || max == MADE_MIDDLE_PAIR || max == MADE_TOP_PAIR  || max == MADE_OVER_PAIR) {
