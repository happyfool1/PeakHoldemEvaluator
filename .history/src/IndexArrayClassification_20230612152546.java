...
public class IndexArrayClassification implements Constants {
	...
	* Distribution and Flush Potential.
	...
	/*-*****************************************************************************
	* This method will classify a Flop.
	* Another useful way to characterize the flop could be by evaluating its Connectedness and High-Low Spread.

Connectedness: This categorizes the flop based on how sequential the ranks of the cards are.
...
High-Low Spread: This characterizes the flop based on the difference between the highest and lowest cards.
...
Low: The difference is 2 or less (e.g., 7 and 8).
	...
	******************************************************************************/
	private static void flopTextureX() {
	}
