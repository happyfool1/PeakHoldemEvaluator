...
static void returnUncalledBet(){
	final int active = EvalData.PLAYERS - EvalData.foldCount;
		...
		Table.moneyIn[seat] -= Table.lastBet;
		Table.stack[seat] += Table.lastBet;
		Table.pot -= Table.lastBet;
		Table.pot$[Table.streetNumber][seat][Table.orbit] = Table.pot;
		Table.returnedTo$[Table.streetNumber][seat][Table.orbit] = Table.lastBet;
		Table.isReturnedTo[Table.streetNumber][seat][Table.orbit] = true;
