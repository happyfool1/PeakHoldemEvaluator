...
public class IndexArrayClassification implements Constants {
	...
	* Characterizing a flop can be done in many ways depending on what is important to the player.
	...
	and the third card has a different rank. For example, a flop of 4-4-8 would be classified as "two ranks". This type of flop is said to be paired, which increases the likelihood of hands like three-of-a-kind or full houses.
