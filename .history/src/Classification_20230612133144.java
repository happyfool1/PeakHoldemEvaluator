...
public class Classification implements Constants {
	...
	***************************************************************************************************/
	 ...
	 * 
	 * We can have 9 combinations in total, given three types of suit distributions (Monotone, Two-tone, and Rainbow) and three types of connectivity (Connected, Semi-connected, and Unconnected). These combinations can be represented by integers from 1 to 9.
	 *******************************************************************************/
