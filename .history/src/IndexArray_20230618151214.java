...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        st += "The worst Draw rows were "+ Format.formatPer(worstDrawRowsPer[0]) + " "+ allArrayRowNames[worstDrawRowsPer[0]] + ", "
                + Format.formatPer(worstDrawRows[1]) + " " + allArrayRowNames[worstDrawRows[1]]
                + ", "+ Format.formatPer(worstDrawRows[2]) + " " + allArrayRowNames[worstDrawRows[2]] + "\r\n";
        st += "The best Made rows were " ++ Format.formatPer(bestMadeRows[0][0]) + " "+ allArrayRowNames[bestMadeRows[0]] + ", " + allArrayRowNames[bestMadeRows[1]]
