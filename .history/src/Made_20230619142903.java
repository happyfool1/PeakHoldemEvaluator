	...
	*
	...
	private void finish(int type) {
		...
		if (this.size >= 4) {
			...
			if (EvalData.street == FLOP) {
				EvalData.madeTypeFlop[EvalData.seat] = MADE_NONE;
			}
			if (EvalData.street == TURN) {
				EvalData.madeTypeTurn[EvalData.seat] = MADE_NONE;
			} else {
				EvalData.madeTypeRiver[EvalData.seat] = MADE_NONE;
			}
			EvalData.kicker1 = this.kicker1;
			EvalData.kicker2 = this.kicker2;
			EvalData.kicker3 = this.kicker3;
