...
void createIndexArrayList() {
    ...
    ***************************************************************************************** */
    class  ArrayList {
        ...
        public  ArrayList(Double percentage, int row, int col, String rowSt, String colSt) {
    ...
    ***************************************************************************************** */
    ...
    // List for each array
    List<ArrayList> drawArrayList = new  List<ArrayList>90;
   List<ArrayList> madeArrayList = new  List<ArrayList>;
   List<ArrayList> showdownArrayList = new  List<ArrayList>;
