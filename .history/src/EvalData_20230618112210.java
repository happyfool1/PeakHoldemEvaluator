...
if (street == FLOP){}
		for (int i = 0; i < PLAYERS; i++) {
				drawTypeFlop[i] = DRAW_NONE;
			drawTypeTurn[i] =DRAW_NONE;
			madeTypeFlop[i] = MADE_NONE;
			madeTypeTurn[i] = MADE_NONE;
			madeTypeRiver[i] = MADE_NONE;
		}
	}

	maxValue=-1;streetNumber=PREFLOP;manyHands=true;fullSimulation=false;fullSimulationNum=0;detailedAnalysis=true;do1755=false;rotatePlayers=false;hh=false;simulation=false;holeCard1=null;holeCard2=null;boardHighCardValue1=-1;boardHighCardValue2=-1;boardLowCardValue=-1;boardCount=-1;turnCard=null;riverCard=null;bothCount=-1;betCalled=false;potBD=zeroBD;mainPotBD=zeroBD;betToMeBD=zeroBD;betNowBD=zeroBD;foldCount=-1;allinCount=-1;limpCount=-1;streetComplete=false;boardComplete=false;betType=0;orbit=0;

	boardArrayMax=-1;handValue=-1;position=-1;bestFlopIndex=-1;bestTurnIndex=-1;bestRiverIndex=-1;handIndex=-1;hmlIndex=-1;flop1755Index=-1;flopTypeOf1755=-1;winnerShowdown=-1;

	cardCount=-1;

	seat=-1;street=-1;

	lastSeat=-1;lastStreet=-1;

	handStrength=-1;rangeAdvantage=-1;bestPossible=-1;outs=-1;makeHandPer=-1;flopTexture=-1;turnTexture=-1;

	type=-1;hmlIndexFlop=-1;hmlIndexTurn=-1;hmlIndexRiver=-1;

	sumOfBoardValuesFlop=-1;sumOfHoleCardValues=-1;wetDryIndex=-1;flopIndex=-1;boardArrayIndex=-1;pair=false;

	winnerSeat=-1;showdown=false;winner=false;kicker1=-1;kicker2=-1;kicker3=-1;

	highCard1=-1;highCard2=-1;suit=-1;

	bothGap1_2=-1;bothGap2_3=-1;bothGap3_4=-1;bothGap4_5=-1;bothGap5_6=-1;bothGap6_7=-1;bothGap1_3=-1;bothGap1_4=-1;bothGap2_4=-1;bothGap2_5=-1;bothGap4_6=-1;bothGap5_7=-1;

	boardGap1_2=-1;boardGap2_3=-1;boardGap3_4=-1;boardGap4_5=-1;boardGap5_6=-1;boardGap6_7=-1;

	holeValue1=-1;holeValue2=-1;

	bothValue1=-1;bothValue2=-1;bothValue3=-1;bothValue4=-1;bothValue5=-1;bothValue6=-1;bothValue7=-1;

	bothCardsSuit1=-1;bothCardsSuit2=-1;bothCardsSuit3=-1;bothCardsSuit4=-1;bothCardsSuit5=-1;bothCardsSuit6=-1;bothCardsSuit7=-1;

	boardValue1=-1;boardValue2=-1;boardValue3=-1;boardValue4=-1;boardValue5=-1;

	onePair=false;twoPair=false;threeOfKind=false;fourOfKind=false;fullHouse=false;anyPaired=false;straight=false;flush=false;

	boardAceHigh=false;boardPair=false;boardPairValue=-1;boardTwoPair=false;boardTwoPairValue1=-1;boardTwoPairValue2=-1;boardSet=false;boardSetValue=-1;boardHighCard=false;boardHighCardValue=-1;boardF0=false;boardF2=false;boardF3=false;boardF4=false;boardF4Draw=false;boardFlushDraw=false;boardStraightDraw=false;boardOesdDraw=false;

	flopHighCards=false;flopOverCards=false;flopAceHigh=false;flopHoleCardPairedWithBoard=false;flopPocketPair=false;flopOverPair=false;flopWeakPair=false;flopMiddlePair=false;flopBoardPair=false;flopSet=false;flopPaired=false;

	bothGutshotDraw=false;bothFlushDraw=false;bothStraightDraw=false;bothOesdDraw=false;bothFlush=false;bothStraight=false;bothStraightAce=false;bothNone=false;bothPair=false;both2Pair=false;bothSet=false;bothQuad=false;bothFull=false;flopRainbow=false;flop2Suited=false;flop3Suited=false;gap0=-1;gap1=-1;gap2=-1;gap0Score=-1;gap1Score=-1;gap2Score=-1;handsToPlay=0;interactive=false;
