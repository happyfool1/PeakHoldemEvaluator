	...
	private static void autoTurn() {
		for (int i = 0; i < Rules.HANDS; ++i) {
			for (int k = 0; k < Rules.OP_ACTIONS; ++k) {
				...
				if (i == DRAW_DRAW_GUTSHOT_DRAW_OESD_PAIR) {
					if (k == Rules.OP_CHECK) {
						ruleArray[i][k] = Rules.BET;
					}
					if (k == Rules.OP_BET1) {
				...
				if (i == DRAW_FLUSH_DRAW_DRAW_GUTSHOT) {
					if (k == Rules.OP_CHECK) {
						ruleArray[i][k] = Rules.BET;
					}
					if (k == Rules.OP_BET1) {
	...
	private static void autoTurnNIT() {
		for (int i = 0; i < Rules.HANDS; ++i) {
			for (int k = 0; k < Rules.OP_ACTIONS; ++k) {
				...
				if (i == DRAWFLUSH_DRAW_DRAW_GUTSHOT) {
					if (k == Rules.OP_CHECK) {
						ruleArray[i][k] = Rules.NO_ACTION;
					}
					if (k == Rules.OP_BET1) {
