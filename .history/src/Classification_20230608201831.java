...
public class Classification implements Constants {
	...
	***************************************************************************************************/
	...
	private static void boardPossiblesTurn() {
		for (int i = 0; i < POSSIBLE_DRAW_DRAW_SIZE; i++) {
			EvalData.boardPossibleArrayTurn[i] = false;
		}
		EvalData.boardPossibleArrayTurnMax = -1;

		if (EvalData.boardArray[BOARD_GAP0]) {
			 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_OESD] = true;
			 EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_GUTSHOT] = true;
		}

		if (EvalData.boardArray[BOARD_PAIR]) {
			EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_TWO_PAIR] = true;
			EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_SET] = true;
			EvalData.boardPossibleArrayTurn[POSSIBLE_DRAW_DRAW_FOUR_OF_A_KIND] = true;
		}
