...
public interface Constants {
	...
	*******************************************************************************/
	...
	int MADE_BOARDPAIR = 1;

	int MADE_BOTTOM_PAIR = 1;

	int MADE_MIDDLE_PAIR = 2;

	int MADE_TOP_PAIR = 3;

	int MADE_OVER_PAIR = 4;

	int MADE_BOTTOM_TWO_PAIR = 5;

	int MADE_TOP_AND_BOTTOM_TWO_PAIR = 6;

	int MADE_TOP_TWO_PAIR = 7;
	...
	int MADE_FULL_HOUSE = 11;

	int MADE_FOUR_OF_A_KIND = 12;

	int MADE_STRAIGHT_FLUSH = 13;

	int MADE_ROYAL_FLUSH = 14;

	int MADE_HANDS_SIZE = 15;
