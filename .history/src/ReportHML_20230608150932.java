...
public class ReportHML implements Constants {
    ...
    private static final Object[] columnsDrawFlop = { "HML", "No draw", "Gutshot",
    ...
    private static final Object[] columnsMadeFlop = { "HML","No hand", "Board Pait", "Bottom Pair", "Middle Pair", "Top Pair", "Over Pair",
    ...
    "Straight flush", "Royal flush","Total" };
    ...
    private static final Object[] columnsShowdownFlop = { "No hand", "Board Pait", "Bottom Pair", "Middle Pair", "Top Pair", "Over Pair",
    "Board two Pair", "Board Pair + Under Pair","Board Pair + Over Pair","Bottom 2 pair",
    "Top-Bottom 2 Pair", "Top 2 Pair", "Board Set", "Set", "Straight", "Flush", "Full house",
    "Straight flush", "Royal flush","Total" };
    ...
    private static final Object[] columnsDrawTurn = { "HML", "No draw", "Gutshot", "Straight", "OESD", "Flush",
            "Flush OESD", "Total" };
    ...
    private static final Object[] columnsMadeTurn =  {"HML", "No hand", "Board Pair", "Bottom Pair", "Middle Pair", "Top Pair", "Over Pair",
    "Board two Pair", "Board Pair + Under Pair","Board Pair + Over Pair","Bottom 2 pair",
    "Top-Bottom 2 Pair", "Top 2 Pair", "Board Set", "Set", "Straight", "Flush", "Full house",
    "Straight flush", "Royal flush","Total" };
    ...
    private static final Object[] columnsHMLShowdownTurn = { "No hand", "Board Pait", "Bottom Pair", "Middle Pair", "Top Pair", "Over Pair",
    "Board two Pair", "Board Pair + Under Pair","Board Pair + Over Pair","Bottom 2 pair",
    "Top-Bottom 2 Pair", "Top 2 Pair", "Board Set", "Set", "Straight", "Flush", "Full house",
    "Straight flush", "Royal flush","Total" };
    ...
    private static final Object[] columnsShowdownRiver =  {"HML", "No hand", "Board Pait", "Bottom Pair", "Middle Pair", "Top Pair", "Over Pair",
    "Board two Pair", "Board Pair + Under Pair","Board Pair + Over Pair","Bottom 2 pair",
    "Top-Bottom 2 Pair", "Top 2 Pair", "Board Set", "Set", "Straight", "Flush", "Full house",
    "Straight flush", "Royal flush","Total" };
            ...
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
                if (ManyData.hmlMade[i][j] > 0) {
                    ...
                    table2.setValueAt(Format.formatPer(per), row, col);
                     table2.setValueAt(Format.formatPer(sum), row, MADE_HANDS_SIZE);
    ...
    ********************************************************************************** */
    static void reportShowdownRiver(int c, int r) {
        ...
        PriorityQueue<Cell> largestCells = new PriorityQueue<>(5, Comparator.comparingInt(cell -> cell.value));
        PriorityQueue<Cell> smallestCells = new PriorityQueue<>(5, Comparator.comparingInt(cell -> cell.value));
        tableModel8 = new DefaultTableModel(dataShowdownRiver, columnsHMLShowdownRiver);
