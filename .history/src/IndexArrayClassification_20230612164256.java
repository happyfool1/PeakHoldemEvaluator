 ...
 if the input is valid), it defaults to "Group 4".
	...
	*****************************************************************************/
	private static String flopTextureA() {
		   // Calculate the gaps
        int gap1 = EvalData.board[1] - EvalData.board[0];
        int gap2 = EvalData.board[2] - EvalData.board[1];
	...
	/*-***************************************************************************
	* This method will classify a Flop.
	*This method works similarly to the previous one, but with an additional gap to consider. We calculate the three gaps and then categorize the turn based on those gaps. Please note that this method will only categorize the turns into six groups based on the specific gap patterns we discussed. In reality, there are many other possible gap patterns on the turn.
	*****************************************************************************/
