...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    *******************************************************************************/
    public void myFrame() {
        ...
        Border typFlopBorder = BorderFactory.createTitledBorder("Type of Flop Reports");
        panelCheckBoxesTypeFlop.setBorder(typeFlopBorder);
        ...
        Border wetDryFlopBorder = BorderFactory.createTitledBorder("Wet Dry Reports");
        panelCheckBoxesSumOfHoleCardsFlop.setBorder(SumOfHoleCardsFFlopBorder);
        panelCheckBoxes.add(panelCheckBoxesSumOfHoleCardsFlop);

        panelCheckBoxesFlop = new JPanel(new GridLayout(1, 3));
        ...
        Border wetDryBorder = BorderFactory.createTitledBorder("Wet Dry Reports");
        panelCheckBoxesTypeOf1755Flop.setBorder(wetDryBorder);
        ...
        Border flopINdexBorder = BorderFactory.createTitledBorder("Wet Dry Reports");
        panelCheckBoxesFlopINdexFlop.setBorder(wetDryBorder);
