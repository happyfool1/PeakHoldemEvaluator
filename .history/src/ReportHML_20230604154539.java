...
public class ReportHML implements Constants {
    ...
    private static final Object[] columnsHMLShowdownFlop = { "HML", "No hand", "Bottom Pair",
            "Middle Pair", "Top Pair", "Over Pair",  "Bottom Two pair","Top and Bottom Two Pair"
            ,"Top Two Pair","Set","Straight", "Flush", "Full house", "Straight flush", "Royal flush", "Total" };
    ...
    static void reportHMLShowdownFlopWon(int c, int r) {
        ...
        tableModell0 = new DefaultTableModel(dataHMLShowdownFlop, columnsHMLShowdownFlop);
        ...
        for (int i = 0; i < HML_FLOP_SIZE; ++i) {
            ...
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
                if (ManyData.hmlShowdownWon[i][j] > 0) {
                    ...
                    table10.setValueAt(cellValueStr, row, col);
        ...
        table10.setDefaultRenderer(Object.class, new TableCellRenderer() {
