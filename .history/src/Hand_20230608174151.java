...
public class Hand implements Constants {
	...
	*
	 ...
	 * Chdeck board first, for board paired, two pair, or set
	 ***************************************************************************************/
	private int doPairs() {
		...
		if (EvalData.boardSet && isSet()) {
			if (EvalData.street == FLOP)					System.out.println("//BBB " + EvalData.both[0].value
					+ " " + EvalData.both[1].value + " " + EvalData.both[2].value 
					+ " " + EvalData.both[3].value + " " + EvalData.both[4].value);
