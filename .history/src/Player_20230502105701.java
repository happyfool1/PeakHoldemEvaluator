...
public class Player implements Constants {
	...
	private final BigDecimal bet = zeroBD; //
	private final BigDecimal betDiff = zeroBD; // If previous action part of current bet is already in
	...
	Action getDecision(int toMe, BigDecimal betToMe, BigDecimal betNow) {
		...
		if (toMe == PREFLOP_LIMP) {
			System.out.println(new StringBuilder().append("//PREFLOP_LIMP  ").append(this.handIndex).append(" ")
					.append(this.betToMe).append(" ").append(this.toMe).append(" ").append(this.betNow).append(" ")
					.append(this.rangeOpen.rangeArray[this.handIndex]).toString());
		...
		if (toMe == PREFLOP_OPEN) {
			System.out.println(new StringBuilder().append("//PREFLOP_OPEN  ").append(this.handIndex).append(" ")
					.append(this.betToMe).append(" ").append(this.toMe).append(" ").append(this.betNow).toString());
		...
		if (toMe == PREFLOP_BET3) {
			System.out.println(new StringBuilder().append("//PREFLOP_BET3 ").append(this.handIndex).append(" ")
					.append(this.betToMe).append(" ").append(this.toMe).append(" ").append(this.betNow).toString());
		...
		if (toMe == PREFLOP_BET4) {
			System.out.println(new StringBuilder().append("//PREFLOP_BET4  ").append(this.handIndex).append(" ")
					.append(this.betToMe).append(" ").append(this.toMe).append(" ").append(this.betNow).toString());
		...
		if (toMe == PREFLOP_ALLIN) {
			System.out.println(new StringBuilder().append("//PREFLOP_ALLIN  ").append(this.handIndex).append(" ")
					.append(this.betToMe).append(" ").append(this.toMe).append(" ").append(this.betNow).toString());
		...
		if (toMe == PREFLOP_CALL_ALLIN) {
			System.out.println(new StringBuilder().append("//PREFLOP_CALL_ALLIN ").append(this.handIndex).append(" ")
					.append(this.betToMe).append(" ").append(this.toMe).append(" ").append(this.betNow).toString());
			if (this.rangeAllin.rangeArray[this.handIndex] > 0) {
				doAllinCall();
				this.action.actionAfter = PREFLOP_ALLIN;
	...
	private void doFold() {
		...
		System.out.println(new StringBuilder().append("//doFold() ").append(this.seat).append(" ")
				.append(EvalData.orbit).append(" ").append(this.action.moneyToPot).append(" ").append(this.moneyIn)
				.append(" ").append(EvalData.stackBD[this.seat]).append(" ").append(EvalData.foldCount).toString());
	}
	...
	private void doOpen() {
		...
		if (canRaise) {
			...
			var tempBD = EvalData.SBBetBD.multiply(limpCountBD);
			tempBD = tempBD.add(EvalData.preflopBet2SizeBD);
			this.action.moneyToPot = this.action.moneyToPot.add(tempBD);
			this.moneyIn = tempBD;
	...
	private void doBet3() {
		...
		if (canRaise) {
			...
			var temp = zeroBD;
			this.call = this.betNow.subtract(this.moneyIn);
			temp = EvalData.potBD.multiply(EvalData.betMultiplierBD);
			temp = temp.subtract(this.call);
