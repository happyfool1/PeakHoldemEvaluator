...
This example  adds a new  potOdds field  to the PlayerContext class and  adjusts the   strategy percentages
    ...
    If the  pot odds are low (meaning the player has to risk a lot to win a little), the code increases the likelihood of folding or bluffing and decreases the likelihood of calling or raising. Conversely, if the pot odds are
