...
public interface Constants {
	...
	*******************************************************************************/
	...
	int HAVE_GUTSHOT_DRAW_PAIR = 2;
	int HAVE_GUTSHOT_DRAW_OESD = 3;
	int HAVE_GUTSHOT_DRAW_FLUSH = 4;
	...
	int HAVE_FLUSH = 18;
	int HAND_SIZE = 19;
	String HAVE_ST = { "None", "Gutshot draw", "Gutshot draw + pair","Gurshot draw + OESD", "Gurshot draw + Flush",	
