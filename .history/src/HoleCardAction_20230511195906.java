    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            panelActionA.add(actionArrayPlayabilityTextE[i][0][0]);
            actionArrayPlayabilityTextE[i][1][1] = new JTextEField(String.valueOf(actionArrayPlayability[i][4][1]));
            actionArrayPlayabilityTextE[i][14][1].setFont(f0);
