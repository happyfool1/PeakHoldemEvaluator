...
private static void copyDataHandRanges() {
	for (int i = 0; i < HANDS; i++) {
	action.rangesArrayCall[SB][0][i] = rangeSBLimp.rangesArray[i];
	action.rangesArrayRaise[SB][0][i] = rangeSBOpen.rangesArray[i];
	action.rangesArrayCall[SB][1][i] = rangeSBCall.rangesArray[i];
	action.rangesArrayRaise[SB][1][i] = rangeSBBet3.rangesArray[i];
	action.rangesArrayCall[SB][2][i] = rangeSBBet3Call.rangesArray[i];
	action.rangesArrayRaise[SB][2][i] = rangeSBBet4.rangesArray[i];
	action.rangesArrayCall[SB][3][i] = rangeSBBet4Call.rangesArray[i];
	action.rangesArrayRaise[SB][3][i] = rangeSBAllin.rangesArray[i];
	action.rangesArrayCall[SB][4][i] = rangeSBAllinCall.rangesArray[i];
	action.rangesArrayRaise[BB][0][i] = rangeBBLimp.rangesArray[i];
	action.rangesArrayRaise[BB][0][i] = rangeBBOpen.rangesArray[i];
	action.rangesArrayCall[BB][1][i] = rangeBBCall.rangesArray[i];
	action.rangesArrayRaise[BB][1][i] = rangeBBBet3.rangesArray[i];
	action.rangesArrayCall[BB][2][i] = rangeBBBet3Call.rangesArray[i];
	action.rangesArrayRaise[BB][2][i] = rangeBBBet4.rangesArray[i];
	action.rangesArrayCall[BB][3][i] = rangeBBBet4Call.rangesArray[i];
	action.rangesArrayRaise[BB][3][i] = rangeBBAllin.rangesArray[i];
	action.rangesArrayCall[BB][4][i] = rangeBBAllinCall.rangesArray[i];
	action.rangesArrayCall[UTG][0][i] = rangeUTGLimp.rangesArray[i];
	action.rangesArrayRaise[UTG][0][i] = rangeUTGOpen.rangesArray[i];
	action.rangesArrayCall[UTG][1][i] = rangeUTGCall.rangesArray[i];
	action.rangesArrayRaise[UTG][1][i] = rangeUTGBet3.rangesArray[i];
	action.rangesArrayCall[UTG][2][i] = rangeUTGBet3Call.rangesArray[i];
	action.rangesArrayRaise[UTG][2][i] = rangeUTGBet4.rangesArray[i];
	action.rangesArrayCall[UTG][3][i] = rangeUTGBet4Call.rangesArray[i];
	action.rangesArrayRaise[UTG][3][i] = rangeUTGAllinCall.rangesArray[i];
	action.rangesArrayCall[MP][0][i] = rangeMPLimp.rangesArray[i];
	action.rangesArrayRaise[MP][0][i] = rangeMPOpen.rangesArray[i];
	action.rangesArrayCall[MP][1][i] = rangeMPCall.rangesArray[i];
	action.rangesArrayRaise[MP][1][i] = rangeMPBet3.rangesArray[i];
	action.rangesArrayCall[MP][2][i] = rangeMPBet3Call.rangesArray[i];
	action.rangesArrayRaise[MP][2][i] = rangeMPBet4.rangesArray[i];
	action.rangesArrayCall[MP][3][i] = rangeMPBet4Call.rangesArray[i];
	action.rangesArrayRaise[MP][3][i] = rangeMPAllin.rangesArray[i];
	action.rangesArrayCall[MP][4][i] = rangeMPAllinCall.rangesArray[i];
	action.rangesArrayCall[CO][0][i] = rangeCOLimp.rangesArray[i];
	action.rangesArrayRaise[CO][0][i] = rangeCOOpen.rangesArray[i];
	action.rangesArrayCall[CO][1][i] = rangeCOCall.rangesArray[i];
	action.rangesArrayRaise[CO][1][i] = rangeCOBet3.rangesArray[i];
	action.rangesArrayCall[CO][2][i] = rangeCOBet3Call.rangesArray[i];
	action.rangesArrayRaise[CO][2][i] = rangeCOBet4.rangesArray[i];
	action.rangesArrayCall[CO][3][i] = rangeCOBet4Call.rangesArray[i];
	action.rangesArrayRaise[CO][3][i] = rangeCOAllin.rangesArray[i];
	action.rangesArrayCall[CO][4][i] = rangeCOAllinCall.rangesArray[i];
	action.rangesArrayCall[BU][0][i] = rangeBULimp.rangesArray[i];
	action.rangesArrayRaise[BU][0][i] = rangeBUOpen.rangesArray[i];
	action.rangesArrayCall[BU][1][i] = rangeBUCall.rangesArray[i];
	action.rangesArrayRaise[BU][1][i] = rangeBUBet3.rangesArray[i];
	action.rangesArrayCall[BU][2][i] = rangeBUBet3Call.rangesArray[i];
	action.rangesArrayRaise[BU][2][i] = rangeBUBet4.rangesArray[i];
	action.rangesArrayCall[BU][3][i] = rangeBUBet4Call.rangesArray[i];
	action.rangesArrayRaise[BU][3][i] = rangeBUAllin.rangesArray[i];
	action.rangesArrayCall[BU][4][i] = rangeBUAllinCall.rangesArray[i];
}
}
