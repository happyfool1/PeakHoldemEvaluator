...
public class Temp2 implements Constants {
	...
	************************************************************************************** */
	...
	playerPositions = new int[PLAYERS]; // indexed by position returns seat
	 streetNumber = PREFLOP;
	  int[] positionsStart = { SB, BB, UTG, MP, CO, BU };
	...
	*  but keep in mind that poker is a dynamic game that requires constant adjustments
	 ...
	 * 
	 ************************************************************************************** */
	  BigDecimal SBBetBD = new BigDecimal(1);
	  BigDecimal BBBetBD = new BigDecimal(2);
	  BigDecimal preflopBetMultiplyerOpenBD = new BigDecimal(3);; // Times BB + 1 each limp
	  BigDecimal preflopBetMultiplyer3BetBD = new BigDecimal(3);; // Times Open 2 Bet
	  BigDecimal preflopBetMultiplyer4BetBD = new BigDecimal(2.5); // Times 3 Bet
	  BigDecimal postFlopBbetMultiplierBD = new BigDecimal(.5); // Times pot size
	  BigDecimal buyinBD = new BigDecimal(200);
	  BigDecimal rebuyBD = new BigDecimal(100);
	  BigDecimal maxStackBD = new BigDecimal(500);
	/*-  ************************************************************************************* 
	 * For the hand currently being evaluated
