...
public class HandRangeConverter implements Constants {
	...
	void newRanges(String type) {
		...
		rangeBB.buildRangePercentage(percentBB * x );
		rangeUTG.buildRangePercentage(percentUTG * x);
		rangeMP.buildRangePercentage(percentMP * x);
		rangeCO.buildRangePercentage(percentCO * x);
		rangeBU.buildRangePercentage(percentBU * x);
