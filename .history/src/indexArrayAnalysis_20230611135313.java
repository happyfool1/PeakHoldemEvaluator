...
public class IndexArrayAnalysis implements Constants {
    ...
    ****************************************************************************** */
    IndexArrayAnalysis(int[][] drawArray, int[][] madeArray, int[][] showdownArray) {
        ...
        this.drawColTotalPer = new double[this.drawArray.length];
        this.madeColTotalPer = new double[this.madeArray.length];
        this.showdownColTotalPer = new double[this.showdownArray.length];
