	...
	***************************************************************************** */
	...
	private static void cardsAndBoardTurn(int seat) {
		...
		if (EvalData.board[0].value != EvalData.board[1].value) {
			...
			EvalData.boardHighCardValue2 = EvalData.board[].value;
		}
	...
	private static void cardsAndBoardRiver(int seat) {
		...
		//zzz  9 4 0
		if (EvalData.twoPair) {
			System.out.println("//yyy  " + EvalData.board[0] + " " + EvalData.board[1] + " " + EvalData.board[2]
					+ " " + EvalData.board[3] + " " + EvalData.board[4]);
			System.out.println("//zzz  " + EvalData.boardHighCardValue1 + " " + EvalData.boardHighCardValue2
