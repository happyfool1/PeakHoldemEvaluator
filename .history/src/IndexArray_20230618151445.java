...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        st += "The best Made rows were " + Format.formatPer(bestMadeRowsPer[0]) + " "+ allArrayRowNames[bestMadeRows[1]] + ", "  + Format.formatPer(bestMadeRowsPer[0]) + " "+ allArrayRowNames[bestMadeRows[1]]
                + ", " + Format.formatPer(bestMadeRowsPer[2]) + " "+ allArrayRowNames[bestMadeRows[2]] + "\r\n";
