...
public class IndexArrays implements Constants {
	...
	* +1 because of Showdown
	...
	static int[][][] hmlDrawTurnrawFlopToMadWon = new int[HML_FLOP_SIZE][DRAW_SIZE][MADE_SIZE];
	...
	static int[][][] hmlMadeRiverToMadeWon = new int[HML_FLOP_SIZE][[HML_FLOP_SIZE]MADE_SIZE][MADE_SIZE];
