...
public class ReportHML implements Constants {
    ...
    private static final Object[] columnsHHHMLShowdownWonRiver = { "HML", "No hand", "Any pair", "Two pair", "Set",
            "Straight",
            "Flush", "Full house", "Straight flush", "Royal flush" };
 ...
 ********************************************************************************** */
    static void reportHMLShowdownTurn(int c, int r) {
        ...
        tableModel6 = new DefaultTableModel(dataHMLTurnShowdownWon, columnsHMLTurnShowdownWon);
