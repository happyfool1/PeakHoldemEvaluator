...
public class IndexArrayClassification implements Constants {
	...
	* Characterizing a flop can be done in many ways depending on what is important to the player.
	...
	For example, a flop of 7-9-Jack would be classified as "three ranks". This type of flop doesn't complete any sets but may create possibilities for straights and flushes.
