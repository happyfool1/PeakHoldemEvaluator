...
public class Hand implements Constants {
	...
	* Returns MADE_BOTTOM_TWO_PAIR, MADE_TOP_AND_BOTTOM_TWO_PAIR, or MADE_TOP_TWO_PAIR
	...
	Your hole card, Ten, pairs with the Ten on the board, and the two Jacks on the board form the second pair.
	 ...
	 "kicker" or tiebreaker card, meaning that if another player also has two pair (Jacks and Tens), your hand would beat theirs if their fifth card (or kicker) is lower than an Ace.
