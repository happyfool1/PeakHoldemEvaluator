...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private static final JCheckBox hmlShowdownFDlop = new JCheckBox("HML Flop Showdown");

    private JPanel panelCheckBoxesHHML;
    private static final JCheckBox hhmlDrawTurn = new JCheckBox("HHML Turn Draw");
    private static final JCheckBox HHMLMADETURN_J_CHECK_BOX = new JCheckBox("HML Turn Made Hand");
    private static final JCheckBox hhmlShowdownTurn = new JCheckBox("HML Turn Showdown");
    ...
    private static final JCheckBox sumOfDrawRiver = new JCheckBox("Sum Of Flop Cards Draw");
