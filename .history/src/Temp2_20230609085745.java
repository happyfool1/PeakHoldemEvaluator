...
public class Temp2 implements Constants {
	...
	*******************************************************************************/
	...
	flop3Suited = false;
	 ...
	 handsToPlay = 0;
	interactive = false;
	decSt = { "Rules", "MDFCheck", "MDFBet1", "MDFBet2", "Bluff", "ABC", "C-Bet", "GTO", "Barrel",
			"Final", "None" };
	rpSt = { "First", "First HU", "Middle", "Last", "Last HU" };
	actionSt = { "Check", "Bet", "Raise", "Call", "All-in", "Call All-in", "Fold", "None" };
	ruleSt = { "Bet", "Call", "All-in", "None" };
	opActionSt = { "Check", "Bet", "Raise", "Call", "All-in", "Call All-in", "Fold", "None" };
	streetSt = { "Preflop", "Flop", "Turn", "River", "None" };
