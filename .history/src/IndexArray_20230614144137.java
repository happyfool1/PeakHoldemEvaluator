...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    void copyArrays() {
        for (int i = 0; i < this.drawArray.length; i++) {
            for (int j = 0; j < this.drawArray0].length; j++) {
    ...
    ***************************************************************************************** */
    void findBestAndWorst() {
        ...
        worstMadeCols[2] = madeTotalColPerEntries.get(2).getRowOrCol();
         System.out.println("//yyy " + showdownTotalColPerEntries.get(showdownTotalColPerEntries.size() - 3).getRowOrCol() + 
        " " + showdownTotalColPerEntries.size());
    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        System.out.println("//xxx " +bestShowdownwCols[0]+ " "+  madeArrayColNames[0] + " "
         + bestShowdownwCols[1]+ " "+  madeArrayColNames[1] + " " +2 + " "+  madeArrayColNames[2] + " ");
