    ...
    * a radio button or control button.
    ...
    private void doSimulationDataCollection() {
        ...
        if (number == 0) {
            ...
            R   ReportManyHands.reportHMLMade(750, 100);eportManyHands.reportHMLDraw(100, 100);
         
            ReportManyHands.reportHHMLDraw(100, 200);
            ReportManyHands.reportHHMLMade(750, 200);
             ReportManyHands.reportHHHMLMade(100, 300);

           // ReportManyHands.reportHMLShowdown(100, 100);
