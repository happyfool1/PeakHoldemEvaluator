...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private static final JCheckBox sumOfDrawRiver = new JCheckBox("Sum Of River Cards Made Hand");
    private static final JCheckBox sumOfMadeRiver = new JCheckBox("Sum Of River Cards Made Hand");
    private static final JCheckBox sumOfShowdownRiver = new JCheckBox("Sum of Flop Cards Showdown");
    ...
    private static final JCheckBox wetDryDrawRiver = new JCheckBox("Wet Dry Draw");
