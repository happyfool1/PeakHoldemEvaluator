...
public class HandRangeConverter implements Constants {
	...
	private static void copyDataGapsArray() {
				for (int i = 0; i < HANDS; j++) {

				action.gapsArrayCall[SB][0][j] = rangeSBLimp.gapsArray[j];
				action.gapsArrayRaise[SB][0][j] = rangeSBOpen.gapsArray[j];
				action.gapsArrayCall[SB][1][j] = rangeSBCall.gapsArray[j];
				action.gapsArrayRaise[SB][1][j] = rangeSBBet3.gapsArray[j];
				action.gapsArrayCall[SB][2][j] = rangeSBBet3Call.gapsArray[j];
				action.gapsArrayRaise[SB][2][j] = rangeSBBet4.gapsArray[j];
				action.gapsArrayCall[SB][3][j] = rangeSBBet4Call.gapsArray[j];
				action.gapsArrayRaise[SB][3][j] = rangeSBAllin.gapsArray[j];
				action.gapsArrayCall[SB][4][j] = rangeSBAllinCall.gapsArray[j];
				action.gapsArrayRaise[BB][0][j] = rangeBBLimp.gapsArray[j];
				action.gapsArrayRaise[BB][0][j] = rangeBBOpen.gapsArray[j];
				action.gapsArrayCall[BB][1][j] = rangeBBCall.gapsArray[j];
				action.gapsArrayRaise[BB][1][j] = rangeBBBet3.gapsArray[j];
				action.gapsArrayCall[BB][2][j] = rangeBBBet3Call.gapsArray[j];
				action.gapsArrayRaise[BB][2][j] = rangeBBBet4.gapsArray[j];
				action.gapsArrayCall[BB][3][j] = rangeBBBet4Call.gapsArray[j];
				action.gapsArrayRaise[BB][3][j] = rangeBBAllin.gapsArray[j];
				action.gapsArrayCall[BB][4][j] = rangeBBAllinCall.gapsArray[j];
				action.gapsArrayCall[UTG][0][j] = rangeUTGLimp.gapsArray[j];
				action.gapsArrayRaise[UTG][0][j] = rangeUTGOpen.gapsArray[j];
				action.gapsArrayCall[UTG][1][j] = rangeUTGCall.gapsArray[j];
				action.gapsArrayRaise[UTG][1][j] = rangeUTGBet3.gapsArray[j];
				action.gapsArrayCall[UTG][2][j] = rangeUTGBet3Call.gapsArray[j];
				action.gapsArrayRaise[UTG][2][j] = rangeUTGBet4.gapsArray[j];
				action.gapsArrayCall[UTG][3][j] = rangeUTGBet4Call.gapsArray[j];
				action.gapsArrayRaise[UTG][3][j] = rangeUTGAllinCall.gapsArray[j];
				action.gapsArrayCall[MP][0][j] = rangeMPLimp.gapsArray[j];
				action.gapsArrayRaise[MP][0][j] = rangeMPOpen.gapsArray[j];
				action.gapsArrayCall[MP][1][j] = rangeMPCall.gapsArray[j];
				action.gapsArrayRaise[MP][1][j] = rangeMPBet3.gapsArray[j];
				action.gapsArrayCall[MP][2][j] = rangeMPBet3Call.gapsArray[j];
				action.gapsArrayRaise[MP][2][j] = rangeMPBet4.gapsArray[j];
				action.gapsArrayCall[MP][3][j] = rangeMPBet4Call.gapsArray[j];
				action.gapsArrayRaise[MP][3][j] = rangeMPAllin.gapsArray[j];
				action.gapsArrayCall[MP][4][j] = rangeMPAllinCall.gapsArray[j];
				action.gapsArrayCall[CO][0][j] = rangeCOLimp.gapsArray[j];
				action.gapsArrayRaise[CO][0][j] = rangeCOOpen.gapsArray[j];
				action.gapsArrayCall[CO][1][j] = rangeCOCall.gapsArray[j];
				action.gapsArrayRaise[CO][1][j] = rangeCOBet3.gapsArray[j];
				action.gapsArrayCall[CO][2][j] = rangeCOBet3Call.gapsArray[j];
				action.gapsArrayRaise[CO][2][j] = rangeCOBet4.gapsArray[j];
				action.gapsArrayCall[CO][3][j] = rangeCOBet4Call.gapsArray[j];
				action.gapsArrayRaise[CO][3][j] = rangeCOAllin.gapsArray[j];
				action.gapsArrayCall[CO][4][j] = rangeCOAllinCall.gapsArray[j];
				action.gapsArrayCall[BU][0][j] = rangeBULimp.gapsArray[j];
				action.gapsArrayRaise[BU][0][j] = rangeBUOpen.gapsArray[j];
				action.gapsArrayCall[BU][1][j] = rangeBUCall.gapsArray[j];
				action.gapsArrayRaise[BU][1][j] = rangeBUBet3.gapsArray[j];
				action.gapsArrayCall[BU][2][j] = rangeBUBet3Call.gapsArray[j];
				action.gapsArrayRaise[BU][2][j] = rangeBUBet4.gapsArray[j];
				action.gapsArrayCall[BU][3][j] = rangeBUBet4Call.gapsArray[j];
				action.gapsArrayRaise[BU][3][j] = rangeBUAllin.gapsArray[j];
				action.gapsArrayCall[BU][4][j] = rangeBUAllinCall.gapsArray[j];
			}
		}
