...
public class Classification implements Constants {
	...
	***************************************************************************************************/
	 ...
	 * The logic for the computation is that we subtract 1 from the suitType and multiply by 3 (since we have three connectivity types), and then we add the connectivityType. This ensures a unique value for each combination.
	 * 
	 *******************************************************************************/
