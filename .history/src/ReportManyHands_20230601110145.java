...
public class ReportManyHands implements Constants {
	...
	static DefaultTableModel tableModel8 = null;
	static DefaultTableModel tableModel9 = null;
	static DefaultTableModel tableModel0 = null;
	static DefaultTableModel tableMode11 = null;
	static DefaultTableModel tableMode12 = null;
	static DefaultTableModel tableMode13 = null;
	static DefaultTableModel tableMode14 = null;
	static DefaultTableModel tableMode15 = null;
	static DefaultTableModel tableMode16 = null;
	...
	********************************************************************************** */
	static void reportHMLDraw(int c, int r) {
		if (frame1 == null) {
			...
			frame1.setPreferredSize(new Dimension(350, 600));
			...
			table1.setModel(new DefaultTableModel(dataHMLDraw, columnsHMLDraw));
			table1.getColumnModel().getColumn(0).setPreferredWidth(140);
			table1.getColumnModel().getColumn(1).setPreferredWidth(120);
		}
		...
		for (int i = 0; i < HML_FLOP_SIZE; ++i) {
			...
			for (int j = 0; j < DRAW_HANDS_SIZE; ++j) {
				if (ManyData.hmlDraw[i][j] > 0) {
					...
					double per = (double) ManyData.hmlCount / (double) ManyData.hmlDraw[i][j]/(double) ManyData.hmlCount ;
					System.out.println(per +" " + ManyData.hmlCount + " " + ManyData.hmlDraw[i][j]);
	...
	********************************************************************************** */
	static void reportHMLMade(int c, int r) {
		...
		if (frame2 == null) {
			...
			frame2.setPreferredSize(new Dimension(350, 600));
			...
			table2.setModel(new DefaultTableModel(dataHMLMade, columnsHMLMade));
			table2.getColumnModel().getColumn(0).setPreferredWidth(140);
			table2.getColumnModel().getColumn(1).setPreferredWidth(120);
		}
