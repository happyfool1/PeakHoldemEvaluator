    ...
    *******************************************************************************/
    ...
    HoleCardAction() {
        for (int i = 0; i < POSITIONS; ++i) {
            for (int j = 0; j < 5; ++j) {
                      this.actionArrayGaps[i][j] = 0;
                    this.actionArrayCombos[i][j] = -1;
                    this.actionArrayPercentage[i][j] = -1;
                    this.actionArrayPlayability[i][j] = -1;
                            }
        makePlayability();
