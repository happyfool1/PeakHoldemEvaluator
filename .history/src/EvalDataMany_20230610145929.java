...
static int[] hmlDrawRowTotalRiver = new int[HML_FLOP_SIZE];
	static int[] hmlDrawColTotalRiver = new int[DRAW_SIZE];
	static int[] hmlMadeRowTotalRiver = new int[HML_FLOP_SIZE];
	static int[] hmlMadeColTotalRiver = new int[MADE_SIZE];
	static int[] hmlShowdownRowTotalRiver = new int[HML_FLOP_SIZE];
