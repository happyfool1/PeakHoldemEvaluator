...
public class EvalDataMany implements Constants {
	...
	* +1 because of Showdown
	...
	static int[][] hmlShowdownWonFlop = new int[HML_FLOP_SIZE][MADE_SIZE];

	static int[][] hmlDrawTurn = new int[HML_TURN_SIZE][DRAW_SIZE];
	static int[][] hmlMade = new int[HML_TURN_SIZE][MADE_SIZE];
	static int[][] hmlShowdownWon = new int[HML_TURN_SIZE][MADE_SIZE];

	static int[][] hmlMade = new int[HML_RIVER_SIZE][MADE_SIZE];
	static int[][] hmlShowdownWon = new int[HML_RIVER_SIZE][MADE_SIZE];
