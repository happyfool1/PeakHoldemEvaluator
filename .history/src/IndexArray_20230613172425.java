...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    void searchIndexArrayList() {
        ...
        List<PairEntry> matchingEntriesX = drawEntries.stream()
    ...
    ***************************************************************************************** */
    void indexArrayListInSortedOrder() {
        for (PercentageEntry entry : drawTotalRowPerEntries) {
            System.out.println("Percentage: " + entry.getPercentage() + ", Row: " + entry.getRow() + ", Column: "
                    + entry.getColumn());
        }
    }
