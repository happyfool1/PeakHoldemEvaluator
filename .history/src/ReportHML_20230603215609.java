    ...
    ****************************************************************************************************************/
    ...
    static void reportHMLShowdownFlop(int c, int r) {
        if (frame3 == null) {
            ...
            frame3.setPreferredSize(new Dimension(750, 330));
        }
        ...
        for (int i = 0; i < HML_TURN_SIZE; ++i) {
            ...
            for (int j = 0; j < DRAW_HANDS_SIZE; ++j) {
                if (ManyData.hhmlDraw[i][j] > 0) {
                    double per = ((double) ManyData.hhmlDraw[i][j] / (double) ManyData.hmlCount) * 400.0;
    ...
    static void reportHMLMadeTurn(int c, int r) {
        if (frame5 == null) {
            ...
            frame5.setPreferredSize(new Dimension(750, 440));
        }
        ...
        for (int i = 0; i < HML_TURN_SIZE; ++i) {
            ...
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
                if (ManyData.hhmlMade[i][j] > 0) {
                    double per = ((double) ManyData.hhmlMade[i][j] / (double) ManyData.hmlCount) * 500.0;
    ...
    static void reportHMLShowdownTurn(int c, int r) {
        if (frame6 == null) {
            ...
            frame6.setPreferredSize(new Dimension(750, 440));
        }
        ...
        for (int i = 0; i < HML_TURN_SIZE; ++i) {
            ...
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
                if (ManyData.hhmlShowdownWon[i][j] > 0) {
                    double per = ((double) ManyData.hhmlShowdownWon[i][j] / (double) ManyData.showdownCount) * 60.0;
    ...
    ********************************************************************************** */
    static void reportHMLMadeRiver(int c, int r) {
        ...
        for (int i = 0; i < HML_RIVER_SIZE; ++i) {
            ...
            col = 1;
            for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
                if (ManyDatahh.hmlMade[i][j] > 0) {
                    double per = ((double) ManyData.hhhmlMade[i][j] / (double) ManyData.hmlCount) * 700.0;
    ...
    ********************************************************************************** */
    static void reportHMLShowdownRiver(int c, int r) {
        if (frame8 == null) {
            ...
            frame8.setPreferredSize(new Dimension(750, 600));
        }
