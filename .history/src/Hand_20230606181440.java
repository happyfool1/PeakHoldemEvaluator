...
public class Hand implements Constants {
	...
	* Returns MADE_BOTTOM_TWO_PAIR, MADE_TOP_AND_BOTTOM_TWO_PAIR, or MADE_TOP_TWO_PAIR
	...
	where you have a pair in your hole cards that is higher than any card on the board. For instance, if you held A-A and the board was J-7-2, you'd have an over pair (Aces), as your pair is higher than any card on the board.
