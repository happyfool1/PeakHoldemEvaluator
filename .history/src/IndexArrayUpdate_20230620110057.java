...
public class IndexArrayUpdate implements Constants {
	...
	for (int i = 0; i < PLAYERS; i++) {
			if (!EvalData.playerFolded[i] && EvalData.playerWonShowdown[i]) {
					...
					++IndexArrays.hmlMadeFlopToMadeWon[EvalData.hmlIndexFlop][EvalData.] [EvalData.showdownHand[i]];
					++IndexArrays.hmlDrawFlopToMadeWon[EvalData.hmlIndexFlop[ [EvalData.showdownHand[i]];

					++IndexArrays.hmlMadeTurnToMadeWon[EvalData.hmlIndexTurn    [EvalData.showdownHand[i]];
					++IndexArrays.hmlDrawTurnToMadeWon[[EvalData.hmlIndexTurn]   [EvalData.showdownHand[i]];
