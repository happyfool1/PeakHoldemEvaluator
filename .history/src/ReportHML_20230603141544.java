...
public class ReportHML implements Constants {
    ...
    ********************************************************************************** */
    ...
    /*-********************************************************************************
    * The method reportHMLShowdownFlopWon does the following:
    * 
    ...
    ***********************************************************************************/
    static void reportHMLShowdownFlopWonX(int c, int r) {
        if (frame7 == null) {
            ...
            System.out.println(dataHMLFlopShowdownWon.length + " " + columnsHMLFlopShowdownWon.length);
            for (int row = 0; row < dataHMLFlopShowdownWon.length; row++) {
                // Start from column 1 to exclude column 0
                for (int column = 1; column < columnsHMLFlopShowdownWon.length; column++) {
                    // Get value from the cell, parse it to integer and assign to the variable
                    System.out.println("WTF " + dataHMLFlopShowdownWon[row][column]);
                    if (dataHMLFlopShowdownWon[row][column] != null && dataHMLFlopShowdownWon[row][column] instanceof String) {
            ...
            System.out.println("largest " + largestCells.size());
