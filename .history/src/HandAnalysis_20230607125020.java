	...
	*******************************************************************************/
	static void doBoard3() {
		...
		if (EvalData.board[0].value == EvalData.board[1].value && EvalData.board[0].value == EvalData.board[2].value) {
		 ...
		 if(EvalData.board[0].value == EvalData.board[2].value){
					EvalData.boardArray[BOARD_PAIR] = true;
					EvalData.boardPair = true;
					EvalData.boardPairValue = EvalData.board[0].value;
				}
	...
	// sss
	int suit = EvalData.boardCards[0].suit;if(suit==EvalData.boardCards[1].suit&&suit==EvalData.boardCards[2].suit)
	{
		EvalData.boardArray[BOARD_3F] = true;
		EvalData.boardF3 = true;
	}
	// ssx xss
	suit=EvalData.boardCards[0].suit;if(suit==EvalData.boardCards[1].suit&&suit!=EvalData.boardCards[2].suit)
	{
	...
	if(!(EvalData.boardCards[0].suit!=EvalData.boardCards[1].suit&&EvalData.boardCards[0].suit!=EvalData.boardCards[2].suit&&EvalData.boardCards[1].suit!=EvalData.boardCards[2].suit))
	{
		return;
