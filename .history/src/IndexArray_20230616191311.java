...
public class IndexArray implements Constants {
    ...
    ****************************************************************************** */
    IndexArray(int[][] drawArray, int[][] madeArray, int[][] showdownArray, String[] rowNames, String[] drawColNames,
            String[] madeColNames) {
   this.drawArray  = new double[this.drawArray.length][this.drawArray[0].length];
        this.madeArray  = new double[this.madeArray.length][this.madeArray[0].length];
        this.showdownArray  = new double[this.showdownArray.length][this.showdownArray[0].length];
        ...
        for (int i = 0; i < rowNames.length; i++) {
            this.allArrayRowNames[i] = rowNames[i];
        }
        for (int i = 0; i < drawColNames.length; i++) {
            this.drawArrayColNames[i] = drawColNames[i];
        }
        for (int i = 0; i < madeColNames.length; i++) {
            this.madeArrayColNames[i] = madeColNames[i];
        }
