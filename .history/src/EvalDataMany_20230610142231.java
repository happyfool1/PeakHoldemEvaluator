...
public class EvalDataMany implements Constants {
	...
	* +1 because of Showdown
	...
	static int[][] hmlShowdownWonTurn = new int[HML_TURN_SIZE][MADE_SIZE];

	static int[][] hmlMadeRiver = new int[HML_RIVER_SIZE][MADE_SIZE];
	static int[][] hmlShowdownWonRiver = new int[HML_RIVER_SIZE][MADE_SIZE];
	...
	static int[][] sumOfShowdowFlop = new int[36][MADE_SIZE];
