...
public class RangeComparator implements Constants {
	...
	private static void test() {
		...
		final double rangeAdvantage = rangeComparator.getRangeAdvantage();
		final double rangeIntersection = rangeComparator.getRangeIntersection();
		final double rangeRatio = rangeComparator.getRangeRatio();
		final int[] combinedRange = rangeComparator.getCombinedRange();
	}
