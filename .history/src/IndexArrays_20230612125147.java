...
public class IndexArrays implements Constants {
	...
	* +1 because of Showdown
	...
	static int[][] madeFlopToMade = new int[PLAYERS][DRAW_SIZE];
	static int[][] madeTurnToMade = new int[PLAYERS][DRAW_SIZE];
	static int[][] madeRiverToMade = new int[PLAYERS][DRAW_SIZE];
