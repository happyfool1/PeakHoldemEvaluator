...
public class Hand implements Constants {
	...
	* Returns MADE_BOTTOM_PAIR, MADE_MIDDLE_PAIR, MADE_TOP_PAIR, or MADE_OVER_PAIR 
	/*- ************************************************************************************/
	int whatKindOfPair() {
		if(EvalData.boardHighCardValue > this.pair1Value){
			return MADE_OVER_PAIR;
		}
		if(EvalData.boardLowCardValue  > this.pair1Value){
            return MADE_TOP_PAIR;
        }
		if(EvalData.boardHighCardValue < this.pair2Value){
            return MADE_MIDDLE_PAIR;
        }
		if(EvalData.boardLowCardValue  < this.pair2Value){
