    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        st += "The worst Showdown rows were " + Format.formatPer(worstShowdownRowsPer[0])
              ...
              + Format.formatPer(worstShowdownRowsPer[0]  + allArrayRowNames[worstShowdownRows[1]]
             + Format.formatPer(worstShowdownRowsPer[0]   + ", " + allArrayRowNames[worstShowdownRows[2]] + "\r\n";
