...
public class IndexArrayUpdate implements Constants {
	...
	for (int i = 0; i < PLAYERS; i++) {
			if (!EvalData.playerFolded[i] && EvalData.playerWonShowdown[i]) {
					...
					++IndexArrays.hmlMadeFlopToMadeWon[EvalData.hmlIndexFlop[i][EvalData.showdownHand[i]];
					++IndexArrays.hmlDrawFlopToMadeWon[EvalData.hmlIndexFlop[i][EvalData.showdownHand[i]];

					++IndexArrays.hmlMadeTurnToMadeWon[EvalData.hmlIndexFlop[i][EvalData.showdownHand[i]];
					++IndexArrays.hmlDrawTurnToMadeWon[[EvalData.hmlIndexFlopi][EvalData.showdownHand[i]];
