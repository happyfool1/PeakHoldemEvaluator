...
public interface Constants {
	...
	*******************************************************************************/
	...
	String[] HML_TURN_ST = { "LLLL", "MLLL", "MMLL", "MMML", "MMMM", "HMll", "HMML", "HHLL", "HHML", "HHLL",
			"HHHl", "HHHM", "HHHH" };
	...
	int HHHHM = 15;
	int HHHHH = 16;
	nt HML_RIVER_SIZE = 17;

	String[] HML_RIVER_ST = { "LLLLL", "MLLLL", "MMLLL", "MMMLL", "MMMMM", "HLLLL", "HMLLL", "HMMLL", "HMMML", "HMMMM",
			"HHLLL", "HHMLL", "HHMML", "HHMMM", "HHHLL", "HHHML", "HHHMM", "HHHHL", "HHHHM", "HHHHH" };
