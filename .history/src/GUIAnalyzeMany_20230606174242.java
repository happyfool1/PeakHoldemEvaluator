...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private static final JCheckBox sumOfHoleCardsDrawFlop = new JCheckBox("Sum Of Flop Cards Made Hand");
    private static final JCheckBox sumOfHoleCardsMadeFlop = new JCheckBox("Sum Of Flop Cards Made Hand");
    private static final JCheckBox sumOfHoleCardsShowdownFlop = new JCheckBox("Sum of Flop Cards Showdown");

    private JPanel panelCheckBoxesSumOfHoleCardsTurn;
    private static final JCheckBox sumOfHoleCardsDrawTurn = new JCheckBox("Sum Of Turn Cards Made Hand");
    private static final JCheckBox sumOfHoleCardsMadeTurn = new JCheckBox("Sum Of Turn Cards Made Hand");
    private static final JCheckBox sumOfHoleCardsShowdownTurn = new JCheckBox("Sum of Turn Cards Showdown");

    private JPanel panelCheckBoxesSumOfHoleCardsRiver;
    private static final JCheckBox sumOfHoleCardsMadeRiver = new JCheckBox("Sum Of River Cards Made Hand");
    private static final JCheckBox sumOfHoleCardsShowdownRiver = new JCheckBox("Sum of River Cards Showdown");
    ...
    *******************************************************************************/
    public void myFrame() {
        ...
        panelCheckBoxesWetDryFlop.add(sumOfHoleCardsDrawFlop);
        ...
        sumOfHoleCardsMadeFlop.setSelected(false);
        panelCheckBoxesWetDryFlop.add(sumOfHoleCardsMadeFlop);
        ...
        panelCheckBoxesWetDryFlop.add(sumOfHoleCardsShowdownFlop);
        ...
        panelCheckBoxesWetDryFlop.add(sumOfBoardCardsDrawFlop);
        ...
        sumOfBoardCardsMadeFlop.setSelected(false);
        panelCheckBoxesWetDryFlop.add(sumOfBoardCardsMadeFlop);
        ...
        panelCheckBoxesWetDryFlop.add(sumOfBoardCardsShowdownFlop);
        ...
        panelCheckBoxesWetDryFlop.add(typeOf1755DrawFlop);
        ...
        typeOf1755MadeFlop.setSelected(false);
        panelCheckBoxesWetDryFlop.add(typeOf1755MadeFlop);
        ...
        panelCheckBoxesWetDryFlop.add(typesOf1755ShowdownFlop);
