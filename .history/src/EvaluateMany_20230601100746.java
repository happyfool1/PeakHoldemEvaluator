...
public class EvaluateMany implements Constants {
	...
	static void updateFlop() {
		++ManyData.hmlCount = 0;
		++ManyData.hhmlCount = 0;
		++ManyData.hhhmlCount = 0;
		++ManyData.typeCount = 0;
		++ManyData.wetDryCount = 0;
		++ManyData.type1755Count = 0;
		f++ManyData.lopIndexCount = 0;
		++ManyData.handValueCount = 0;
		++ManyData.sumOfDrawCount = 0;
		++ManyData.sumOfMadeCount = 0;
		++ManyData.sumOfShowdownCount = 0;
		...
		++ManyData.sumOfHandValuesFlopArray[EvalData.sumOfHandValuesFlop[EvalData.seat]];
	...
	static void updateShowdown() {
		...
		for (int i = 0; i < PLAYERS; i++) {
			if (!EvalData.playerFolded[i]) {
				ManyData.hmlShowdown[EvalData.hmlIndexFlop][EvalData.showdownHand[i]]++;
			}
		}
	}
