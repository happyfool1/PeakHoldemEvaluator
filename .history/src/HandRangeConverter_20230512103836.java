...
public class HandRangeConverter implements Constants {
	...
	private static void copyDataPlayability() {
		...
		action.actionArrayPlayabilityRaise = rangeSBLimp.lowPlayabilitrhyArrayIndex;
		action.actionArrayPlayabilityRaise[SB][1] = rangeSBBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPlayabilityCallSB][1] = rangeSBCall.lowPlayabilitrhyArrayIndex;
	...
	private static void copyDataCombos() {
		...
		action.actionArrayCombosCallSB][1] = rangeSBCall.combos;
	...
	private static void copyDataPercentage() {
		...
		action.actionArrayPercentageCallSB][1] = rangeSBCall.percentage;
	...
	private static void copyDataGaps() {
		...
		action.actionArrayGapsCallSB][1] = rangeSBCall.gaps;
