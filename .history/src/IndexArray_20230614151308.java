...
public class IndexArray implements Constants {
 ...
 /*- **************************************************************************************
    * This method will find the best and worst percentages
    * The 5 best and the 3 worst are found
    * Helper to constructor 
    ***************************************************************************************** */
    void findBestAndWorstOverall() {
    }
    ...
    ***************************************************************************************** */
    ...
    int[] drawTop5Row = new int[5];
    int[] drawTop5Col = new int[5];
    double[] drawTop5Per = new double[5];

    int[] madeTop5Row = new int[5];
    int[] madeTop5Col = new int[5];
    double[] madeTop5Per = new double[5];

    int[] showdownTop5Row = new int[5];
    int[] showdownTop5Col = new int[5];
    double[] showdownTop5Per = new double[5];
