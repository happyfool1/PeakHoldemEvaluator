...
public class HoleCardAction implements Constants {
 ...
 static JTextField[] cardsText = new JTextField[PLAYERS];
static JTextField[][][] actionArrayText = new JTextField[PLAYERS][5][2];
static JTextField[] lowRangeArrayIndexText = new JTextField[PLAYERS];
static JTextField[] lowPlayabilitrhyArrayIndexdsText = new JTextField[PLAYERS];
static JTextField[] lowPlayabilityArrayNumericValueText = new JTextField[PLAYERS];
static JTextField[] gapCountText = new JTextField[PLAYERS];
static JTextField[][] rangeArrayText = new JTextField[PLAYERS][HANDS];
static JTextField[][] gapCountArrayText = new JTextField[PLAYERS][HANDS];
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        final var panel0Layout = new GridLayout(5, 1);
        ...
        panelLowRange.setSize(40, 20);
        panelLowRange.setFont(f0);

        JPanel panelLowPlay = new JPanel();
        panelLowPlay.setSize(40, 20);
        panelLowPlay.setFont(f0);
        final var panelLowPlayLayout = new GridLayout(1, 8);
        panelLowPlay.setLayout(panelLowPlayLayout);

        JPanel panelLowPlanNum = new JPanel();
        panelLowPlanNum.setSize(40, 20);
        panelLowPlanNum.setFont(f0);
        final var panelLowPlanNumLayout = new GridLayout(1, 8);
        panelCards.setLayout(panelLowPlanNumLayout);

        JPanel panelGaps = new JPanel();
        panelGaps.setSize(40, 20);
        panelGaps.setFont(f0);
        final var panelGapsLayout = new GridLayout(1, 8);
        ...
        for (int i = 0; i < PLAYERS; ++i) {
            ...
            lowPlayabilitrhyArrayIndexdsText[i] =new JTextFieldString.valueOf(lowPlayabilitrhyArrayIndex[i]));
            lowPlayabilityArrayNumericValueText[i]= new JTextFieldString.valueOf(lowPlayabilityArrayNumericValue[i]));
        ...
        final var actionArrayLayout = new GridLayout(10, PLAYERS);
        ...
        panelAction.setSize(40, 20);
        panelAction.setFont(f0);
        final var actionLayout = new GridLayout(1, 8);
        panelAction.setLayout(actionLayout);
        for (int i = 0; i < PLAYERS; ++i) {
            for (int j = 0; j < 5; ++j) {
                actionArrayText[i][j][0].setText(String.valueOf(actionArray[i][j][0]));
                panelAction.add(actionArrayText[i][j][0]);
                actionArrayText[i][j][0].setText(String.valueOf(actionArray[i][j][1]));
                panelAction.add(actionArrayText[i][j][1]);
            }
        }
        panelActionArray.add(panelAction);
