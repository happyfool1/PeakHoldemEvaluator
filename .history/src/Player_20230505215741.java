...
public class Player implements Constants {
	 ...
	 *  Arg2 - 
	 **************************************************************************** */
	intgetDecision(int toMe, BigDecimal betToMe, BigDecimal betNow) {
	...
	private void doFold() {
		...
		this.call = EvalData.betNowBD;
		this.action.action = FOLD;

		this.action.moneyToPot = zeroBD;
		this.action.betNow = EvalData.betNowBD;
		EvalData.pot$[0][seat][EvalData.orbit] = EvalData.potBD;
		EvalData.moneyIn$[0][seat][EvalData.orbit] = zeroBD;
	
		System.out.println("FFF " + " this.call " + this.call +   " this.moneyIn "
		+ this.moneyIn + " potBD " + EvalData.potBD
		+ " moneyInBD " + EvalData.moneyInBD[seat]
		+ " betNowBD " + EvalData.betNowBD + " this.betNow " + this.betNow + " action.betNow "
		 + action.betNow + " action.moneyToPot " + action.moneyToPot);
	}
	...
	private void doLimp() {
		...
		System.out.println("LLL " +  " this.call " + this.call +  " this.moneyIn "
				+ this.moneyIn + " potBD " + EvalData.potBD
				+ " moneyInBD " + EvalData.moneyInBD[seat]
	...
	private void doAllin() {
		...
		EvalData.betNowBD = this.betNow.add(bet);
		EvalData.moneyInBD[seat] = this.moneyIn;
		System.out.println("AAA " +  " this.call " + this.call + " bet " + bet + " this.moneyIn "
				+ this.moneyIn + " potBD " + EvalData.potBD
				+ " moneyInBD " + EvalData.moneyInBD[seat]
				+ " betNowBD " + EvalData.betNowBD + " raisedTo " + EvalData.raisedToBD[0][seat][EvalData.orbit]);
	}
	...
	private void doAllinCall() {
		...
		EvalData.callBD[0][seat][EvalData.orbit] = this.call;
		EvalData.moneyInBD[seat] = this.moneyIn;
		System.out.println("AACC " +  " this.call " + this.call + " this.moneyIn "
		+ this.moneyIn + " potBD " + EvalData.potBD
		+ " moneyInBD " + EvalData.moneyInBD[seat]
		+ " betNowBD " + EvalData.betNowBD + " raisedTo " + EvalData.raisedToBD[0][seat][EvalData.orbit]);
	}
	...
	private void doCalls() {
		this.action.action = CALL;
		this.action.moneyToPot = this.call;
		...
		EvalData.callBD[0][seat][EvalData.orbit] = this.call;
		EvalData.moneyInBD[seat] = this.moneyIn;
		System.out.println("CCC  " + this.call +" " + this.call +  " this.moneyIn "
		+ this.moneyIn + " potBD " + EvalData.potBD
		+  " moneyInBD " + EvalData.moneyInBD[seat]
		+ " betNowBD " + EvalData.betNowBD + " raisedTo " + EvalData.raisedToBD[0][seat][EvalData.orbit]);
	}	
