    ...
    private String stringStrategy() {
        ...
        st += "The best Made rows were " + Format.formatPer(bestMadeRowsPer[0]) + " "+ allArrayRowNames[bestMadeRows[0]] + ", " 
         + Format.formatPer(bestMadeRowsPer[1]) + " "+ allArrayRowNames[bestMadeRows[1]]
                + ", " + Format.formatPer(worstMadeRowsPer[0]) + " "+ allArrayRowNames[bestMadeRows[2]] + "\r\n";
        st += "The worst Made rows were "  + Format.formatPer(bestMadeRowsPer[0]) + " "+ allArrayRowNames[worstMadeRows[0]] + ", "
