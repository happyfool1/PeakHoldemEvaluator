...
public class ReportManyHands implements Constants {
	...
	private static final Object[][] dataHHMLTurnShowdown = { { "", "", "", "", "", "", "", "", "", "" },
			...
			private static final Object[] columnsHHHLMRiverShowdown = { "HML", "No hand", "Any pair", "Two pair", "Set", "Straight",
			"Flush", "Full house", "Straight flush", "Royal flush" };

	private static final Object[][] dataHHHLMRiverShowdown = { { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" },
		...
		for (int i = 0; i < HML_FLOP_SIZE; ++i) {
			...
			for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
				if (ManyData.hmlMade[i][j] > 0) {
					...
					double per = ((double) ManyData.hhhmlMade[i][j] / (double) ManyData.hhhlmCount) * 100.0;
...
static void reportHMLShowdownRiver(int c, int r) {
	if (frame9 == null) {
		...
		tableModel9 = new DefaultTableModel(dataHHHLMRiverShowdown, columnsHHHLMRiverShowdown);
