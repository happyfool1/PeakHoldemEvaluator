...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        st += "The best Showdownw rows were " + Format.formatPer(bestShowdownwRows[0]) + " "+ allArrayRowNames[bestShowdownwRows[0]] + ", "
             + Format.formatPer(bestShowdownwRowPer[1])  + allArrayRowNames[bestShowdownwRows[1]]
            + Format.formatPer(bestShowdownwRows[2])    + ", " + allArrayRowNames[bestShowdownwRows[2]] + "\r\n";
        st += "The worst Showdown rows were " + Format.formatPer(worstShowdownRowsPer[0])+ allArrayRowNames[worstShowdownRows[0]] + ", "
