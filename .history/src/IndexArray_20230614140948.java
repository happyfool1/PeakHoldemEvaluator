...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        st += "The worstDraw cols were " + allArrayRowNames[worstDrawCols[0]] + ", "
                + allArrayRowNames[worstDrawCols[1]]
                + ", " + allArrayRowNames[worstDrawCols[2]] + "\r\n";
        st += "The bestMade cols were " + allArrayRowNames[bestMadeCols[0]] + ", " + allArrayColNames[bestMadeCols[1]]
                + ", " + allArrayRowNames[bestMadeCols[2]] + "\r\n";
        st += "The worstMade cols were " + allArrayRowNames[worstMadeCols[0]] + ", "
