...
public class HandRangeMultiple implements Constants, java.io.Serializable {
    ...
    *******************************************************************************/
    int getEVRaise(int pos, int toMe) {
        return this.rangeArrayRaise[pos][toMe].;
    }
    ...
    * Arg0 - The full path name. 
    ...
    boolean readArray(String path) {
        if (!new File(path).exists()) {
            Logger.log("ERROR HandRangeMultiple readArray() File does not exist " + path);
            return false;
        }
        // TODO
    ...
    /*- ***************************************************************************
    *	Write a HandRangeMultiple object to a disk file Arg0 - The full path name. 
    *******************************************************************************/
