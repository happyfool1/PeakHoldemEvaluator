...
public class HandRangeConverter implements Constants {
	...
	private static void copyDataPlayability() {
		...
		action.actionArrayPlayabilityCall[SB][1] = rangeSBBet3.lowPlayabilitrhyArrayIndex;
	...
	private static void copyDataCombos() {
		...
		action.actionArrayCombosCall[SB][1] = rangeSBBet3.combos;
	...
	private static void copyDataPercentage() {
		...
		action.actionArrayPercentageCall[SB][1] = rangeSBBet3.percentage;
	...
	private static void copyDataGaps() {
		...
		action.actionArrayGapsCall[SB][1] = rangeSBBet3.gaps;
