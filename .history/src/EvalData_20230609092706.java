 ...
 ******************************************************************************************** */
	...
	foldedPreflop = new int[4][PLAYERS];
	 ...
	 playerWon = new boolean[PLAYERS];  
	 	showdownValue = new int[PLAYERS];  
...
lastOrbit = new int[4];  
	 isFold = new boolean[4][PLAYERS][4]; 
	 isLimp = new boolean[4][PLAYERS][4];  
	 isCheck = new boolean[4][PLAYERS][4];  
	 isCall = new boolean[4][PLAYERS][4];  
	 isBet = new boolean[4][PLAYERS][4];  
	 isRaise = new boolean[4][PLAYERS][4];  
	 isAllin = new boolean[4][PLAYERS][4]; / 

	 raisedToBD = new BigDecimal[4][PLAYERS][4]; 
	 returnedToBD = new BigDecimal[4][PLAYERS][4];  
	 betBD = new BigDecimal[4][PLAYERS][4];  
	 callBD = new BigDecimal[4][PLAYERS][4];   
	  returnedToShowdownBD = new BigDecimal[PLAYERS];  
	  playerSidePotSplitTotalBD = new BigDecimal[PLAYERS]; 
	  playerSidePotSplitBD = new BigDecimal[PLAYERS]; 

	   boardArray = new boolean[BOARD_ARRAY_SIZE];  
 ...
 boardPossibleArrayFlop = new boolean[POSSIBLE_DRAW_SIZE];
	...
	boardComplete = false;
	 ...
	 orbit = 0;
	  ...
	  preflopBetMultiplyerOpenBD = new BigDecimal(3);; 
	  preflopBetMultiplyer3BetBD = new BigDecimal(3);; 
	  preflopBetMultiplyer4BetBD = new BigDecimal(2.5);  
	  postFlopBbetMultiplierBD = new BigDecimal(.5); 
