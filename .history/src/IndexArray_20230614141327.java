...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        st += "The bestMade cols were " + drawArrayColNames[bestMadeCols[0]] + ", " + drawArrayColNames[bestMadeCols[1]]
                + ", " + allArrayRowNames[bestMadeCols[2]] + "\r\n";
        st += "The worstMade cols were " + drawArrayColNames.equalsworstMadeCols[0]] + ", "
                + allArrayRowNames[worstMadeCols[1]]
                + ", " + allArrayRowNames[worstMadeCols[2]] + "\r\n";
        st += "The bestShowdownw cols were " + drawArrayColNames[bestShowdownwCols[0]] + ", "
                + allArrayRowNames[bestShowdownwCols[1]]
                + ", " + adrawArrayColNames[bestShowdownwCols[2]] + "\r\n";
        st += "The worstShowdown cols were " + drawArrayColNames[worstShowdownCols[0]]
                + ", " + drawArrayColNames[worstShowdownCols[1]]
                + ", " + drawArrayColNames[worstShowdownCols[2]] + "\r\n";
