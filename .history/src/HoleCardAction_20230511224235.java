    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            actionArrayPercentageTextA[i][0][0] = new JTextField(String.valueOf(actionArrayPercentage[i][0][0]));
            actionArrayPercentageTextA[i][0][0].setFont(f0);
            actionArrayPercentageTextA[i][0][0].setSize(40, 40);
            panelActionA.add(actionArrayPercentageTextA[i][0][0]);
            actionArrayPercentageTextA[i][0][1] = new JTextField(String.valueOf(actionArrayPercentage[i][0][1]));
            actionArrayPercentageTextA[i][0][1].setFont(f0);
            actionArrayPercentageTextA[i][0][1].setSize(40, 40);
            panelActionA.add(actionArrayPercentageTextA[i][0][1]);
