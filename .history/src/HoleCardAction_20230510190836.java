...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        panel0.setSize(1000, 1000);
        panel0.setFont(f0);

        JPanel panelCards = new JPanel();
        panelCards.setSize(1000, 20);
        ...
        panelLowRange.setSize(600, 20);
        panelLowRange.setFont(f0);

        JPanel panelLowPlay = new JPanel();
        panelLowPlay.setSize(600, 20);
        ...
        panelLowPlanNum.setSize(200, 20);
