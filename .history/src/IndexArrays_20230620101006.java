...
public class IndexArrays implements Constants {
	...
	* +1 because of Showdown
	 ...
	 * The value in the third index is the number of times that the hand in the second index won.
	 ************************************************************************************** */
	static int[][][] drawFlopToMade = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
	static int[][][] drawTurnToMade = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
	static int[][][] madeFlopToMade = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
	static int[][[]] madeTurnToMade = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
	static int[][][] madeRiverToMade = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
[MADE_SIZE];
	/*-  ***********************************************************************************
