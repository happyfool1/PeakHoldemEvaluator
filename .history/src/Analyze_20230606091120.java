...
class Analyze implements Constants {
	...
	***************************************************************************** */
	...
	private static void cardsAndBoardFlop(int seat) {
		...
		if (EvalData.twoPair ) {
			System.out.println("xxx  " +EvalData.board[0] + " " +EvalData.board[1] + " " +EvalData.board[2] );
 			System.out.println("xxx  " +EvalData.boardHighCardValue1 + " " +EvalData.boardHighCardValue2
			+ " " +EvalData.boardLowCardValue);
		}
	//xxx  3s Td 4d 7d 5d
	//xxx  1 2 2
		EvalData.boardHighCardValue1 = EvalData.board[0].value;
		if (EvalData.board[0].value != EvalData.board[1].value) {
			EvalData.boardHighCardValue2 = EvalData.boards[2].value;
		} else if (EvalData.board[0].value != EvalData.boardCards[2].value) {
			EvalData.boardHighCardValue2 = EvalData.boardCards[2].value;
		}
		EvalData.boardLowCardValue = EvalData.boardCards[2].value;
		...
		if (EvalData.twoPair ) {
			System.out.println("//xxx  " +EvalData.boardCards[0] + " " +EvalData.boardCards[1] + " " +EvalData.boardCards[2] 
			+ " " +EvalData.boardCards[3] + " " +EvalData.boardCards[4]);
 			System.out.println("//xxx  " +EvalData.boardHighCardValue1 + " " +EvalData.boardHighCardValue2
			+ " " +EvalData.boardLowCardValue);
		}
	...
	private static void cardsAndBoardTurn(int seat) {
		...
		EvalData.boardHighCardValue1 = EvalData.boardCards[0].value;
		if (EvalData.boardCards[0].value != EvalData.boardCards[1].value) {
			EvalData.boardHighCardValue2 = EvalData.boardCards[1].value;
		} else if (EvalData.boardCards[0].value != EvalData.boardCards[2].value) {
			EvalData.boardHighCardValue2 = EvalData.boardCards[2].value;
		} else if (EvalData.boardCards[0].value != EvalData.boardCards[3].value) {
			EvalData.boardLowCardValue = EvalData.boardCards[3].value;
		}
		EvalData.boardLowCardValue = EvalData.boardCards[3].value;
	...
	private static void cardsAndBoardRiver(int seat) {
		...
		EvalData.boardHighCardValue1 = EvalData.both[0].value;
		if (EvalData.both[0].value != EvalData.both[1].value) {
			EvalData.boardHighCardValue2 = EvalData.both[1].value;
		} else if (EvalData.both[0].value != EvalData.both[2].value) {
			EvalData.boardHighCardValue2 = EvalData.both[2].value;
		} else if (EvalData.both[0].value != EvalData.both[3].value) {
			EvalData.boardLowCardValue = EvalData.both[3].value;
		} else {
			EvalData.boardHighCardValue2 = EvalData.both[4].value;
		}
