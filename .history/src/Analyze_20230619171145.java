...
class Analyze implements Constants {
	...
	static void evaluateTurn(int seat) {
		...
		if (EvalData.madeTypeTurn[EvalData.seat] == -1) {
			System.out.println("TTT1 " + EvalData.hand[EvalData.seat].toString() + " " + EvalData.boardSet + " " + EvalData.threeOfKind + " " + EvalData.boardPair + " " + EvalData.boardTwoPair + " " +);
		...
		if (EvalData.madeTypeTurn[EvalData.seat] == -1) {
			System.out.println("TTT2 " + EvalData.hand[EvalData.seat].toString() + " " + EvalData.boardSet + " " + EvalData.threeOfKind);
			System.out.println("TTT " + EvalData.both[0] + "," + EvalData.both[1] + "," + EvalData.both[2] + ","
					+ EvalData.both[3] + "," + EvalData.both[4]);
		}
		if (r == MADE_NONE) {
