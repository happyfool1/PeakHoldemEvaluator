...
public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    ...
    void createIndexArrayRowAndColumnList() {
        ...
        madeTotalRowPerEntries.sort(Comparator.comparing(PairEntry::getPercentage));
            ...
            showdownRowTotalPerEntries.add(new PairEntry(showdownRowTotalPer[row], row));
        }
    ...
    ***************************************************************************************** */
    ...
    List<PairEntry> showdownTotalRowPerRowEntries = new ArrayList<>();
    List<PairEntry> drawTotalColPerEntries = new ArrayList<>();
    List<PairEntry> madeTotalColPerEntries = new ArrayList<>();
    List<PairEntry> showdownTotalPerColEntries = new ArrayList<>();
