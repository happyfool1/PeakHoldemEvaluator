...
public class IndexArrays implements Constants {
	...
	* +1 because of Showdown
	 ...
	 * made on the River.
	 ************************************************************************************** */
	static int[][] hmlDrawFlopToMadRiver = new int[DRAW_SIZE][MADE_SIZE];
	static int[][] hmlIndexRiverrawTurnToMadeRiver = new int[DRAW_SIZE][MADE_SIZE];
	static int[][] hmlMadeFlopToMadeRiver = new int[MADE_SIZE][MADE_SIZE];
	static int[][] hmlMadeTurnToMadeRiver = new int[MADE_SIZE][MADE_SIZE];
	static int[][] hmlMadeRiverToMadeRiver = new int[MADE_SIZE][MADE_SIZE];

	static int[][] hmlDrawTurnrawFlopToMadWon = new int[DRAW_SIZE][MADE_SIZE];
	static int[][] hmlDrawTurnToMadeWon = new int[DRAW_SIZE][MADE_SIZE];
	static int[][] hmlMadeFlopToMadeWon = new int[MADE_SIZE][MADE_SIZE];
	static int[][] hmlMadeTurnToMadeWon = new int[MADE_SIZE][MADE_SIZE];
	static int[][] hmlMmadeRiverToMadeWon = new int[MADE_SIZE][MADE_SIZE];
