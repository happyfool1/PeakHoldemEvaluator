...
public class ReportHML implements Constants {
    ...
    private static final Object[] columnsHMLMadeFlop = { "HML","No hand", "Board Pait", "Bottom Pair", "Middle Pair", "Top Pair", "Over Pair",
    ...
    private static final Object[] columnsHMLShowdownFlop = { "No hand", "Board Pait", "Bottom Pair", "Middle Pair", "Top Pair", "Over Pair",
    "Board two Pair", "Board Pair + Under Pair","Board Pair + Over Pair","Bottom 2 pair",
    "Top-Bottom 2 Pair", "Top 2 Pair", "Board Set", "Set", "Straight", "Flush", "Full house",
    "Straight flush", "Royal flush","Total" };
