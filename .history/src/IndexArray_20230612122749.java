...
/*- **************************************************************************************** 
    ...
    ***************************************************************************************** */
    ...
    /*- ***************************************************************************************** 
     * Create a String suggesting strategy
     If you missed the flop: In this case, the optimal play depends on a variety of factors such as your position, the number of opponents, their playing styles, and the betting action. You may consider bluffing if you were the pre-flop aggressor, especially if the flop is likely to have missed your opponents' ranges.

If you have a draw: On a neutral board, you may have a decent draw such as a gutshot straight draw or a flush draw. The general strategy is to continue with the hand if the pot odds justify it, possibly through a semi-bluff or a call.

If you have a pair (top pair or otherwise): With a pair on a neutral board, you should consider the strength of your pair and the potential draws available. If you have top pair with a good kicker or an overpair, you should generally bet for value. If you have a weaker pair, you might want to play more cautiously, possibly checking or calling rather than betting or raising.
     ***************************************************************************************** */
