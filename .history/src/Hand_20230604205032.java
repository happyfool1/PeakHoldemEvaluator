...
public class Hand implements Constants {
	...
	* Is this a Royal Flush
	...
	private boolean isCardsOnePair() {
		if (this.size == 5) {
			if (this.cards[0].value == this.cards[1].value) {
				F.pair1Value = this.cards[0].value;
				return true;
			}
			if (this.cards[1].value == this.cards[2].value) {
				EvalData.pair1Value = this.cards[1].value;
				return true;
			}
			if (this.cards[2].value == this.cards[3].value) {
				EvalData.pair1Value = this.cards[2].value;
				return true;
			}
			if (this.cards[3].value == this.cards[4].value) {
				EvalData.pair1Value = this.cards[3].value;
				return true;
			}
		} else if (this.size == 4) {
			if (this.cards[0].value == this.cards[1].value) {
				EvalData.pair1Value = this.cards[0].value;
				return true;
			}
			if (this.cards[1].value == this.cards[2].value) {
				EvalData.pair1Value = this.cards[1].value;
	 ...
	 * Sets pair values in EvalData.pair1Valur and EvalData.pair2Value
	 ***************************************************************************************/
	private boolean isCardsTwoPair() {
		int numPairs = 0;
		EvalData.pair1Value = this.cards[i].value;
		for (int i = 0; i < 4; i++) {
