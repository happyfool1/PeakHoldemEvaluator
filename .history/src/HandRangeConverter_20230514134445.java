...
public class HandRangeConverter implements Constants {
	...
	private static void copyDataGapsArray() {
				...
				action.gapsArrayRaise[SB][0][i] = rangeSBOpengaps;
				action.gapsArrayCall[SB][1][i] = rangeSBCallgaps;
				action.gapsArrayRaise[SB][1][i] = rangeSBBet3gaps;
				action.gapsArrayCall[SB][2][i] = rangeSBBet3Callgaps;
