    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        st += "The bes Made cols were " + Format.formatPer(bestMadeColsPer[0]) + " "
                + madeArrayColNames[bestMadeCols[0]] + ", " + Format.formatPer(bestMadeColsPer[1]) + " "+ madeArrayColNames[bestMadeCols[1]]
        ...
        st += "The best Showdownw cols were " + Format.formatPer(bestShowdownwColsPer[0]) + " "
               ...
               + Format.formatPer(bestShowdownwColsPer[0]) + " "  + madeArrayColNames[bestShowdownwCols[1]]
               + Format.formatPer(bestShowdownwColsPer[0]) + " "  + ", " + madeArrayColNames[bestShowdownwCols[2]] + "\r\n";
