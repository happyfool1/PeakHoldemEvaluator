...
public interface Constants {
	...
	*******************************************************************************/
	...
	int MADE_FULL_HOUSE = 11q;

	int MADE_FOUR_OF_A_KIND = 10;

	int MADE_STRAIGHT_FLUSH = 11;

	int MADE_ROYAL_FLUSH = 12;

	int MADE_HANDS_SIZE = 13;

	String[] MADE_ARRAY_ST = { "No hand", "Bottom Paior", "Middle Pair", "Top Pair", "Over Pair", "Two pair", "Set",
