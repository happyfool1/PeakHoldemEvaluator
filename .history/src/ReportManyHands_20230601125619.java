...
public class ReportManyHands implements Constants {
	...
	private static final Object[] columnsHHMLDraw = { "HML", "No draw", "Gutshot",
			"Straight", "OESD", "Flush", "Flush OESD" };
	...
	private static final Object[][] dataHHHMLMade = { { "", "", "", "", "", "", "", "", "", "" },
			...
			private static final Object[] columnsHMLFlopShowdown = { "HML", "No hand", "Any pair", "Two pair", "Set", "Straight",
			"Flush", "Full house", "Straight flush", "Royal flush" };

		private static final Object[][] dataHMLFlopShowdown = { { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" },
			...
			private static final Object[] columnsHHMLTurnShowdown = { "HML", "No hand", "Any pair", "Two pair", "Set", "Straight",
			"Flush", "Full house", "Straight flush", "Royal flush" };

	private static final Object[][] dataHHMLTurnShowdown = { { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" },
			...
			private static final Object[] columnsHHHMLRiverShowdown = { "HML", "No hand", "Any pair", "Two pair", "Set", "Straight",
			"Flush", "Full house", "Straight flush", "Royal flush" };

	private static final Object[][] dataHHHMLRiverShowdown = { { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" }, { "", "", "", "", "", "", "", "", "", "" },
			{ "", "", "", "", "", "", "", "", "", "" },
...
********************************************************************************** */
	static void reportHMLShowdownFlop(int c, int r) {
		if (frame7 == null) {
			...
			tableModel7 = new DefaultTableModel(dataHMLFlopShowdown , columnsHMLFlopShowdown );
		...
		for (int i = 0; i < HML_FLOP_SIZE; ++i) {
			...
			for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
				if (ManyData.hmlMade[i][j] > 0) {
					table7.setValueAt("   " + String.valueOf(ManyData.hmlShowdown[i][j]), row, col);
					double per = ((double) ManyData.hmlShowdown[i][j] / (double) ManyData.hmlCount) * 100.0;
...
static void reportHMLShowdownTurn(int c, int r) {
	if (frame8 == null) {
		...
		tableModel8 = new DefaultTableModel(dataHHMLTurnShowdown , columnsHHMLTurnShowdown );
	...
	for (int i = 0; i < HML_FLOP_SIZE; ++i) {
		...
		for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
			if (ManyData.hmlMade[i][j] > 0) {
				table8.setValueAt("   " + String.valueOf(ManyData.hhhmlShowdown[i][j]), row, col);
				double per = ((double) ManyData.hhhmlShowdown[i][j] / (double) ManyData.hhhmlCount) * 100.0;
...
static void reportHMLShowdownRiver(int c, int r) {
	if (frame9 == null) {
		...
		tableModel9 = new DefaultTableModel(dataHHHMLRiverShowdown, columnsHHHMLRiverShowdown);
	...
	for (int i = 0; i < HML_FLOP_SIZE; ++i) {
		...
		for (int j = 0; j < MADE_HANDS_SIZE; ++j) {
			if (ManyData.hmlMade[i][j] > 0) {
				table9.setValueAt("   " + String.valueOf(ManyData.hhhmlShowdown[i][j]), row, col);
				double per = ((double) ManyData.hhhmlShowdown[i][j] / (double) ManyData.hhhmlCount) * 100.0;
