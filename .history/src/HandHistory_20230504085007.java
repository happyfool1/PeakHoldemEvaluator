...
class HandHistory implements Constants {
	...
	*  stackBD = new BigDecimal[PLAYERS];
	*  playerMainPotBD = new BigDecimal[PLAYERS];
	*  stackPreflopBD = new BigDecimal[PLAYERS];
	...
	*  returnedToShowdownBD = new BigDecimal[PLAYERS]; // Indexed by street,seat,orbit TODO
	 *  playerSidePotSplitTotalBD = new BigDecimal[PLAYERS]; // Indexed by street,seat,orbit TODO
	 *  playerSidePotSplitBD = new BigDecimal[PLAYERS]; // Indexed by street,seat,orbit TODO
	* [] potStart$ = new BigDecimal[4][4];
	* [] potEnd$ = new BigDecimal[4][4];
