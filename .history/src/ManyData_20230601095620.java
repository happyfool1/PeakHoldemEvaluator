...
public class ManyData implements Constants {
	...
	static void initialize() {
		...
		sumOfShowdownCount = 0;
		  ...
		  boardArrayRiverCount = 0;
			...
			// Showdown
		 showdownCount = 0;
		static int[] winningHand = new int[MADE_HANDS_SIZE]; // ?? TODO
	...
	* Number of hands counted, not games
	...
	private static int flopIndexCount = 0;
	private static int handValueCount = 0;
	private static int sumOfDrawCount = 0;
	private static int sumOfMadeCount = 0;
	private static int sumOfShowdownCount = 0;
	private static int boardArrayFlopCount = 0;
	private static int boardArrayTurnCount = 0;
	private static int boardArrayRiverCount = 0;
	private static int flopArraysCount = 0;
