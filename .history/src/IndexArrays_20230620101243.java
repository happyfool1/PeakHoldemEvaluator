...
public class IndexArrays implements Constants {
	...
	* +1 because of Showdown
	...
	/*-  ************************************************************************************
	 * Hand that was made from draw or made hand by River and won showdown
	 * Indexes are:
	 * 		Player number
	 * 		Made hand or Draw on ( Flop, Turn, River )
	 * 		Made hand that won showdown
	 * The value in the third index is the number of times that the hand in the second index was
	 * made on the River.
	 ************************************************************************************** */
	static int[][][] drawFlopToMadRiver = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
	static int[][][] drawTurnToMadeRiver = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
	static int[][][] madeFlopToMadeRiver = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
	static int[][][] madeTurnToMadeRiver = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
	static int[][][] madeRiverToMadeRiver = new int[PLAYERS][MADE_SIZE][MADE_SIZE];

static int[][][] drawFlopToMadWon = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
	static int[][][] drawTurnToMadeWon = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
	static int[][][] madeFlopToMadeWon = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
	static int[][][] madeTurnToMadeWon = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
	static int[][][] madeRiverToMadeWon = new int[PLAYERS][MADE_SIZE][MADE_SIZE];
