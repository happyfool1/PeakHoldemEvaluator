...
public class HandRangeConverter implements Constants {
	...
	private static void copyDataGaps() {
		for (int i = 0; i < 5; i++) {
	        ...
	        action.gapsArrayCall[SB][i] = rangeSBLimp.gapsArray[i];
			...
			action.gapsArrayRaise[CO][i] = rangeCOAllinCall.gapsArray[i];
			action.gapsArrayRaise[BU][i] = rangeBULimp.gapsArray[i];
			action.gapsArrayRaise[BU][i] = rangeBUOpen.gapsArray[i];
			action.gapsArrayRaise[BU][i] = rangeBUCall.gapsArray[i];
			action.gapsArrayRaise[BU][i] = rangeBUBet3.gapsArray[i];
			action.gapsArrayRaise[BU][i] = rangeBUBet3Call.gapsArray[i];
			action.gapsArrayRaise[BU][i] = rangeBUBet4.gapsArray[i];
			action.gapsArrayRaise[BU][i] = rangeBUBet4Call.gapsArray[i];
			action.gapsArrayRaise[BU][i] = rangeBUAllin.gapsArray[i];
			action.gapsArrayRaise[BU][i] = rangeBUAllinCall.gapsArray[i];
		}
	}
}
