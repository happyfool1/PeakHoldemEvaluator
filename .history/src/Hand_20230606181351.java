...
public class Hand implements Constants {
	...
	* Returns MADE_BOTTOM_TWO_PAIR, MADE_TOP_AND_BOTTOM_TWO_PAIR, or MADE_TOP_TWO_PAIR
	...
	such as three-of-a-kind or full houses, so a simple pair or two pair hand is often much weaker in relative terms. Always consider the whole board texture, the possible hands your opponents could have, and the betting action when determining the strength of your hand.
