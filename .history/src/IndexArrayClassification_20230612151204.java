...
Low: All three cards have different suits, indicating low potential for a flush.
  ******************************************************************************/
	    public static int flopTextureDistributionFlushPotential(Card[] cards) {
        if (cards.length != 3) {
            throw new IllegalArgumentException("Flop must contain exactly 3 cards");
        }
        ...
        } else if (cards[0].rank == cards[1].rank || cards[1].rank == cards[2].rank || cards[0].rank == cards[2].rank) {
