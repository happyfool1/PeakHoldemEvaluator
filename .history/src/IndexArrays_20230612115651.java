...
static int[][] drawFlopToMade = new int[PLAYERS][MADE_SIZE];
	...
	static int[][] drawRiverToMade = new int[PLAYERS][MADE_SIZE];
	static int[][] madeFlopToDraw = new int[PLAYERS][DRAW_SIZE];
	static int[][] madeTurnToDraw = new int[PLAYERS][DRAW_SIZE];
	static int[][] madeRiverToDraw = new int[PLAYERS][DRAW_SIZE];
