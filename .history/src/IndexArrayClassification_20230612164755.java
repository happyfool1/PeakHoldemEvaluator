...
public class IndexArrayClassification implements Constants {
	...
	* Characterizing a flop can be done in many ways depending on what is important to the player.
	...
	medium (no face cards, but one or more cards 8 through 10), or low (all cards 7 or lower). This could be important if you have hole cards that match these categories.
