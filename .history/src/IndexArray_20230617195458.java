...
public class IndexArray implements Constants {
    ...
    ****************************************************************************** */
    IndexArray(intzzz[][] drawArray, int[][] madeArray, int[][] showdownArray, String[] rowNames, String[] drawColNames,
            String[] madeColNames) {
        ...
        System.out.println("zzz " + madeArray[4][0] + " " +  madeArray[4][2]);
    ...
    ***************************************************************************************** */
    private void copyArrays() {
        ...
        System.out.println("AAA " + this.showdownArrayPer[4][0] + " " + this.showdownSumOfAllValuesPer);   
        for (int i = 0; i < this.showdownArray.length; i++) {
            for (int j = 0; j < this.showdownArray[0].length; j++) {
