...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        Border bet4 = BorderFactory.createTitledBorder("4 Bet Call    Playability, Percentage, Combos, Gaps");
        Border bet4Call = BorderFactory.createTitledBorder("4 Bet     Playability, Percentage, Combos, Gaps");
      ...
      for (int i = 0; i < POSITIONS; ++i) {
          bet3Text[i][0] = new JTextField(String.valueOf(actionArrayPlayabilityRaise[i][0]));
          bet3Text[i][0].setFont(f0);
          bet3Text[i][0].setSize(40, 40);
          panelBet3.add(bet3Text[i][0]);
      }
      for (int i = 0; i < POSITIONS; ++i) {
            bet3Text[i][1] = new JTextField(Format.formatPer(actionArrayPercentageRaise[i][0] ));
          bet3Text[i][1].setFont(f0);
          bet3Text[i][1].setSize(40, 40);
          panelBet3.add(bet3Text[i][1]);
      }
      for (int i = 0; i < POSITIONS; ++i) {
          bet3Text[i][2] = new JTextField(String.valueOf(actionArrayCombosRaise[i][0]));
     ...
     for (int i = 0; i < POSITIONS; ++i) {
         bet3CallText[i][0] = new JTextField(String.valueOf(actionArrayPlayabilityCall[i][0]));
         bet3CallText[i][0].setFont(f0);
         bet3CallText[i][0].setSize(40, 40);
         panelBet3Call.add(bet3CallText[i][0]);
     }
     for (int i = 0; i < POSITIONS; ++i) {
           bet3CallText[i][1] = new JTextField(Format.formatPer(actionArrayPercentageCall[i][0] ));
         bet3CallText[i][1].setFont(f0);
         bet3CallText[i][1].setSize(40, 40);
         panelBet3Call.add(bet3CallText[i][1]);
     }
     for (int i = 0; i < POSITIONS; ++i) {
         bet3CallText[i][2] = new JTextField(String.valueOf(actionArrayCombosCall[i][0]));
         bet3CallText[i][2].setFont(f0);
         bet3CallText[i][2].setSize(40, 40);
         panelBet3Call.add(bet3CallText[i][2]);
     }
     for (int i = 0; i < POSITIONS; ++i) {
         bet3CallText[i][3] = new JTextField(String.valueOf(actionArrayGapsRaise[i][0]));
    ...
    for (int i = 0; i < POSITIONS; ++i) {
        bet4Text[i][0] = new JTextField(String.valueOf(actionArrayPlayabilityRaise[i][0]));
        bet4Text[i][0].setFont(f0);
        bet4Text[i][0].setSize(40, 40);
        panelBet4.add(bet4Text[i][0]);
    }
    for (int i = 0; i < POSITIONS; ++i) {
          bet4Text[i][1] = new JTextField(Format.formatPer(actionArrayPercentageRaise[i][0] ));
        bet4Text[i][1].setFont(f0);
        bet4Text[i][1].setSize(40, 40);
        panelBet4.add(bet4Text[i][1]);
    }
    for (int i = 0; i < POSITIONS; ++i) {
        bet4Text[i][2] = new JTextField(String.valueOf(actionArrayCombosRaise[i][0]));
        bet4Text[i][2].setFont(f0);
        bet4Text[i][2].setSize(40, 40);
        panelBet4.add(bet4Text[i][2]);
    }
    for (int i = 0; i < POSITIONS; ++i) {
        bet4Text[i][3] = new JTextField(String.valueOf(actionArrayGapsRaise[i][0]));
   ...
   for (int i = 0; i < POSITIONS; ++i) {
       bet4CallText[i][0] = new JTextField(String.valueOf(actionArrayPlayabilityCall[i][0]));
       bet4CallText[i][0].setFont(f0);
       bet4CallText[i][0].setSize(40, 40);
       panelBet4Call.add(bet4CallText[i][0]);
   }
   for (int i = 0; i < POSITIONS; ++i) {
         bet4CallText[i][1] = new JTextField(Format.formatPer(actionArrayPercentageCall[i][0] ));
       bet4CallText[i][1].setFont(f0);
       bet4CallText[i][1].setSize(40, 40);
       panelBet4Call.add(bet4CallText[i][1]);
   }
   for (int i = 0; i < POSITIONS; ++i) {
       bet4CallText[i][2] = new JTextField(String.valueOf(actionArrayCombosCall[i][0]));
       bet4CallText[i][2].setFont(f0);
       bet4CallText[i][2].setSize(40, 40);
       panelBet4Call.add(bet4CallText[i][2]);
   }
   for (int i = 0; i < POSITIONS; ++i) {
       bet4CallText[i][3] = new JTextField(String.valueOf(actionArrayGapsCall[i][0]));
  ...
  for (int i = 0; i < POSITIONS; ++i) {
      allinText[i][0] = new JTextField(String.valueOf(actionArrayPlayabilityRaise[i][0]));
      allinText[i][0].setFont(f0);
      allinText[i][0].setSize(40, 40);
      panelAllin.add(allinText[i][0]);
  }
  for (int i = 0; i < POSITIONS; ++i) {
        allinText[i][1] = new JTextField(Format.formatPer(actionArrayPercentageRaise[i][0] ));
      allinText[i][1].setFont(f0);
      allinText[i][1].setSize(40, 40);
      panelAllin.add(allinText[i][1]);
  }
  for (int i = 0; i < POSITIONS; ++i) {
      allinText[i][2] = new JTextField(String.valueOf(actionArrayCombosRaise[i][0]));
      allinText[i][2].setFont(f0);
      allinText[i][2].setSize(40, 40);
      panelAllin.add(allinText[i][2]);
  }
  for (int i = 0; i < POSITIONS; ++i) {
      allinText[i][3] = new JTextField(String.valueOf(actionArrayGapsRaise[i][0]));
 ...
 for (int i = 0; i < POSITIONS; ++i) {
     allinCallText[i][0] = new JTextField(String.valueOf(actionArrayPlayabilityRaise[i][0]));
     allinCallText[i][0].setFont(f0);
     allinCallText[i][0].setSize(40, 40);
     panelAllinCall.add(allinCallText[i][0]);
 }
 for (int i = 0; i < POSITIONS; ++i) {
       allinCallText[i][1] = new JTextField(Format.formatPer(actionArrayPercentageRaise[i][0] ));
     allinCallText[i][1].setFont(f0);
     allinCallText[i][1].setSize(40, 40);
     panelAllinCall.add(allinCallText[i][1]);
 }
 for (int i = 0; i < POSITIONS; ++i) {
     allinCallText[i][2] = new JTextField(String.valueOf(actionArrayCombosRaise[i][0]));
     allinCallText[i][2].setFont(f0);
     allinCallText[i][2].setSize(40, 40);
     panelAllinCall.add(allinCallText[i][2]);
 }
 for (int i = 0; i < POSITIONS; ++i) {
     allinCallText[i][3] = new JTextField(String.valueOf(actionArrayGapsRaise[i][0]));
