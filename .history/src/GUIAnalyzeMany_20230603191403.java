...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    *******************************************************************************/
    public void myFrame() {
        ...
        hhmlDrawTurn.setFont(fs);
        hhmlDrawTurn.setPreferredSize(new Dimension(20, 20));
        hhmlDrawTurn.addActionListener(this);
        hhmlDrawTurn.setSelected(true);
        panelCheckBoxesHHML.add(hhmlDrawTurn);

        hhmlMadeTurn.setFont(fs);
        hhmlMadeTurn.setPreferredSize(new Dimension(20, 20));
        hhmlMadeTurn.addActionListener(this);
        hhmlMadeTurn.setSelected(true);
        panelCheckBoxesHHML.add(hhmlMade);

        hhmlShowdownTurn.setFont(fs);
        hhmlShowdownTurn.setPreferredSize(new Dimension(20, 20));
        hhmlShowdownTurn.addActionListener(this);
        hhmlShowdownTurn.setSelected(true);
        panelCheckBoxesHHML.add(hhmlShowdownTurn);

        hhhmlDraw.setFont(fs);
        hhhmlDraw.setPreferredSize(new Dimension(20, 20));
        hhhmlDraw.addActionListener(this);
        hhhmlDraw.setSelected(false);
        panelCheckBoxesHHHML.add(hhhmlDraw);

        hhhmlMadeRiver.setFont(fs);
        hhhmlMadeRiver.setPreferredSize(new Dimension(20, 20));
        hhhmlMadeRiner.addActionListener(this);
        hhhmlMadeRiver.setSelected(false);
        panelCheckBoxesHHHML.add(hhhmlMadeRiver);

        hhhmlShowdownRiver.setFont(fs);
        hhhmlShowdownRiver.setPreferredSize(new Dimension(20, 20));
        hhhmlShowdownRiver.addActionListener(this);
        hhhmlShowdownRiver.setSelected(false);
        panelCheckBoxesHHHML.add(hhhmlShowdownRiver);

        typeDraw.setFont(fs);
        typeDraw.setPreferredSize(new Dimension(20, 20));
        typeDraw.addActionListener(this);
        typeDraw.setSelected(false);
        panelCheckBoxesType.add(typeDraw);

        typeMade.setFont(fs);
        typeMade.setPreferredSize(new Dimension(20, 20));
        typeMade.addActionListener(this);
        typeMade.setSelected(false);
        panelCheckBoxesType.add(typeMade);

        typeShowdown.setFont(fs);
        typeShowdown.setPreferredSize(new Dimension(20, 20));
        ...
        sumOfShowdown.setPreferredSize(new Dimension(20, 20));
        ...
        wetDryShowdown.setPreferredSize(new Dimension(20, 20));
    ...
    * a radio button or control button.
    ...
    private void doSimulationDataCollection() {
        ...
        if (hmlShowdownFlop.isSelected()) {
            // ReportHML.reportHMLShowdownWonFlop(150, 150);
        }
