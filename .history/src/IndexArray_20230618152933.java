    ...
    ***************************************************************************************** */
    private String stringStrategy() {
        ...
        st += "The bes Made cols were " + Format.formatPer(bestMadeColsPer[0]) + " "
                + madeArrayColNames[bestMadeCols[0]] + ", " + Format.formatPer(bestMadeColsPer[0]) + " "+ madeArrayColNames[bestMadeCols[1]]
                + ", " + Format.formatPer(bestMadeColsPer[0]) + " "+ madeArrayColNames[bestMadeCols[2]] + "\r\n";
