	...
	*
	...
	private int doPairs() {
		...
		if (EvalData.threeOfKind && isSet()) {
			System.out.println("Set1 " + this.cards[0] + this.cards[1] + this.cards[2] + this.cards[3] + this.cards[4] + " " + EvalData.threeOfKind );
		}
		return MADE_NONE;
	}
	...
	private int boardPairs() {
		...
		if (EvalData.boardSet && isSet()) {
				...
				System.out.println(
						"Set2 " + this.cards[0] + this.cards[1] + this.cards[2] + this.cards[3] + this.cards[4] + " " + EvalData.boardSet);
