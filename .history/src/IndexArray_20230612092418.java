...
public class IndexArray implements Constants {
    ...
    ****************************************************************************** */
    IndexArray(int[][] drawArray, int[][] madeArray, int[][] showdownArray, String[] rowNames) {
        ...
        this.showdownRowTotaSortedPer = new double[this.showdownArray.length];
        ...
        this.showdownColTotaSortedPer = new double[this.showdownArray[0].length];
...
// same as above but sorted 
    ...
    double[] showdownRowTotaSortedPer;
