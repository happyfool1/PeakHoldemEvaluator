...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    *******************************************************************************/
    public void myFrame() {
        ...
        Border SumOfBoardBoardCardsBorderFlop = BorderFactory.createTitledBorder("Wet Dry Reports");
        panelCheckBoxesSumOfBoardCardsFlop.setBorder(sumOfBoardCardsBorder);
