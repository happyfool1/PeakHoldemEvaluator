...
0public class IndexArray implements Constants {
    ...
    ***************************************************************************************** */
    void findBestAndWorst() {
       ...
       bestDrawRows[2] = drawTotalRowPerEntries.get(drawTotalRowPerEntries.size() -3).getRowOrCol();
        ...
        worstMadeRows[2] = madeTotalRowPerEntries.get(drawTotalRowPerEntries.size() -3).getRowOrCol();
        bestShowdownwRows[2] = showdownTotalRowPerEntries.get(0).getRowOrCol();
        worstShowdownRows[2] = showdownTotalRowPerEntries.get(drawTotalRowPerEntries.size() -3).getRowOrCol();
        bestDrawCols[2] = drawTotalColPerEntries.get(0).getRowOrCol();
        worstDrawCols[2] = drawTotalColPerEntries.get(drawTotalColPerEntries.size() -3).getRowOrCol();
        bestMadeCols[2] = madeTotalColPerEntries.get(0).getRowOrCol();
        worstMadeCols[2] = madeTotalColPerEntries.get(drawTotalColPerEntries.size() -3).getRowOrCol();
        bestShowdownwCols[2] = showdownTotalColPerEntries.get(0).getRowOrCol();
        worstShowdownCols[2] = showdownTotalColPerEntries.get(drawTotalColPerEntries.size() -3).getRowOrCol();
