...
this.dataMadeArray = madeArray;
this.showdownArrayArray = showdownArray;
this.drawArraySorted = drawArray;
this.dataMadeArraySorted = madeArray;
this.showdownArrayArraySorted = showdownArray;
Arrays.sort(drawArraySorted);
Arrays.sort(madeArraySorted);
Arrays.sort(showdownArrayArray);
