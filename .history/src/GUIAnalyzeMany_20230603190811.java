...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private static final JCheckBox  hmlDrawFlop = new JCheckBox("HHML Turn Draw");
    private static final JCheckBox   hmlDrawTurn JCheckBox(= new JCheckBox("HML Turn Made Hand");
