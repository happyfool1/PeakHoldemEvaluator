...
public class IndexArrays implements Constants {
	...
	* +1 because of Showdown
	...
	static int[][] drawTurnToMade = new int[PLAYERS][DRAW_SIZE];
	static int[][] madeFlopToMade = new int[PLAYERS][MADE_SHORT_SIZE];
	static int[][] madeTurnToMade = new int[PLAYERS][MADE_SHORT_SIZE];
	static int[][] madeRiverToMade = new int[PLAYERS][MADE_SHORT_SIZE];
