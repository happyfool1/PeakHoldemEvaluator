...
public interface Constants {
	...
	*******************************************************************************/
	...
	int HAVE_FLUSH_OESD_DRAW = 9;
	int HAVE_BOTTOM_PAIR = 12;
	int HAVE_MIDDLE_PAIR = 13;
	int HAVE_TOP_PAIR = 14;
	int HAVE_OVER_PAIR = 15;
	int HAVE_BOARD_PAIR_PLUS_UNDER_PAIR = 15;
int HAVE_BOARD_PAIR_PLUS_UNDER_PAIR = 7;

	int HAVE_BOARD_PAIR_PLUS_OVER_PAIR = 8;

	int HAVE_BOTTOM_TWO_PAIR = 9;

	int HAVE_TOP_AND_BOTTOM_TWO_PAIR = 10;

	int HAVE_TOP_TWO_PAIR = 11;

	int HAVE_BOARD_SET = 12;

	int HAVE_SET = 13;

	int HAVE_STRAIGHT = 14;
