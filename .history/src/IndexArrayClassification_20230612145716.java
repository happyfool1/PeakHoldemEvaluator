 ...
 ***************************************************************************** */
   private static void flopTextureStrengthSuitedness() {
        ...
        int maxRank = Math.max(EvalData.board[0].rank, Math.max(EvalData.board[1].rank, EvalData.board[2].rank));
        ...
        } else if (EvalData.board[0].suit == EvalData.board[1].suit || EvalData.board[1].suit == EvalData.board[2].suit || EvalData.board[0].suit == cards[2].suit) {
