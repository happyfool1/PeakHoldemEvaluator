    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            panelActionA.add(actionArrayPlayabilityTextD[i][0][0]);
            actionArrayPlayabilityTextD[i][1][1] = new JTextDField(String.valueOf(actionArrayPlayability[i][3][1]));
            actionArrayPlayabilityTextD[i][1][1].setFont(f0);
            actionArrayPlayabilityTextD[i][1][1].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextD[i][10][1]);
        }
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            actionArrayPlayabilityTextE[i][04][0] = new JTextEField(String.valueOf(actionArrayPlayability[i][4][0]));
