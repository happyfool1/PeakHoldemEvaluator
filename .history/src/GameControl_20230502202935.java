...
public class GameControl implements Constants {
	...
	*******************************************************************************/
	...
	private static final int[] flopCountPos = new int[PLAYERS];
	private static final int[] turnCountPos = new int[PLAYERS];
	private static final int[] riverCountPos = new int[PLAYERS];
	...
	**************************************************************************** */
	...
	static double run(int numGames) {
		games = EvalData.gamesInASession;
		played = EvalData.handsToPlay;
		startGame();
		--played;
		return 0;
	}
	...
	*******************************************************************************/
	 ...
	 *  With side pots that is more complex and we use PotAndSidePots.streetComplete()
	 *  Return true if street done.
	 **************************************************************************** */
