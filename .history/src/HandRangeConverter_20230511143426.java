...
public class HandRangeConverter implements Constants {
	...
	private static void copyData2() {
		...
		action.actionArray[SB][3][0] = rangeSBBet4.lowPlayabilitrhyArrayIndex;
		action.actionArray[SB][3][1] = rangeSBBet4Call.lowPlayabilitrhyArrayIndex;
		...
		action.actionArray[BB][3][0] = rangeBBBet4.lowPlayabilitrhyArrayIndex;
		action.actionArray[BB][3][1] = rangeBBBet4Call.lowPlayabilitrhyArrayIndex;
		...
		action.actionArray[UTG][3][0] = rangeUTGBet4.lowPlayabilitrhyArrayIndex;
		action.actionArray[UTG][3][1] = rangeUTGBet4Call.lowPlayabilitrhyArrayIndex;
		...
		action.actionArray[MP][3][0] = rangeMPBet4.lowPlayabilitrhyArrayIndex;
		action.actionArray[MP][3][1] = rangeMPBet4Call.lowPlayabilitrhyArrayIndex;
		...
		action.actionArray[CO][3][0] = rangeCOBet4.lowPlayabilitrhyArrayIndex;
		action.actionArray[CO][3][1] = rangeCOBet4Call.lowPlayabilitrhyArrayIndex;
		...
		action.actionArray[BU][3][0] = rangeBUBet4.lowPlayabilitrhyArrayIndex;
		action.actionArray[BU][3][1] = rangeBUBet4Call.lowPlayabilitrhyArrayIndex;
