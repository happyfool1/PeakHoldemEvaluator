...
public class IndexArrayClassification implements Constants {
	...
	* Characterizing a flop can be done in many ways depending on what is important to the player.
	...
	This is a highly unusual flop and immediately completes four-of-a-kind for anyone holding a card of the same rank. It also makes full houses possible for all players still in the hand.
