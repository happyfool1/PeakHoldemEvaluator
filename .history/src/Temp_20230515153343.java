...
your bet size. On dry, unconnected flops (e.g., K-7-2 rainbow), you can use smaller
 bet sizes (around 1/3 to 1/2 of the pot) because it's less likely that your opponent has connected with the board. On wet, coordinated flops (e.g., Q-J-10 with two suited cards), larger bet sizes (around 2/3 to full pot) are more appropriate to charge your opponents for drawing to better hands.
