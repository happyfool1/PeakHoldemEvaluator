...
public class IndexArrayUpdate implements Constants {
	...
	for (int i = 0; i < PLAYERS; i++) {
			if (!EvalData.playerFolded[i] ) {
				System.out.println("XXX " + i + " " + EvalData.hmlIndexFlop + " " +EvalData.madeTypeFlop[i] + " " + EvalData.showdownHand[i]l);
				++IndexArrays.hmlMadeFlopToMadeRiver[EvalData.hmlIndexFlop][EvalData.madeTypeFlop[i]][EvalData.showdownHand[i]];
