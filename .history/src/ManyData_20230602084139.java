...
public class ManyData implements Constants {
	...
	* +1 because of Showdown
	...
	static int[][] hmlShowdownMade = new int[HML_FLOP_SIZE][MADE_HANDS_SIZE];
	...
	static int[][] hhmlShowdownMade = new int[HML_TURN_SIZE][MADE_HANDS_SIZE];
	...
	static int[][] hhhmlShowdownMade = new int[HML_RIVER_SIZE][MADE_HANDS_SIZE];
