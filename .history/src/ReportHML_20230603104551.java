...
public class ReportHML implements Constants {
    ...
    ********************************************************************************** */
    ...
    /*-********************************************************************************
     * Search through JTable for largest values and sett color of cell
    ***********************************************************************************/
    public void createAndShowGUI(Object[] columns, Object[][] data) {
        ...
        JTable table = new JTable(data, columns){
            ...
            public Component prepareRenderer(TableCellRenderer renderer, int row, int column) {
                ...
                if (contains(largestCells, row, column)) {
    ...
    private static boolean contains(PriorityQueue<Cell> cells, int row, int column) {
        for (Cell cell : cells) {
