    ...
    *******************************************************************************/
    public void myFrame() {
       ...
       panelCheckBoxesIndexFlop.add(indexDrawFlop);
        ...
        sumOfHoleCardsDrawFlop.setBackground(IVORY);
        ...
        sumOfHoleCardsMadeFlop.setBackground(IVORY);
        ...
        sumOfHoleCardsShowdownFlop.setBackground(IVORY);
        panelCheckBoxesSumOfHoleCardsFlop.add(sumOfHoleCardsShowdownFlop);
        panelCheckBoxesSumOfHoleCardsFlop.setBackground(IVORY);
        ...
        sumOfBoardCardsDrawFlop.setBackground(DARK_GRAY );
        ...
        sumOfBoardCardsMadeFlop.setBackground(DARK_GRAY );
        ...
        sumOfBoardCardsShowdownFlop.setBackground(DARK_GRAY );
        panelCheckBoxesSumOfBoardCardsFlop.add(sumOfBoardCardsShowdownFlop);
        panelCheckBoxesSumOfBoardCardsFlop.setBackground(DARK_GRAY );
        ...
        typeOf1755DrawFlop.setBackground(GOLDEN_ROD );
        ...
        typeOf1755MadeFlop.setBackground(GOLDEN_ROD );
        ...
        typeOf1755ShowdownFlop.setBackground(GOLDEN_ROD );
        panelCheckBoxesTypeOf1755Flop.add(typeOf1755ShowdownFlop);
        panelCheckBoxesTypeOf1755Flop.setBackground(GOLDEN_ROD );

        indexDrawFlop.setFont(fs);
        indexDrawFlop.setPreferredSize(new Dimension(20, 20));
        indexDrawFlop.addActionListener(this);
        indexDrawFlop.setSelected(false);
        indexDrawFlop.setBackground(LIGHT_CORAL);
        panelCheckBoxesIndexFlop.add(indexDrawFlop);
        ...
        indexMadeFlop.addActionListener(this);
        indexMadeFlop.setSelected(false);
        indexMadeFlop.setBackground(LIGHT_CORAL);
        panelCheckBoxesIndexFlop.add(indexMadeFlop);
        panelCheckBoxesIndexFlop.setBackground(LIGHT_CORAL);

        indexShowdownFlop.setFont(fs);
        indexShowdownFlop.setPreferredSize(new Dimension(20, 20));
        indexShowdownFlop.addActionListener(this);
        indexShowdownFlop.setSelected(false);
        indexShowdownFlop.setBackground(LIGHT_CORAL);
        panelCheckBoxesIndexFlop.add(indexShowdownFlop);
