...
/*- **************************************************************************** 
	...
	******************************************************************************************* */
	...
	/*-
		 ...
		 *  Rules uses opponent actions, RULE_Check, RULE_BET1,
		 * RULE_BET2. RULE_BET3, RULE_BET4, RULE_ALLIN 
	...
	private static void getRulePLay() {
		...
		if (EvalData.seat == first) {
			if (EvalData.foldCount - EvalData.PLAYERS == 2) {
				...
				// rulePlay =
				// EvalData.strategy[stratIndex].riverFirstRULE_ruleArray[handValue[EvalData.seat]][EvalData.betType];
				return;
			}
			// Not heads up
