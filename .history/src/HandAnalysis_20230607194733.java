...
public class HandAnalysis implements Constants {
	...
	*******************************************************************************/
	private static void doBoard3() {
		...
		// ssx xss
		suit = EvalData.boardCards[0].suit;
		if (suit == EvalData.boardCards[1].suit && suit != EvalData.boardCards[2].suit) {
			EvalData.boardArray[BOARD_2F] = true;
			EvalData.boardF2 = true;
		} else {
			suit = EvalData.boardCards[1].suit;
			if (suit != EvalData.boardCards[0].suit && suit == EvalData.boardCards[2].suit) {
				EvalData.boardArray[BOARD_2F] = true;
				EvalData.boardF2 = true;
			}
		}
	...
	*******************************************************************************/
	private static void doBoard4() {
		...
		if (EvalData.board[0].value == EvalData.board[1].value && EvalData.board[0].value == EvalData.board[2].value){
			EvalData.boardArray[BOARD_SET] = true;
			EvalData.boardSet = true;
			EvalData.madeArray[BOARD_SET] = true;
			EvalData.boardSetValue = EvalData.board[0].value;
		}else
		if(EvalData.board[1].value == EvalData.board[2].value	&& EvalData.board[1].value == EvalData.board[3].value) {
							EvalData.boardArray[BOARD_SET] = true;
							EvalData.madeArray[BOARD_SET] = true;
							EvalData.boardSetValue = EvalData.board[0].value;
						EvalData.boardSet = true;
	...
	if(!(EvalData.boardCards[0].suit!=EvalData.boardCards[1].suit&&EvalData.boardCards[0].suit!=EvalData.boardCards[2].suit&&EvalData.boardCards[1].suit!=EvalData.boardCards[2].suit&&EvalData.boardCards[3].suit!=EvalData.boardCards[3].suit))
	{
		return;
	}
	...
	// sss
	int suit = EvalData.boardCards[0].suit;
	int suit2 = EvalData.boardCards[1].suit;if((suit==EvalData.boardCards[1].suit&&suit==EvalData.boardCards[2].suit)||(suit==EvalData.boardCards[2].suit&&suit2==EvalData.boardCards[3].suit))
	{
		EvalData.boardArray[BOARD_3F] = true;
		EvalData.boardF3 = true;
	}
	// ssx xss
	suit=EvalData.boardCards[0].suit;suit2=EvalData.boardCards[1].suit;if((suit==EvalData.boardCards[1].suit&&suit!=EvalData.boardCards[2].suit)||(suit2==EvalData.boardCards[2].suit&&suit!=EvalData.boardCards[3].suit))
	{
		EvalData.boardArray[BOARD_2F] = true;
		EvalData.boardF2 = true;
	}else
	{
		suit = EvalData.boardCards[1].suit;
		suit2 = EvalData.boardCards[2].suit;
		// TODO ERROR

		if ((suit != EvalData.boardCards[0].suit && suit == EvalData.boardCards[2].suit) ||
				(suit2 != EvalData.boardCards[1].suit && suit2 == EvalData.boardCards[3].suit)) {
			EvalData.boardArray[BOARD_2F] = true;
			EvalData.boardF2 = true;
		}
	}

	EvalData.boardArray[BOARD_RAINBOW]=true;EvalData.boardF2=true;
	}
