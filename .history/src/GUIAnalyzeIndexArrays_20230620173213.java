    ...
    * a radio button or control button.
    ...
    private void doSimulationDataCollection() {
        ...
        if (hmlDrawFlop.isSelected()) {
            reportFlop.reportDraw(10, 200, "Flop Draws with HML Index", hmFlop);
        }
        if (hmlMadeFlop.isSelected()) {
            reportFlop.reportMade(10, 220, "Flop  Made hands with HML Index", hmlFlop);

        }
        if (hmlShowdownFlop.isSelected()) {
            reportFlop.reportShowdown(10, 240, "Flop  Showdown hands with HML Index", hmlFlop);
