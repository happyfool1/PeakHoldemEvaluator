...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private JPanel panelCheckBoxesTypesOf1755JFlop;
    private static final JCheckBox typesOf1755DrawFlop = new JCheckBox("HML Flop Draw");
    private static final JCheckBox typesOf1755MadeFlop = new JCheckBox("HML Flop Made Hand");
    private static final JCheckBox typesOf1755ShowdownFlop = new JCheckBox("HML Flop Showdown");

    private JPanel panelCheckBoxesTypesOf1755JTurn;
    private static final JCheckBox typesOf1755DrawTurn = new JCheckBox("HML Turn Draw");
    private static final JCheckBox typesOf1755MadeTurn = new JCheckBox("HML Turn Made Hand");
    private static final JCheckBox typesOf1755ShowdownTurn = new JCheckBox("HML Turn Showdown");

    private JPanel panelCheckBoxesTypesOf1755JRiver;
    private static final JCheckBox typesOf1755DrawRiver = new JCheckBox("HML River Draw");
