...
public class HandRange implements Constants, java.io.Serializable {
	...
	*******************************************************************************/
	...
	String[] playabilityOrder = {"AA", "KK", "QQ", "JJ", "TT","99", "88", "77", "66", "55", "44", "33", "22",
			"AKs", "AQs", "AJs", "ATs","KQs", "KJs", "KTs",	"AKo", "AQo", "AJo", "ATo",	"QJs", "QTs","KQo", "KJo", "KTo","JTs",	"A9s", "K9s", "Q9s", "J9s",
			"A8s", "K8s", "Q8s", "J8s", "T8s",	"A7s", "K7s", "Q7s", "J7s", "T7s", "97s",
			"A6s", "K6s", "Q6s", "J6s", "T6s", "96s", "86s","A5s", "K5s", "Q5s", "J5s", 
			"T5s", "95s", "85s", "75s",
			"A4s", "K4s", "Q4s", "J4s", "T4s", "94s", "84s", "74s", "64s","A3s", "K3s", "Q3s", "J3s", "T3s", "93s", "83s", "73s", "63s", "53s",
			"A2s", "K2s", "Q2s", "J2s", "T2s", "92s", "82s", "72s", "62s", "52s", "42s",
			"A9o", "K9o", "Q9o", "J9o", "T9o","A8o", "K8o", "Q8o", "J8o", "T8o", "98o",
			"A7o", "K7o", "Q7o", "J7o", "T7o", "97o", "87o","A6o", "K6o", "Q6o", "J6o", "T6o", "96o", "86o", "76o",
			"A5o", "K5o", "Q5o", "J5o", "T5o", "95o", "85o", "75o", "65o",	"A4o", "K4o", "Q4o", "J4o", "T4o", "94o", "84o", "74o", "64o", "54o",
			"A3o", "K3o", "Q3o", "J3o", "T3o", "93o", "83o", "73o", "63o", "53o", "43o",	"A2o", "K2o", "Q2o", "J2o", "T2o", "92o", "42o", "83o", "62o", "82o", "32o", "72o" };
	...
	****************************************************************************** */
	...
	void updateRangeData() {
		...
		if (this.high != -1) {
			...
			this.cards = this.handsArray[this.high];
	...
	void combineRangeWithThisRange(HandRange range) {
		for (int i = 0; i < HANDS; ++i) {
			if (range.rangeArray[i] > 0) {
				...
				if (this.debug) {
					System.out.println(
							"//combineRangeWithThisRange() " + i + " " + this.rangeArray[i] + " "
									+ range.rangeArray[i]);
				}
