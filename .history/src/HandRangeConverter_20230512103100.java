...
public class HandRangeConverter implements Constants {
	...
	private static void copyDataPlayability() {
		...
		action.actionArrayPlayability[SB][0][1] = rangeSBLimp.lowPlayabilitrhyArrayIndex;
	...
	private static void copyDataCombos() {
		...
		action.actionArrayCombos[SB][0][1] = rangeSBLimp.combos;
	...
	private static void copyDataPercentage() {
		...
		action.actionArrayPercentage[SB][0][1] = rangeSBLimp.percentage;
	...
	private static void copyDataGaps() {
		...
		action.actionArrayGaps[SB][0][1] = rangeSBLimp.gaps;
