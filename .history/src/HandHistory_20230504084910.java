...
class HandHistory implements Constants {
	...
	*  isFold = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	*  isLimp = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	*  isCheck = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	*  isCall = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	*  isBet = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	*  isRaise = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	*  isAllin = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	*  raisedToBD = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
