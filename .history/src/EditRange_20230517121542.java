...
class EditRange implements Constants {
	...
	private static final Color range1Color= Color.CYAN;
	private static final Color range2Ciolor= Color.YELLOW;
	 ...
	 * 
	 * TODO GUI to select RangeHandMultiple based on type and position and bet type.
	 * 
	 * ****************************************************************************** */
	...
	*********************************************************************************/
		...
		// Add shadow range
			...
			if (subset) {
				for (int k = 0; k < HANDS; ++k) {
					...
					if (range1.isRangeArray(k) > 0 && rangeShadow.isRangeArray(k) > 0) {
						buttonArr[k].setBackground(range1Color);
					}
				}
			}
	...
	private void doFrame() {
		...
		if (edit) {
			...
			gaps.setBackground(range1Color);
			...
			play2.setFont(f3);
			gaps2.setFont(f3);
			combos2.setBackground(range1Color);
			comboPer2.setBackground(range1Color);
			play2.setBackground(range1Color);
			gaps2.setBackground(range1Color);
		...
		JSlider slider1 = new JSlider(JSlider.HORIZONTAL, 0, 100, range1.high);
		slider1.setMajorTickSpacing(10);
		slider1.setPaintTicks(true);
		slider1.setPaintLabels(true);
		slider1.setBackground(range1Color);
		...
		slider1.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent event) {
				...
				// TODO label.setText("Current value: " + value);
			}
		});

		// Create a slider with initial value playability high
		JSlider slider2 = new JSlider(JSlider.HORIZONTAL, 0, 100, range1.high);
		slider2.setMajorTickSpacing(10);
		slider2.setPaintTicks(true);
		slider2.setPaintLabels(true);
		slider2.setBackground(range2Color);
