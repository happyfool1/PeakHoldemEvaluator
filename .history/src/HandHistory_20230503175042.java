...
class HandHistory implements Constants {
	 ...
	 * Copied from the game project and edited for this application.
	 * 
	 *  @author PEAK_
	 *   ****************************************************************************** */
	...
	private static void newHHFile() {
		...
		fileN = new StringBuilder().append(EvalData.applicationDirectory).append("\\HandHistory\\HH").append(hhDate.substring(5, 7))
	...
	* *** SECOND RIVER *** [9c 4h 7d 6c] [7c]
	 ...
	 * PokerStars Hand #173806000000:  Hold'em No Limit ($1/$2 USD) - 2023/05/03 17:38:06 ET  - Generated by PeakHoldemEvaluation NOT by PokerStars
Table 'PeakHoldem' 6-max Seat #1 is the button
Seat 1: Hero ($ $200 in chips)
Seat 2: Happy ($ $200 in chips)
Seat 3: Fool ($ $200 in chips)
Seat 4: JustMe ($ $200 in chips)
Seat 5: Sue ($ $200 in chips)
Seat 6: Chucky ($ $200 in chips)
Hero: posts small blind $1
Hero: posts big blind $2
*** HOLE CARDS ***
*** SUMMARY *** 
Total pot $2 Main pot $2. Side pot $0 | Rake $0.0
	...
	private static void doStreetHH(int street) {
		...
		for (int orbit = 0; orbit < EvalData.lastOrbit[street]; ++orbit) {
			...
			System.out.println("//HH isFold "+ street + " " + orbit + " " +EvalData.isFold[street][seat][orbit]);
