...
public interface Constants {
	...
	*******************************************************************************/
	...
	String[] HAVE_ST = { "None", "Gutshot draw", "Straight draw", "OESD", "Flush draw", "Flush OESD draw",
			"Bottom pair",
			"Middle pair", "Top pair", "Over pair", "Board pair plus under pair", "Board pair plus over pair",
			"Bottom 2 pair", "Top and bottom 2 pair", "Top two pair", "Board set", "Set", "Straight", "Flush" };
	...
	int MADE_ACE_HIGH = -2;
	int MADE_BOTTOM_PAIR = 3;
	int MADE_WEAK_PAIR = -4;
	int MADE_MIDDLE_PAIR = -2;
	int MADE_POCKET_PAIR_BELOW_TP =- ;
	int MADE_TOP_PAIR = -4;
	...
	int MADE_SHORT_SIZE = 16; // IndexArrays do not use all becuuse Full House + is so rare
	...
	int DRAW_GUTSHOT_OESD_PAIR = 5;
	int DRAW_GUTSHOT_HIGH = 5;
	int DRAW_FLUSH_GUTSHOT = 5;
	...
	******************************************************************************/
	...
	String[] PAIR_BROADWAY_ST = { "Trips High", "Trips Medium", "Trips Low", "Pair High", "Pair Medium",
			"Pair Low", "Unpaired High", "Unpaired Medium", "Unpaired Low" };
	...
	******************************************************************************/
	...
	String[] DISTRIBUTION_FLUSH_POTENTIAL_ST = { "Trips High", "Trips Medium", "Trips Low", "One Pair High",
			"One Pair Medium",
			"One Pair Low", "No Pair High", "No Pair Medium", "No Pair Low" };
	...
	******************************************************************************/
	...
	String[] DISTRIBUTION_VALUE_ST = { "High High", "High bMedium", "High Low", "Medium High",
			"Medium Low", "Low High", "Low Medium", "Low Low" };
	/*- **************************************************************************
	* Flop texture Strength Suitedness
	******************************************************************************/
	int STRENGTH_SUITEDNESS_HIGH_MONOTONE = 0;
