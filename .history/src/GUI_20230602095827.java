...
public class GUI extends JFrame implements ActionListener, Constants {
	...
	private static final Color SHOWDOWN= GREEN;

	private static final Color SHO= GREEN;
	...
	private static final JTextArea showdownValue = new JTextArea("");
	...
	private JPanel panelShowdown;
	
    private JPanel panelShowdownValue;
	...
	*******************************************************************************/
	public void myFrame() {
		...
		panelShowdown.setBounds(850 + offset, 40, 600, 50);
		mainPanel.add(panelShowdown);
	 
		panelShowdownValue = new JPanel(new GridLayout(1, 1));
        panelShowdownValue.setBounds(910 + offset, 40, 600, 50);
		...
		panelShowdown.add(showdown);
		panelShowdown.setFont(fs);
		panelShowdown.setPreferredSize(new Dimension(500, 25));
		panelShowdown.setBackground(CONTROL);
	
		panelShowdownValue.add(showdownValue);
		panelShowdownValue.setFont(fs);
		panelShowdownValue.setPreferredSize(new Dimension(500, 25));
		panelShowdownValue.setBackground(CONTROL);
			...
			if (seatActive[i]) {
				...
				if (i == selectedSeat) {
					...
					if (detailedReportOption) {
						Reports.report(1180, 20);
					}
					if (boardReportOption) {
						Reports.reportBoard(800, 600);
					}
					if (preflopReportOption) {
						Reports.reportPreflop(400, 600);
					}
				}
			}
		}
...
start = 1;
	...
	/*-  ******************************************************************************
	 * Handle radio button clicks for seat 
	 *  ****************************************************************************** */
