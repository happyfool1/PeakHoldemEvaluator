 ...
 * Same as above but for Made hands
 ********************************************************************************** */
static void reportHMLDrawRiver(int c, int r) {
    if (frame4 == null) {
        frame4 = new JFrame("River HML Drawing hands");
        frame4.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        frame4.setLocation(c, r);
        frame4.setPreferredSize(new Dimension(750, 330));
    }
    ...
    tableModel4 = new DefaultTableModel(dataHMLDrawRiver, columnsHMLDrawRiver);
    table4 = new JTable(tableModel4);
    table4.setFont(ff1);
    table4.setRowHeight(25);
