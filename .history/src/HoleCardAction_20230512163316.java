    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4Text[i][0].setBackground(GREEN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4Text[i][1].setBackground(GREEN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4Text[i][2].setBackground(GREEN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4Text[i][3].setBackground(GREEN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3CallText[i][0].setBackground(GREEN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3CallText[i][1].setBackground(GREEN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3CallText[i][2].setBackground(GREEN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3CallText[i][3].setBackground(GREEN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinText[i][0].setBackground(BLUE);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinText[i][1].setBackground(BLUE);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinText[i][2].setBackground(BLUE);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinText[i][3].setBackground(BLUE);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4CallText[i][0].setBackground(BLUE);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4CallText[i][1].setBackground(BLUE);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4CallText[i][2].setBackground(BLUE);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4CallText[i][3].setBackground(BLUE);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinCallText[i][0].setBackground(YELLOW);
