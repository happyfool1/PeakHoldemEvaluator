...
public class HoleCardAction implements Constants {
    ...
    ****************************************************************************** */
    ...
    private static JTextField[][][] actionArrayPlayabilityTextA = new JTextField[POSITIONS][4][2];
    ...
    private static JTextField[][][] actionArrayCombosTextA = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayCombosTextB = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayCombosTextC = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayCombosTextD = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayCombosTextE = new JTextField[POSITIONS][1][2];

    private static JTextField[][][] actionArrayPercentageTextA = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayPercentageTextB = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayPercentageTextC = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayPercentageTextD = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayPercentageTextE = new JTextField[POSITIONS][1][2];

    private static JTextField[][][] actionArrayGapsTextA = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayGapsTextB = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayGapsTextC = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayGapsTextD = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayGapsTextE = new JTextField[POSITIONS][1][2];
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
         ...
         actionArrayPlayabilityTextA[i][0][2] = new JTextField(String.valueOf(actionArrayPlayability[i][0][0]));
            actionArrayPlayabilityTextA[i][2][0].setFont(f0);
            actionArrayPlayabilityTextA[i][2][0].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextA[i][2][0]);
            actionArrayPlayabilityTextA[i][3][1] = new JTextField(String.valueOf(actionArrayPlayability[i][0][1]));
            actionArrayPlayabilityTextA[i][3][1].setFont(f0);
            actionArrayPlayabilityTextA[i][3][1].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextA[i][3][1]);
