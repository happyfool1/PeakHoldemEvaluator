	...
	*******************************************************************************/
	...
	static void boardGapScore() {
		...
		if (EvalData.gap0 > 0) {
			...
			if (EvalData.boardArray[BOARD_HHH] || EvalData.boardArray[BOARD_HHM]) {
				EvalData.gap0Score += 3;
			}
			if (EvalData.boardArray[BOARD_MMM] || EvalData.boardArray[BOARD_HMM]) {
				EvalData.gap0Score += 2;
			}
		}
		if (EvalData.gap1 <= 0) {
		...
		if (EvalData.boardArray[BOARD_HHH] || (EvalData.boardArray[BOARD_HHM] && EvalData.boardValue1 != ACE)) {
			EvalData.gap1Score += 2;
		}
		if (EvalData.boardArray[BOARD_MMM] || EvalData.boardArray[BOARD_HMM]) {
			EvalData.gap1Score += 2;
		}
		if (EvalData.boardArray[BOARD_MLL] || (EvalData.boardArray[BOARD_LLL] && EvalData.boardValue1 != ACE)) {
