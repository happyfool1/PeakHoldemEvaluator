	...
	***************************************************************************************** */
	private String stringStrategy() {
		String st = "The best Draw rows were " + Format.formatPer(bestDrawRowsPer[0]) + " "
				+ allArrayRowNames[bestDrawRows[0]] + ", " + Format.formatPer(bestDrawRowsPer[1]) + " "
				+ allArrayRowNames[bestDrawRows[1]] + ", " + Format.formatPer(bestDrawRowsPer[2]) + " "
				+ allArrayRowNames[bestDrawRows[2]] + "\r\n";
		st += "The worst Draw rows were " + Format.formatPer(worstDrawRowsPer[0]) + " "
				+ allArrayRowNames[worstDrawRows[0]] + ", " + Format.formatPer(worstDrawRowsPer[1]) + " "
				+ allArrayRowNames[worstDrawRows[1]] + ", " + Format.formatPer(worstDrawRowsPer[2]) + " "
				+ allArrayRowNames[worstDrawRows[2]] + "\r\n";
		st += "The best Made rows were " + Format.formatPer(bestMadeRowsPer[0]) + " "
				+ allArrayRowNames[bestMadeRows[0]] + ", " + Format.formatPer(bestMadeRowsPer[1]) + " "
				+ allArrayRowNames[bestMadeRows[1]] + ", " + Format.formatPer(worstMadeRowsPer[2]) + " "
				+ allArrayRowNames[bestMadeRows[2]] + "\r\n";
		st += "The worst Made rows were " + Format.formatPer(bestMadeRowsPer[0]) + " "
				+ allArrayRowNames[worstMadeRows[0]] + ", " + Format.formatPer(bestMadeRowsPer[1]) + " "
				+ allArrayRowNames[worstMadeRows[1]] + Format.formatPer(bestMadeRowsPer[2]) + " " + ", "
				+ allArrayRowNames[worstMadeRows[2]] + "\r\n";

		st += "The best Showdownw rows were " + Format.formatPer(bestShowdownRowsPer[0]) + " "
				+ allArrayRowNames[bestShowdownRows[0]] + ", " + Format.formatPer(bestShowdownRowsPer[1])
				+ allArrayRowNames[bestShowdownRows[1]] + Format.formatPer(bestShowdownRowsPer[2]) + ", "
				+ allArrayRowNames[bestShowdownRows[2]] + "\r\n";
		st += "The worst Showdown rows were " + Format.formatPer(worstShowdownRowsPer[0])
				+ allArrayRowNames[worstShowdownRows[0]] + ", " + Format.formatPer(worstShowdownRowsPer[1])
				+ allArrayRowNames[worstShowdownRows[1]] + Format.formatPer(worstShowdownRowsPer[2]) + ", "
				+ allArrayRowNames[worstShowdownRows[2]] + "\r\n\r\n";

		st += "The best Draw cols were " + Format.formatPer(bestDrawColsPer[0]) + " "
				+ drawArrayColNames[bestDrawCols[0]] + ", " + Format.formatPer(bestDrawColsPer[0])
				+ drawArrayColNames[bestDrawCols[1]] + ", " + Format.formatPer(bestDrawColsPer[1]) + " "
				+ drawArrayColNames[bestDrawCols[2]] + "\r\n";
		st += "The worst Draw cols were " + Format.formatPer(worstDrawColsPer[0]) + " "
				+ drawArrayColNames[worstDrawCols[0]] + ", " + Format.formatPer(worstDrawColsPer[1]) + " "
				+ drawArrayColNames[worstDrawCols[1]] + ", " + Format.formatPer(worstDrawColsPer[2]) + " "
		...
		st += "The bes Made cols were " + Format.formatPer(bestMadeColsPer[0]) + " "
				...
				+ madeArrayColNames[bestMadeCols[1]] + ", " + Format.formatPer(bestMadeColsPer[2]) + " "
				+ madeArrayColNames[bestMadeCols[2]] + "\r\n";
		st += "The worst Made cols were " + Format.formatPer(worstMadeColsPer[0]) + " "
				+ madeArrayColNames[worstMadeCols[0]] + ", " + Format.formatPer(worstMadeColsPer[1]) + " "
				+ madeArrayColNames[worstMadeCols[1]] + Format.formatPer(worstMadeColsPer[2]) + " " + ", "
				+ madeArrayColNames[worstMadeCols[2]] + "\r\n";
		st += "The best Showdownw cols were " + Format.formatPer(bestShowdownwColsPer[0]) + " "
				+ madeArrayColNames[bestShowdownCols[0]] + ", " + Format.formatPer(bestShowdownwColsPer[1]) + " "
				+ madeArrayColNames[bestShowdownCols[1]] + Format.formatPer(bestShowdownwColsPer[2]) + " " + ", "
				+ madeArrayColNames[bestShowdownCols[2]] + "\r\n";
		st += "The worst Showdown cols were " + Format.formatPer(worstShowdownColsPer[0]) + " "
				+ madeArrayColNames[worstShowdownCols[0]] + ", " + Format.formatPer(worstShowdownColsPer[1]) + " "
				+ madeArrayColNames[worstShowdownCols[1]] + ", " + Format.formatPer(worstShowdownColsPer[2]) + " "
		...
		st += "The best 5 draws were \r\n" + Format.formatPer(bestDraw5Per[0]) + " " + allArrayRowNames[bestDraw5Row[0]]
				+ ", " + drawArrayColNames[bestDraw5Col[1]] + "\r\n" + Format.formatPer(bestDraw5Per[1]) + " "
				+ allArrayRowNames[bestDraw5Row[1]] + ", " + drawArrayColNames[bestDraw5Col[0]] + "\r\n"
				+ Format.formatPer(bestDraw5Per[2]) + " " + allArrayRowNames[bestDraw5Row[2]] + ", "
				+ drawArrayColNames[bestDraw5Col[2]] + "\r\n" + Format.formatPer(bestDraw5Per[3]) + " "
				+ allArrayRowNames[bestDraw5Row[3]] + ", " + drawArrayColNames[bestDraw5Col[3]] + "\r\n"
				+ Format.formatPer(bestDraw5Per[4]) + " " + allArrayRowNames[bestDraw5Row[4]] + ", "
				+ drawArrayColNames[bestDraw5Col[4]] + "\r\n";
		st += "The worstt 5 draws were \r\n" + Format.formatPer(worstDraw5Per[0]) + " "
				+ allArrayRowNames[worstDraw5Row[0]] + ", " + drawArrayColNames[worstDraw5Col[1]] + "\r\n"
				+ Format.formatPer(worstDraw5Per[1]) + " " + allArrayRowNames[worstDraw5Row[1]] + ", "
				+ drawArrayColNames[worstDraw5Col[0]] + "\r\n" + Format.formatPer(worstDraw5Per[2]) + " "
				+ allArrayRowNames[worstDraw5Row[2]] + ", " + drawArrayColNames[worstDraw5Col[2]] + "\r\n"
				+ Format.formatPer(worstDraw5Per[3]) + " " + allArrayRowNames[worstDraw5Row[3]] + ", "
				+ drawArrayColNames[worstDraw5Col[3]] + "\r\n" + Format.formatPer(worstDraw5Per[4]) + " "
				+ allArrayRowNames[worstDraw5Row[4]] + ", " + drawArrayColNames[worstDraw5Col[4]] + "\r\n";
