...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
                actionArrayPlayabilityText[i][3][0] = new JTextField(String.valueOf(actionArrayPlayability[i][j][0]));
                actionArrayPlayabilityText[i][3][0].setFont(f0);
                actionArrayPlayabilityText[i][3][0].setSize(40, 40);
                panelActionA.add(actionArrayPlayabilityText[i][j][0]);
                actionArrayPlayabilityText[i][3][1] = new JTextField(String.valueOf(actionArrayPlayability[i][j][1]));
