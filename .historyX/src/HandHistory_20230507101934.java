...
class HandHistory implements Constants {
	...
	* returnedToShowdown$ 
	...
	static void initialize() {
		...
		listFiles(EvalData.applicationDirectory +"\\HandHistory");
		 newHHFile();
	}
     ...
     *  Erase HH files
     *   ****************************************************************************** */
	static void eraseHHFile() {

	if (condition1)

	{

		log("condition1 is true");

		if (condition2)

		{

			log("condition2 is true");
...

	{
		...
		log("condition1 is false, skipping");
