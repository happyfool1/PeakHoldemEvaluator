...
/*- **************************************************************************** 
* This is the primary GUI for this project. The other is GUIAnalizeMany.
* This one is use d to select hole cards and board cards that will be evaluated for 
* draws and made hands. Analyze 
*
* 
* @author PEAK_
*******************************************************************************/
...
public class GUI extends JFrame implements ActionListener, Constants {
	...
	*******************************************************************************/
	...
	String helpString = new StringBuilder().append("Welcome to the evaluate_street project GUI.\r\n")
			...
			.append("are run, using random cards, and gathering results based on detailed analysis of each hand simulated.\r\n")
			.append("\r\n ").toString();
	// @formater:on
	...
	* a radio button or control button.
	...
	public void actionPerformed(ActionEvent e) {
		...
		switch (action) {
			...
			case "Step" -> doStep();
			case "Reset" -> doReset();
			case "Data Collection" -> doSimulationDataCollection();
