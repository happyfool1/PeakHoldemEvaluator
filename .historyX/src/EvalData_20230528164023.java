...
public class EvalData implements Constants {
	...
	************************************************************************************* */
	 ...
	 * Extracted from drawAndMadeArray, only made hands in this array, no draws
	  ************************************************************************************** */
	static boolean[] madeArrayFlop = new boolean[MADE_HANDS_SIZE];
	static boolean[] madeArrayTurn = new boolean[MADE_HANDS_SIZE];
	static boolean[] madeArrayRiver = new boolean[MADE_HANDS_SIZE];
	 ...
	 * Extracted from drawAndMadeArray, only made hands in this array, no draws
	  ************************************************************************************** */
	static boolean[] drawArrayFlop = new boolean[DRAW_HANDS_SIZE];
	static boolean[] drawArrayTurn = new boolean[DRAW_HANDS_SIZE];
