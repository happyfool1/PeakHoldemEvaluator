    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            actionArrayPlayabilityTextA[i][0][1] = new JTextField(Format(actionArrayPlayability[i][0][1]));
            ...
            panelActionA.add(actionArrayPlayabilityTextA[i][0][1]);
             ...
             actionArrayPlayabilityTextA[i][1][0] = new JTextField(Format.formatPe(actionArrayPercentage[i][0][0]));
