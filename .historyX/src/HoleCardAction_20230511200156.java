    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            actionArrayPlayabilityTextA[i]10][1].setFont(f0);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            actionArrayPlayabilityTextE[i][04][0] = new JTextField(String.valueOf(actionArrayPlayability[i][4][0]));
            ...
            actionArrayPlayabilityTextE[i][1][1] = new JTextField(String.valueOf(actionArrayPlayability[i][4][1]));
