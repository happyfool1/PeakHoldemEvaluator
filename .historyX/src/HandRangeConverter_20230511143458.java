...
public class HandRangeConverter implements Constants {
	...
	private static void copyData2() {
		...
		action.actionArray[SB][4][0] = rangeSBAllin.lowPlayabilitrhyArrayIndex;
		action.actionArray[SB][4][1] = rangeSBAllinCall.lowPlayabilitrhyArrayIndex;
		...
		action.actionArray[BB][4][0] = rangeBBAllin.lowPlayabilitrhyArrayIndex;
		action.actionArray[BB][4][1] = rangeBBAllinCall.lowPlayabilitrhyArrayIndex;
		...
		action.actionArray[UTG][4][0] = rangeUTGAllin.lowPlayabilitrhyArrayIndex;
		action.actionArray[UTG][4][1] = rangeUTGAllinCall.lowPlayabilitrhyArrayIndex;
		...
		action.actionArray[MP][4][0] = rangeMPAllin.lowPlayabilitrhyArrayIndex;
		action.actionArray[MP][4][1] = rangeMPAllinCall.lowPlayabilitrhyArrayIndex;
		...
		action.actionArray[CO][4][0] = rangeCOAllin.lowPlayabilitrhyArrayIndex;
		action.actionArray[CO][4][1] = rangeCOAllinCall.lowPlayabilitrhyArrayIndex;
		...
		action.actionArray[BU][4][0] = rangeBUAllin.lowPlayabilitrhyArrayIndex;
		action.actionArray[BU][4][1] = rangeBUAllinCall.lowPlayabilitrhyArrayIndex;
