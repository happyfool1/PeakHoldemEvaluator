...
public class GUIAlalizeMany implements Constants {
    ...
    ***************************************************************************** */
    ...
    private static final JRadioButton tenMillion = new JRadioButton("2,000,000");

    private static final JRadioButton hundredMillion = new JRadioButton("5,000,000");

    private static final JRadioButton hundredMillion = new JRadioButton("10,000,000");

    private static final JRadioButton hundredMillion = new JRadioButton("1,000,000");
