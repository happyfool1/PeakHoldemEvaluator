...
private static void copyDataHandRanges() {
	...
	action.rangeArrayCall[SB][1][i] = rangeSBCall;
	action.rangeArrayRaise[SB][1][i] = rangeSBBet3;
	action.rangeArrayCall[SB][2][i] = rangeSBBet3Call;
	action.rangeArrayRaise[SB][2][i] = rangeSBBet4;
	action.rangeArrayCall[SB][3][i] = rangeSBBet4Call;
	action.rangeArrayRaise[SB][3][i] = rangeSBAllin;
	action.rangeArrayCall[SB][4][i] = rangeSBAllinCall;
	action.rangeArrayRaise[BB][0][i] = rangeBBLimp;
	action.rangeArrayRaise[BB][0][i] = rangeBBOpen;
	action.rangeArrayCall[BB][1][i] = rangeBBCall;
	action.rangeArrayRaise[BB][1][i] = rangeBBBet3;
	action.rangeArrayCall[BB][2][i] = rangeBBBet3Call;
	action.rangeArrayRaise[BB][2][i] = rangeBBBet4;
	action.rangeArrayCall[BB][3][i] = rangeBBBet4Call;
	action.rangeArrayRaise[BB][3][i] = rangeBBAllin;
	action.rangeArrayCall[BB][4][i] = rangeBBAllinCall;
	action.rangeArrayCall[UTG][0][i] = rangeUTGLimp;
	action.rangeArrayRaise[UTG][0][i] = rangeUTGOpen;
	action.rangeArrayCall[UTG][1][i] = rangeUTGCall;
	action.rangeArrayRaise[UTG][1][i] = rangeUTGBet3;
	action.rangeArrayCall[UTG][2][i] = rangeUTGBet3Call;
	action.rangeArrayRaise[UTG][2][i] = rangeUTGBet4;
	action.rangeArrayCall[UTG][3][i] = rangeUTGBet4Call;
	action.rangeArrayRaise[UTG][3][i] = rangeUTGAllinCall;
	action.rangeArrayCall[MP][0][i] = rangeMPLimp;
	action.rangeArrayRaise[MP][0][i] = rangeMPOpen;
	action.rangeArrayCall[MP][1][i] = rangeMPCall;
	action.rangeArrayRaise[MP][1][i] = rangeMPBet3;
	action.rangeArrayCall[MP][2][i] = rangeMPBet3Call;
	action.rangeArrayRaise[MP][2][i] = rangeMPBet4;
	action.rangeArrayCall[MP][3][i] = rangeMPBet4Call;
	action.rangeArrayRaise[MP][3][i] = rangeMPAllin;
	action.rangeArrayCall[MP][4][i] = rangeMPAllinCall;
	action.rangeArrayCall[CO][0][i] = rangeCOLimp;
	action.rangeArrayRaise[CO][0][i] = rangeCOOpen;
	action.rangeArrayCall[CO][1][i] = rangeCOCall;
	action.rangeArrayRaise[CO][1][i] = rangeCOBet3;
	action.rangeArrayCall[CO][2][i] = rangeCOBet3Call;
	action.rangeArrayRaise[CO][2][i] = rangeCOBet4;
	action.rangeArrayCall[CO][3][i] = rangeCOBet4Call;
	action.rangeArrayRaise[CO][3][i] = rangeCOAllin;
	action.rangeArrayCall[CO][4][i] = rangeCOAllinCall;
	action.rangeArrayCall[BU][0][i] = rangeBULimp;
	action.rangeArrayRaise[BU][0][i] = rangeBUOpen;
	action.rangeArrayCall[BU][1][i] = rangeBUCall;
	action.rangeArrayRaise[BU][1][i] = rangeBUBet3;
	action.rangeArrayCall[BU][2][i] = rangeBUBet3Call;
	action.rangeArrayRaise[BU][2][i] = rangeBUBet4;
	action.rangeArrayCall[BU][3][i] = rangeBUBet4Call;
	action.rangeArrayRaise[BU][3][i] = rangeBUAllin;
	action.rangeArrayCall[BU][4][i] = rangeBUAllinCall;
