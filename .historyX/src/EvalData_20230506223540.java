...
public class EvalData implements Constants {
	...
	* Stack sizes: Consider the effective stack sizes when determining your bet size. 
	...
	when you have a strong hand. When you or your opponent have smaller stacks, smaller bet sizes can help you control the pot and prevent committing too many chips with a marginal hand.
	*
