...
public class HandRange implements Constants {
	...
	****************************************************************************** */
	...
	/*-******************************************************************************
	 * Constructed from orderArray
	 * AA is 0, 72o is 168, the reverse of playabilityArrayNumeric 
	 * Copy RangeOrder values to array   
	 *******************************************************************************/
...
/*-  ****************************************************************************
	...
	* Called by constructor when the first instance is created to initialize 
	 ...
	 * This is the inverse of playabilityArrayNumeric
	  ******************************************************************************/
	private static void createPlayabilityArrayOrder() {
		int num = 169;
		int k = 0;
		for (int i = 0; i < HANDS; ++i) {
			k = getHandStringToIndex(playabilityArray[i]);
			playabilityArrayOrder[k] = num--;
		}
	}
