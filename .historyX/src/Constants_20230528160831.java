...
/*- *****************************************************************************
	...
	int BOARD_LLL = 9;
	int HML_SIZE_FLOP = 10;
	int HML_SIZE_TURN = 13;
	int HML_SIZE_RIVER = 17;

	// OneHand.HMLIndex
	String[] HML_FLOP_ST = { "HHH", "HHM", "HHL", "HMM", "HML", "HLL", "MMM", "MML", "MLL", "LLL" };

	String[] HML_TURN_ST = { "HHHH", "HHHM", "HHHL", "HHMM", "HHML", "HHLL",
	"HMMM", "HMML", "HMLL", "MMMM", "MMML",
			"MMLL", "MLLL" };

	String[] HML_RIVER_ST = { "HHHHH", "HHHHM", "HHHHL", "HHHMM", 
	"HHHML", "HHHLL", "HHMMM", "HHMML", "HHMLL", "HMMM",
	...
	int TWO_SUITED_LOW = 5;

	int TWO_SUITED_HIGH = 6;

	int TWO_SUITED_HIGH_LOW = 7;
	 ...
	 * pair  - Two adjacent Cards with same value
