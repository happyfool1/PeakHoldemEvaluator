...
public class HandRangeConverter implements Constants {
	...
	private static void copyDataPlayability() {
		action.actionArrayPlayabilityRAISE[SB][0] = rangeSBXx.lowPlayabilitrhyArrayIndex;
		...
		action.actionArrayPlayability[BB][0][0] = rangeBBXx.lowPlayabilitrhyArrayIndex;
		...
		action.actionArrayPlayability[UTG][0][0] = rangeUTGXx.lowPlayabilitrhyArrayIndex;
		...
		action.actionArrayPlayability[MP][0][0] = rangeMPXx.lowPlayabilitrhyArrayIndex;
		...
		action.actionArrayPlayability[CO][0][0] = rangeCOXx.lowPlayabilitrhyArrayIndex;
		...
		action.actionArrayPlayability[BU][0][0] = rangeBUXx.lowPlayabilitrhyArrayIndex;
	...
	private static void copyDataCombos() {
		action.actionArrayCombosRAISE[SB][0] = rangeSBXx.combos;
		...
		action.actionArrayCombos[BB][0][0] = rangeBBXx.combos;
		...
		action.actionArrayCombos[UTG][0][0] = rangeUTGXx.combos;
		...
		action.actionArrayCombos[MP][0][0] = rangeMPXx.combos;
		...
		action.actionArrayCombos[CO][0][0] = rangeCOXx.combos;
		...
		action.actionArrayCombos[BU][0][0] = rangeBUXx.combos;
	...
	private static void copyDataPercentage() {
		action.actionArrayPercentageRaise[SB][0] = rangeSBXx.percentage;
		...
		action.actionArrayPercentage[BB][0][0] = rangeBBXx.percentage;
		...
		action.actionArrayPercentage[UTG][0][0] = rangeUTGXx.percentage;
		...
		action.actionArrayPercentage[MP][0][0] = rangeMPXx.percentage;
		...
		action.actionArrayPercentage[CO][0][0] = rangeCOXx.percentage;
		...
		action.actionArrayPercentage[BU][0][0] = rangeBUXx.percentage;
	...
	private static void copyDataGaps() {
		action.actionArrayGapsRAISE[SB][0] = rangeSBXx.gaps;
		...
		action.actionArrayGaps[BB][0][0] = rangeBBXx.gaps;
		...
		action.actionArrayGaps[UTG][0][0] = rangeUTGXx.gaps;
		...
		action.actionArrayGaps[MP][0][0] = rangeMPXx.gaps;
		...
		action.actionArrayGaps[CO][0][0] = rangeCOXx.gaps;
		...
		action.actionArrayGaps[BU][0][0] = rangeBUXx.gaps;
