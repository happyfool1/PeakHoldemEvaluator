...
public class HandRangeConverter implements Constants {
	...
	private static void doConversion() {
		...
		// PREFLOP_OPEN BET2
		ndx1 = rangeSBBet3.updateForHoleCardAction();
		action.actionArray[SB][1][0] = ndx1;
		ndx2 = rangeSBCall.updateForHoleCardAction();
		action.actionArray[SB][1][1] = ndx2;
		// PREFLOP_BET3
		ndx1 = rangeSBBet4.updateForHoleCardAction();
		action.actionArray[SB][2][0] = ndx1;
		ndx2 = rangeSBBet4Call.updateForHoleCardAction();
		action.actionArray[SB][2][1] = ndx2;
		// PREFLOP_BET4
		ndx1 = rangeSBAllin.updateForHoleCardAction();
		action.actionArray[SB][3][0] = ndx1;
		ndx2 = rangeSBBet4Call.updateForHoleCardAction();
		action.actionArray[SB][3][1] = ndx2;
		// PREFLOP_ALLIN
		ndx2 = rangeSBAllinCall.updateForHoleCardAction();
		action.actionArray[SB][4][1] = ndx2;

		// PREFLOP_LIMP BET1
		ndx1 = rangeBBOpen.updateForHoleCardAction();
		action.actionArray[BB][0][0] = ndx1;
		ndx2 = rangeBBLimp.updateForHoleCardAction();
		action.actionArray[BB][0][1] = ndx2;
		// PREFLOP_OPEN BET2
		ndx1 = rangeBBBet3.updateForHoleCardAction();
		action.actionArray[BB][1][0] = ndx1;
		ndx2 = rangeBBCall.updateForHoleCardAction();
		action.actionArray[BB][1][1] = ndx2;
		// PREFLOP_BET3
		ndx1 = rangeBBBet4.updateForHoleCardAction();
		action.actionArray[BB][2][0] = ndx1;
		ndx2 = rangeBBBet4Call.updateForHoleCardAction();
		action.actionArray[BB][2][1] = ndx2;
		// PREFLOP_BET4
		ndx1 = rangeBBAllin.updateForHoleCardAction();
		action.actionArray[BB][3][0] = ndx1;
		ndx2 = rangeBBBet4Call.updateForHoleCardAction();
		action.actionArray[BB][3][1] = ndx2;
		// PREFLOP_ALLIN
		ndx2 = rangeBBAllinCall.updateForHoleCardAction();
		action.actionArray[BB][4][1] = ndx2;

		// PREFLOP_LIMP BET1
		ndx1 = rangeUTGOpen.updateForHoleCardAction();
		action.actionArray[UTG][0][0] = ndx1;
		ndx2 = rangeUTGLimp.updateForHoleCardAction();
		action.actionArray[UTG][0][1] = ndx2;
		// PREFLOP_OPEN BET2
		ndx1 = rangeUTGBet3.updateForHoleCardAction();
		action.actionArray[UTG][1][0] = ndx1;
		ndx2 = rangeUTGCall.updateForHoleCardAction();
		action.actionArray[UTG][1][1] = ndx2;
		// PREFLOP_BET3
		ndx1 = rangeUTGBet4.updateForHoleCardAction();
		action.actionArray[UTG][2][0] = ndx1;
		ndx2 = rangeUTGBet4Call.updateForHoleCardAction();
		action.actionArray[UTG][2][1] = ndx2;
		// PREFLOP_BET4
		ndx1 = rangeUTGAllin.updateForHoleCardAction();
		action.actionArray[UTG][3][0] = ndx1;
		ndx2 = rangeUTGBet4Call.updateForHoleCardAction();
		action.actionArray[UTG][3][1] = ndx2;
		// PREFLOP_ALLIN
		ndx2 = rangeUTGAllinCall.updateForHoleCardAction();
		action.actionArray[UTG][4][1] = ndx2;

		// PREFLOP_LIMP BET1
		ndx1 = rangeMPOpen.updateForHoleCardAction();
		action.actionArray[MP][0][0] = ndx1;
		ndx2 = rangeMPLimp.updateForHoleCardAction();
		action.actionArray[MP][0][1] = ndx2;
		// PREFLOP_OPEN BET2
		ndx1 = rangeMPBet3.updateForHoleCardAction();
		action.actionArray[MP][1][0] = ndx1;
		ndx2 = rangeMPCall.updateForHoleCardAction();
		action.actionArray[MP][1][1] = ndx2;
		// PREFLOP_BET3
		ndx1 = rangeMPBet4.updateForHoleCardAction();
		action.actionArray[MP][2][0] = ndx1;
		ndx2 = rangeMPBet4Call.updateForHoleCardAction();
		action.actionArray[MP][2][1] = ndx2;
		// PREFLOP_BET4
		ndx1 = rangeMPAllin.updateForHoleCardAction();
		action.actionArray[MP][3][0] = ndx1;
		ndx2 = rangeMPBet4Call.updateForHoleCardAction();
		action.actionArray[MP][3][1] = ndx2;
		// PREFLOP_ALLIN
		ndx2 = rangeMPAllinCall.updateForHoleCardAction();
		action.actionArray[MP][4][1] = ndx2;

		// PREFLOP_LIMP BET1
		ndx1 = rangeCOOpen.updateForHoleCardAction();
		action.actionArray[CO][0][0] = ndx1;
		ndx2 = rangeCOLimp.updateForHoleCardAction();
		action.actionArray[CO][0][1] = ndx2;
		// PREFLOP_OPEN BET2
		ndx1 = rangeCOBet3.updateForHoleCardAction();
		action.actionArray[CO][1][0] = ndx1;
		ndx2 = rangeCOCall.updateForHoleCardAction();
		action.actionArray[CO][1][1] = ndx2;
		// PREFLOP_BET3
		ndx1 = rangeCOBet4.updateForHoleCardAction();
		action.actionArray[CO][2][0] = ndx1;
		ndx2 = rangeCOBet4Call.updateForHoleCardAction();
		action.actionArray[CO][2][1] = ndx2;
		// PREFLOP_BET4
		ndx1 = rangeCOAllin.updateForHoleCardAction();
		action.actionArray[CO][3][0] = ndx1;
		ndx2 = rangeCOBet4Call.updateForHoleCardAction();
		action.actionArray[CO][3][1] = ndx2;
		// PREFLOP_ALLIN
		ndx2 = rangeCOAllinCall.updateForHoleCardAction();
		action.actionArray[CO][4][1] = ndx2;

		// PREFLOP_LIMP BET1
		ndx1 = rangeBUOpen.updateForHoleCardAction();
		action.actionArray[BU][0][0] = ndx1;
		ndx2 = rangeBULimp.updateForHoleCardAction();
		action.actionArray[BU][0][1] = ndx2;
		// PREFLOP_OPEN BET2
		ndx1 = rangeBUBet3.updateForHoleCardAction();
		action.actionArray[BU][1][0] = ndx1;
		ndx2 = rangeBUCall.updateForHoleCardAction();
		action.actionArray[BU][1][1] = ndx2;
		// PREFLOP_BET3
		ndx1 = rangeBUBet4.updateForHoleCardAction();
		action.actionArray[BU][2][0] = ndx1;
		ndx2 = rangeBUBet4Call.updateForHoleCardAction();
		action.actionArray[BU][2][1] = ndx2;
		// PREFLOP_BET4
		ndx1 = rangeBUAllin.updateForHoleCardAction();
		action.actionArray[BU][3][0] = ndx1;
		ndx2 = rangeBUBet4Call.updateForHoleCardAction();
		action.actionArray[BU][3][1] = ndx2;
		// PREFLOP_ALLIN
		ndx2 = rangeBUAllinCall.updateForHoleCardAction();
