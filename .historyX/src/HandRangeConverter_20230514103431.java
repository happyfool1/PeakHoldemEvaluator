	...
	private static void copyDataGaps() {
		for (int i = 0; i < 5; i++) {
			for (int j = 0; j < HANDS; j++) {
				...
				action.gapsArrayCall[BU][i] = rangeBULimp.gapsArray[i];
				action.gapsArrayRaise[BU][i] = rangeBUOpen.gapsArray[i];
				action.gapsArrayCall[BU][i] = rangeBUCall.gapsArray[i];
				action.gapsArrayRaise[BU][i] = rangeBUBet3.gapsArray[i];
				action.gapsArrayCall[BU][i] = rangeBUBet3Call.gapsArray[i];
				action.gapsArrayRaise[BU][i] = rangeBUBet4.gapsArray[i];
				action.gapsArrayCall[BU][i] = rangeBUBet4Call.gapsArray[i];
				action.gapsArrayRaise[BU][i] = rangeBUAllin.gapsArray[i];
				action.gapsArrayCall[BU][i] = rangeBUAllinCall.gapsArray[i];
			}
		}
	}
