...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            bet4CallText[i][4] = new JTextField(String.valueOf(actionArrayGapsCall[i][2]));
            bet4CallText[i][4].setFont(f0);
            bet4CallText[i][4].setSize(40, 40);
            panelBet4Call.add(bet4CallText[i][4]);
        }
        panel1.add(panelBet3Call);
