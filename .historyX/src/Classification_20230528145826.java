...
public class Classification implements Constants {
	...
	* Do Flop characterization
	...
	static void doFlop() {
		...
		flopType();
		wetDry();
		for (int i =0; i < BOARD_ARRAY_SIZE i >= 0; --i)
		EvalData.wetDryIndexes[EvalData.seat] = 
		boardIndexesFlop();
	...
	***************************************************************************************************/
	private static void flopType() {
		...
		EvalData.typesIndexes[EvalData.seat] = EvalData.type;
	...
	***************************************************************************** */
	...
	static int[] showdownCount = new int[HML_SIZE_FLOP]; // How many we went to at showdown
	static int[] showdownWin = new int[HML_SIZE_FLOP]; // How many we went to at showdown
	static int[] showdownLoose = new int[HML_SIZE_FLOP]; // How many we went to at showdown
	static int[] showdown = new int[HML_SIZE_FLOP]; // How many we won at showdown
	static int[] flopoCount = new int[HML_SIZE_FLOP]; // How many we won at Flop
	static int[] turnCount = new int[HML_SIZE_FLOP]; // How many we won at Turn
	static int[] riverCount = new int[HML_SIZE_FLOP]; // How many we won at River
