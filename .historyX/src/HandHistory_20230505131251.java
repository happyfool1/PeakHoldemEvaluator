	...
	private static void doStreetHH(int street) {
		...
		for (int orbit = 0; orbit < EvalData.lastOrbit[street]; ++orbit) {
			...
			for (int j = 0; j < seatCount; ++j) {
				...
				System.out.println(
						"HHH isFold " + " seat " + seat +"  orbit " + orbit +  " " + EvalData.playerNames[seat] + " last orbit "
								+ EvalData.lastOrbit[street]
								 + " " + EvalData.isFold[street][seat][orbit]);
								 System.out.println(
									"HHH isRaise " + " seat " + seat +"  orbit " + orbit +  " " + EvalData.playerNames[seat] + " last orbit "
											+ EvalData.lastOrbit[street]
				...
				// System.out.println(
				// "HHH isLimp " + street + " " + orbit + " " + seat + " " +
				// EvalData.playerNames[seat] + " "
				// + EvalData.lastOrbit[street]
				// + " " + seat + " " + EvalData.isLimp[street][seat][orbit]);
				// System.out.println(
				// "HHH isCall " + street + " " + orbit + " " + seat + " " +
				// EvalData.playerNames[seat] + " "
				// + EvalData.lastOrbit[street]
				// + " " + seat + " " + EvalData.isCall[street][seat][orbit]);
				// System.out.println(
				// "HHH isBet " + street + " " + orbit + " " + seat + " " +
				// EvalData.playerNames[seat] + " "// + EvalData.lastOrbit[street]
