...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    *******************************************************************************/
    ...
    private static boolean sumOfDrawOption = false;
    private static boolean sumOfMadeOption = false;
    private static boolean sumOfShowdownOption = false;
    ...
    *******************************************************************************/
    ...
    private void checkBoxesl() {
        ...
        if (sumOfDraw.isSelected()) {
            sumOfFlopOption = true;
        } else {
            sumOfFlopOption = false;
        }
