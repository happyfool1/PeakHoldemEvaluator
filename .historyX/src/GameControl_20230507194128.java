...
public class GameControl implements Constants {
	...
	*  Return uncalled bet
	...
	static void returnUncalledBet() {
		...
		EvalData.pot$[EvalData.streetNumber][seat][EvalData.orbit] = EvalData.potBD;
		EvalData.returnedTo$[0][seat][EvalData.orbit] = EvalData.lastBetBD;
		EvalData.returnedToBD[0][seat][EvalData.orbit] = EvalData.lastBetBD;
