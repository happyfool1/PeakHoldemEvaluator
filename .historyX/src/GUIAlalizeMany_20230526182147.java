...
public class GUIAlalizeMany extends JFrame implements ActionListener, Constants {
  ...
  private static final JCheckBox hhhmlShowdown = new JCheckBox("HHHML River Wins Showdown");
    ...
    private static final JCheckBox wetDryDraw = new JCheckBox("Wet Drt Draw");
    private static final JCheckBox wetDrylMade = new JCheckBox("HML Made Hand");
    private static final JCheckBox wetDryShowdown = new JCheckBox("HML Wins Showdown");
