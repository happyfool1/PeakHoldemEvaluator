...
public class GameControl implements Constants {
	...
	**************************************************************************** */
	...
	private static void createPlayers() {
		players[seatSB] = new Player(EvalData.handIndexes[seatSB], rangeSBLimp, rangeSBOpen, rangeSBCall,
				rangeSBBet3, rangeSBBet3Call, rangeSBBet4, rangeSBBet4Call, rangeSBAllin, rangeSBAllinCall);
		players[seatBB] = new Player( EvalData.handIndexes[seatBB], rangeBBLimp, rangeBBOpen, rangeBBCall,
				rangeBBBet3, rangeBBBet3Call, rangeBBBet4, rangeBBBet4Call, rangeBBAllin, rangeBBAllinCall);
		players[seatUTG] = new Player( EvalData.handIndexes[seatUTG], rangeUTGLimp, rangeUTGOpen, rangeUTGCall,
				rangeUTGBet3, rangeUTGBet3Call, rangeUTGBet4, rangeUTGBet4Call, rangeUTGAllin, rangeUTGAllinCall);
		players[seatMP] = new Player( EvalData.handIndexes[seatMP], rangeMPLimp, rangeMPOpen, rangeMPCall,
				rangeMPBet3, rangeMPBet3Call, rangeMPBet4, rangeMPBet4Call, rangeMPAllin, rangeMPAllinCall);
		players[seatCO] = new Player( EvalData.handIndexes[seatCO], rangeCOLimp, rangeCOOpen, rangeCOCall,
				rangeCOBet3, rangeCOBet3Call, rangeCOBet4, rangeCOBet4Call, rangeCOAllin, rangeCOAllinCall);
		players[seatBU] = new Player( EvalData.handIndexes[seatBU], rangeBULimp, rangeBUOpen, rangeBUCall,
	...
	private static void playHandPreflop() {
		...
		action = players[seat].getDecision(seat,EvalData.betType, EvalData.betToMeBD, EvalData.betNowBD);
