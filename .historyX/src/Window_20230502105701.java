...
public class Window extends JFrame implements Constants {
	...
	private static final JLabel betSize = new JLabel("");
	private static final JLabel bets = new JLabel("");
	...
	private static final JPanel panelBlank7 = new JPanel();
	private static final JPanel panelBlank8 = new JPanel();
	...
	private static final JTextField potSide1 = new JTextField("");
	private static final JTextField potSide2 = new JTextField("");
	private static final JPanel potPanel = new JPanel();
	...
	private static final JLabel card1 = new JLabel("");
	private static final JLabel card2 = new JLabel("");
	...
	private static double sizeOfCall;
	private static double sizeOfAllin;

	private static final int saveToPlay = -1;
