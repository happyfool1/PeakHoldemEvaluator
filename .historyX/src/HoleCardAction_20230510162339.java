...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        final var panelCards = new JPanel();

        panel0.setLayout(new BoxLayout(panelcards, BoxLayout.Y_AXIS));
       ...
       final var panelpanelGapsLayout = new GridLayout(1, 8);
