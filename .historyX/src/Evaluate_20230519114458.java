...
/*- ******************************************************************************
	...
	* Like preflopSimulation except for:
	*         - the number of hands to run	
	* Arg0 - NUmber of hands to run
	 ********************************************************************************/
	static void doPreflopFullSimulation(int numer) {
		GameControl.preflopFullSimulationOneHand(number);
	}
