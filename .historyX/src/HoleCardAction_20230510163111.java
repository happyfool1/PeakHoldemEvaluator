...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
       ...
       final var panelpanelLowRangeLayout = new GridLayout(1, 8);
       ...
       final var panelGapsLayout = new GridLayout(1, 8);
        ...
        for (int i = 0; i < PLAYERS; ++i) {
            ...
            panelLowRange.add( lowRangeArrayIndexTex[i]);
            panelLowPlay.add(cardsText[i]);
            panelLowPlanNum.add(cardsText[i]);
            panelGaps.add(cardsText[i]);
        }
