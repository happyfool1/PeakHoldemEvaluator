...
public class GUI extends JFrame implements ActionListener, Constants {
	...
	private static final JButton dataCollection = new JButton("Data Collection");
	...
	****************************************************************************** */
	...
	private void doPreflopSimulationDataCollection() {
		...
		if (response != null && !response.isEmpty()) {
			...
			ReportManyHands.reportBoardArrayFlopPer(100, 100);
			ReportManyHands.reportBoardArrayFlopPer(1500, 100);
			}
		}
	}
