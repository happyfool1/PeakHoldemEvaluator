...
public class GameControl implements Constants {
	...
	**************************************************************************** */
	static void preflopSimulationOneHand() {
		...
		System.out.println("//seats " + seatSB + " " + seatBB + " " + seatUTG + " " + seatMP + " " + seatCO + " " + seatBU);
		createPlayers();
		seat = seatSB;
		playerBetSB();
		seat = seatBB;
	...
	*******************************************************************************/
	private static void setPlayerPositions() {
		EvalData.playerPositions[seatSB] = SB;
		EvalData.playerPositions[seatBB] = BB;
		EvalData.playerPositions[seatUTG] = UTG;
		EvalData.playerPositions[seatMP] = MP;
		EvalData.playerPositions[seatCO] = CO;
		EvalData.playerPositions[seatBU] = BU;
