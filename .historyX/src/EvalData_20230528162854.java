...
public class EvalData implements Constants {
	...
	* Results of evaluation 
	...
	// static boolean[] drawAndMadeArray = new boolean[SIZE_HANDS];
	// Flop only information, not draw or made hand, just information
	static boolean[] flopArray = new boolean[FLOP_SIZE];
	// Drawing hands
	static boolean[] drawArray = new boolean[DRAW_SIZE_HANDS_SIZE];
	// Made hands
	static boolean[] madeArray = new boolean[MADE_SIZE_HANDS];
	...
	************************************************************************************* */
	static boolean[] boardPossibleArrayFlop = new boolean[POSSIBLE_SIZE];
	 ...
	 * Extracted from drawAndMadeArray, only made hands in this array, no draws
	  ************************************************************************************** */
	static boolean[] madeArrayFlop = new boolean[MADE_SIZE_HANDS];
	static boolean[] madeArrayTurn = new boolean[MADE_SIZE_HANDS];
	static boolean[] madeArrayRiver = new boolean[MADE_SIZE_HANDS];
	 ...
	 * Extracted from drawAndMadeArray, only made hands in this array, no draws
	  ************************************************************************************** */
	static boolean[] drawArrayFlop = new boolean[DRAW_SIZE_HANDS];
	static boolean[] drawArrayTurn = new boolean[DRAW_SIZE_HANDS];
	...
	/*-  **************************************************************************************
	 * Indexes saved from Flop, Turn, and River for use when winner is known
	  ************************************************************************************** */
	static int[] hmlIndexes= new int[PLAYERS];
	static int[] hhmlIndexes = new int[PLAYERS];
	static int[] hhhmlIndexes = new int[PLAYERS];
	static int[] typeIndexes = new int[PLAYERS];
	static int[] flopSumOfValueslIndexes = new int[PLAYERS];
	static int[] wetDryIndexes = new int[PLAYERS];
// A couple set aside for potential new programmers
	static int[] spare1Indexes = new int[PLAYERS];
	static int[] spare2Indexes = new int[PLAYERS];
	static int[] spare3Indexes = new int[PLAYERS];
	static int[] spare4Indexes = new int[PLAYERS];
	static int[] spare5Indexes = new int[PLAYERS];
