...
public class EvalData implements Constants {
	...
	* Sorted high to low, not in the order dealt but equivalents
	...
	static int[] handIndexes = new int[PLAYERS]; // TODO
	...
	************************************************************************************** */
	...
	static int[] positions = new int[PLAYERS];
	static int[] playerPositions = new int[PLAYERS]; // TODO indexed by position returns seat
	...
	static int[][] foldedPreflop = new int[4][PLAYERS]; // TODO
	static BigDecimal[] stackPreflopBD = new BigDecimal[PLAYERS]; // TODO
	//static boolean[] playerFoldedPreflop = new boolean[PLAYERS]; // TODO
	//static boolean[] playerLimpedPreflop = new boolean[PLAYERS]; // TODO
	//static boolean[] playerFoldedFlop = new boolean[PLAYERS]; // TODO
	static boolean[] playerFoldedTurn = new boolean[PLAYERS]; // TODO
	static boolean[] playerFoldedRiver = new boolean[PLAYERS]; // TODO
	static boolean[] playerLostShowdown = new boolean[PLAYERS]; // TODO
	static boolean[] playerWonShowdown = new boolean[PLAYERS]; // TODO
	static BigDecimal[] moneyInBD = new BigDecimal[PLAYERS]; // TODO
	static boolean[] playerWon = new boolean[PLAYERS]; // Indexed by street,seat,orbit TODO
	static int foldCount = -1; // TODO
	//static int[] foldCountPreflop = new int[PLAYERS]; // TODO
	static int allinCount = -1;// TODO
	static int limpCount = -1; // TODO
	static int handsPlayed = 0; // TODO
	static int gamesInASession = 0; // TODO
	static boolean streetComplete = false; // TODO
	static boolean boardComplete = false; // TODO
	static boolean[] playerAllin = new boolean[PLAYERS]; // TODO
	static boolean stop = false;
	static int betType = 0;
	static int orbit = 0;
	static BigDecimal betNowBD = zeroBD;
	static BigDecimal potBD = zeroBD; // TODO
	static BigDecimal sidePotBD = zeroBD; // TODO
	static BigDecimal mainPotBD = zeroBD; // TODO
	static BigDecimal potStartBD = zeroBD; // TODO
	static BigDecimal potEndBD = zeroBD; // TODO
	/*-  *********************************************************************************** 
	 * For simulation modes
	 * Used by HandHistory
	  ************************************************************************************** */
	static int[] lastOrbit = new int[4]; // Indexed by street TODO
	static boolean[][][] isFold = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	static boolean[][][] isLimp = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	static boolean[][][] isCheck = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	static boolean[][][] isCall = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	static boolean[][][] isBet = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	static boolean[][][] isRaise = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	static boolean[][][] isAllin = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	static boolean[][][] raisedToBD = new boolean[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO

	static BigDecimal[][][] returnedToBD = new BigDecimal[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	static BigDecimal[][][] betBD = new BigDecimal[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	static BigDecimal[][][] callBD = new BigDecimal[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	static BigDecimal[][][] winBD = new BigDecimal[4][PLAYERS][4]; // Indexed by street,seat,orbit TODO
	static BigDecimal[] winnerCollectedBD = new BigDecimal[PLAYERS]; // Indexed by street,seat,orbit TODO
	static BigDecimal[] returnedToShowdownBD = new BigDecimal[PLAYERS]; // Indexed by street,seat,orbit TODO
	static BigDecimal[] playerSidePotSplitTotalBD = new BigDecimal[PLAYERS]; // Indexed by street,seat,orbit TODO
	static BigDecimal[] playerSidePotSplitBD = new BigDecimal[PLAYERS]; // Indexed by street,seat,orbit TODO
	...
	static BigDecimal[][][] stack$ = new BigDecimal[4][PLAYERS][4];
	static BigDecimal[][][] side1$ = new BigDecimal[4][PLAYERS][4];
	static BigDecimal[][][] side2$ = new BigDecimal[4][PLAYERS][4];
	static BigDecimal[][][] side3$ = new BigDecimal[4][PLAYERS][4];
	static BigDecimal[][][] side4$ = new BigDecimal[4][PLAYERS][4];
	static BigDecimal[][][] short$ = new BigDecimal[4][PLAYERS][4];
	...
	static final BigDecimal preflopMinBetSizeBD = BBBetBD.add(SBBetBD); // BB * 1.5
	static final BigDecimal betMultiplierBD = new BigDecimal(.5); // Times pot size
