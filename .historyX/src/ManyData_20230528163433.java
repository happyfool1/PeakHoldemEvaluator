...
public class ManyData implements Constants {
	...
	****************************************************************************** */
	...
	static void initialize() {
		...
		for (int i = 0; i < TYPE1755_SIZE; i++) {
			for (int j = 0; j < DRAW_SIZE_HANDS; j++) {
				type1755Draw[i][j] = 0;
			}
			for (int j = 0; j < MADE_SIZE_HANDS; j++) {
				type1755Made[i][j] = 0;
		...
		for (int i = 0; i < DRAW_SIZE_HANDS; i++) {
			drawArrayFlop[i] = 0;
			drawArrayTurn[i] = 0;
		}
		for (int i = 0; i < MADE_SIZE_HANDS; i++) {
			madeArrayFlop[i] = 0;
			madeArrayTurn[i] = 0;
			madeArrayRiver[i] = 0;
		}
	...
	static int[] drawArrayFlop = new int[DRAW_SIZE_HANDS];
	static int[] drawArrayTurn = new int[DRAW_SIZE_HANDS];

	static int[] madeArrayFlop = new int[MADE_SIZE_HANDS];
	static int[] madeArrayTurn = new int[MADE_SIZE_HANDS];
	static int[] madeArrayRiver = new int[MADE_SIZE_HANDS];
	...
	static int[] madeHandArray = new int[MADE_SIZE_HANDS];
	static int[] bestDrawArray = new int[BEST_SIZE_HANDS];
	...
	*/
	 ...
	 ****************************************************************************** */
	static int[][] hmlDraw = new int[HML_FLOP_SIZE][DRAW_SIZE_HANDS];
	static int[][] hmlMade = new int[HML_FLOP_SIZE][MADE_SIZE_HANDS];
	static int[][] hmlShowdown = new int[HML_FLOP_SIZE][MADE_SIZE_HANDS];

	static int[][] hhmlDraw = new int[HML_SIZE_TURN][DRAW_SIZE_HANDS];
	static int[][] hhmlMade = new int[HML_SIZE_TURN][MADE_SIZE_HANDS];
	static int[][] hhmlShowdown = new int[HML_SIZE_TURN][MADE_SIZE_HANDS];

	static int[][] hhhmlMade = new int[HML_SIZE_RIVER][MADE_SIZE_HANDS];
	static int[][] hhhmlShowdown = new int[HML_SIZE_RIVER][MADE_SIZE_HANDS];

	static int[][] typeDraw = new int[4][DRAW_SIZE_HANDS];
	static int[][] typeMade = new int[4][MADE_SIZE_HANDS];
	static int[][] typeShowdown = new int[4][MADE_SIZE_HANDS];

	static int[][] sumOfDraw = new int[36][DRAW_SIZE_HANDS];
	static int[][] sumOfMade = new int[36][MADE_SIZE_HANDS];
	static int[][] sumOfShowdown = new int[36][MADE_SIZE_HANDS];

	static int[][] wetDryDraw = new int[4][DRAW_SIZE_HANDS];
	static int[][] wetDryMade = new int[4][MADE_SIZE_HANDS];
	static int[][] wetDryShowdown = new int[4][MADE_SIZE_HANDS];

	static int[][] type1755Draw = new int[TYPE1755_SIZE][DRAW_SIZE_HANDS];
	static int[][] type1755Made = new int[TYPE1755_SIZE][MADE_SIZE_HANDS];
	static int[][] type1755Showdown = new int[TYPE1755_SIZE][MADE_SIZE_HANDS];

	static int[][] flopIndexDraw = new int[FLOP_INDEX_SIZE][DRAW_SIZE_HANDS];
	static int[][] flopIndexMade = new int[FLOP_INDEX_SIZE][MADE_SIZE_HANDS];
	static int[][] flopIndexShowdown = new int[FLOP_INDEX_SIZE][MADE_SIZE_HANDS];

	static int[][] handValueDraw = new int[HAND_VALUE_SIZE][DRAW_SIZE_HANDS];
	static int[][] handValueMade = new int[HAND_VALUE_SIZE][MADE_SIZE_HANDS];
	static int[][] handValueShowdown = new int[HAND_VALUE_SIZE][MADE_SIZE_HANDS];
