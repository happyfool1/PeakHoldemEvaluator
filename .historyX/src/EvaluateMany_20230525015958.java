...
public class EvaluateMany implements Constants {
	...
	static void initialize() {
		...
		/*- ******************************************************************
	 * Initialized HML arrays  
	**********************************************************************/
	static void initializeHMLArrays() {
		for (int i = 0; i < HML_SIZE_FLOP; i++) {
            hmlWonAtShowdown[i] = 0;
            hmlDrawNone[i] = 0;
            hmlDrawBoardPair[i] = 0;
            hmlDrawPairedWithBoard[i] = 0;
            hmlDrawGutshot[i] = 0;
            hmlDrawStraight[i] = 0;
            hmlDrawOESD[i] = 0;
            hmlDrawFlush[i] = 0;
            hmlDrawFlushOESD[i] = 0;
			hmlMadeNone[i] = 0;
			hmlMadePair[i] = 0;
			hmlMadeTwoPair[i] = 0;
			hmlMadeSet[i] = 0;
			hmlMadeStraight[i] = 0;
			hmlMadeFlush[i] = 0;
			hmlMadeFullHouse[i] = 0;
			hmlMadeFourOfAKind[i] = 0;
			hmlMadeStraightFlush[i] = 0;
			hmlMadeRoyalFlush[i] = 0;
		}
