...
public class GUIAlalizeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private static final Font fc = new Font("Dialog", Font.PLAIN, 44);
    ...
    *******************************************************************************/
    public void myFrame() {
        ...
        panelRadioHands.setBounds(100 ,100, 450, 50);
        ...
        panelControl.setBounds(100, 800, 450, 50);
        mainPanel.add(panelControl);

        panelCheckBoxes = new JPanel(new GridLayout(6, 1));
        panelCheckBoxes.setBounds(100, 200, 450, 550);
