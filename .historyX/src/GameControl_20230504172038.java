...
public class GameControl implements Constants {
	...
	**************************************************************************** */
	static void preflopSimulationOneHand() {
		...
		System.out.println(
				...
				System.out.println(
				"//positions  " + EvalData.positions[0);	
		createPlayers();
		seat = seatSB;
		playerBetSB();
		seat = seatBB;
	...
	*******************************************************************************/
	...
	/*- **************************************************************************** 
	* This method sets the players seat number intpEvalData.positions array
	* EvalData.positions  indexed by seat returns position ( SB, BB, UTG, MO, CO, BU)
	*******************************************************************************/
	private static void setPositions() {
		for (int i = 0; i < PLAYERS; i++) {
			EvalData.positions[i] = EvalData.playerPositions[i]] = i;
		}
	}
