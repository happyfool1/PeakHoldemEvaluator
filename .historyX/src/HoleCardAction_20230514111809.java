...
public class HoleCardAction implements Constants, java.io.Serializable {
    ...
    ****************************************************************************** */
    ...
    int[][] actionArrayPlayabilityRaise = new int[POS][5];
    ...
    int[][][] gapsArrayRaise = new int[POSITIONS][5][HANDS];
    int[][][] gapsArrayCall = new int[POSITIONS][5][HANDS];

   int[][][] rangeArrayRaise = new int POSITIONS][5][HANDS];
    int[][][] rangeArrayCall = new int [POSITIONS][5][HANDS];
