...
public class ManyData implements Constants {
	...
	*/
	...
	static int[][] sumOfMade = new int[36P][MADE_MAX_HANDS];
	...
	static int[][] flopIndexDraw = new int[TYPE1755_MAX][DRAW_MAX_HANDS];
	static int[][] flopIndexMade = new int[TYPE1755_MAX][DRAW_MAX_HANDS];
	static int[] flopIndexShowdown = new int[TYPE1755_MAX];
