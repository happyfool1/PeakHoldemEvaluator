...
public class ManyData implements Constants {
	...
	*/
	...
	static int[][]hhmlDraw = new int[HML_SIZE_FLOP][DRAW_MAX_HANDS];
	static int[][]hhmlMade = new int[HML_SIZE_FLOP][MADE_MAX_HANDS];
	static int[]hhmlShowdown = new int[HML_SIZE_FLOP];

	static int[][] hhhmlDraw = new int[HML_SIZE_FLOP][DRAW_MAX_HANDS];
	static int[][] hhhmlMade = new int[HML_SIZE_FLOP][MADE_MAX_HANDS];
	static int[] hhhmlShowdown = new int[HML_SIZE_FLOP];
