...
public class HandRangeConverter implements Constants {
	...
	void testRanges() {
		...
		rangeSB.buildRangePercentage(percentSB * j );
		rangeBB.buildRangePercentage(percentBB * j );
		rangeUTG.buildRangePercentage(percentUTG * j);
		rangeMP.buildRangePercentage(percentMP * j);
		rangeCO.buildRangePercentage(percentCO * j);
		rangeBU.buildRangePercentage(percentBU * j);
        ...
        rangeCO.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\CO\\Open.ser");
		rangeBU.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\BU\\Open.ser");
        ...
        rangeCO.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\CO\\Bet3.ser");
		rangeBU.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\BU\\Bet3.ser");
        ...
        rangeCO.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\CO\\Bet3Call.ser");
		rangeBU.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\BU\\Bet3Call.ser");
        ...
        rangeCO.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\CO\\Bet4.ser");
		rangeBU.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\BU\\Bet4.ser");
        ...
        rangeCO.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\CO\\Bet4Call.ser");
		rangeBU.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\BU\\Bet4Call.ser");
        ...
        rangeCO.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\CO\\Allin.ser");
		rangeBU.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\BU\\Allin.ser");
        ...
        rangeCO.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\CO\\AllinCall.ser");
		rangeBU.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\BU\\AllinCall.ser");

		rangeSB.buildRangePercentage(percentSB * i );
		rangeBB.buildRangePercentage(percentBB * i );
		rangeUTG.buildRangePercentage(percentUTG * i);
		rangeMP.buildRangePercentage(percentMP * i);
		rangeCO.buildRangePercentage(percentCO * i);
		rangeBU.buildRangePercentage(percentBU * i);
		rangeSB.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\SB\\Limp.ser");
		rangeBB.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\BB\\Limp.ser");
        rangeUTG.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\UTG\\Limp.ser");
		rangeMP.writeRange("C:\\PeakHoldemDatabase\\" + type + "\\Preflop\\MP\\Limp.ser");
