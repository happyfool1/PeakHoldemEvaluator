...
public class EvaluateMany implements Constants {
	...
	/*-  ******************************************************************************
	 * Update HML Arrays
	 * TODO in Analyze arrays like HML only done once not each time evalusteFlop is called
	 ****************************************************************************** */
	static void updateHMLArrays(){
	...
	static void initialize() {
		...
		for (int i = 0; i < HML_SIZE_FLOP; i++) {
            ManyData.hmlWonAtShowdown[i] = 0;
           	ManyData.hmlDrawNone[i] = 0;
            ManyData.hmlDrawBoardPair[i] = 0;
            ManyData.hmlDrawPairedWithBoard[i] = 0;
            ManyData.hmlDrawGutshot[i] = 0;
            ManyData.hmlDrawStraight[i] = 0;
            ManyData.hmlDrawOESD[i] = 0;
            ManyData.hmlDrawFlush[i] = 0;
            ManyData.hmlDrawFlushOESD[i] = 0;
			ManyData.hmlMadeNone[i] = 0;
			ManyData.hmlMadePair[i] = 0;
			ManyData.hmlMadeTwoPair[i] = 0;
			ManyData.hmlMadeSet[i] = 0;
			ManyData.hmlMadeStraight[i] = 0;
			ManyData.hmlMadeFlush[i] = 0;
			ManyData.hmlMadeFullHouse[i] = 0;
			ManyData.hmlMadeFourOfAKind[i] = 0;
			ManyData.hmlMadeStraightFlush[i] = 0;
			ManyData.hmlMadeRoyalFlush[i] = 0;
		}
