...
public class Player implements Constants {
	...
	private void doCalls() {
		...
		System.out.println(
				"//doCalls() seat " + this.seat + + " orbit " + EvalData.orbit + " betNowBD " + EvalData.betNowBD +  " moneyInBD " + EvalData.moneyInBD[this.seat]
				+ " call " + call + " stack " + EvalData.stackBD[this.seat] + " pot " +
						EvalData.potBD);
	}
