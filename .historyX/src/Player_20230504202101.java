...
public class Player implements Constants {
	...
	private void doRaises() {
		...
		if (this.action.action == OPEN) {
			bet = EvalData.preflopBet2SizeBD.add(EvalData.potBD);
		} else {
		...
		EvalData.betNowBD = this.betNow.add(bet);
		EvalData.moneyInBD[seat] = this.moneyIn;
		System.out.println("RRR " + temp + " " + this.call + " " + bet + " moneyIn " + this.moneyIn + "potBD " + EvalData.potBD
				+ " multiplier " + EvalData.betMultiplierBD + " "+EvalData.moneyInBD[seat]
				 + " " +EvalData.betNowBD + " " + EvalData.raisedToBD[0][seat][EvalData.orbit] );
	}
