...
public class HoleCardAction implements Constants {
    ...
    double [] percentage = new double[PLAYERS];
    int[] combos = new int[PLAYERS];
    ...
    static JTextField[] percentageText = new JTextField[PLAYERS];
    static JTextField[] combosText = new JTextField[PLAYERS];
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        final var panel0Layout = new GridLayout(5, 6);
        panel0.setLayout(panel0Layout);
        panel0.setSize(500, 500);
        panel0.setFont(f0);
        ...
        panelPercentage.setLayout(panelPercentageLayout);
        ...
        panelGaps.setLayout(panelCombosLayout);
        ...
        for (int i = 0; i < PLAYERS; ++i) {
            ...
            gapPercentageText[i] = new JTextField(String.valueOf(percentage[i]));
            gapCombosText[i] = new JTextField(String.valueOf(combos[i]));
        ...
        for (int i = 0; i < PLAYERS; ++i) {
            for (int j = 0; j < 5; ++j) {
                  actionArrayText[i][j][0]= new
                  JTextField(String.valueOf(actionArray[i][j][0]));
                  actionArrayText[i][j][0].setFont(f0);
                  actionArrayText[i][j][0].setSize(40,40);
                  panelAction.add(actionArrayText[i][j][0]);
                  actionArrayText[i][j][1]= new
                  JTextField(String.valueOf(actionArray[i][j][1]));
        ...
        final var frameDimN = new Dimension(500, 700);
