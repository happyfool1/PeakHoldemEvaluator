    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            openLimpText[i][1] = new JTextField(String.valueOf(actionArrayPlayability[i][0][1]));
            openLimpText[i][1].setFont(f0);
            openLimpText[i][1].setSize(40, 40);
            panelActionA.add(openLimpText[i][0][1]);

            openLimpText[i][2] = new JTextField(Format.format(actionArrayPercentage[i][0][0]));
            openLimpText[i][2].setFont(f0);
            openLimpText[i][2].setSize(40, 40);
            panelActionA.add(openLimpText[i][1]);
            openLimpText[i][3] = new JTextField(Format.format(actionArrayPercentage[i][0][1]));
            openLimpText[i][3].setFont(f0);
            openLimpText[i][4].setSize(40, 40);
            panelActionA.add(openLimpText[i][]);
        }
