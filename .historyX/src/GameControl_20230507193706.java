...
public class GameControl implements Constants {
	...
	*  Return uncalled bet
	...
	static void returnUncalledBet() {
		...
		EvalData.moneyInBD[seat] = EvalData.moneyInBD[seat]subtract(EvalData.lastBetBD);
		EvalData.stackBD[seat] = EvalData.stackBD[seat].add(EvalData.lastBetBD);
		EvalData.potBD = EvalData.potBD.add(EvalData.lastBetBD);
