...
public class GUIAlalizeMany extends JFrame implements ActionListener, Constants {
  ...
  private static final JCheckBox hhhmlShowdown = new JCheckBox("HHHML River Wins Showdown");
    ...
    private static final JCheckBox typeDraw = new JCheckBox("HML Draw");
    private static final JCheckBox typeMade = new JCheckBox("HML Made Hand");
    private static final JCheckBox typeShowdown = new JCheckBox("HML Wins Showdown");
