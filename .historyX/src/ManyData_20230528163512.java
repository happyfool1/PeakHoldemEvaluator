...
public class ManyData implements Constants {
	...
	*/
	...
	static int[][] hhmlDraw = new int[HML_TURN_SIZE][DRAW_SIZE_HANDS];
	static int[][] hhmlMade = new int[HML_TURN_SIZE][MADE_SIZE_HANDS];
	static int[][] hhmlShowdown = new int[HML_TURN_SIZE][MADE_SIZE_HANDS];
