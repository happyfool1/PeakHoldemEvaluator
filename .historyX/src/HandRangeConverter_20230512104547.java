...
public class HandRangeConverter implements Constants {
	...
	private static void copyDataPlayability() {
		...
		action.actionArrayPlayabilityRaise[SB][2] = rangeSBBet3.lowPlayabilitrhyArrayIndex;
		action.actionArrayPlayabilityCall[SB][2] = rangeSBBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArrayPlayabilityRaise[SB][3] = rangeSBBet4.lowPlayabilitrhyArrayIndex;
		...
		action.actionArrayPlayability[BB][0][0] = rangeBBOpen.lowPlayabilitrhyArrayIndex;
		action.actionArrayPlayability[BB][0][1] = rangeBBLimp.lowPlayabilitrhyArrayIndex;
		...
		action.actionArrayPlayability[UTG][0][0] = rangeUTGOpen.lowPlayabilitrhyArrayIndex;
		action.actionArrayPlayability[UTG][0][1] = rangeUTGLimp.lowPlayabilitrhyArrayIndex;
		...
		action.actionArrayPlayability[MP][0][0] = rangeMPOpen.lowPlayabilitrhyArrayIndex;
		action.actionArrayPlayability[MP][0][1] = rangeMPLimp.lowPlayabilitrhyArrayIndex;
		...
		action.actionArrayPlayability[CO][0][0] = rangeCOOpen.lowPlayabilitrhyArrayIndex;
		action.actionArrayPlayability[CO][0][1] = rangeCOLimp.lowPlayabilitrhyArrayIndex;
		...
		action.actionArrayPlayability[BU][0][0] = rangeBUOpen.lowPlayabilitrhyArrayIndex;
		action.actionArrayPlayability[BU][0][1] = rangeBULimp.lowPlayabilitrhyArrayIndex;
	...
	private static void copyDataCombos() {
		...
		action.actionArrayCombosRaise[SB][1] = rangeSBBet3.combos;
		action.actionArrayCombosCall[SB][1] = rangeSBCall.combos;
		action.actionArrayCombosRaise[SB][2] = rangeSBBet3.combos;
		action.actionArrayCombosCall[SB][2] = rangeSBBet3Call.combos;
		action.actionArrayCombosRaise[SB][3] = rangeSBBet4.combos;
		...
		action.actionArrayCombos[BB][0][0] = rangeBBOpen.combos;
		action.actionArrayCombos[BB][0][1] = rangeBBLimp.combos;
		...
		action.actionArrayCombos[UTG][0][0] = rangeUTGOpen.combos;
		action.actionArrayCombos[UTG][0][1] = rangeUTGLimp.combos;
		...
		action.actionArrayCombos[MP][0][0] = rangeMPOpen.combos;
		action.actionArrayCombos[MP][0][1] = rangeMPLimp.combos;
		...
		action.actionArrayCombos[CO][0][0] = rangeCOOpen.combos;
		action.actionArrayCombos[CO][0][1] = rangeCOLimp.combos;
		...
		action.actionArrayCombos[BU][0][0] = rangeBUOpen.combos;
		action.actionArrayCombos[BU][0][1] = rangeBULimp.combos;
	...
	private static void copyDataPercentage() {
		...
		action.actionArrayPercentageRaise[SB][2][0] = rangeSBBet3.percentage;
		action.actionArrayPercentageCall[SB][2] = rangeSBBet3Call.percentage;
		action.actionArrayPercentageRaise[SB][3] = rangeSBBet4.percentage;
		...
		action.actionArrayPercentage[BB][0][0] = rangeBBOpen.percentage;
		action.actionArrayPercentage[BB][0][1] = rangeBBLimp.percentage;
		...
		action.actionArrayPercentage[UTG][0][0] = rangeUTGOpen.percentage;
		action.actionArrayPercentage[UTG][0][1] = rangeUTGLimppercentage;
		...
		action.actionArrayPercentage[MP][0][0] = rangeMPOpen.percentage;
		action.actionArrayPercentage[MP][0][1] = rangeMPLimp.percentage;
		...
		action.actionArrayPercentage[CO][0][0] = rangeCOOpen.percentage;
		action.actionArrayPercentage[CO][0][1] = rangeCOLimp.percentage;
		...
		action.actionArrayPercentage[BU][0][0] = rangeBUOpen.percentage;
		action.actionArrayPercentage[BU][0][1] = rangeBULimp.percentage;
	...
	private static void copyDataGaps() {
		...
		action.actionArrayGapsRaise[SB][2] = rangeSBBet3.gaps;
		action.actionArrayGapsCall[SB][2] = rangeSBBet3Call.gaps;
		action.actionArrayGapsRaise[SB][3] = rangeSBBet4.gaps;
		...
		action.actionArrayGaps[BB][0][0] = rangeBBOpen.gaps;
		action.actionArrayGaps[BB][0][1] = rangeBBLimp.gaps;
		...
		action.actionArrayGaps[UTG][0][0] = rangeUTGOpen.gaps;
		action.actionArrayGaps[UTG][0][1] = rangeUTGLimp.gaps;
		...
		action.actionArrayGaps[MP][0][0] = rangeMPOpen.gaps;
		action.actionArrayGaps[MP][0][1] = rangeMPLimp.gaps;
		...
		action.actionArrayGaps[CO][0][0] = rangeCOOpen.gaps;
		action.actionArrayGaps[CO][0][1] = rangeCOLimp.gaps;
		...
		action.actionArrayGaps[BU][0][0] = rangeBUOPen.gaps;
		action.actionArrayGaps[BU][0][1] = rangeBULimp.gaps;
