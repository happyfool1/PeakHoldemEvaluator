...
public class PreflopAdjustments implements Constants {
  ...
  ******************************************************************************/
static final int[] adjustmentLimp = new int[] { 0, 0, 0, 0, 0,0,0}; 
static final BigDecimal[] adjustmentBetSize = new BigDecimal[] { zeroBD, zeroBD, zeroBD,zeroBD,zeroBD,zeroBD,zeroBD};
