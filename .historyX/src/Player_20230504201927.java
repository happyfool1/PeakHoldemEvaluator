...
public class Player implements Constants {
	...
	private void doRaises() {
		...
		EvalData.betNowBD = this.betNow.add(bet);
		EvalData.moneyInBD[seat] = this.moneyIn;
		System.out.println("RRR " + temp + " " + this.call + " " + bet + "  " + this.moneyIn + " " + EvalData.potBD
				+ " " + EvalData.betMultiplierBD + " "+EvalData.moneyInBD[seat] + " " +EvalData.betNowBD + " " + EvalData.raisedToBD[0][seat][EvalData.orbit] );
	}
