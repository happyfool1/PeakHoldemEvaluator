    ...
    *******************************************************************************/
    private static final int[] handsArrayPioSolver = { UTG, UTG, UTG, UTG, UTG, UTG, UTG, UTG, UTG, UTG, UTG, UTG, UTG,
            ...
            public static final double[] VALUES_DOUBLE = {
                1.522, 1.442, 1.291, 1.178, 1.154, 1.087, 1.062, 1.005, 0.980, 0.923,
                0.908, 0.851, 0.826, 0.801, 0.744, 0.729, 0.672, 0.647, 0.622, 0.597,
                0.572, 0.547, 0.522, 0.497, 0.472, 0.447, 0.422, 0.397, 0.372, 0.347,
                0.322, 0.297, 0.272
            };

            public static final String[] _STRING = {
                "AA", "KK", "QQ", "AKs", "AQs", "AJs", "ATs", "KQs", "KJs", "QJs", "QTs", "JTs", "T9s", "T8s", "98s", "97s", "87s", "76s", "65s", "54s", "AKo", "ATo", "KQo", "KJo", "QJo", "JTo", "T9o", "87o", "76o", "65o", "54o"
            };
