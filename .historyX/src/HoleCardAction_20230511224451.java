    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            actionArrayPercentageTextA[i][0][2] = new JTextField(String.valueOf(actionArrayPercentage[i][0][0]));
            actionArrayPercentageTextA[i][0][2].setFont(f0);
            actionArrayPercentageTextA[i][0][2].setSize(40, 40);
            panelActionA.add(actionArrayPercentageTextA[i][2][0]);
            actionArrayPercentageTextA[i][0][3] = new JTextField(String.valueOf(actionArrayPercentage[i][0][1]));
            actionArrayPercentageTextA[i][0][3].setFont(f0);
            actionArrayPercentageTextA[i][0][3].setSize(40, 40);
            panelActionA.add(actionArrayPercentageTextA[i][3][1]);
