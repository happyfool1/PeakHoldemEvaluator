...
public class GameControl implements Constants {
	...
	**************************************************************************** */
	...
	private static void createRanges() {
		...
		nit = nit.readFromFile(EvalData.applicationDirectory + "nit-HandRangeMultiple.ser");
		lag = lag.readFromFile(EvalData.applicationDirectory + "lag-HandRangeMultiple.ser");
		tag = tag.readFromFile(EvalData.applicationDirectory + "tag-HandRangeMultiple.ser");
		test = test.readFromFile(EvalData.applicationDirectory + "test-HandRangeMultiple.ser");
		reg = reg.readFromFile(EvalData.applicationDirectory + "reg-HandRangeMultiple.ser");
		looser = looser.readFromFile(EvalData.applicationDirectory + "looser-HandRangeMultiple.ser");
	}
