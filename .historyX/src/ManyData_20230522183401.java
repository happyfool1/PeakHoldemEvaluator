...
public class ManyData implements Constants {
	/*-  ******************************************************************************
	 * Copied from OneHand - Updated foe each hand played
	...
	static int[] sumOfHandValuesFlopArray = new int[30];
	static int[] sumOfBoardValuesFlopArray = new int[70];
	static int[] sumOfHoleCardValuesArray = new int[20];

	static int[] flopSumOfDigitsArray = new int[30];

	static int[] hmlArrayFlop = new int[HML_SIZE+FLOP_BOARD_PAIRED];
	static int[] hmlArrayTurn = new int[HML_SIZE+TURN];
	static int[] hmlArrayRiver = new int[HML_SIZE];
	...
	static double[] hmlArrayPer = new double[HML_SIZE];
