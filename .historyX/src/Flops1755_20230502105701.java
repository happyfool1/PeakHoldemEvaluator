...
public class Flops1755 implements java.io.Serializable {
	...
	/*- **************************************************************************************************
	 * Return a flop as a String
	* Arg0 - Index into array of flops
	  ***************************************************************************************************/
	private static String get(int index) {
		final var a = new Card(flops[index][0]);
		final var b = new Card(flops[index][1]);
		final var c = new Card(flops[index][2]);
		var st = "";
		st = new StringBuilder().append(a.toString()).append(b.toString()).append(c.toString()).toString();
		return st;
	}
