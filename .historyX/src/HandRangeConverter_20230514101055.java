...
public class HandRangeConverter implements Constants {
	...
	// Copy HandRange from HandRange into HoleCardAction
	private static void copyDataRanges() {
		for (int i = 0; i < HANDS; i++) {
			 action.ranges[positions][5][i] = rangeSBOpen.rangeArray[i];
			 action.RANGE_ST[SB][i] = rangeSBOPen.gapsArray[i];
	}
}
	...
	private static void copyData() {
		for (int i = 0; i < HANDS; i++) {
			action.gapsArrayRaise[SB][i] = rangeSBLimp.gapsArrayRaise[i];
			action.gapsArrayRaise[SB][i] = rangeSBOpen.gapsArrayRaise[i];
			action.gapsArrayRaise[SB][i] = rangeSBCall.gapsArrayRaise[i];
			action.gapsArrayRaise[SB][i] = rangeSBBet3.gapsArrayRaise[i];
			action.gapsArrayRaise[SB][i] = rangeSBBet3Call.gapsArrayRaise[i];
			action.gapsArrayRaise[SB][i] = rangeSBBet4.gapsArrayRaise[i];
			action.gapsArrayRaise[SB][i] = rangeSBBet4Call.gapsArrayRaise[i];
			action.gapsArrayRaise[SB][i] = rangeSBAllin.gapsArrayRaise[i];
			action.gapsArrayRaise[SB][i] = rangeSBAllinCall.gapsArrayRaise[i];
			action.gapsArrayRaise[BB][i] = rangeBBLimp.gapsArrayRaise[i];
			action.gapsArrayRaise[BB][i] = rangeBBOpen.gapsArrayRaise[i];
			action.gapsArrayRaise[BB][i] = rangeBBCall.gapsArrayRaise[i];
			action.gapsArrayRaise[BB][i] = rangeBBBet3.gapsArrayRaise[i];
			action.gapsArrayRaise[BB][i] = rangeBBBet3Call.gapsArrayRaise[i];
			action.gapsArrayRaise[BB][i] = rangeBBBet4.gapsArrayRaise[i];
			action.gapsArrayRaise[BB][i] = rangeBBBet4Call.gapsArrayRaise[i];
			action.gapsArrayRaise[BB][i] = rangeBBAllin.gapsArrayRaise[i];
			action.gapsArrayRaise[BB][i] = rangeBBAllinCall.gapsArrayRaise[i];
			action.gapsArrayRaise[UTG][i] = rangeUTGLimp.gapsArrayRaise[i];
			action.gapsArrayRaise[UTG][i] = rangeUTGOpen.gapsArrayRaise[i];
			action.gapsArrayRaise[UTG][i] = rangeUTGCall.gapsArrayRaise[i];
			action.gapsArrayRaise[UTG][i] = rangeUTGBet3.gapsArrayRaise[i];
			action.gapsArrayRaise[UTG][i] = rangeUTGBet3Call.gapsArrayRaise[i];
			action.gapsArrayRaise[UTG][i] = rangeUTGBet4.gapsArrayRaise[i];
			action.gapsArrayRaise[UTG][i] = rangeUTGBet4Call.gapsArrayRaise[i];
			action.gapsArrayRaise[UTG][i] = rangeUTGAllinCall.gapsArrayRaise[i];
			action.gapsArrayRaise[MP][i] = rangeMPLimp.gapsArrayRaise[i];
			action.gapsArrayRaise[MP][i] = rangeMPOpen.gapsArrayRaise[i];
			action.gapsArrayRaise[MP][i] = rangeMPCall.gapsArrayRaise[i];
			action.gapsArrayRaise[MP][i] = rangeMPBet3.gapsArrayRaise[i];
			action.gapsArrayRaise[MP][i] = rangeMPBet3Call.gapsArrayRaise[i];
			action.gapsArrayRaise[MP][i] = rangeMPBet4.gapsArrayRaise[i];
			action.gapsArrayRaise[MP][i] = rangeMPBet4Call.gapsArrayRaise[i];
			action.gapsArrayRaise[MP][i] = rangeMPAllin.gapsArrayRaise[i];
			action.gapsArrayRaise[MP][i] = rangeMPAllinCall.gapsArrayRaise[i];
			action.gapsArrayRaise[CO][i] = rangeCOLimp.gapsArrayRaise[i];
			action.gapsArrayRaise[CO][i] = rangeCOOpen.gapsArrayRaise[i];
			action.gapsArrayRaise[CO][i] = rangeCOCall.gapsArrayRaise[i];
			action.gapsArrayRaise[CO][i] = rangeCOBet3.gapsArrayRaise[i];
			action.gapsArrayRaise[CO][i] = rangeCOBet3Call.gapsArrayRaise[i];
			action.gapsArrayRaise[CO][i] = rangeCOBet4.gapsArrayRaise[i];
			action.gapsArrayRaise[CO][i] = rangeCOBet4Call.gapsArrayRaise[i];
			action.gapsArrayRaise[CO][i] = rangeCOAllin.gapsArrayRaise[i];
			action.gapsArrayRaise[CO][i] = rangeCOAllinCall.gapsArrayRaise[i];
			action.gapsArrayRaise[BU][i] = rangeBULimp.gapsArrayRaise[i];
			action.gapsArrayRaise[BU][i] = rangeBUOpen.gapsArrayRaise[i];
			action.gapsArrayRaise[BU][i] = rangeBUCall.gapsArrayRaise[i];
			action.gapsArrayRaise[BU][i] = rangeBUBet3.gapsArrayRaise[i];
			action.gapsArrayRaise[BU][i] = rangeBUBet3Call.gapsArrayRaise[i];
			action.gapsArrayRaise[BU][i] = rangeBUBet4.gapsArrayRaise[i];
			action.gapsArrayRaise[BU][i] = rangeBUBet4Call.gapsArrayRaise[i];
			action.gapsArrayRaise[BU][i] = rangeBUAllin.gapsArrayRaise[i];
			action.gapsArrayRaise[BU][i] = rangeBUAllinCall.gapsArrayRaise[i];
		}
	}
