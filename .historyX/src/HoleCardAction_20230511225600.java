...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
       ...
       //      actionArrayPlayabilityTextA[i][1][0] = new JTextField(Format.format(actionArrayPercentage[i][0][0]));
       ...
       //     actionArrayPlayabilityTextA[i][1][0].setSize(40, 40);
        ...
        //    actionArrayPlayabilityTextA[i][1][1] = new JTextField(Format.format(actionArrayPercentage[i][0][1]));
