...
public class ReplaceStringInAllJavaFiles {
	...
	//	final var directoryPath = "C:\\users\\PEAK_\\git\\repository\\evaluate_streets\\src\\evaluate_streets";
		...
		final var searchString = "Showdown.java
		SortCards.java
		StaticFlops.java
		TableImage.java
		Temp.java
		Test.java
		TexasHoldemCalculator.java
		Timer.java
		UserAccount
		WetDry.java
		Window.java
		...
		FileReadWrite.java
		FileUtils.java
		Flop1755Methods.java
		FlopAsNumbers.java
		FlopCombinationsWithHoleCards
		Flops1755.java
		Format.java
		GameControl.java
		GetImages.java
		...
		Player.java
		Popup.java
		PositionStringForSeat.java
		Possible.java
		PreflopRanges.java
		RangeComparator.java
		ReplaceStringInAllJavaFiles.java
		ReportManyHands.java
		ReportOneHand.java
		SearchAll.java
		SeatPanel.java";
