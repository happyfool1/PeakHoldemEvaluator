...
public class EvaluateMany implements Constants {
	...
	static void calculate() {
		...
		ManyData.hmlArrayTurnPer = calculatePercentagesArrays(ManyData.hmlArrayTurn, ManyData.flopArraysCount);
		ManyData.hmlArrayRiverPer = calculatePercentagesArrays(ManyData.hmlArrayRiver, ManyData.flopArraysCount);
