...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    JTextField[] carlowPlayabilitrhyArrayIndexdsText = new JTextField[PLAYERS];
    JTextField[][] gapArrayText = new JTextField[PLAYERS][HANDS];
    ...
    void constructPanel() {
        ...
        final var panel0Layout = new GridLayout(PLAYERS, PLAYERS);
        for (int i = 0; i < PLAYERS; ++i) {
            cardsText[i].setText(cards[i]);
            lowRangeArrayIndexText[i].setText(String.valueOf(lowRangeArrayIndex[i]));
            carlowPlayabilitrhyArrayIndexdsText[i].setText(String.valueOf(lowPlayabilitrhyArrayIndex[i]));
            carlowPlayabilitrhyArrayIndexdsText[i].setText(String.valueOf(carlowPlayabilitrhyArrayIndex[i]));
            carlowPlayabilitrhyArrayIndexdsText[i].setText(String.valueOf(carlowPlayabilitrhyArrayIndex[i]));
            gapArrayText[i][0].setText(String.valueOf(gapCount[i]));
            gapArrayText[i][1].setText(String.valueOf(gapsArray[i][0]));
            gapArrayText[i][2].setText(String.valueOf(gapsArray[i][1]));
