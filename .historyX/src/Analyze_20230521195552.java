	...
	***************************************************************************************************/
	...
	private static void cardsAndBoardTurn(int seat) {
		...
		|| EvalData.both[4] == null || EvalData.both[5] == null) {
			System.out.println("Error:TurnA " +EvalData.both[0] + " " + EvalData.both[1] +
			 " " + EvalData.both[2] + " " + EvalData.both[3] + " " + EvalData.both[);	
		}
		for (int i = 0; i < 4; i++) {
		...
		EvalData.both[2] == null || EvalData.both[3] == null
		|| EvalData.both[4] == null || EvalData.both[5] == null) {
			System.out.println("Error:TurnB cardsAndBoardFlop: both arrays are null");	
		}
