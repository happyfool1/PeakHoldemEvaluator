    ...
    *  Construct panel. 
    ...
    void constructPanel(String title) {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            openText[i][0] = new JTextField(String.valueOf(this.rangeArrayRaise[i][0].this.high)
                    + "  " + playabilityArray[high]);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            openText[i][1] = new JTextField(Format.formatPer(this.rangeArrayRaise[i][0]));
