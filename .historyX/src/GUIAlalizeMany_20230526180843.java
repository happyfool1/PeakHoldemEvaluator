...
public class GUIAlalizeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private JPanel panelCheckBoxesHML  = new JCheckBox("HML Flop");


    private JPanel panelCheckBoxesHHML  = new JCheckBox("HHML Turn");


  private JPanel panelCheckBoxesHHHML  = new JCheckBox("HHHML River");


    private JPanel panelCheckBoxesSumOfFlop  = new JCheckBox("Sum of Flop Card Values");


    private JPanel panelCheckBoxesType  = new JCheckBox("Ed Miller Type);


    private JPanel panelCheckBoxesWetDry  = new JCheckBox("Wet/Dry Static/Dynamic ");
