...
public class GUIAlalizeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private JPanel panelCheckBoxesHML  = new JCheckBox("Detailed Report");


    private JPanel panelCheckBoxesHHML  = new JCheckBox("Detailed Report");


  private JPanel panelCheckBoxesHHHML  = new JCheckBox("Detailed Report");


    private JPanel panelCheckBoxesSumOfFlop  = new JCheckBox("Detailed Report");


    private JPanel panelCheckBoxesType  = new JCheckBox("Detailed Report");


    private JPanel panelCheckBoxesWetDry  = new JCheckBox("Detailed Report");
