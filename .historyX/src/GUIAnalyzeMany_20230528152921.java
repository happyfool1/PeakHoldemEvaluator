...
public class GUIAnalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    *******************************************************************************/
    public void myFrame() {
        ...
        Border hmlFlopBoarder= BorderFactory.createTitledBorder("Flop nHML Reports");
        ...
        Border hmlTurnBorder= BorderFactory.createTitledBorder("Turnn HML Reports");
        panelCheckBoxesHML.setBorder(hmlTurnBorder);
