...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            for (int j = 0; j < 5; ++j) {
                actionArrayPlayabilityText[i][j][0] = new JPlayabilityTextField(String.valueOf(actionArrayPlayability[i][j][0]));
                ...
                actionArrayPlayabilityText[i][j][1] = new JPlayabilityTextField(String.valueOf(actionArrayPlayability[i][j][1]));
