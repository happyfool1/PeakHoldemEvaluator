...
public class GameControl implements Constants {
	...
	**************************************************************************** */
	...
	private static void createPlayers() {
		...
		players[CO] = new Player(averageX);
	...
	private static void createRanges() {
		...
		averageX = averageX.readFromFile(EvalData.applicationDirectory + "averageX-HandRangeMultiple.ser");
		hero = hero.readFromFile(EvalData.applicationDirectory + "hero-HandRangeMultiple.ser");
		average =average.readFromFile(EvalData.applicationDirectory + "average-HandRangeMultiple.ser");
		fish = fish.readFromFile(EvalData.applicationDirectory + "fish-HandRangeMultiple.ser");
		hero.readFromFile(EvalData.applicationDirectory + "hero-HandRangeMultiple.ser");
		average.readFromFile(EvalData.applicationDirectory + "average-HandRangeMultiple.ser");
		nit.readFromFile(EvalData.applicationDirectory + "nit-HandRangeMultiple.ser");
		lag.readFromFile(EvalData.applicationDirectory + "lag-HandRangeMultiple.ser");
		tag.readFromFile(EvalData.applicationDirectory + "tag-HandRangeMultiple.ser");
		test.readFromFile(EvalData.applicationDirectory + "test-HandRangeMultiple.ser");
		reg.readFromFile(EvalData.applicationDirectory + "reg-HandRangeMultiple.ser");
		looser.readFromFile(EvalData.applicationDirectory + "looser-HandRangeMultiple.ser");
