...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    int[] gapCount = new int[PLAYERS];
     *****************************************************************************/
    private JTextField [][][][][] actionArrayText = new JTextField[PLAYERS][5][2];
    private JTextField [] cardsText = new JTextField[PLAYERS];
    private JTextField [] lowRangeArrayIndexText = new JTextField[PLAYERS];
    private JTextField [] carlowPlayabilitrhyArrayIndexdsText = new JTextField[PLAYERS];
    private JTextField [][]  gapArrayText = new JTextField[PLAYERS][HANDS];
    private JTextField [][]  rangeArrayText = new JTextField[PLAYERS][HANDS];
