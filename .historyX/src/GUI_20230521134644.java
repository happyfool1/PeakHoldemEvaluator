...
public class GUI extends JFrame implements ActionListener, Constants {
	...
	private static final JButton fullSimulation = new JButton("Data Collection");
	...
	private static final JCheckBox freezeSeat = new JCheckBox("Freeze Seat 1");
	...
	****************************************************************************** */
	 ...
	 *  ****************************************************************************** */
	private void doPreflopSimulationDataCollection() {
		int number = 0;
		...
		if (response != null && !response.isEmpty()) {
			...
			Evaluate.doPreflopSimulationDataCollection(number);
		}
	...
	* a radio button or control button.
	...
	public void actionPerformed(ActionEvent e) {
		...
		switch (action) {
			...
			case "Step" -> doStep();
			case "Reset" -> doReset();
			case "Data Collection" -> doPreflopSimulationDataCollection();
