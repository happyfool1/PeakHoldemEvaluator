    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3Text[i][0].setBackground(PINK);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3Text[i][1].setBackground(PINK);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3Text[i][2].setBackground(PINK);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3Text[i][3].setBackground(PINK);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinCallText[i][0].setBackground(KHAKI);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            allinCallText[i][1] = new JTextField(Format.formatPer(actionArrayPercentageRaise[i][4]));
                     ...
                     allinCallText[i][1].setBackground(KHAKI);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinCallText[i][2].setBackground(KHAKI);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinCallText[i][3].setBackground(KHAKI);
