    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            panelActionA.add(actionArrayPlayabilityTextB[i][0][0]);
            actionArrayPlayabilityTextB[i][1][1] = new JTextBField(String.valueOf(actionArrayPlayability[i][0][1]));
            actionArrayPlayabilityTextB[i][1][1].setFont(f0);
            actionArrayPlayabilityTextB[i][1][1].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextB[i][1][1]);
        }
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            actionArrayPlayabilityTextC[i][2][0] = new JTextCField(String.valueOf(actionArrayPlayability[i][2][0]));
            actionArrayPlayabilityTextC[i][2][0].setFont(f0);
            actionArrayPlayabilityTextC[i][2][0].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextC[i][2][0]);
            actionArrayPlayabilityTextC[i][2][1] = new JTextCField(String.valueOf(actionArrayPlayability[i][2][1]));
            actionArrayPlayabilityTextC[i][2][1].setFont(f0);
            actionArrayPlayabilityTextC[i][2][1].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextC[i][2][1]);
        }
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            actionArrayPlayabilityTextD[i][3][0] = new JTextDField(String.valueOf(actionArrayPlayability[i][3][0]));
            actionArrayPlayabilityTextD[i][3][0].setFont(f0);
            actionArrayPlayabilityTextD[i][3][0].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextD[i][3][0]);
            actionArrayPlayabilityTextD[i][3][1] = new JTextDField(String.valueOf(actionArrayPlayability[i][3][1]));
            actionArrayPlayabilityTextD[i][3][1].setFont(f0);
            actionArrayPlayabilityTextD[i][3][1].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextD[i][3][1]);
        }
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            actionArrayPlayabilityTextE[i][4][0] = new JTextEField(String.valueOf(actionArrayPlayability[i][4][0]));
            actionArrayPlayabilityTextE[i][4][0].setFont(f0);
            actionArrayPlayabilityTextE[i][4][0].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextE[i][4][0]);
            actionArrayPlayabilityTextE[i][4][1] = new JTextEField(String.valueOf(actionArrayPlayability[i][4][1]));
            actionArrayPlayabilityTextE[i][4][1].setFont(f0);
            actionArrayPlayabilityTextE[i][4][1].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextE[i][4][1]);
        }
