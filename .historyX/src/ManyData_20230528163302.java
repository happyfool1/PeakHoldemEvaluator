...
public class ManyData implements Constants {
	...
	****************************************************************************** */
	...
	static void initialize() {
		...
		for (int i = 0; i < HML_RIVER_SIZE; i++) {
			for (int j = 0; j < MADE_MAX_HANDS_SIZE; j++) {
				hhhmlMade[i][j] = 0;
				hhhmlShowdown[i][j] = 0;
			}
		}
	...
	*/
	...
	static int[][] hmlShowdown = new int[HML_SIZE_FLOP][MADE_MAX_HANDS];

	static int[][] hhmlDraw = new int[HML_SIZE_TURN][DRAW_MAX_HANDS];
	static int[][] hhmlMade = new int[HML_SIZE_TURN][MADE_MAX_HANDS];
	static int[][] hhmlShowdown = new int[HML_SIZE_TURN][MADE_MAX_HANDS];

	static int[][] hhhmlMade = new int[HML_SIZE_RIVER][MADE_MAX_HANDS];
	static int[][] hhhmlShowdown = new int[HML_SIZE_RIVER][MADE_MAX_HANDS];

	static int[][] typeDraw = new int[4][DRAW_MAX_HANDS];
	static int[][] typeMade = new int[4][MADE_MAX_HANDS];
	static int[][] typeShowdown = new int[4][MADE_MAX_HANDS];

	static int[][] sumOfDraw = new int[36][DRAW_MAX_HANDS];
	static int[][] sumOfMade = new int[36][MADE_MAX_HANDS];
	static int[][] sumOfShowdown = new int[36][MADE_MAX_HANDS];

	static int[][] wetDryDraw = new int[4][DRAW_MAX_HANDS];
	static int[][] wetDryMade = new int[4][MADE_MAX_HANDS];
	static int[][] wetDryShowdown = new int[4][MADE_MAX_HANDS];

	static int[][] type1755Draw = new int[TYPE1755_MAX][DRAW_MAX_HANDS];
	static int[][] type1755Made = new int[TYPE1755_MAX][MADE_MAX_HANDS];
	static int[][] type1755Showdown = new int[TYPE1755_MAX][MADE_MAX_HANDS];

	static int[][] flopIndexDraw = new int[FLOP_INDEX_MAX][DRAW_MAX_HANDS];
	static int[][] flopIndexMade = new int[FLOP_INDEX_MAX][MADE_MAX_HANDS];
	static int[][] flopIndexShowdown = new int[FLOP_INDEX_MAX][MADE_MAX_HANDS];

	static int[][] handValueDraw = new int[HAND_VALUE_MAX][DRAW_MAX_HANDS];
	static int[][] handValueMade = new int[HAND_VALUE_MAX][MADE_MAX_HANDS];
	static int[][] handValueShowdown = new int[HAND_VALUE_MAX][MADE_MAX_HANDS];
