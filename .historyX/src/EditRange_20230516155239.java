...
class EditRange implements Constants {
	...
	HandRangeMUltiple range1 = new HandRange();
	HandRangeMuktiple rangeShadow = new HandRange();
	HandRangeMultiple rangeShadow2 = new HandRange();
	Color range1Color;
	...
	*********************************************************************************/
	EditRange(String typ, int position, int betTYpe, boolean raiseOrCall ) {
		...
		position = 0;
		fileName = EvalData.applicationDirectory + type + "HandRangeMultiple.ser";
		shadow = fileShadow = "";
		rangesToEdit();
		doFrame();
