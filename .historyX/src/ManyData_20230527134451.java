...
public class ManyData implements Constants {
	...
	*/
	...
	static int[][] type755Draw = new int[HML_SIZE_FLOP][4];
	static int[][] type1755TypeMade = new int[HML_SIZE_FLOP][4];
	static int[] type1755TypeShowdown = new int[HML_SIZE_FLOP];
