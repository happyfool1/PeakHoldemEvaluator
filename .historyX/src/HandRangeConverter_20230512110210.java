...
public class HandRangeConverter implements Constants {
	...
	// BET2
		action.actionArrayCombosRaise[SB][1] = rangeSBLimp.lowPlayabilitrhyArrayIndex;
		action.actionArrayCombosCall[SB][1] = rangeSBBet3.combos;
	// BET3
		action.actionArrayCombosRaise[SB][2] = rangeSBCall.combos;
		action.actionArrayCombosCall[SB][2] = rangeSBBet3.combos;
	// BET4
		action.actionArrayCombosRaise[SB][2] = rangeSBBet3Call.combos;
	 	action.actionArrayCombosCall[SB][3] = rangeSBBet4.combos;
		// ALLIN
	...
	private static void copyDataPercentage() {
		...
		// BET4
		action.actionArrayPercentageRaise[SB][3] = rangeSBBet4Call.percentage;
		action.actionArrayPercentageCall[SB][3] = rangeSBAllin.percentage;
		action.actionArrayPlayabilityCall[SB][3] = rangeSBBet4Call.lowPlayabilitrhyArrayIndex;
		// ALLIN
