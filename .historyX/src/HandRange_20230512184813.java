...
/*-  ****************************************************************************
	...
	/*- ****************************************************************************
     * Get range highest ( worst ) playability in
     * 
     ******************************************************************************/
	private int getRangeHigh() {
        double rangePercent = 0;
        if (this.lowRangeArrayIndex > 1) {
            rangePercent = (double) this.rangeArray[this.lowRangeArrayIndex - 1] / (double) this.rangeArray[this.lowRangeArrayIndex];
        }
        return rangePercent;
    }
