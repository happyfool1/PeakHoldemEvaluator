...
public class ManyData implements Constants {
	...
	*/
	 ...
	 ****************************************************************************** */
	static int[][] hmlDraw = new int[HML_SIZE_FLOP][DRAW_SIZE_HANDS];
	static int[][] hmlMade = new int[HML_SIZE_FLOP][MADE_SIZE_HANDS];
	static int[][] hmlShowdown = new int[HML_SIZE_FLOP][MADE_SIZE_HANDS];
