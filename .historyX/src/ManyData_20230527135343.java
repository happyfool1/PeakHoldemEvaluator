...
public class ManyData implements Constants {
	...
	*/
	...
	static int[][] handValueDraw = new int[FLOP_INDEX_MAX][DRAW_MAX_HANDS];
	static int[][] handValueMade = new int[FLOP_INDEX_MAX[DRAW_MAX_HANDS];
	static int[] handValueShowdown = new int[FLOP_INDEX_MAX];
