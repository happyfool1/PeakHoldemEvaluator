...
public class GameControl implements Constants {
	...
	*******************************************************************************/
	...
	private static HoleCardAction heroX  = new HoleCardAction();
	private static HoleCardAction averageX = new HoleCardAction();
	...
	**************************************************************************** */
	...
	private static void createRanges() {
		heroX.readRange(EvalData.applicationDirectory + "heroX.ser");
		averageX.readRange(EvalData.applicationDirectory + "averageX.ser");
		fish.readRange(EvalData.applicationDirectory + "fish.ser");
		hero.readRange(EvalData.applicationDirectory + "hero.ser");
		average.actionArray(EvalData.applicationDirectory + "average.ser");
		nit.actionArray(EvalData.applicationDirectory + "nit.ser");
		lag.actionArray(EvalData.applicationDirectory + "lag.ser");
		tag.actionArray(EvalData.applicationDirectory + "tag.ser");
		fish.actionArray(EvalData.applicationDirectory + "fish.ser");
