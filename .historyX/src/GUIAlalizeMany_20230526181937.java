...
public class GUIAlalizeMany extends JFrame implements ActionListener, Constants {
  ...
  private static final JCheckBox hhhmlShowdown = new JCheckBox("HHHML River Wins Showdown");
    ...
    private static final JCheckBox sumOfDraw = new JCheckBox("Sum Of FlopDraw");
    private static final JCheckBox sumOfMade = new JCheckBox("HML Made Hand");
    private static final JCheckBox SumOfShowdown = new JCheckBox("HML Wins Showdown");
