    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            openText[i][0].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            openText[i][1].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            openText[i][2].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            openText[i][3].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            limpText[i][0].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            limpText[i][1].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            limpText[i][2].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            limpText[i][3].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3Text[i][0].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3Text[i][1].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3Text[i][2].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3Text[i][3].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            callText[i][0].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
           ...
           callText[i][1].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            callText[i][2].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
           callText[i][3] = new JTextField(String.valueOf(actionArrayGapsRaise[i][1]));
            ...
            callText[i][3].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4Text[i][0].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4Text[i][1].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4Text[i][2].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4Text[i][3].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3CallText[i][0].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3CallText[i][1].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3CallText[i][2].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet3CallText[i][3].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinText[i][0].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinText[i][1].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinText[i][2].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinText[i][3].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4CallText[i][0].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4CallText[i][1].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4CallText[i][2].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            bet4CallText[i][3].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinCallText[i][0].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            allinCallText[i][1] = new JTextField(Format.formatPer(actionArrayPercentageRaise[i][4]));
                     ...
                     allinCallText[i][1].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinCallText[i][2].setBackground(CYAN);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            allinCallText[i][3].setBackground(CYAN);
