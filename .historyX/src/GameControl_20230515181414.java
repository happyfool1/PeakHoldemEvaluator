...
public class GameControl implements Constants {
	...
	**************************************************************************** */
	...
	private static void createRanges() {
		...
		hero.readFromFile(EvalData.applicationDirectory + "heroX-HandRangeMultiple.ser");
		average.readFromFile(EvalData.applicationDirectory + "averageX-HandRangeMultiple.ser");
