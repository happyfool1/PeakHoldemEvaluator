...
public class HandConversion implements Constants {
	...
	static Card[] convertStringToHands(String h) {
		...
		final var card1 = new Card(c1);
		final var card2 = new Card(c2);
		final var card3 = new Card(c3);
		final var card4 = new Card(c4);
		final var card5 = new Card(c5);
		final var card6 = new Card(c6);
		final var card7 = new Card(c7);
