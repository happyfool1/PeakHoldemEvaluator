...
*  
* Ideas for analysis done after each street:
*	1. For a flop like HML for each in array counr the following"
*		Haw winning hand at Showdown.
*       Had good draw on Flop
*		Had good made hand on flop
*			How do we quantify good??? 6 flush draw 5 Straight draw? 
* 			Or do an array for each type. 	
* 
* @author PEAK_
 ****************************************************************************** */
...
public class EvaluateMany implements Constants {
	 ...
	 * Evaluation arrays
	 ****************************************************************************** */
	static int[] hnlWonAtShowdown = new int[HML_SIZE_FLOP];
	static int[] hnlDrawNone = new int[HML_SIZE_FLOP];
	static int[] hnlDrawBoardPair= new int[HML_SIZE_FLOP];
	static int[] hnlDrawPairedWithBoard = new int[HML_SIZE_FLOP];
	static int[] hnlDrawGutshot new int[HML_SIZE_FLOP];
	static int[] hnlDrawStraight new int[HML_SIZE_FLOP];
	static int[] hnlDrawOESD = new int[HML_SIZE_FLOP];
	static int[] hnlDrawNFlush= new int[HML_SIZE_FLOP];
	static int[] hnlDrawFlushOESD = new int[HML_SIZE_FLOP];

	static int[] hnlMadeNone = new int[HML_SIZE_FLOP];
	static int[] hnlMadePair= new int[HML_SIZE_FLOP];
	static int[] hnlMadeTwoPair = new int[HML_SIZE_FLOP];
	static int[] hnlMadeSet = new int[HML_SIZE_FLOP];
	static int[] hnlMadeStraight= new int[HML_SIZE_FLOP];
	static int[] hnlMadeFlush= new int[HML_SIZE_FLOP];
	static int[] hnlMadeFullHouse = new int[HML_SIZE_FLOP];
	static int[] hnlMadeFourOfAKind = new int[HML_SIZE_FLOP];
	static int[] hnlMadeStraightFlush= new int[HML_SIZE_FLOP];
	static int[] hnlMadeRoyalFlush= new int[HML_SIZE_FLOP];
	...
	/*-
	* Takes two arguments: an array of integervalues and a count. 
	...
	* Returns an array of percentages      
	 */
	public static double[] calculatePercentagesArrays(int[] values, int count) {
	...
	*/
	public static double calculatePercentage(int value, int count) {
		if (count == 0) {
			return -1.;
		}
	...
	*/
	public static double[] convertToOddsX(double percentage) {
	...
	/*-
	 * Converts outs to a percentage
	 * 	Takes two integer arguments: 
	 * 	the number of outs outs, and the number of remaining cards remainingCards.
	 * 	 It calculates the percentage by multiplying the number of outs by 100 and dividing 
	 * 	 by the number of remaining cards, and then returns the percentage.
	 * 	
	 */
	public static double convertToPercentage(int outs, int remainingCards) {
		return (outs * 100.0) / remainingCards;
	}
