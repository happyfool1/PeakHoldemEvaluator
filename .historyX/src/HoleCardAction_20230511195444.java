...
public class HoleCardAction implements Constants {
    ...
    ****************************************************************************** */
    ...
    private static JTextField[][][] actionArrayPlayabilityTextA = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayPlayabilityTextB = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayPlayabilityTextC = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayPlayabilityTextD = new JTextField[POSITIONS][1][2];
    private static JTextField[][][] actionArrayPlayabilityTextE = new JTextField[POSITIONS][1][2];
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            actionArrayPlayabilityTextA[i][0][0] = new JTextField(String.valueOf(actionArrayPlayability[i][0][0]));
            actionArrayPlayabilityTextA[i][0][0].setFont(f0);
            actionArrayPlayabilityTextA[i][0][0].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextA[i][0][0]);
            actionArrayPlayabilityTextA[i][0][1] = new JTextField(String.valueOf(actionArrayPlayability[i][0][1]));
            actionArrayPlayabilityTextA[i][0][1].setFont(f0);
            actionArrayPlayabilityTextA[i][0][1].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityTextA[i][1][1]);
        }
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            actionArrayPlayabilityTextB[i][1][0] = new JTextField(String.valueOf(actionArrayPlayability[i][0][0]));
