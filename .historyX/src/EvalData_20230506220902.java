...
public class EvalData implements Constants {
	...
	************************************************************************************** */
	...
	static final BigDecimal preflopBetMultiplyer3OpenBD =  new BigDecimal((double) .5);; // Times BB + 1 each limp
	static final BigDecimal preflopBetMultiplyer3BetBD =  new BigDecimal((double) .5);; // Times Open 2 Bet
	static final BigDecimal preflopBetMultiplyer4BetBD =  new BigDecimal((double) .5); // Times 3 Bet
