...
public class Dealer implements Constants {
	...
	*********************************************************************************/
	...
	/*- ******************************************************************************
	 * One time initializationn of ranges
	*********************************************************************************/
	static void initializeRanges() {
		if (initialzedRanges ) {
			return;
		}
		initialzedRanges = true;
...
/*- ******************************************************************************
	...
	*******************************************************************************/
	private static void setPositions() {
		EvalData.playerPositions[EvalData.playerPositions[SB]] = SB;
		EvalData.playerPositions[EvalData.playerPositions[BB]] = BB;
		EvalData.playerPositions[EvalData.playerPositions[UTG]] = UTG;
		EvalData.playerPositions[EvalData.playerPositions[MP]] = MP;
		EvalData.playerPositions[EvalData.playerPositions[CO]] = CO;
		EvalData.playerPpositions[EvalData.playerPositions[BU]] = BU;
		}
	}
