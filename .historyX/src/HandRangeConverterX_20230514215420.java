...
private static void copyDataRanges() {
	...
	action.rangeArrayCall[SB][0] = rangeSBLimp.gaps;
	// BET2
	action.rangeArrayRaise[SB][1] = rangeSBBet3.gaps;
	action.rangeArrayCall[SB][1] = rangeSBCall.gaps;
	// BET3
	action.rangeArrayRaise[SB][2] = rangeSBBet4.gaps;
	action.rangeArrayCall[SB][2] = rangeSBBet3Call.gaps;
	// BET4
	action.rangeArrayRaise[SB][3] = rangeSBAllin.gaps;
	action.rangeArrayCall[SB][3] = rangeSBBet4Call.gaps;
	// ALLIN
	action.rangeArrayRaise[SB][4] = rangeSBAllin.gaps;
	action.rangeArrayCall[SB][4] = rangeSBAllinCall.gaps;

	// BET1
	action.rangeArrayRaise[SB][0] = rangeSBOpen.gaps;
	action.rangeArrayCall[SB][0] = rangeSBLimp.gaps;
	// BET2
	action.rangeArrayRaise[SB][1] = rangeSBBet3.gaps;
	action.rangeArrayCall[SB][1] = rangeSBCall.gaps;
	...
	// BET1
	action.rangeArrayRaise[BB][0] = rangeBBOpen.gaps;
	action.rangeArrayCall[BB][0] = rangeBBLimp.gaps;
	// BET2
	action.rangeArrayRaise[BB][1] = rangeBBBet3.gaps;
	action.rangeArrayCall[BB][1] = rangeBBCall.gaps;
	// BET3
	action.rangeArrayRaise[BB][2] = rangeBBBet4.gaps;
	action.rangeArrayCall[BB][2] = rangeBBBet3Call.gaps;
	// BET4
	action.rangeArrayRaise[BB][3] = rangeBBAllin.gaps;
	action.rangeArrayCall[BB][3] = rangeBBBet4Call.gaps;
	// ALLIN
	action.rangeArrayRaise[BB][4] = rangeBBAllin.gaps;
	action.rangeArrayCall[BB][4] = rangeBBAllinCall.gaps;

	// BET1
	action.rangeArrayRaise[UTG][0] = rangeUTGOpen.gaps;
	action.rangeArrayCall[UTG][0] = rangeUTGLimp.gaps;
	// BET2
	action.rangeArrayRaise[UTG][1] = rangeUTGBet3.gaps;
	action.rangeArrayCall[UTG][1] = rangeUTGCall.gaps;
	// BET3
	action.rangeArrayRaise[UTG][2] = rangeUTGBet4.gaps;
	action.rangeArrayCall[UTG][2] = rangeUTGBet3Call.gaps;
	// BET4
	action.rangeArrayRaise[UTG][3] = rangeUTGAllin.gaps;
	action.rangeArrayCall[UTG][3] = rangeUTGBet4Call.gaps;
	// ALLIN
	action.rangeArrayRaise[UTG][4] = rangeUTGAllin.gaps;
	action.rangeArrayCall[UTG][4] = rangeUTGAllinCall.gaps;
	// BET1
	action.rangeArrayRaise[MP][0] = rangeMPOpen.gaps;
	action.rangeArrayCall[MP][0] = rangeMPLimp.gaps;
	// BET2
	action.rangeArrayRaise[MP][1] = rangeMPBet3.gaps;
	action.rangeArrayCall[MP][1] = rangeMPCall.gaps;
	// BET3
	action.rangeArrayRaise[MP][2] = rangeMPBet4.gaps;
	action.rangeArrayCall[MP][2] = rangeMPBet3Call.gaps;
	// BET4
	action.rangeArrayRaise[MP][3] = rangeMPAllin.gaps;
	action.rangeArrayCall[MP][3] = rangeMPBet4Call.gaps;
	// ALLIN
	action.rangeArrayRaise[MP][4] = rangeMPAllin.gaps;
	action.rangeArrayCall[MP][4] = rangeMPAllinCall.gaps;
	// BET1
	action.rangeArrayRaise[CO][0] = rangeCOOpen.gaps;
	action.rangeArrayCall[CO][0] = rangeCOLimp.gaps;
	// BET2
	action.rangeArrayRaise[CO][1] = rangeCOBet3.gaps;
	action.rangeArrayCall[CO][1] = rangeCOCall.gaps;
	// BET3
	action.rangeArrayRaise[CO][2] = rangeCOBet4.gaps;
	action.rangeArrayCall[CO][2] = rangeCOBet3Call.gaps;
	// BET4
	action.rangeArrayRaise[CO][3] = rangeCOAllin.gaps;
	action.rangeArrayCall[CO][3] = rangeCOBet4Call.gaps;
	// ALLIN
	action.rangeArrayRaise[CO][4] = rangeCOAllin.gaps;
	action.rangeArrayCall[CO][4] = rangeCOAllinCall.gaps;

	// BET1
	action.rangeArrayRaise[BU][0] = rangeBUOpen.gaps;
	action.rangeArrayCall[BU][0] = rangeBULimp.gaps;
	// BET2
	action.rangeArrayRaise[BU][1] = rangeBUBet3.gaps;
	action.rangeArrayCall[BU][1] = rangeBUCall.gaps;
	// BET3
	action.rangeArrayRaise[BU][2] = rangeBUBet4.gaps;
	action.rangeArrayCall[BU][2] = rangeBUBet3Call.gaps;
	// BET4
	action.rangeArrayRaise[BU][3] = rangeBUAllin.gaps;
	action.rangeArrayCall[BU][3] = rangeBUBet4Call.gaps;
	// ALLIN
	action.rangeArrayRaise[BU][4] = rangeBUAllin.gaps;
	action.rangeArrayCall[BU][4] = rangeBUAllinCall.gaps;
