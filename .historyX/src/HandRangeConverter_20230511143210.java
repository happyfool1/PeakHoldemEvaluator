...
public class HandRangeConverter implements Constants {
	...
	private static void copyData2() {
		action.actionArray[SB][0][0] = rangeSBLimp.lowPlayabilitrhyArrayIndex;
		action.actionArray[SB][0][1] = rangeSBOpen.lowPlayabilitrhyArrayIndex;
		action.actionArray[SB][1][0] = rangeSBBet3.lowPlayabilitrhyArrayIndex;
		action.actionArray[SB][1][1] = rangeSBCall.lowPlayabilitrhyArrayIndex;
		action.actionArray[SB][2][0] = rangeSBBet3.lowPlayabilitrhyArrayIndex;
		action.actionArray[SB][2][1] = rangeSBBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArray[SB][4][0] = rangeSBBet4.lowPlayabilitrhyArrayIndex;
		action.actionArray[SB][4][1] = rangeSBBet4Call.lowPlayabilitrhyArrayIndex;
		action.actionArray[SB][5][0] = rangeSBAllin.lowPlayabilitrhyArrayIndex;
		action.actionArray[SB][5][1] = rangeSBAllinCall.lowPlayabilitrhyArrayIndex;

		action.actionArray[BB][0][0] = rangeBBLimp.lowPlayabilitrhyArrayIndex;
		action.actionArray[BB][0][1] = rangeBBOpen.lowPlayabilitrhyArrayIndex;
		action.actionArray[BB][1][0] = rangeBBBet3.lowPlayabilitrhyArrayIndex;
		action.actionArray[BB][1][1] = rangeBBCall.lowPlayabilitrhyArrayIndex;
		action.actionArray[BB][2][0] = rangeBBBet3.lowPlayabilitrhyArrayIndex;
		action.actionArray[BB][2][1] = rangeBBBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArray[BB][4][0] = rangeBBBet4.lowPlayabilitrhyArrayIndex;
		action.actionArray[BB][4][1] = rangeBBBet4Call.lowPlayabilitrhyArrayIndex;
		action.actionArray[BB][5][0] = rangeBBAllin.lowPlayabilitrhyArrayIndex;
		action.actionArray[BB][5][1] = rangeBBAllinCall.lowPlayabilitrhyArrayIndex;

		action.actionArray[UTG][0][0] = rangeUTGLimp.lowPlayabilitrhyArrayIndex;
		action.actionArray[UTG][0][1] = rangeUTGOpen.lowPlayabilitrhyArrayIndex;
		action.actionArray[UTG][1][0] = rangeUTGBet3.lowPlayabilitrhyArrayIndex;
		action.actionArray[UTG][1][1] = rangeUTGCall.lowPlayabilitrhyArrayIndex;
		action.actionArray[UTG][2][0] = rangeUTGBet3.lowPlayabilitrhyArrayIndex;
		action.actionArray[UTG][2][1] = rangeUTGBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArray[UTG][4][0] = rangeUTGBet4.lowPlayabilitrhyArrayIndex;
		action.actionArray[UTG][4][1] = rangeUTGBet4Call.lowPlayabilitrhyArrayIndex;
		action.actionArray[UTG][5][0] = rangeUTGAllin.lowPlayabilitrhyArrayIndex;
		action.actionArray[UTG][5][1] = rangeUTGAllinCall.lowPlayabilitrhyArrayIndex;

		action.actionArray[MP][0][0] = rangeMPLimp.lowPlayabilitrhyArrayIndex;
		action.actionArray[MP][0][1] = rangeMPOpen.lowPlayabilitrhyArrayIndex;
		action.actionArray[MP][1][0] = rangeMPBet3.lowPlayabilitrhyArrayIndex;
		action.actionArray[MP][1][1] = rangeMPCall.lowPlayabilitrhyArrayIndex;
		action.actionArray[MP][2][0] = rangeMPBet3.lowPlayabilitrhyArrayIndex;
		action.actionArray[MP][2][1] = rangeMPBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArray[MP][4][0] = rangeMPBet4.lowPlayabilitrhyArrayIndex;
		action.actionArray[MP][4][1] = rangeMPBet4Call.lowPlayabilitrhyArrayIndex;
		action.actionArray[MP][5][0] = rangeMPAllin.lowPlayabilitrhyArrayIndex;
		action.actionArray[MP][5][1] = rangeMPAllinCall.lowPlayabilitrhyArrayIndex;

		action.actionArray[CO][0][0] = rangeCOLimp.lowPlayabilitrhyArrayIndex;
		action.actionArray[CO][0][1] = rangeCOOpen.lowPlayabilitrhyArrayIndex;
		action.actionArray[CO][1][0] = rangeCOBet3.lowPlayabilitrhyArrayIndex;
		action.actionArray[CO][1][1] = rangeCOCall.lowPlayabilitrhyArrayIndex;
		action.actionArray[CO][2][0] = rangeCOBet3.lowPlayabilitrhyArrayIndex;
		action.actionArray[CO][2][1] = rangeCOBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArray[CO][4][0] = rangeCOBet4.lowPlayabilitrhyArrayIndex;
		action.actionArray[CO][4][1] = rangeCOBet4Call.lowPlayabilitrhyArrayIndex;
		action.actionArray[CO][5][0] = rangeCOAllin.lowPlayabilitrhyArrayIndex;
		action.actionArray[CO][5][1] = rangeCOAllinCall.lowPlayabilitrhyArrayIndex;


		action.actionArray[BU][0][0] = rangeBULimp.lowPlayabilitrhyArrayIndex;
		action.actionArray[BU][0][1] = rangeBUOpen.lowPlayabilitrhyArrayIndex;
		action.actionArray[BU][1][0] = rangeBUBet3.lowPlayabilitrhyArrayIndex;
		action.actionArray[BU][1][1] = rangeBUCall.lowPlayabilitrhyArrayIndex;
		action.actionArray[BU][2][0] = rangeBUBet3.lowPlayabilitrhyArrayIndex;
		action.actionArray[BU][2][1] = rangeBUBet3Call.lowPlayabilitrhyArrayIndex;
		action.actionArray[BU][4][0] = rangeBUBet4.lowPlayabilitrhyArrayIndex;
		action.actionArray[BU][4][1] = rangeBUBet4Call.lowPlayabilitrhyArrayIndex;
		action.actionArray[BU][5][0] = rangeBUAllin.lowPlayabilitrhyArrayIndex;
		action.actionArray[BU][5][1] = rangeBUAllinCall.lowPlayabilitrhyArrayIndex;
