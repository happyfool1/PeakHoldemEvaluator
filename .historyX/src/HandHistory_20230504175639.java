	...
	private static void doStreetHH(int street) {
		...
		for (int orbit = 0; orbit < EvalData.lastOrbit[street]; ++orbit) {
			...
			for (int j = 0; j < seatCount; ++j) {
				...
				System.out.println(
						"HHH isFold " + street + " " + orbit + " " + seat + " " + EvalData.playerNames[seat] + " "
								+ EvalData.lastOrbit[street]
								+ " " + seat + " " + EvalData.isFold[street][seat][orbit]);
				System.out.println(
						"HHH isLimp " + street + " " + orbit + " " + seat + " " + EvalData.playerNames[seat] + " "
								+ EvalData.lastOrbit[street]
								+ " " + seat + " " + EvalData.isLimp[street][seat][orbit]);
				System.out.println(
						"HHH isOpen " + street + " " + orbit + " " + seat + " " + EvalData.playerNames[seat] + " "
								+ EvalData.lastOrbit[street]
								+ " " + seat + " " + EvalData.isOPen[street][seat][orbit]);
				System.out.println(
						"HHH isCall " + street + " " + orbit + " " + seat + " " + EvalData.playerNames[seat] + " "
								+ EvalData.lastOrbit[street]
								+ " " + seat + " " + EvalData.isCall[street][seat][orbit]);
				System.out.println(
						"HHH isBet " + street + " " + orbit + " " + seat + " " + EvalData.playerNames[seat] + " "
								+ EvalData.lastOrbit[street]
								+ " " + seat + " " + EvalData.isBet[street][seat][orbit]);

				System.out.println(
						"HHH isRaise " + street + " " + orbit + " " + seat + " " + EvalData.playerNames[seat] + " "
								+ EvalData.lastOrbit[street]
								+ " " + seat + " " + EvalData.isRaise[street][seat][orbit]);

				System.out.println(
						"HHH isAllin " + street + " " + orbit + " " + seat + " " + EvalData.playerNames[seat] + " "
								+ EvalData.lastOrbit[street]
								+ " " + seat + " " + EvalData.isAllin[street][seat][orbit]);
				System.out.println(
						"HHH isFold " + street + " " + orbit + " " + seat + " " + EvalData.playerNames[seat] + " "
								+ EvalData.lastOrbit[street]
								+ " " + seat + " " + EvalData.isFold[street][seat][orbit]);
