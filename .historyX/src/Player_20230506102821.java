...
public class Player implements Constants {
	...
	private void doLimp() {
		...
		System.out.println("doLimp() " + this.seat + EvalData.moneyInBD[this.seat] + " " + EvalData.potBD);
	}
	...
	private void doRaises(BigDecimal bet) {
		var temp = zeroBD;
		vatemp = bet.add(call);r call = EvalData.betNowBD.subtract(EvalData.moneyInBD[this.seat]);\
		...
		System.out.println("doRaises() " + this.seat + " " + bet + " " + temp + " " + EvalData.stackBD);
