...
public class GameControl implements Constants {
	...
	**************************************************************************** */
	...
	private static void createRanges() {
		heroX.readFromFile(EvalData.applicationDirectory + "heroX.ser");
		averageX.readFromFile(EvalData.applicationDirectory + "averageX.ser");
		fish.readFromFile(EvalData.applicationDirectory + "fish.ser");
		hero.readFromFile(EvalData.applicationDirectory + "hero-HandRangeMultiple.ser");
		average.readFromFile(EvalData.applicationDirectory + "average.ser");
		nit.readFromFile(EvalData.applicationDirectory + "nit.ser");
		lag.readFromFile(EvalData.applicationDirectory + "lag.ser");
		tag.readFromFile(EvalData.applicationDirectory + "tag.ser");
		fish.readFromFile(EvalData.applicationDirectory + "fish.ser");
