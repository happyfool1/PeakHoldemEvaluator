...
public class GUIAlalizeMany extends JFrame implements ActionListener, Constants {
    ...
    *******************************************************************************/
    public void myFrame() {
        ...
        panelRadioHands.setBounds(100 ,100, 450, 550);
        ...
        panelControl.setBounds(100, 100, 71150, 550);
        mainPanel.add(panelControl);

        panelCheckBoxes = new JPanel(new GridLayout(6, 1));
        panelCheckBoxes.setBounds(100, 100, 1150, 550);
       ...
       // mainPanel.add(panelCheckBoxes);
        ...
        mainPaned.add(panelControl, BorderLayout.SOUTH);
