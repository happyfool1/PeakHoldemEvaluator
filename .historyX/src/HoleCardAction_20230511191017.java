...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        panelActionTaise.setSize(500, 200);
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            for (int j = 0; j < 5; ++j) {
                actionArrayPlayabilityText[i][j][0] = new JTextField(String.valueOf(actionArrayPlayability[i][j][0]));
                actionArrayPlayabilityText[i][j][0].setFont(f0);
                actionArrayPlayabilityText[i][j][0].setSize(40, 40);
                panelAction.add(actionArrayPlayabilityText[i][j][0]);
                actionArrayPlayabilityText[i][j][1] = new JTextField(String.valueOf(actionArrayPlayability[i][j][1]));
                actionArrayPlayabilityText[i][j][1].setFont(f0);
                actionArrayPlayabilityText[i][j][1].setSize(40, 40);
