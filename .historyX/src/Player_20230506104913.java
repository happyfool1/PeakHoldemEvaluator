...
public class Player implements Constants {
	...
	private void doLimp() {
		...
		System.out.println("doLimp() seat " + this.seat + " moneyIn " + EvalData.moneyInBD[this.seat] + "pot " +
				EvalData.potBD + " stack " + EvalData.stackBD[this.seat]);
	}
...
// Money
		...
		System.out.println("doAllin() seat  " + this.seat + " bet " + bet + " call " + call + " stack " + EvalData.stackBD[this.seat]);
	}
	...
	private void doCalls() {
		...
		System.out.println("doCalls() seat " + this.seat + " call " + call + " stack " + EvalData.stackBD[this.seat]);
	}
	...
	private void doRaises(BigDecimal bet) {
		...
		System.out.println("doRaises() seat " + this.seat + " bet " + bet + " temp " + temp + " stack " + EvalData.stackBD[this.seat]);
					}
