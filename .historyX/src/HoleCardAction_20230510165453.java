...
public class HoleCardAction implements Constants {
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        final var panelLowRangeLayout = new GridLayout(1, 8);
        panelCards.setLayout(panelLowRangeLayout);
        ...
        panelCards.setLayout(panelLowPlayLayout);
        ...
        panelCards.setLayout(panelGapsLayout);
        ...
        for (int i = 0; i < PLAYERS; ++i) {
            for (int j = 0; j < 5; ++j) {
                ...
                panelActionArra.add( actionArrayText[i][j][0]);
                actionArrayText[i][j][0].setText(String.valueOf(actionArray[i][j][1]));
                panelActionArray.add( actionArrayText[i][j][1]);
            }
        }
