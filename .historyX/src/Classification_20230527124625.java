...
public class Classification  implements   Constants {
    ...
    * paticuler Flop, hand, or draw. If you don not have a made hand, or good draw,
    ...
    * real Hand Histoties dfrom PokerStars and is a similar experimentg but with real 
    * data.
    *
    *
    *
...
/*- *****************************************************************************
 ...
 static void calculateFlopIndex(int rank1, int rank2, int rank3) {
