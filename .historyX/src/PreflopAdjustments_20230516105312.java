...
public class PreflopAdjustments implements Constants {
  ...
  * the new bet size not added or subtracted.
  ******************************************************************************/
  static final int[] adjustmentBet1Limps = new int[] { 0, 0, 0, 0, 0 };
  static final int[] adjustmentBet1Folds = new int[] { 0, 0, 0, 0, 0 };
  static final int[] adjustmentBet2Limps = new int[] { 0, 0, 0, 0, 0 };
  static final int[] adjustmentBet2Folds = new int[] { 0, 0, 0, 0, 0 };
  static final int[] adjustmentBet3Limps = new int[] { 0, 0, 0, 0, 0 };
  static final int[] adjustmentBet3Folds = new int[] { 0, 0, 0, 0, 0 };
  static final int[] adjustmentBet4Limps = new int[] { 0, 0, 0, 0, 0 };
  static final int[] adjustmentBet4Folds = new int[] { 0, 0, 0, 0, 0 };
  ...
  * Returns new maximum playability value
  ******************************************************************************/
  static int adjustPreflopRange(int playValue ) {
    if (EvalData.betType == PREFLOP_BET1){
      return playValue + adjustmentBet1Limps[EvalData.limpCount] + adjustmentBet1Folds[EvalData.folderCount]; 
    }  
    if (EvalData.betType == PREFLOP_BET2){
      return playValue  + adjustmentBet2Limps[EvalData.limpCount] + adjustmentBet2Folds[EvalData.folderCount]; 
    } 
    if (EvalData.betType == PREFLOP_BET3){
      return playValue  +  adjustmentBet3Limps[EvalData.limpCount] + adjustmentBet3Folds[EvalData.folderCount]; 
    }
    return -1;
  }
  ...
  * 3. Relative position
  ******************************************************************************/
  static BigDecimal adjustPreflopBetSize(BigDecima  bet) {
    if (EvalData.betType == PREFLOP_BET1){
      return bet.add(adjustmentBet1BetLimps[EvalData.limpCount].add(adjustmentBet1BetsFolds[EvalData.folderCount]));  
    }  
    if (EvalData.betType == PREFLOP_BET2){
      return bet.add(adjustmentBet2BetLimps[EvalData.limpCount].add(adjustmentBet2BetsFolds[EvalData.folderCount]));  
    } 
    if (EvalData.betType == PREFLOP_BET3){
      return bet.add(adjustmentBet3BetLimps[EvalData.limpCount].add(adjustmentBet3BetsFolds[EvalData.folderCount]));   
    }
    return null;
    return zeroBD;
  }
