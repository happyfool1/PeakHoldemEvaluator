...
public class HoleCardAction implements Constants, java.io.Serializable {
    ...
    ****************************************************************************** */
    ...
    boolean debug = false; // Fod test and debug of one specific instance
    ...
    *  Construct panel. 
    ...
    void constructPanel(String title) {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            String st1 = df.format(this.actionArrayPercentageRaise[i][0]);
         //   openText[i][1] = new JTextField(st1 + "%");
