	...
	private static void copyDataGaps() {
		for (int i = 0; i < 5; i++) {
			for (int j = 0; j < HANDS; j++) {
				...
				action.gapsArrayCall[SB][i][j] = rangeSBLimp.gapsArray[i][j];
				action.gapsArrayRaise[SB][i][j] = rangeSBOpen.gapsArray[i][j];
				action.gapsArrayCall[SB][i][j] = rangeSBCall.gapsArray[i][j];
				action.gapsArrayRaise[SB][i][j] = rangeSBBet3.gapsArray[i][j];
				action.gapsArrayCall[SB][i][j] = rangeSBBet3Call.gapsArray[i][j];
				action.gapsArrayRaise[SB][i][j] = rangeSBBet4.gapsArray[i][j];
				action.gapsArrayCall[SB][i][j] = rangeSBBet4Call.gapsArray[i][j];
				action.gapsArrayRaise[SB][i][j] = rangeSBAllin.gapsArray[i][j];
				action.gapsArrayCall[SB][i][j] = rangeSBAllinCall.gapsArray[i][j];
				action.gapsArrayRaise[BB][i][j] = rangeBBLimp.gapsArray[i][j];
				action.gapsArrayRaise[BB][i][j] = rangeBBOpen.gapsArray[i][j];
				action.gapsArrayCall[BB][i][j] = rangeBBCall.gapsArray[i][j];
				action.gapsArrayRaise[BB][i][j] = rangeBBBet3.gapsArray[i][j];
				action.gapsArrayCall[BB][i][j] = rangeBBBet3Call.gapsArray[i][j];
				action.gapsArrayRaise[BB][i][j] = rangeBBBet4.gapsArray[i][j];
				action.gapsArrayCall[BB][i][j] = rangeBBBet4Call.gapsArray[i][j];
				action.gapsArrayRaise[BB][i][j] = rangeBBAllin.gapsArray[i][j];
				action.gapsArrayCall[BB][i][j] = rangeBBAllinCall.gapsArray[i][j];
				action.gapsArrayCall[UTG][i][j] = rangeUTGLimp.gapsArray[i][j];
				action.gapsArrayRaise[UTG][i][j] = rangeUTGOpen.gapsArray[i][j];
				action.gapsArrayCall[UTG][i][j] = rangeUTGCall.gapsArray[i][j];
				action.gapsArrayRaise[UTG][i][j] = rangeUTGBet3.gapsArray[i][j];
				action.gapsArrayCall[UTG][i][j] = rangeUTGBet3Call.gapsArray[i][j];
				action.gapsArrayRaise[UTG][i][j] = rangeUTGBet4.gapsArray[i][j];
				action.gapsArrayCall[UTG][i][j] = rangeUTGBet4Call.gapsArray[i][j];
				action.gapsArrayRaise[UTG][i][j] = rangeUTGAllinCall.gapsArray[i][j];
				action.gapsArrayCall[MP][i][j] = rangeMPLimp.gapsArray[i][j];
				action.gapsArrayRaise[MP][i][j] = rangeMPOpen.gapsArray[i][j];
				action.gapsArrayCall[MP][i][j] = rangeMPCall.gapsArray[i][j];
				action.gapsArrayRaise[MP][i][j] = rangeMPBet3.gapsArray[i][j];
				action.gapsArrayCall[MP][i][j] = rangeMPBet3Call.gapsArray[i][j];
				action.gapsArrayRaise[MP][i][j] = rangeMPBet4.gapsArray[i][j];
				action.gapsArrayCall[MP][i][j] = rangeMPBet4Call.gapsArray[i][j];
				action.gapsArrayRaise[MP][i][j] = rangeMPAllin.gapsArray[i][j];
				action.gapsArrayCall[MP][i][j] = rangeMPAllinCall.gapsArray[i][j];
				action.gapsArrayCall[CO][i][j] = rangeCOLimp.gapsArray[i][j];
				action.gapsArrayRaise[CO][i][j] = rangeCOOpen.gapsArray[i][j];
				action.gapsArrayCall[CO][i][j] = rangeCOCall.gapsArray[i][j];
				action.gapsArrayRaise[CO][i][j] = rangeCOBet3.gapsArray[i][j];
				action.gapsArrayCall[CO][i][j] = rangeCOBet3Call.gapsArray[i][j];
				action.gapsArrayRaise[CO][i][j] = rangeCOBet4.gapsArray[i][j];
				action.gapsArrayCall[CO][i][j] = rangeCOBet4Call.gapsArray[i][j];
				action.gapsArrayRaise[CO][i][j] = rangeCOAllin.gapsArray[i][j];
				action.gapsArrayCall[CO][i][j] = rangeCOAllinCall.gapsArray[i][j];
				action.gapsArrayCall[BU][i][j] = rangeBULimp.gapsArray[i][j];
				action.gapsArrayRaise[BU][i][j] = rangeBUOpen.gapsArray[i][j];
				action.gapsArrayCall[BU][i][j] = rangeBUCall.gapsArray[i][j];
				action.gapsArrayRaise[BU][i][j] = rangeBUBet3.gapsArray[i][j];
				action.gapsArrayCall[BU][i][j] = rangeBUBet3Call.gapsArray[i][j];
				action.gapsArrayRaise[BU][i][j] = rangeBUBet4.gapsArray[i][j];
				action.gapsArrayCall[BU][i][j] = rangeBUBet4Call.gapsArray[i][j];
				action.gapsArrayRaise[BU][i][j] = rangeBUAllin.gapsArray[i][j];
				action.gapsArrayCall[BU][i][j] = rangeBUAllinCall.gapsArray[i][j];
			}
		}
	}
