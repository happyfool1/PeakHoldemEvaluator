...
public class Player implements Constants {
	...
	private void doFold() {
		...
		EvalData.playerFolded[this.this.seat] = true;
	...
	private void doAllin() {
		...
		EvalData.stackBD[this.this.seat] = zeroBD;
		++EvalData.allinCount;
	...
	private void doCalls() {
		...
		++EvalData.allinCount;
		EvalData.allin$[0][this.seat][EvalData.orbit] = call;
		EvalData.betBD[0][this.seat][EvalData.orbit] = call;
		EvalData.raisedToBD[0][this.seat][EvalData.orbit] = EvalData.betNowBD.add(call);
		EvalData.betNowBD = EvalData.betNowBD.add(call);
		EvalData.isCall[0][this.seat][EvalData.orbit] = true;
		EvalData.stackBD[this.this.seat] = EvalData.stackBD[this.this.seat].subtract(call);
	...
	private void checkRebuy() {
		if (EvalData.stackBD[this.this.seat].compareTo(EvalData.maxStackBD) == 1) {
	...
	void canRaiseOrCall() {
		this.canRaise = false;
		this.canCall = false;
		var temp = EvalData.stackBD[seat].subtract(EvalData.betNowBD).subtract(EvalData.moneyInBD[this.seat]);
