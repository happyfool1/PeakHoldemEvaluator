...
public class HoleCardAction implements Constants {
    ...
    ****************************************************************************** */
    ...
    int[][][] actionArrayGaps = new int[POSITIONS][5][2];
    int[][][] actionArrayCombos = new int[POSITIONS][5][2];
    double[][][] actionArrayPercentage = new double[POSITIONS][5][2];
    ...
    private static JTextField[][][] actionArrayPlayabilityText = new JTextField[POSITIONS][5][2];
    private static JTextField[][][] actionArrayCombosText = new JTextField[POSITIONS][5][2];
    private static JTextField[][][] actionArrayGapsText = new JTextField[POSITIONS][5][2];
    private static JTextField[][][] actionArrayPercentageText = new JTextField[POSITIONS][5][2];
    ...
    *  Construct panel. 
    ...
    void constructPanel() {
        ...
        final var panelLayout = new GridLayout(5, 1);
        panel.setLayout(panelLayout);
        panel.setSize(500, 800);
        panel.setFont(f0);

        final var panel1Layout = new GridLayout5, 1);
        panel1.setLayout(panel1Layout);
        panel1.setSize(500, 200);
        panel1.setFont(f0);

        String spaces = "                   ";
        Border positions = BorderFactory.createTitledBorder("SB       BB      UTG      MP      CO      BU");
        Border raiseCall = BorderFactory.createTitledBorder("Raise or Call");
        panel1.add(new JLabel("   "));
        panel1.setBorder(raiseCall);
        ...
        panelActionA.setSize(500, 40);
        panelActionA.setFont(f0);
        final var actionLayout = new GridLayout(2, 6);
        panelActionA.setLayout(actionLayout);
        panelActionA.setBorder(positions);
        for (int i = 0; i < POSITIONS; ++i) {
            actionArrayPlayabilityText[i][0][0] = new JTextField(String.valueOf(actionArrayPlayability[i][0][0]));
            actionArrayPlayabilityText[i][0][0].setFont(f0);
            actionArrayPlayabilityText[i][0][0].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityText[i][0][0]);
            actionArrayPlayabilityText[i][0][1] = new JTextField(String.valueOf(actionArrayPlayability[i][0][1]));
            actionArrayPlayabilityText[i][0][1].setFont(f0);
            actionArrayPlayabilityText[i][0][1].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityText[i][0][1]);
        }
        panel1.add(panelActionA);

        JPanel panelActionB = new JPanel();
        panelActionB.setSize(500, 40);
        panelActionB.setFont(f0);
        panelActionB.setLayout(actionLayout);
        panelActionB.setBorder(positions);
        for (int i = 0; i < POSITIONS; ++i) {
            actionArrayPlayabilityText[i][1][0] = new JTextField(String.valueOf(actionArrayPlayability[i][0][0]));
            actionArrayPlayabilityText[i][1][0].setFont(f0);
            actionArrayPlayabilityText[i][1][0].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityText[i][1][0]);
            actionArrayPlayabilityText[i][1][1] = new JTextField(String.valueOf(actionArrayPlayability[i][0][1]));
            actionArrayPlayabilityText[i][1][1].setFont(f0);
            actionArrayPlayabilityText[i][1][1].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityText[i][1][1]);
        }
        panel1.add(panelActionB);

        JPanel panelActionC = new JPanel();
        panelActionC.setSize(500, 40);
        panelActionC.setFont(f0);
        panelActionC.setLayout(actionLayout);
        panelActionC.setBorder(positions);
        for (int i = 0; i < POSITIONS; ++i) {
            actionArrayPlayabilityText[i][2][0] = new JTextField(String.valueOf(actionArrayPlayability[i][2][0]));
            actionArrayPlayabilityText[i][2][0].setFont(f0);
            actionArrayPlayabilityText[i][2][0].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityText[i][2][0]);
            actionArrayPlayabilityText[i][2][1] = new JTextField(String.valueOf(actionArrayPlayability[i][2][1]));
            actionArrayPlayabilityText[i][2][1].setFont(f0);
            actionArrayPlayabilityText[i][2][1].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityText[i][2][1]);
        }
        panel1.add(panelActionC);

        JPanel panelActionD = new JPanel();
        panelActionD.setSize(500, 40);
        panelActionD.setFont(f0);
        panelActionD.setLayout(actionLayout);
        panelActionD.setBorder(positions);
        for (int i = 0; i < POSITIONS; ++i) {
            actionArrayPlayabilityText[i][3][0] = new JTextField(String.valueOf(actionArrayPlayability[i][3][0]));
            actionArrayPlayabilityText[i][3][0].setFont(f0);
            actionArrayPlayabilityText[i][3][0].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityText[i][3][0]);
            actionArrayPlayabilityText[i][3][1] = new JTextField(String.valueOf(actionArrayPlayability[i][3][1]));
            actionArrayPlayabilityText[i][3][1].setFont(f0);
            actionArrayPlayabilityText[i][3][1].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityText[i][3][1]);
        }
        panel1.add(panelActionD);

        JPanel panelActionE = new JPanel();
        panelActionE.setSize(500, 40);
        panelActionE.setFont(f0);
        panelActionE.setLayout(actionLayout);
        panelActionE.setBorder(positions);
        for (int i = 0; i < POSITIONS; ++i) {
            actionArrayPlayabilityText[i][4][0] = new JTextField(String.valueOf(actionArrayPlayability[i][4][0]));
            actionArrayPlayabilityText[i][4][0].setFont(f0);
            actionArrayPlayabilityText[i][4][0].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityText[i][4][0]);
            actionArrayPlayabilityText[i][4][1] = new JTextField(String.valueOf(actionArrayPlayability[i][4][1]));
            actionArrayPlayabilityText[i][4][1].setFont(f0);
            actionArrayPlayabilityText[i][4][1].setSize(40, 40);
            panelActionA.add(actionArrayPlayabilityText[i][4][1]);
        }
