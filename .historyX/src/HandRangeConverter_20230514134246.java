...
public class HandRangeConverter implements Constants {
	...
	private static void copyDataGapsArray() {
				...
				action.gapsArrayCall[SB][0][i] = rangeSBLimp;
				action.gapsArrayRaise[SB][0][i] = rangeSBOpen;
				action.gapsArrayCall[SB][1][i] = rangeSBCall;
				action.gapsArrayRaise[SB][1][i] = rangeSBBet3;
				action.gapsArrayCall[SB][2][i] = rangeSBBet3Call;
				action.gapsArrayRaise[SB][2][i] = rangeSBBet4;
				action.gapsArrayCall[SB][3][i] = rangeSBBet4Call;
				action.gapsArrayRaise[SB][3][i] = rangeSBAllin;
				action.gapsArrayCall[SB][4][i] = rangeSBAllinCall;
				action.gapsArrayRaise[BB][0][i] = rangeBBLimp;
				action.gapsArrayRaise[BB][0][i] = rangeBBOpen;
				action.gapsArrayCall[BB][1][i] = rangeBBCall;
				action.gapsArrayRaise[BB][1][i] = rangeBBBet3;
				action.gapsArrayCall[BB][2][i] = rangeBBBet3Call;
				action.gapsArrayRaise[BB][2][i] = rangeBBBet4;
				action.gapsArrayCall[BB][3][i] = rangeBBBet4Call;
				action.gapsArrayRaise[BB][3][i] = rangeBBAllin;
				action.gapsArrayCall[BB][4][i] = rangeBBAllinCall;
				action.gapsArrayCall[UTG][0][i] = rangeUTGLimp;
				action.gapsArrayRaise[UTG][0][i] = rangeUTGOpen;
				action.gapsArrayCall[UTG][1][i] = rangeUTGCall;
				action.gapsArrayRaise[UTG][1][i] = rangeUTGBet3;
				action.gapsArrayCall[UTG][2][i] = rangeUTGBet3Call;
				action.gapsArrayRaise[UTG][2][i] = rangeUTGBet4;
				action.gapsArrayCall[UTG][3][i] = rangeUTGBet4Call;
				action.gapsArrayRaise[UTG][3][i] = rangeUTGAllinCall;
				action.gapsArrayCall[MP][0][i] = rangeMPLimp;
				action.gapsArrayRaise[MP][0][i] = rangeMPOpen;
				action.gapsArrayCall[MP][1][i] = rangeMPCall;
				action.gapsArrayRaise[MP][1][i] = rangeMPBet3;
