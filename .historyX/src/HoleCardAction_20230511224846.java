    ...
    void constructPanel() {
        ...
        for (int i = 0; i < POSITIONS; ++i) {
            ...
            panelActionA.add(actionArrayPlayabilityTextA[i][0][1]);
             ...
             actionArrayPlayabilityTextA[i][1][2] = new JTextField(String.valueOf(actionArrayPlayability[i][0][0]));
            actionArrayPlayabilityTextA[i][1][0].setFont(f0);
            actionArrayPlayabilityTextA[i][1][0].setSize(40, 40);
