...
public class GUIAlalizeMany extends JFrame implements ActionListener, Constants {
    ...
    *******************************************************************************/
    public void myFrame() {
        ...
        panelCheckBoxesHML.add(hhmlMade);
        ...
        panelCheckBoxesHML.add(hhmlShowdown);
        ...
        panelCheckBoxesHML.add(hhhmlDraw);
        ...
        panelCheckBoxesHML.add(hhhmlMade);
        ...
        panelCheckBoxesHML.add(hhhmlShowdown);
