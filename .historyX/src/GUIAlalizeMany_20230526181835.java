...
public class GUIAlalizeMany extends JFrame implements ActionListener, Constants {
  ...
  private static final JCheckBox hhhmlDraw = new JCheckBox("HHHML Draw");
  private static final JCheckBox hhhmlMade = new JCheckBox("HHHML Made Hand");
  private static final JCheckBox hhhmlShowdown = new JCheckBox("HHHML Wins Showdown");
