...
public class GUIAlalyzeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    // @formatter:off
    String helpString = new StringBuilder().append("Welcome to the PeakoldemEvaluator project GUI.\r\n")
            .append("This GUIrund thousands or millions of hands in order to obtain data used in \r\n")
