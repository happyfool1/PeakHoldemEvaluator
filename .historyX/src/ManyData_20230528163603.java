...
public class ManyData implements Constants {
	...
	****************************************************************************** */
	...
	static double[] hmlArrayRiverPer = new double[HML_SIZE_RIVER_SIZE];
	...
	*/
	...
	static int[][] hhhmlMade = new int[HML_SIZE_RIVER][MADE_HANDS_SIZE];
	static int[][] hhhmlShowdown = new int[HML_SIZE_RIVER][MADE_HANDS_SIZE];
