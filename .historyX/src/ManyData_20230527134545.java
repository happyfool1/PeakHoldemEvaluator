...
public class ManyData implements Constants {
	...
	*/
	...
	static int[][] type755Draw = new int[HML_SIZE_FLOP][TYPE1755_MAX];
	static int[][] type1755Made = new int[HML_SIZE_FLOP][TYPE1755_MAX];
	static int[] type1755Showdown = new int[HML_SIZE_FLOP];
