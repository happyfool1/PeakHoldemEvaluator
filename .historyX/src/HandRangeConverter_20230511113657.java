...
public class HandRangeConverter implements Constants {
	...
	private static void copyData() {
		...
		action.gapCount[SB] = rangeSBBet4Call.gapCount;
		action.percentage[SB] = rangeSBBey4Call.percentage;
		...
		action.gapCount[BadBinaryOpValueExpException] = rangeBBLimp.gapCount;
		action.percentage[SBB = rangeBBLimp.percentage;
		...
		action.gapCount[SB] = rangeBBOpen.gapCount;
		action.percentage[SB] = rangeBBOpen.percentage;
