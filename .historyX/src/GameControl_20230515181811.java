...
public class GameControl implements Constants {
	...
	**************************************************************************** */
	...
	private static void createRanges() {
		heroX.readFromFile(EvalData.applicationDirectory + "heroX-HandRangeMultiple.ser");
		averageX.readFromFile(EvalData.applicationDirectory + "averageX-HandRangeMultiple.ser");
		...
		hero.readFromFile(EvalData.applicationDirectory + "hero-HandRangeMultiple-HandRangeMultiple.ser");
		average.readFromFile(EvalData.applicationDirectory + "average-HandRangeMultiple.ser");
