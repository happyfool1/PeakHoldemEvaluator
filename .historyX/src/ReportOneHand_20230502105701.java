...
public class ReportOneHand implements Constants {
	...
	private static final Object[] columnsSummary = { "Type" };
	...
	private static final Object[][] dataDraws = { { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" },
			{ "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" } };
	...
	private static final Object[] columnBoardPossibleArrayFlop = { "Possible Flop hands" };

	private static final Object[][] dataBoardPossibleArrayFlop = { { "" }, { "" }, { "" }, { "" }, { "" }, { "" },
			{ "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" } };

	private static final Object[] columnBoardPossibleArrayTurn = { "Possible Turn hands" };

	private static final Object[][] dataBoardPossibleArrayTurn = { { "" }, { "" }, { "" }, { "" }, { "" }, { "" },
			{ "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" }, { "" } };
	...
	private static final JFrame frame3 = null;
	private static final JFrame frame4 = null;
	private static final JFrame frame5 = null;
	private static final JFrame frame6 = null;
	private static final JFrame frame7 = null;

	private static JTable table1 = null;
	private static final JTable table2 = null;
	private static final JTable table3 = null;
	private static final JTable table4 = null;
	private static final JTable table5 = null;
	private static final JTable table6 = null;
	private static final JTable table71 = null;
	...
	*/
	...
	static void reportHands(int c, int r) {
		...
		table1.setValueAt(Evaluate.holeCardsToString(), row++, 1);

		table1.setValueAt("Board", row, 0);
		table1.setValueAt(Evaluate.boardToString(), row++, 1);
	...
	static void reportSummary(int c, int r) {
		...
		if (frame2 == null) {
			...
			tableModel = new DefaultTableModel(dataSummary, columnsSummary);
			...
			table.setModel(new DefaultTableModel(dataHand, columnsHand));
			table.getColumnModel().getColumn(0).setPreferredWidth(140);
			table.getColumnModel().getColumn(1).setPreferredWidth(120);
		}
		...
		table.setValueAt(String.valueOf(EvalData.madeHand), row++, 1);

		table.setValueAt("bestDraw", row, 0);
		table.setValueAt(String.valueOf(EvalData.bestDraw), row++, 1);
	...
	* All data is in EvalData.boardArray
	...
	/*-
	 * Displays a report of shared data from board evaluation
	 * All data is in EvalData.boardPossibleArrayFlop
	 * 
	 * Arg0 - Column for frame
	 * Arg1 - Row for frame
	 */
	static void reportBoardPossibleArrayFlop(int c, int r) {
		JTable table = null;
		final var ff = new Font(Font.SERIF, Font.BOLD, 14);
		final var frame = new JFrame("Flop  ");
		columnBoardPossibleArrayFlop[0] = "Flop possible draw/hands";
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		frame.setLocation(c, r);
		frame.setPreferredSize(new Dimension(200, 400));
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		final var tableModel = new DefaultTableModel(dataBoardPossibleArrayFlop, columnBoardPossibleArrayFlop);
		table = new JTable(tableModel);
		table.setFont(ff);
		table.setRowHeight(25);
		final var pane = new JScrollPane(table);
		...
		for (int i = 0; i < POSSIBLE_ST.length; ++i) {
			if (EvalData.boardPossibleArrayFlop[i]) {
				table.setValueAt(POSSIBLE_ST[i], row, 0);
				++row;
			}
		}
	}
	 ...
	 * Arg1 - Row for frame
	 */
	static void reportBoardPossibleArrayTurn(int c, int r) {
		JTable table = null;
		final var ff = new Font(Font.SERIF, Font.BOLD, 14);
		final var frame = new JFrame("Turn");
		columnBoardPossibleArrayTurn[0] = "Turn possible draws/hands";
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		frame.setLocation(c, r);
		frame.setPreferredSize(new Dimension(200, 400));
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		final var tableModel = new DefaultTableModel(dataBoardPossibleArrayTurn, columnBoardPossibleArrayTurn);
		table = new JTable(tableModel);
		table.setFont(ff);
		table.setRowHeight(25);
		final var pane = new JScrollPane(table);
