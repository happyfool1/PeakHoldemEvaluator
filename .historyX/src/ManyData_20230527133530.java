...
public class ManyData implements Constants {
	...
	*/
	...
	static int[][] typeDraw = new int[HML_SIZE_FLOP][DRAW_MAX_HANDS];
	static int[][] typeMade = new int[HML_SIZE_FLOP][MADE_MAX_HANDS];
	static int[] yypeShowdown = new int[HML_SIZE_FLOP];
