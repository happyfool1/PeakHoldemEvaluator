...
public class GUIAlalizeMany extends JFrame implements ActionListener, Constants {
    ...
    ***************************************************************************** */
    ...
    private static final JCheckBox hmlDraw = new JCheckBox("HML Draw");
    private static final JCheckBox hmlMade = new JCheckBox("HML Made Hand");
    private static final JCheckBox hmlShowdown = new JCheckBox("HML Wins Showdown");


    private JPanel panelCheckBoxesHHML ;
    private static final JCheckBox hhmlDraw = new JCheckBox("HHML Draw");
    private static final JCheckBox hhmlMade = new JCheckBox("HML Made Hand");
    private static final JCheckBox hhmlShowdown = new JCheckBox("HML Wins Showdown");

  private JPanel panelCheckBoxesHHHML;
  private static final JCheckBox hhhmlDraw = new JCheckBox("HML Draw");
  private static final JCheckBox hhhmlMade = new JCheckBox("HML Made Hand");
  private static final JCheckBox hhhmlShowdown = new JCheckBox("HML Wins Showdown");
