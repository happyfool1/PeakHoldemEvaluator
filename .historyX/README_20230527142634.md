...
This project is used to analyze thousands or millions of simulated hands.
 ...
 This is not a final implementation. We will be experimenting continuously trying to find ways to characterize a Flop that will result in  information on
...
player will call or fold. Far too many other things to describe here. It will be released here nwithin a couple of
months.
