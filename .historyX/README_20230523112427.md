 ...
 This code was originally developed for three projects:
    	game - Simulates a Texas Hold'em 6-max no limit game.
  		...
  		evaluate - This project. I use it to run millions of hands gathering information
  			...
  			how to play any particular Flop. 

About me. I am 80 years old, wrote my first program in 1965. ( in machine language )
	Worked for IBM for 30 years. Wrote 3 compilers and worked on the Fortran optimizer. Most of my career was in manufacturing engoineering. 
	I was a friend of the man that deesigned the IBM PC. Very few even know his name. 
	( Ever wonder why? ) I am retired but still write code to keep my mind sharp.
	A dinasour learning new tricks. 
